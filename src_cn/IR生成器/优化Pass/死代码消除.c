...
函数 消除不可达基本块(IR函数* 函数指针, 死代码消除上下文* 上下文) -> 空类型 {
    如果 (!函数指针 || !上下文) {
        返回;
    }
...
*)cn_rt_array_get_element(r17, r18, 8);
  r20 = r19.已定义;
