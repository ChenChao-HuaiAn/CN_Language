...
void 标记基本块已访问(struct 基本块* cn_var_块) {
  ...
  r4 = cn_var_块->后继列表;
/* P7DBG_STORE src1.kind=1 */  cn_var_后继_0 = r4;
  goto while_cond_8;
  ...
  标记基本块已访问(r6);
  r7 = cn_var_后继_0->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_后继_0 = r7;
  goto while_cond_8;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_块_0 = r5;
  ...
  while_body_16:
  r7 = cn_var_块_0->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_0 = r7;
  goto while_cond_15;
...
void 消除不可达基本块(struct IR函数* cn_var_函数指针, struct 死代码消除上下文* cn_var_上下文) {
  ...
  struct 基本块* cn_var_块_0;
  r6 = cn_var_函数指针->首个块;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_0 = r6;
  struct 基本块* cn_var_前一个_1;
/* P7DBG_STORE src1.kind=2 */  cn_var_前一个_1 = 0;
  goto while_cond_22;
  ...
  r8 = cn_var_块_0->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_下一个_2 = r8;
  r9 = cn_var_块_0->已访问;
  r10 = !r9;
  ...
  if_else_26:
  r20 = cn_var_块_0;
/* P7DBG_STORE src1.kind=1 */  cn_var_前一个_1 = r20;
  goto if_merge_27;

  if_merge_27:
  r21 = cn_var_下一个_2;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_0 = r21;
  goto while_cond_22;
...
struct 使用信息* 创建使用信息数组(long long cn_var_寄存器数量) {
  ...
  r2 = 分配清零内存(r0, r1);
/* P7DBG_STORE src1.kind=1 */  cn_var_信息_0 = r2;
  r3 = cn_var_信息_0;
  return r3;
}
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r19 = cn_var_i_0;
  r20 = r19 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r20;
  goto while_cond_55;
...
_Bool 可以删除指令(struct IR指令* cn_var_指令, struct 使用信息* cn_var_信息) {
  ...
  r14 = cn_var_指令->目标;
  r15 = r14.寄存器编号;
/* P7DBG_STORE src1.kind=1 */  cn_var_编号_0 = r15;
  r17 = cn_var_信息;
  r18 = cn_var_编号_0;
...
void 消除基本块死代码(struct 基本块* cn_var_块, struct 使用信息* cn_var_信息, struct 死代码消除上下文* cn_var_上下文) {
  ...
  struct IR指令* cn_var_指令_0;
  r8 = cn_var_块->首条指令;
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r8;
  struct IR指令* cn_var_前一条_1;
/* P7DBG_STORE src1.kind=2 */  cn_var_前一条_1 = 0;
  goto while_cond_99;
  ...
  r10 = cn_var_指令_0->下一条;
/* P7DBG_STORE src1.kind=1 */  cn_var_下一条_2 = r10;
  r11 = cn_var_指令_0;
  r12 = cn_var_信息;
  r13 = 可以删除指令(r11, r12);
  ...
  if_else_103:
  r23 = cn_var_指令_0;
/* P7DBG_STORE src1.kind=1 */  cn_var_前一条_1 = r23;
  goto if_merge_104;

  if_merge_104:
  r24 = cn_var_下一条_2;
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r24;
  goto while_cond_99;
...
void 消除函数死代码(struct IR函数* cn_var_函数指针, struct 死代码消除上下文* cn_var_上下文) {
  ...
  r8 = r7 + 1;
  r9 = 创建使用信息数组(r8);
/* P7DBG_STORE src1.kind=1 */  cn_var_信息_0 = r9;
  r10 = cn_var_信息_0;
  r11 = !r10;
  ...
  r14 = cn_var_函数指针->首个块;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_1 = r14;
  goto while_cond_117;
  ...
  r19 = cn_var_块_1->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_1 = r19;
  goto while_cond_117;
