...
struct 常量值 操作数转常量值(struct IR操作数 cn_var_操作数) {
  ...
  r9 = r8.种类;
  r10 = r9 == IR操作数种类_小数常量;
  if (r10) goto if_then_3; else goto if_merge_4;
...
struct IR操作数 常量值转操作数(struct 常量值 cn_var_值) {
  ...
  r1 = r0.是常量;
  r2 = !r1;
  if (r2) goto if_then_5; else goto if_merge_6;
  ...
  r5 = r4.种类;
  r6 = r5 == IR操作数种类_整数常量;
  if (r6) goto if_then_7; else goto if_else_8;
  ...
  r12 = cn_var_值;
  r13 = r12.种类;
  r14 = r13 == IR操作数种类_小数常量;
  if (r14) goto if_then_10; else goto if_merge_11;
...
_Bool 折叠二元运算(struct IR指令* cn_var_指令) {
  long long r2, r11, r20, r31, r34, r37, r38, r39, r40, r46, r64, r75;
  struct IR指令* r0;
  struct IR指令* r3;
  struct IR指令* r7;
  struct IR指令* r12;
  ...
  r5 = r4.种类;
  r6 = r5 != IR操作数种类_整数常量;
  if (r6) goto logic_rhs_90; else goto logic_merge_91;
  ...
  r13 = r12->源操作数2;
  r14 = r13.种类;
  r15 = r14 != IR操作数种类_整数常量;
  if (r15) goto logic_rhs_94; else goto logic_merge_95;
  ...
  logic_merge_91:
  if (r10) goto if_then_88; else goto if_merge_89;
  ...
  r22 = r21->源操作数1;
  r23 = r22.种类;
  r24 = r23 == IR操作数种类_整数常量;
  if (r24) goto logic_rhs_98; else goto logic_merge_99;

  logic_rhs_94:
  r16 = cn_var_指令;
  r17 = r16->源操作数2;
  r18 = r17.种类;
  r19 = r18 != IR操作数种类_小数常量;
  goto logic_merge_95;

  logic_merge_95:
  if (r19) goto if_then_92; else goto if_merge_93;
  ...
  r48 = r47->源操作数1;
  r49 = r48.种类;
  r50 = r49 == IR操作数种类_小数常量;
  if (r50) goto logic_merge_103; else goto logic_rhs_102;

  logic_rhs_98:
  r25 = cn_var_指令;
  r26 = r25->源操作数2;
  r27 = r26.种类;
  r28 = r27 == IR操作数种类_整数常量;
  goto logic_merge_99;

  logic_merge_99:
  if (r28) goto if_then_96; else goto if_merge_97;
  ...
  r52 = r51->源操作数2;
  r53 = r52.种类;
  r54 = r53 == IR操作数种类_小数常量;
  goto logic_merge_103;

  logic_merge_103:
  if (r54) goto if_then_100; else goto if_merge_101;
  return 0;
}

_Bool 折叠一元运算(struct IR指令* cn_var_指令) {
  long long r2, r17, r20, r21, r22;
  struct IR指令* r0;
  struct IR指令* r3;
  struct IR指令* r7;
  struct IR指令* r11;
  ...
  r5 = r4.种类;
  r6 = r5 != IR操作数种类_整数常量;
  if (r6) goto logic_rhs_108; else goto logic_merge_109;
  ...
  r12 = r11->源操作数1;
  r13 = r12.种类;
  r14 = r13 == IR操作数种类_整数常量;
  if (r14) goto if_then_110; else goto if_merge_111;
  ...
  logic_merge_109:
  if (r10) goto if_then_106; else goto if_merge_107;
  ...
  r29 = r28->源操作数1;
  r30 = r29.种类;
  r31 = r30 == IR操作数种类_小数常量;
  if (r31) goto if_then_112; else goto if_merge_113;
...
_Bool 折叠指令(struct IR指令* cn_var_指令) {
  ...
  r3 = r2->操作码;
  r4 = r3 == IR指令种类_加法指令;
  if (r4) goto case_body_117; else goto switch_check_137;

  switch_check_137:
  r5 = r3 == IR指令种类_减法指令;
  if (r5) goto case_body_118; else goto switch_check_138;

  switch_check_138:
  r6 = r3 == IR指令种类_乘法指令;
  if (r6) goto case_body_119; else goto switch_check_139;

  switch_check_139:
  r7 = r3 == IR指令种类_除法指令;
  if (r7) goto case_body_120; else goto switch_check_140;

  switch_check_140:
  r8 = r3 == IR指令种类_取模指令;
  if (r8) goto case_body_121; else goto switch_check_141;

  switch_check_141:
  r9 = r3 == IR指令种类_与指令;
  if (r9) goto case_body_122; else goto switch_check_142;

  switch_check_142:
  r10 = r3 == IR指令种类_或指令;
  if (r10) goto case_body_123; else goto switch_check_143;

  switch_check_143:
  r11 = r3 == IR指令种类_异或指令;
  if (r11) goto case_body_124; else goto switch_check_144;

  switch_check_144:
  r12 = r3 == IR指令种类_左移指令;
  if (r12) goto case_body_125; else goto switch_check_145;

  switch_check_145:
  r13 = r3 == IR指令种类_右移指令;
  if (r13) goto case_body_126; else goto switch_check_146;

  switch_check_146:
  r14 = r3 == IR指令种类_相等指令;
  if (r14) goto case_body_127; else goto switch_check_147;

  switch_check_147:
  r15 = r3 == IR指令种类_不等指令;
  if (r15) goto case_body_128; else goto switch_check_148;

  switch_check_148:
  r16 = r3 == IR指令种类_小于指令;
  if (r16) goto case_body_129; else goto switch_check_149;

  switch_check_149:
  r17 = r3 == IR指令种类_小于等于指令;
  if (r17) goto case_body_130; else goto switch_check_150;

  switch_check_150:
  r18 = r3 == IR指令种类_大于指令;
  if (r18) goto case_body_131; else goto switch_check_151;

  switch_check_151:
  r19 = r3 == IR指令种类_大于等于指令;
  if (r19) goto case_body_132; else goto switch_check_152;

  switch_check_152:
  r20 = r3 == IR指令种类_负号指令;
  if (r20) goto case_body_133; else goto switch_check_153;

  switch_check_153:
  r21 = r3 == IR指令种类_取反指令;
  if (r21) goto case_body_134; else goto switch_check_154;

  switch_check_154:
  r22 = r3 == IR指令种类_逻辑非指令;
  if (r22) goto case_body_135; else goto case_default_136;
...
void 折叠基本块(struct 基本块* cn_var_块, struct 常量折叠上下文* cn_var_上下文) {
  ...
  while_cond_159:
  r7 = cn_var_指令_0;
  if (r7) goto while_body_160; else goto while_exit_161;

  while_body_160:
  r8 = cn_var_指令_0;
  r9 = 折叠指令(r8);
  if (r9) goto if_then_162; else goto if_merge_163;
...
void 折叠函数(struct IR函数* cn_var_函数指针, struct 常量折叠上下文* cn_var_上下文) {
  ...
  while_cond_168:
  r7 = cn_var_块_0;
  if (r7) goto while_body_169; else goto while_exit_170;
...
long long 折叠模块(struct IR模块* cn_var_模块) {
  ...
  while_cond_175:
  r8 = cn_var_函数指针_1;
  if (r8) goto while_body_176; else goto while_exit_177;
...
struct 常量传播上下文* 创建常量传播上下文(long long cn_var_寄存器数量) {
  long long r0, r3, r4, r6, r7, r8, r13, r14, r15;
  void* r1;
  struct 常量传播上下文* r2;
  void* r5;
  struct 常量传播上下文* r11;
  ...
  r12 = r11->寄存器值;
  r13 = cn_var_i_1;
    { long long _tmp_r0 = r10; cn_rt_array_set_element(r12, r13, &_tmp_r0, 8); }
  r14 = cn_var_i_1;
  r15 = r14 + 1;
  cn_var_i_1 = r15;
  goto while_cond_187;
...
void 释放常量传播上下文(struct 常量传播上下文* cn_var_上下文) {
  ...
  r1 = cn_var_上下文;
  r2 = r1->寄存器值;
  if (r2) goto if_then_192; else goto if_merge_193;
...
void 设置寄存器常量(struct 常量传播上下文* cn_var_上下文, long long cn_var_寄存器, struct 常量值 cn_var_值) {
  ...
  r12 = r11->寄存器值;
  r13 = cn_var_寄存器;
    { long long _tmp_r1 = r10; cn_rt_array_set_element(r12, r13, &_tmp_r1, 8); }
  ...
  logic_merge_197:
  if (r9) goto if_then_194; else goto if_merge_195;
...
*)cn_rt_array_get_element(r12, r13, 8);
  return r14;
  ...
  logic_merge_203:
  if (r9) goto if_then_200; else goto if_merge_201;
...
_Bool 传播操作数(struct IR操作数* cn_var_操作数, struct 常量传播上下文* cn_var_上下文) {
  ...
  r12 = cn_var_值_0;
  r13 = r12.是常量;
  if (r13) goto if_then_212; else goto if_merge_213;
  ...
  r14 = cn_var_值_0;
  r15 = r14.种类;
  r16 = r15 == IR操作数种类_整数常量;
  if (r16) goto if_then_214; else goto if_else_215;
  ...
  r19 = cn_var_值_0;
  r20 = r19.种类;
  r21 = r20 == IR操作数种类_小数常量;
  if (r21) goto if_then_217; else goto if_merge_218;
...
void 传播指令(struct IR指令* cn_var_指令, struct 常量传播上下文* cn_var_上下文) {
  ...
  r21 = r20->操作码;
  r22 = r21 == IR指令种类_移动指令;
  if (r22) goto logic_rhs_225; else goto logic_merge_226;
  ...
  r28 = r27->源操作数1;
  r29 = r28.种类;
  r30 = r29 == IR操作数种类_整数常量;
  if (r30) goto if_then_227; else goto if_else_228;
  ...
  r24 = r23->目标;
  r25 = r24.种类;
  r26 = r25 == IR操作数种类_虚拟寄存器;
  goto logic_merge_226;

  logic_merge_226:
  if (r26) goto if_then_223; else goto if_merge_224;
  ...
  if (r45) goto if_then_230; else goto if_merge_231;
...
void 传播基本块(struct 基本块* cn_var_块, struct 常量传播上下文* cn_var_上下文) {
  ...
  while_cond_236:
  r7 = cn_var_指令_0;
  if (r7) goto while_body_237; else goto while_exit_238;
...
long long 传播函数(struct IR函数* cn_var_函数指针) {
  ...
  r6 = cn_var_上下文_0;
  r7 = !r6;
  if (r7) goto if_then_241; else goto if_merge_242;
  ...
  while_cond_243:
  r10 = cn_var_块_1;
  if (r10) goto while_body_244; else goto while_exit_245;
...
long long 执行常量优化(struct IR模块* cn_var_模块, long long cn_var_最大迭代次数) {
  long long r2, r3, r8, r10, r11, r14, r16, r17, r18, r19, r20, r21, r23, r24, r25;
  struct IR模块* r0;
  struct IR模块* r5;
  struct IR函数* r6;
  struct IR函数* r7;
  ...
  while_cond_251:
  r7 = cn_var_函数指针_3;
  if (r7) goto while_body_252; else goto while_exit_253;
  ...
  r21 = cn_var_本轮次数_2;
  r22 = r21 == 0;
  if (r22) goto if_then_254; else goto if_merge_255;
