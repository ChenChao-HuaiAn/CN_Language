...
_Bool 折叠二元运算(struct IR指令* cn_var_指令) {
  ...
  r23 = cn_var_指令->源操作数1;
  r24 = r23.整数值;
/* P7DBG_STORE src1.kind=1 */  cn_var_左_0 = r24;
  double cn_var_右_1;
  r25 = cn_var_指令->源操作数2;
  r26 = r25.整数值;
/* P7DBG_STORE src1.kind=1 */  cn_var_右_1 = r26;
  double cn_var_结果_2;
  r27 = cn_var_指令->操作码;
  r28 = cn_var_左_0;
  r29 = cn_var_右_1;
  r30 = 计算整数二元运算(r27, r28, r29);
/* P7DBG_STORE src1.kind=1 */  cn_var_结果_2 = r30;
  r31 = cn_var_结果_2;
  r32 = cn_var_指令->目标;
  r33 = r32.类型信息;
  r34 = 整数常量操作数(r31, r33);
  ...
  r49 = r48.整数值;
  r50 = (r45 ? r47 : r49);
/* P7DBG_STORE src1.kind=1 */  cn_var_左_3 = r50;
  double cn_var_右_4;
  r51 = cn_var_指令->源操作数2;
  r52 = r51.种类;
  ...
  r57 = r56.整数值;
  r58 = (r53 ? r55 : r57);
/* P7DBG_STORE src1.kind=1 */  cn_var_右_4 = r58;
  double cn_var_结果_5;
  r59 = cn_var_指令->操作码;
  r60 = cn_var_左_3;
  r61 = cn_var_右_4;
  r62 = 计算小数二元运算(r59, r60, r61);
/* P7DBG_STORE src1.kind=1 */  cn_var_结果_5 = r62;
  r63 = cn_var_结果_5;
  r64 = cn_var_指令->目标;
  r65 = r64.类型信息;
  r66 = 小数常量操作数(r63, r65);
...
_Bool 折叠一元运算(struct IR指令* cn_var_指令) {
  ...
  r12 = cn_var_指令->源操作数1;
  r13 = r12.整数值;
/* P7DBG_STORE src1.kind=1 */  cn_var_值_0 = r13;
  double cn_var_结果_1;
  r14 = cn_var_指令->操作码;
  r15 = cn_var_值_0;
  r16 = 计算整数一元运算(r14, r15);
/* P7DBG_STORE src1.kind=1 */  cn_var_结果_1 = r16;
  r17 = cn_var_结果_1;
  r18 = cn_var_指令->目标;
  r19 = r18.类型信息;
  r20 = 整数常量操作数(r17, r19);
  ...
  r25 = cn_var_指令->源操作数1;
  r26 = r25.小数值;
/* P7DBG_STORE src1.kind=1 */  cn_var_值_2 = r26;
  double cn_var_结果_3;
  r27 = cn_var_指令->操作码;
  r28 = cn_var_值_2;
  r29 = 计算小数一元运算(r27, r28);
/* P7DBG_STORE src1.kind=1 */  cn_var_结果_3 = r29;
  r30 = cn_var_结果_3;
  r31 = cn_var_指令->目标;
  r32 = r31.类型信息;
  r33 = 小数常量操作数(r30, r32);
...
void 折叠基本块(struct 基本块* cn_var_块, struct 常量折叠上下文* cn_var_上下文) {
  ...
  r5 = cn_var_块->首条指令;
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r5;
  goto while_cond_159;
  ...
  if_merge_163:
  r11 = cn_var_指令_0->下一条;
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r11;
  goto while_cond_159;
  return;
}
...
void 折叠函数(struct IR函数* cn_var_函数指针, struct 常量折叠上下文* cn_var_上下文) {
  ...
  r5 = cn_var_函数指针->首个块;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_0 = r5;
  goto while_cond_168;
  ...
  折叠基本块(r7, r8);
  r9 = cn_var_块_0->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_0 = r9;
  goto while_cond_168;
...
long long 折叠模块(struct IR模块* cn_var_模块) {
  ...
  r2 = cn_var_模块;
  r3 = 创建常量折叠上下文(r2);
/* P7DBG_STORE src1.kind=1 */  cn_var_上下文_0 = r3;
  r4 = cn_var_上下文_0;
  r5 = !r4;
  ...
  r6 = cn_var_模块->首个函数;
/* P7DBG_STORE src1.kind=1 */  cn_var_函数指针_1 = r6;
  goto while_cond_175;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_函数指针_1 = r10;
  goto while_cond_175;

  while_exit_177:
  long long cn_var_次数_2;
  r11 = cn_var_上下文_0->折叠次数;
/* P7DBG_STORE src1.kind=1 */  cn_var_次数_2 = r11;
  r12 = cn_var_上下文_0;
  释放常量折叠上下文(r12);
  r13 = cn_var_次数_2;
  return r13;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_总次数_0 = 0;
  long long cn_var_迭代_1;
/* P7DBG_STORE src1.kind=2 */  cn_var_迭代_1 = 0;
  goto while_cond_180;
  ...
  r5 = cn_var_模块;
  r6 = 折叠模块(r5);
/* P7DBG_STORE src1.kind=1 */  cn_var_次数_2 = r6;
  r7 = cn_var_总次数_0;
  r8 = cn_var_次数_2;
  r9 = r7 + r8;
/* P7DBG_STORE src1.kind=1 */  cn_var_总次数_0 = r9;
  r10 = cn_var_次数_2;
  r11 = r10 == 0;
  ...
  r12 = cn_var_迭代_1;
  r13 = r12 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_迭代_1 = r13;
  goto while_cond_180;
  return 0;
}
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_1 = 0;
  ...
  r12 = cn_var_i_1;
  r13 = &r11[r12];
/* P7DBG_STORE src1.kind=1 */  *r13 = r10;
  r14 = cn_var_i_1;
  r15 = r14 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_1 = r15;
  goto while_cond_187;
...
void 设置寄存器常量(struct 常量传播上下文* cn_var_上下文, long long cn_var_寄存器, struct 常量值 cn_var_值) {
  ...
  r11 = cn_var_寄存器;
  r12 = &r10[r11];
/* P7DBG_STORE src1.kind=1 */  *r12 = r9;
...
struct 常量值 获取寄存器常量(struct 常量传播上下文* cn_var_上下文, long long cn_var_寄存器) {
  ...
  r10 = cn_var_上下文->寄存器值;
  r11 = cn_var_寄存器;
  r12 = (struct 常量值*)cn_rt_array_get_element(r10, r11, 8);
  return r12;
...
_Bool 传播操作数(struct IR操作数* cn_var_操作数, struct 常量传播上下文* cn_var_上下文) {
  ...
  r8 = cn_var_操作数->寄存器编号;
  r9 = 获取寄存器常量(r7, r8);
/* P7DBG_STORE src1.kind=1 */  cn_var_值_0 = r9;
  r10 = cn_var_值_0.是常量;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r5;
  ...
  传播指令(r7, r8);
  r9 = cn_var_指令_0->下一条;
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r9;
  goto while_cond_236;
...
long long 传播函数(struct IR函数* cn_var_函数指针) {
  ...
  r3 = r2 + 1;
  r4 = 创建常量传播上下文(r3);
/* P7DBG_STORE src1.kind=1 */  cn_var_上下文_0 = r4;
  r5 = cn_var_上下文_0;
  r6 = !r5;
  ...
  r7 = cn_var_函数指针->首个块;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_1 = r7;
  goto while_cond_243;
  ...
  传播基本块(r9, r10);
  r11 = cn_var_块_1->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_1 = r11;
  goto while_cond_243;

  while_exit_245:
  long long cn_var_次数_2;
  r12 = cn_var_上下文_0->传播次数;
/* P7DBG_STORE src1.kind=1 */  cn_var_次数_2 = r12;
  r13 = cn_var_上下文_0;
  释放常量传播上下文(r13);
  r14 = cn_var_次数_2;
  return r14;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_本轮次数_2 = 0;
  struct IR函数* cn_var_函数指针_3;
  r5 = cn_var_模块->首个函数;
/* P7DBG_STORE src1.kind=1 */  cn_var_函数指针_3 = r5;
  goto while_cond_251;
  ...
  r9 = 传播函数(r8);
  r10 = r7 + r9;
/* P7DBG_STORE src1.kind=1 */  cn_var_本轮次数_2 = r10;
  r11 = cn_var_函数指针_3->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_函数指针_3 = r11;
  goto while_cond_251;
  ...
  r14 = 折叠模块(r13);
  r15 = r12 + r14;
/* P7DBG_STORE src1.kind=1 */  cn_var_本轮次数_2 = r15;
  r16 = cn_var_总次数_0;
  r17 = cn_var_本轮次数_2;
  r18 = r16 + r17;
/* P7DBG_STORE src1.kind=1 */  cn_var_总次数_0 = r18;
  r19 = cn_var_本轮次数_2;
  r20 = r19 == 0;
  ...
  r21 = cn_var_迭代_1;
  r22 = r21 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_迭代_1 = r22;
  goto while_cond_248;
  return 0;
}
