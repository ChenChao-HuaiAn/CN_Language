...
struct IR模块* 创建IR模块() {
  ...
  cn_var_模块_0 = r1;
  r2 = cn_var_模块_0;
  if (r2) goto if_then_2760; else goto if_merge_2761;
...
void 释放IR模块(struct IR模块* cn_var_模块) {
  ...
  r0 = cn_var_模块;
  r1 = !r0;
  if (r1) goto if_then_2762; else goto if_merge_2763;
  ...
  r3 = r2->首个全局;
  cn_var_全局_0 = r3;
  goto while_cond_2764;

  while_cond_2764:
  r4 = cn_var_全局_0;
  if (r4) goto while_body_2765; else goto while_exit_2766;
  ...
  r7 = cn_var_全局_0;
  r8 = r7->名称;
  if (r8) goto if_then_2767; else goto if_merge_2768;
  ...
  while_cond_2769:
  r15 = cn_var_函数指针_2;
  if (r15) goto while_body_2770; else goto while_exit_2771;
...
struct IR函数* 创建IR函数(char* cn_var_名称, struct 类型节点* cn_var_返回类型) {
  ...
  cn_var_函数指针_0 = r1;
  r2 = cn_var_函数指针_0;
  if (r2) goto if_then_2772; else goto if_merge_2773;
...
void 释放IR函数(struct IR函数* cn_var_函数指针) {
  ...
  r3 = r2->首个静态变量;
  cn_var_当前静态_0 = r3;
  goto while_cond_2776;

  while_cond_2776:
  r4 = cn_var_当前静态_0;
  if (r4) goto while_body_2777; else goto while_exit_2778;
  ...
  while_cond_2781:
  r15 = cn_var_块_2;
  if (r15) goto while_body_2782; else goto while_exit_2783;
  ...
  r20 = cn_var_函数指针;
  r21 = r20->参数列表;
  if (r21) goto if_then_2784; else goto if_merge_2785;
  ...
  r24 = cn_var_函数指针;
  r25 = r24->局部变量;
  if (r25) goto if_then_2786; else goto if_merge_2787;
  ...
  r28 = cn_var_函数指针;
  r29 = r28->名称;
  if (r29) goto if_then_2788; else goto if_merge_2789;
...
void 添加函数参数(struct IR函数* cn_var_函数指针, struct IR操作数 cn_var_参数) {
  ...
  r0 = cn_var_函数指针;
  r1 = !r0;
  if (r1) goto if_then_2790; else goto if_merge_2791;
...
void 添加局部变量(struct IR函数* cn_var_函数指针, struct IR操作数 cn_var_局部变量值) {
  ...
  r0 = cn_var_函数指针;
  r1 = !r0;
  if (r1) goto if_then_2792; else goto if_merge_2793;
...
void 添加基本块(struct IR函数* cn_var_函数指针, struct 基本块* cn_var_块) {
  ...
  r1 = cn_var_函数指针;
  r2 = !r1;
  if (r2) goto logic_merge_2797; else goto logic_rhs_2796;
  ...
  r6 = r5->首个块;
  r7 = !r6;
  if (r7) goto if_then_2798; else goto if_else_2799;

  logic_rhs_2796:
  r3 = cn_var_块;
  r4 = !r3;
  goto logic_merge_2797;

  logic_merge_2797:
  if (r4) goto if_then_2794; else goto if_merge_2795;
...
void 添加静态变量(struct IR函数* cn_var_函数指针, struct 静态变量* cn_var_静态变量指针) {
  ...
  r1 = cn_var_函数指针;
  r2 = !r1;
  if (r2) goto logic_merge_2804; else goto logic_rhs_2803;
  ...
  r6 = r5->首个静态变量;
  r7 = !r6;
  if (r7) goto if_then_2805; else goto if_else_2806;

  logic_rhs_2803:
  r3 = cn_var_静态变量指针;
  r4 = !r3;
  goto logic_merge_2804;

  logic_merge_2804:
  if (r4) goto if_then_2801; else goto if_merge_2802;
...
long long 分配寄存器(struct IR函数* cn_var_函数指针) {
  ...
  r0 = cn_var_函数指针;
  r1 = !r0;
  if (r1) goto if_then_2808; else goto if_merge_2809;
...
struct 基本块* 创建基本块(char* cn_var_名称提示) {
  ...
  cn_var_块_0 = r1;
  r2 = cn_var_块_0;
  if (r2) goto if_then_2810; else goto if_merge_2811;
...
void 释放基本块(struct 基本块* cn_var_块) {
  ...
  r0 = cn_var_块;
  r1 = !r0;
  if (r1) goto if_then_2812; else goto if_merge_2813;
  ...
  r3 = r2->首条指令;
  cn_var_指令_0 = r3;
  goto while_cond_2814;

  while_cond_2814:
  r4 = cn_var_指令_0;
  if (r4) goto while_body_2815; else goto while_exit_2816;
  ...
  r13 = cn_var_块;
  r14 = r13->名称;
  if (r14) goto if_then_2817; else goto if_merge_2818;
...
void 释放基本块列表(struct 基本块节点* cn_var_列表) {
  ...
  entry:
  goto while_cond_2819;

  while_cond_2819:
  r0 = cn_var_列表;
  if (r0) goto while_body_2820; else goto while_exit_2821;
...
void 添加指令(struct 基本块* cn_var_块, struct IR指令* cn_var_指令) {
  ...
  r1 = cn_var_块;
  r2 = !r1;
  if (r2) goto logic_merge_2825; else goto logic_rhs_2824;
  ...
  r6 = r5->首条指令;
  r7 = !r6;
  if (r7) goto if_then_2826; else goto if_else_2827;

  logic_rhs_2824:
  r3 = cn_var_指令;
  r4 = !r3;
  goto logic_merge_2825;

  logic_merge_2825:
  if (r4) goto if_then_2822; else goto if_merge_2823;
...
void 连接基本块(struct 基本块* cn_var_源块, struct 基本块* cn_var_目标块) {
  ...
  r1 = cn_var_源块;
  r2 = !r1;
  if (r2) goto logic_merge_2832; else goto logic_rhs_2831;
  ...
  r3 = cn_var_目标块;
  r4 = !r3;
  goto logic_merge_2832;

  logic_merge_2832:
  if (r4) goto if_then_2829; else goto if_merge_2830;
  return;
}
...
struct IR指令* 创建IR指令(enum IR操作码 cn_var_操作码, struct IR操作数 cn_var_目标, struct IR操作数 cn_var_源1, struct IR操作数 cn_var_源2) {
  ...
  cn_var_指令_0 = r1;
  r2 = cn_var_指令_0;
  if (r2) goto if_then_2833; else goto if_merge_2834;
...
void 释放IR指令(struct IR指令* cn_var_指令) {
  ...
  r0 = cn_var_指令;
  r1 = !r0;
  if (r1) goto if_then_2835; else goto if_merge_2836;
  ...
  r2 = cn_var_指令;
  r3 = r2->额外参数;
  if (r3) goto if_then_2837; else goto if_merge_2838;
...
struct 全局变量* 创建全局变量(char* cn_var_名称, struct 类型节点* cn_var_类型, struct IR操作数 cn_var_初始值, _Bool cn_var_是常量) {
  ...
  cn_var_全局变量指针_0 = r1;
  r2 = cn_var_全局变量指针_0;
  if (r2) goto if_then_2839; else goto if_merge_2840;
...
void 添加全局变量(struct IR模块* cn_var_模块, struct 全局变量* cn_var_全局变量指针) {
  ...
  r1 = cn_var_模块;
  r2 = !r1;
  if (r2) goto logic_merge_2844; else goto logic_rhs_2843;
  ...
  r6 = r5->首个全局;
  r7 = !r6;
  if (r7) goto if_then_2845; else goto if_else_2846;

  logic_rhs_2843:
  r3 = cn_var_全局变量指针;
  r4 = !r3;
  goto logic_merge_2844;

  logic_merge_2844:
  if (r4) goto if_then_2841; else goto if_merge_2842;
...
void 添加函数(struct IR模块* cn_var_模块, struct IR函数* cn_var_函数指针) {
  ...
  r1 = cn_var_模块;
  r2 = !r1;
  if (r2) goto logic_merge_2851; else goto logic_rhs_2850;
  ...
  r6 = r5->首个函数;
  r7 = !r6;
  if (r7) goto if_then_2852; else goto if_else_2853;

  logic_rhs_2850:
  r3 = cn_var_函数指针;
  r4 = !r3;
  goto logic_merge_2851;

  logic_merge_2851:
  if (r4) goto if_then_2848; else goto if_merge_2849;
...
struct 静态变量* 创建静态变量(char* cn_var_名称, struct 类型节点* cn_var_类型, struct IR操作数 cn_var_初始值) {
  ...
  cn_var_静态变量指针_0 = r1;
  r2 = cn_var_静态变量指针_0;
  if (r2) goto if_then_2855; else goto if_merge_2856;
