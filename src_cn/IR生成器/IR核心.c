...
void 释放IR模块(struct IR模块* cn_var_模块) {
  ...
  while_cond_2880:
  r4 = cn_var_全局_0;
  if (r4) goto while_body_2881; else goto while_exit_2882;
  ...
  r7 = cn_var_全局_0;
  r8 = r7->名称;
  if (r8) goto if_then_2883; else goto if_merge_2884;
  ...
  while_cond_2885:
  r15 = cn_var_函数指针_2;
  if (r15) goto while_body_2886; else goto while_exit_2887;
...
void 释放IR函数(struct IR函数* cn_var_函数指针) {
  ...
  while_cond_2892:
  r4 = cn_var_当前静态_0;
  if (r4) goto while_body_2893; else goto while_exit_2894;
  ...
  r7 = cn_var_当前静态_0;
  r8 = r7->名称;
  if (r8) goto if_then_2895; else goto if_merge_2896;
  ...
  while_cond_2897:
  r15 = cn_var_块_2;
  if (r15) goto while_body_2898; else goto while_exit_2899;
  ...
  r20 = cn_var_函数指针;
  r21 = r20->参数列表;
  if (r21) goto if_then_2900; else goto if_merge_2901;
  ...
  r24 = cn_var_函数指针;
  r25 = r24->局部变量;
  if (r25) goto if_then_2902; else goto if_merge_2903;
  ...
  r28 = cn_var_函数指针;
  r29 = r28->名称;
  if (r29) goto if_then_2904; else goto if_merge_2905;
...
void 添加基本块(struct IR函数* cn_var_函数指针, struct 基本块* cn_var_块) {
  ...
  r6 = r5->首个块;
  r7 = !r6;
  if (r7) goto if_then_2914; else goto if_else_2915;
...
void 添加静态变量(struct IR函数* cn_var_函数指针, struct 静态变量* cn_var_静态变量指针) {
  ...
  r6 = r5->首个静态变量;
  r7 = !r6;
  if (r7) goto if_then_2921; else goto if_else_2922;
...
void 释放基本块(struct 基本块* cn_var_块) {
  ...
  while_cond_2930:
  r4 = cn_var_指令_0;
  if (r4) goto while_body_2931; else goto while_exit_2932;
  ...
  r13 = cn_var_块;
  r14 = r13->名称;
  if (r14) goto if_then_2933; else goto if_merge_2934;
...
void 添加指令(struct 基本块* cn_var_块, struct IR指令* cn_var_指令) {
  ...
  r6 = r5->首条指令;
  r7 = !r6;
  if (r7) goto if_then_2942; else goto if_else_2943;
...
void 释放IR指令(struct IR指令* cn_var_指令) {
  ...
  r2 = cn_var_指令;
  r3 = r2->额外参数;
  if (r3) goto if_then_2953; else goto if_merge_2954;
...
void 添加全局变量(struct IR模块* cn_var_模块, struct 全局变量* cn_var_全局变量指针) {
  ...
  r6 = r5->首个全局;
  r7 = !r6;
  if (r7) goto if_then_2961; else goto if_else_2962;
...
void 添加函数(struct IR模块* cn_var_模块, struct IR函数* cn_var_函数指针) {
  ...
  r6 = r5->首个函数;
  r7 = !r6;
  if (r7) goto if_then_2968; else goto if_else_2969;
