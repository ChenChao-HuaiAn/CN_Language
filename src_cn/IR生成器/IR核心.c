...
struct IR模块* 创建IR模块() {
  ...
  cn_var_模块_0 = /* NONE */;
  r1 = cn_var_模块_0;
  if (r1) goto if_then_2768; else goto if_merge_2769;

  if_then_2768:
  r2 = cn_var_模块_0;
  r3 = r2->目标信息;
  r4 = sizeof(struct 目标三元组);
  设置内存(r3, 0, r4);
  goto if_merge_2769;
...
struct IR函数* 创建IR函数(char* cn_var_名称, struct 类型节点* cn_var_返回类型) {
  ...
  cn_var_函数指针_0 = /* NONE */;
  r1 = cn_var_函数指针_0;
  if (r1) goto if_then_2780; else goto if_merge_2781;
...
void 添加函数参数(struct IR函数* cn_var_函数指针, struct IR操作数 cn_var_参数) {
  long long r1, r5, r6, r7, r8, r13, r15, r16;
  void* r3;
  void* r11;
  struct IR函数* r0;
  struct IR函数* r2;
  ...
  r12 = cn_var_函数指针;
  r13 = r12->参数数量;
    { long long _tmp_r10 = r9; cn_rt_array_set_element(r11, r13, &_tmp_r10, 8); }
  r14 = cn_var_函数指针;
  r15 = r14->参数数量;
  r16 = r15 + 1;
  return;
...
void 添加局部变量(struct IR函数* cn_var_函数指针, struct IR操作数 cn_var_局部变量值) {
  ...
  r12 = cn_var_函数指针;
  r13 = r12->局部变量数量;
    { long long _tmp_r11 = r9; cn_rt_array_set_element(r11, r13, &_tmp_r11, 8); }
  r14 = cn_var_函数指针;
  r15 = r14->局部变量数量;
  r16 = r15 + 1;
  return;
...
struct 基本块* 创建基本块(char* cn_var_名称提示) {
  ...
  cn_var_块_0 = /* NONE */;
  r1 = cn_var_块_0;
  if (r1) goto if_then_2818; else goto if_merge_2819;
...
struct 全局变量* 创建全局变量(char* cn_var_名称, struct 类型节点* cn_var_类型, struct IR操作数 cn_var_初始值, _Bool cn_var_是常量) {
  ...
  分配内存(r0);
  cn_var_全局变量指针_0 = /* NONE */;
  r1 = cn_var_全局变量指针_0;
  if (r1) goto if_then_2847; else goto if_merge_2848;
...
struct 静态变量* 创建静态变量(char* cn_var_名称, struct 类型节点* cn_var_类型, struct IR操作数 cn_var_初始值) {
  ...
  分配内存(r0);
  cn_var_静态变量指针_0 = /* NONE */;
  r1 = cn_var_静态变量指针_0;
  if (r1) goto if_then_2863; else goto if_merge_2864;
