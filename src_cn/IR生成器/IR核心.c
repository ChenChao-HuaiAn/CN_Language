...
void 释放IR模块(struct IR模块* cn_var_模块) {
  ...
  while_cond_4:
  r4 = cn_var_全局_0;
  if (r4) goto while_body_5; else goto while_exit_6;
  ...
  r7 = cn_var_全局_0;
  r8 = r7->名称;
  if (r8) goto if_then_7; else goto if_merge_8;
  ...
  while_cond_9:
  r15 = cn_var_函数指针_2;
  if (r15) goto while_body_10; else goto while_exit_11;
...
void 释放IR函数(struct IR函数* cn_var_函数指针) {
  ...
  while_cond_16:
  r4 = cn_var_当前静态_0;
  if (r4) goto while_body_17; else goto while_exit_18;
  ...
  r7 = cn_var_当前静态_0;
  r8 = r7->名称;
  if (r8) goto if_then_19; else goto if_merge_20;
  ...
  while_cond_21:
  r15 = cn_var_块_2;
  if (r15) goto while_body_22; else goto while_exit_23;
  ...
  r20 = cn_var_函数指针;
  r21 = r20->参数列表;
  if (r21) goto if_then_24; else goto if_merge_25;
  ...
  r24 = cn_var_函数指针;
  r25 = r24->局部变量;
  if (r25) goto if_then_26; else goto if_merge_27;
...
void 添加函数参数(struct IR函数* cn_var_函数指针, struct IR操作数 cn_var_参数) {
  long long r5, r6, r7, r8, r14, r16, r17;
  struct IR函数* r0;
  struct IR函数* r2;
  struct IR操作数* r3;
  struct IR函数* r4;
...
void 添加基本块(struct IR函数* cn_var_函数指针, struct 基本块* cn_var_块) {
  ...
  r6 = r5->首个块;
  r7 = !r6;
  if (r7) goto if_then_38; else goto if_else_39;
...
void 添加静态变量(struct IR函数* cn_var_函数指针, struct 静态变量* cn_var_静态变量指针) {
  ...
  r6 = r5->首个静态变量;
  r7 = !r6;
  if (r7) goto if_then_45; else goto if_else_46;
...
void 释放基本块(struct 基本块* cn_var_块) {
  ...
  while_cond_54:
  r4 = cn_var_指令_0;
  if (r4) goto while_body_55; else goto while_exit_56;
  ...
  r13 = cn_var_块;
  r14 = r13->名称;
  if (r14) goto if_then_57; else goto if_merge_58;
...
void 添加指令(struct 基本块* cn_var_块, struct IR指令* cn_var_指令) {
  ...
  r6 = r5->首条指令;
  r7 = !r6;
  if (r7) goto if_then_66; else goto if_else_67;
...
void 释放IR指令(struct IR指令* cn_var_指令) {
  ...
  r2 = cn_var_指令;
  r3 = r2->额外参数;
  if (r3) goto if_then_77; else goto if_merge_78;
...
void 添加全局变量(struct IR模块* cn_var_模块, struct 全局变量* cn_var_全局变量指针) {
  ...
  r6 = r5->首个全局;
  r7 = !r6;
  if (r7) goto if_then_85; else goto if_else_86;
...
void 添加函数(struct IR模块* cn_var_模块, struct IR函数* cn_var_函数指针) {
  ...
  r6 = r5->首个函数;
  r7 = !r6;
  if (r7) goto if_then_92; else goto if_else_93;
