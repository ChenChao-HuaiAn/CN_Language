...
struct IR模块* 创建IR模块() {
  ...
  cn_var_模块_0 = r1;
  r2 = cn_var_模块_0;
  if (r2) goto if_then_1046; else goto if_merge_1047;
...
void 释放IR模块(struct IR模块* cn_var_模块) {
  long long r1, r2, r4, r5, r6, r9, r11;
  struct IR模块* r0;
  struct 全局变量* r3;
  struct 全局变量* r7;
  struct 全局变量* r8;
  ...
  r0 = cn_var_模块;
  r1 = !r0;
  if (r1) goto if_then_1048; else goto if_merge_1049;
  ...
  r2 = cn_var_模块.首个全局;
  cn_var_全局_0 = r2;
  goto while_cond_1050;

  while_cond_1050:
  r3 = cn_var_全局_0;
  if (r3) goto while_body_1051; else goto while_exit_1052;
  ...
  cn_var_下个_1 = r4;
  r5 = cn_var_全局_0->名称;
  if (r5) goto if_then_1053; else goto if_merge_1054;

  while_exit_1052:
  struct IR函数* cn_var_函数指针_2;
  r9 = cn_var_模块.首个函数;
  cn_var_函数指针_2 = r9;
  goto while_cond_1055;
  ...
  while_cond_1055:
  r10 = cn_var_函数指针_2;
  if (r10) goto while_body_1056; else goto while_exit_1057;
...
struct IR函数* 创建IR函数(const char* cn_var_名称, struct 类型节点* cn_var_返回类型) {
  ...
  cn_var_函数指针_0 = r1;
  r2 = cn_var_函数指针_0;
  if (r2) goto if_then_1058; else goto if_merge_1059;
...
void 释放IR函数(struct IR函数* cn_var_函数指针) {
  long long r1, r2, r4, r5, r6, r9, r11, r14, r15, r16, r17, r18, r19;
  struct IR函数* r0;
  struct 静态变量* r3;
  struct 静态变量* r7;
  struct 静态变量* r8;
  ...
  r0 = cn_var_函数指针;
  r1 = !r0;
  if (r1) goto if_then_1060; else goto if_merge_1061;
  ...
  cn_var_当前静态_0 = r2;
  goto while_cond_1062;

  while_cond_1062:
  r3 = cn_var_当前静态_0;
  if (r3) goto while_body_1063; else goto while_exit_1064;
  ...
  cn_var_下个_1 = r4;
  r5 = cn_var_当前静态_0->名称;
  if (r5) goto if_then_1065; else goto if_merge_1066;

  while_exit_1064:
  struct 基本块* cn_var_块_2;
  r9 = cn_var_函数指针.首个块;
  cn_var_块_2 = r9;
  goto while_cond_1067;
  ...
  while_cond_1067:
  r10 = cn_var_块_2;
  if (r10) goto while_body_1068; else goto while_exit_1069;
  ...
  if (r14) goto if_then_1070; else goto if_merge_1071;
  ...
  if (r16) goto if_then_1072; else goto if_merge_1073;
  ...
  if_merge_1073:
  r18 = cn_var_函数指针.名称;
  if (r18) goto if_then_1074; else goto if_merge_1075;
...
void 添加函数参数(struct IR函数* cn_var_函数指针, struct IR操作数 cn_var_参数) {
  long long r1, r2, r3, r4, r5, r6, r9, r10, r11, r12;
  struct IR函数* r0;
  void* r7;
  struct 参数 r8;
  ...
  r0 = cn_var_函数指针;
  r1 = !r0;
  if (r1) goto if_then_1076; else goto if_merge_1077;
  ...
  r10 = cn_var_函数指针.参数数量;
    { long long _tmp_r8 = r8; cn_rt_array_set_element(r9, r10, &_tmp_r8, 8); }
...
void 添加局部变量(struct IR函数* cn_var_函数指针, struct IR操作数 cn_var_局部变量值) {
  ...
  r0 = cn_var_函数指针;
  r1 = !r0;
  if (r1) goto if_then_1078; else goto if_merge_1079;
  ...
  r10 = cn_var_函数指针.局部变量数量;
    { long long _tmp_r9 = r8; cn_rt_array_set_element(r9, r10, &_tmp_r9, 8); }
...
void 添加基本块(struct IR函数* cn_var_函数指针, struct 基本块* cn_var_块) {
  ...
  r1 = cn_var_函数指针;
  r2 = !r1;
  if (r2) goto logic_merge_1083; else goto logic_rhs_1082;
  ...
  r5 = cn_var_函数指针.首个块;
  r6 = !r5;
  if (r6) goto if_then_1084; else goto if_else_1085;
  ...
  logic_merge_1083:
  if (r4) goto if_then_1080; else goto if_merge_1081;
...
void 添加静态变量(struct IR函数* cn_var_函数指针, struct 静态变量* cn_var_静态变量指针) {
  ...
  r1 = cn_var_函数指针;
  r2 = !r1;
  if (r2) goto logic_merge_1090; else goto logic_rhs_1089;
  ...
  r6 = !r5;
  if (r6) goto if_then_1091; else goto if_else_1092;

  logic_rhs_1089:
  r3 = cn_var_静态变量指针;
  r4 = !r3;
  goto logic_merge_1090;

  logic_merge_1090:
  if (r4) goto if_then_1087; else goto if_merge_1088;
...
long long 分配寄存器(struct IR函数* cn_var_函数指针) {
  ...
  r0 = cn_var_函数指针;
  r1 = !r0;
  if (r1) goto if_then_1094; else goto if_merge_1095;
...
struct 基本块* 创建基本块(const char* cn_var_名称提示) {
  ...
  cn_var_块_0 = r1;
  r2 = cn_var_块_0;
  if (r2) goto if_then_1096; else goto if_merge_1097;
...
void 释放基本块(struct 基本块* cn_var_块) {
  long long r1, r2, r4, r7, r8, r9, r10;
  struct 基本块* r0;
  struct IR指令* r3;
  struct IR指令* r5;
  struct IR指令* r6;
  ...
  while_cond_1100:
  r3 = cn_var_指令_0;
  if (r3) goto while_body_1101; else goto while_exit_1102;
  ...
  释放基本块列表(r8);
  r9 = cn_var_块.名称;
  if (r9) goto if_then_1103; else goto if_merge_1104;
...
void 释放基本块列表(struct 基本块节点* cn_var_列表) {
  ...
  entry:
  goto while_cond_1105;

  while_cond_1105:
  r0 = cn_var_列表;
  if (r0) goto while_body_1106; else goto while_exit_1107;
...
void 添加指令(struct 基本块* cn_var_块, struct IR指令* cn_var_指令) {
  ...
  r1 = cn_var_块;
  r2 = !r1;
  if (r2) goto logic_merge_1111; else goto logic_rhs_1110;
  ...
  r5 = cn_var_块.首条指令;
  r6 = !r5;
  if (r6) goto if_then_1112; else goto if_else_1113;

  logic_rhs_1110:
  r3 = cn_var_指令;
  r4 = !r3;
  goto logic_merge_1111;

  logic_merge_1111:
  if (r4) goto if_then_1108; else goto if_merge_1109;
...
void 连接基本块(struct 基本块* cn_var_源块, struct 基本块* cn_var_目标块) {
  long long r0, r2, r4, r5, r8, r10, r13;
  struct 基本块* r1;
  struct 基本块* r3;
  void* r6;
  struct 基本块* r7;
  ...
  r1 = cn_var_源块;
  r2 = !r1;
  if (r2) goto logic_merge_1118; else goto logic_rhs_1117;
  ...
  r3 = cn_var_目标块;
  r4 = !r3;
  goto logic_merge_1118;

  logic_merge_1118:
  if (r4) goto if_then_1115; else goto if_merge_1116;
  return;
}
...
struct IR指令* 创建IR指令(enum IR操作码 cn_var_操作码, struct IR操作数 cn_var_目标, struct IR操作数 cn_var_源1, struct IR操作数 cn_var_源2) {
  ...
  cn_var_指令_0 = r1;
  r2 = cn_var_指令_0;
  if (r2) goto if_then_1119; else goto if_merge_1120;
...
void 释放IR指令(struct IR指令* cn_var_指令) {
  ...
  if_merge_1122:
  r2 = cn_var_指令.额外参数;
  if (r2) goto if_then_1123; else goto if_merge_1124;
...
struct 全局变量* 创建全局变量(const char* cn_var_名称, struct 类型节点* cn_var_类型, struct IR操作数 cn_var_初始值, _Bool cn_var_是常量) {
  ...
  cn_var_全局变量指针_0 = r1;
  r2 = cn_var_全局变量指针_0;
  if (r2) goto if_then_1125; else goto if_merge_1126;
...
void 添加全局变量(struct IR模块* cn_var_模块, struct 全局变量* cn_var_全局变量指针) {
  ...
  r1 = cn_var_模块;
  r2 = !r1;
  if (r2) goto logic_merge_1130; else goto logic_rhs_1129;
  ...
  r5 = cn_var_模块.首个全局;
  r6 = !r5;
  if (r6) goto if_then_1131; else goto if_else_1132;

  logic_rhs_1129:
  r3 = cn_var_全局变量指针;
  r4 = !r3;
  goto logic_merge_1130;

  logic_merge_1130:
  if (r4) goto if_then_1127; else goto if_merge_1128;
...
void 添加函数(struct IR模块* cn_var_模块, struct IR函数* cn_var_函数指针) {
  ...
  r1 = cn_var_模块;
  r2 = !r1;
  if (r2) goto logic_merge_1137; else goto logic_rhs_1136;
  ...
  r5 = cn_var_模块.首个函数;
  r6 = !r5;
  if (r6) goto if_then_1138; else goto if_else_1139;

  logic_rhs_1136:
  r3 = cn_var_函数指针;
  r4 = !r3;
  goto logic_merge_1137;
...
struct 静态变量* 创建静态变量(const char* cn_var_名称, struct 类型节点* cn_var_类型, struct IR操作数 cn_var_初始值) {
  ...
  cn_var_静态变量指针_0 = r1;
  r2 = cn_var_静态变量指针_0;
  if (r2) goto if_then_1141; else goto if_merge_1142;
