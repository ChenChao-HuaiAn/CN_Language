...
struct IR操作数 生成表达式IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  long long r1, r5, r7, r9, r11, r15, r17, r27, r29, r32, r48;
  char* r42;
  struct 表达式节点* r0;
  struct 表达式节点* r3;
  struct 表达式节点* r31;
  ...
  r13 = cn_var_标识符表达式;
  r14 = r4 == r13;
  if (r14) goto case_body_2945; else goto switch_check_2959;

  switch_check_2959:
  r15 = cn_var_二元运算表达式;
  r16 = r4 == r15;
  if (r16) goto case_body_2946; else goto switch_check_2960;

  switch_check_2960:
  r17 = cn_var_一元运算表达式;
  r18 = r4 == r17;
  if (r18) goto case_body_2947; else goto switch_check_2961;

  switch_check_2961:
  r19 = cn_var_函数调用表达式;
  r20 = r4 == r19;
  if (r20) goto case_body_2948; else goto switch_check_2962;

  switch_check_2962:
  r21 = cn_var_成员访问表达式;
  r22 = r4 == r21;
  if (r22) goto case_body_2949; else goto switch_check_2963;

  switch_check_2963:
  r23 = cn_var_数组访问表达式;
  r24 = r4 == r23;
  if (r24) goto case_body_2950; else goto switch_check_2964;

  switch_check_2964:
  r25 = cn_var_赋值表达式;
  r26 = r4 == r25;
  if (r26) goto case_body_2951; else goto switch_check_2965;

  switch_check_2965:
  r27 = cn_var_取地址表达式;
  r28 = r4 == r27;
  if (r28) goto case_body_2952; else goto switch_check_2966;

  switch_check_2966:
  r29 = cn_var_解引用表达式;
  r30 = r4 == r29;
  if (r30) goto case_body_2953; else goto case_default_2954;
...
struct IR操作数 生成赋值IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r13 = cn_var_标识符表达式;
  r14 = r12 == r13;
  if (r14) goto if_then_3014; else goto if_else_3015;
  ...
  cn_var_唯一名_1 = r19;
  r20 = cn_var_唯一名_1;
  if (r20) goto if_then_3017; else goto if_merge_3018;
...
void 生成语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r7 = cn_var_表达式语句;
  r8 = r6 == r7;
  if (r8) goto case_body_3032; else goto switch_check_3042;
  ...
  r9 = cn_var_变量声明语句;
  r10 = r6 == r9;
  if (r10) goto case_body_3033; else goto switch_check_3043;

  switch_check_3043:
  r11 = cn_var_如果语句;
  r12 = r6 == r11;
  if (r12) goto case_body_3034; else goto switch_check_3044;

  switch_check_3044:
  r13 = cn_var_当循环语句;
  r14 = r6 == r13;
  if (r14) goto case_body_3035; else goto switch_check_3045;

  switch_check_3045:
  r15 = cn_var_循环语句;
  r16 = r6 == r15;
  if (r16) goto case_body_3036; else goto switch_check_3046;

  switch_check_3046:
  r17 = cn_var_返回语句;
  r18 = r6 == r17;
  if (r18) goto case_body_3037; else goto switch_check_3047;

  switch_check_3047:
  r19 = cn_var_中断语句;
  r20 = r6 == r19;
  if (r20) goto case_body_3038; else goto switch_check_3048;

  switch_check_3048:
  r21 = cn_var_继续语句;
  r22 = r6 == r21;
  if (r22) goto case_body_3039; else goto switch_check_3049;

  switch_check_3049:
  r23 = cn_var_块语句;
  r24 = r6 == r23;
  if (r24) goto case_body_3040; else goto case_default_3041;
...
void 生成程序IR(struct IR生成上下文* cn_var_上下文, struct 程序节点* cn_var_程序) {
  ...
  r10 = cn_var_函数声明;
  r11 = r9 == r10;
  if (r11) goto case_body_3111; else goto switch_check_3114;
  ...
  r12 = cn_var_变量声明;
  r13 = r9 == r12;
  if (r13) goto case_body_3112; else goto case_default_3113;
