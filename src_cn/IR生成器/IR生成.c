...
enum IR操作码 二元运算符转IR(enum 二元运算符 cn_var_运算符) {
  ...
  r1 = cn_var_加法运算符;
  r2 = r0 == r1;
  if (r2) goto case_body_2898; else goto switch_check_2915;

  switch_check_2915:
  r3 = cn_var_减法运算符;
  r4 = r0 == r3;
  if (r4) goto case_body_2899; else goto switch_check_2916;

  switch_check_2916:
  r5 = cn_var_乘法运算符;
  r6 = r0 == r5;
  if (r6) goto case_body_2900; else goto switch_check_2917;

  switch_check_2917:
  r7 = cn_var_除法运算符;
  r8 = r0 == r7;
  if (r8) goto case_body_2901; else goto switch_check_2918;

  switch_check_2918:
  r9 = cn_var_取模运算符;
  r10 = r0 == r9;
  if (r10) goto case_body_2902; else goto switch_check_2919;

  switch_check_2919:
  r11 = cn_var_相等运算符;
  r12 = r0 == r11;
  if (r12) goto case_body_2903; else goto switch_check_2920;

  switch_check_2920:
  r13 = cn_var_不等运算符;
  r14 = r0 == r13;
  if (r14) goto case_body_2904; else goto switch_check_2921;

  switch_check_2921:
  r15 = cn_var_小于运算符;
  r16 = r0 == r15;
  if (r16) goto case_body_2905; else goto switch_check_2922;

  switch_check_2922:
  r17 = cn_var_大于运算符;
  r18 = r0 == r17;
  if (r18) goto case_body_2906; else goto switch_check_2923;

  switch_check_2923:
  r19 = cn_var_小于等于运算符;
  r20 = r0 == r19;
  if (r20) goto case_body_2907; else goto switch_check_2924;

  switch_check_2924:
  r21 = cn_var_大于等于运算符;
  r22 = r0 == r21;
  if (r22) goto case_body_2908; else goto switch_check_2925;

  switch_check_2925:
  r23 = cn_var_位与运算符;
  r24 = r0 == r23;
  if (r24) goto case_body_2909; else goto switch_check_2926;

  switch_check_2926:
  r25 = cn_var_位或运算符;
  r26 = r0 == r25;
  if (r26) goto case_body_2910; else goto switch_check_2927;

  switch_check_2927:
  r27 = cn_var_异或运算符;
  r28 = r0 == r27;
  if (r28) goto case_body_2911; else goto switch_check_2928;

  switch_check_2928:
  r29 = cn_var_左移运算符;
  r30 = r0 == r29;
  if (r30) goto case_body_2912; else goto switch_check_2929;

  switch_check_2929:
  r31 = cn_var_右移运算符;
  r32 = r0 == r31;
  if (r32) goto case_body_2913; else goto case_default_2914;
...
struct IR操作数 生成表达式IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  long long r1, r4, r5, r7, r9, r11, r15, r17, r27, r29, r32, r34, r37, r39, r42, r44, r47, r48, r50;
  struct 表达式节点* r0;
  struct 表达式节点* r3;
  struct 表达式节点* r31;
  struct 表达式节点* r33;
  ...
  r5 = cn_var_整数字面量表达式;
  r6 = r4 == r5;
  if (r6) goto case_body_2933; else goto switch_check_2947;

  switch_check_2947:
  r7 = cn_var_小数字面量表达式;
  r8 = r4 == r7;
  if (r8) goto case_body_2934; else goto switch_check_2948;

  switch_check_2948:
  r9 = cn_var_字符串字面量表达式;
  r10 = r4 == r9;
  if (r10) goto case_body_2935; else goto switch_check_2949;

  switch_check_2949:
  r11 = cn_var_布尔字面量表达式;
  r12 = r4 == r11;
  if (r12) goto case_body_2936; else goto switch_check_2950;

  switch_check_2950:
  r13 = cn_var_标识符表达式;
  r14 = r4 == r13;
  if (r14) goto case_body_2937; else goto switch_check_2951;

  switch_check_2951:
  r15 = cn_var_二元运算表达式;
  r16 = r4 == r15;
  if (r16) goto case_body_2938; else goto switch_check_2952;

  switch_check_2952:
  r17 = cn_var_一元运算表达式;
  r18 = r4 == r17;
  if (r18) goto case_body_2939; else goto switch_check_2953;

  switch_check_2953:
  r19 = cn_var_函数调用表达式;
  r20 = r4 == r19;
  if (r20) goto case_body_2940; else goto switch_check_2954;

  switch_check_2954:
  r21 = cn_var_成员访问表达式;
  r22 = r4 == r21;
  if (r22) goto case_body_2941; else goto switch_check_2955;

  switch_check_2955:
  r23 = cn_var_数组访问表达式;
  r24 = r4 == r23;
  if (r24) goto case_body_2942; else goto switch_check_2956;

  switch_check_2956:
  r25 = cn_var_赋值表达式;
  r26 = r4 == r25;
  if (r26) goto case_body_2943; else goto switch_check_2957;

  switch_check_2957:
  r27 = cn_var_取地址表达式;
  r28 = r4 == r27;
  if (r28) goto case_body_2944; else goto switch_check_2958;

  switch_check_2958:
  r29 = cn_var_解引用表达式;
  r30 = r4 == r29;
  if (r30) goto case_body_2945; else goto case_default_2946;
...
struct IR操作数 生成标识符IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  cn_var_唯一名_0 = r9;
  r10 = cn_var_唯一名_0;
  if (r10) goto if_then_2963; else goto if_merge_2964;
...
struct IR操作数 生成二元运算IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_2968; else goto logic_rhs_2967;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_2968;

  logic_merge_2968:
  if (r4) goto if_then_2965; else goto if_merge_2966;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
struct IR操作数 生成一元运算IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  long long r0, r2, r4, r8, r11, r12, r14, r17, r18, r20, r22;
  struct IR生成上下文* r1;
  struct 表达式节点* r3;
  struct IR生成上下文* r6;
  struct 表达式节点* r7;
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_2972; else goto logic_rhs_2971;
  ...
  r18 = cn_var_负号运算符;
  r19 = r17 == r18;
  if (r19) goto case_body_2974; else goto switch_check_2978;

  logic_rhs_2971:
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_2972;

  logic_merge_2972:
  if (r4) goto if_then_2969; else goto if_merge_2970;

  switch_check_2978:
  r20 = cn_var_取反运算符;
  r21 = r17 == r20;
  if (r21) goto case_body_2975; else goto switch_check_2979;

  switch_check_2979:
  r22 = cn_var_逻辑非运算符;
  r23 = r17 == r22;
  if (r23) goto case_body_2976; else goto case_default_2977;

  case_body_2974:
  cn_var_操作码_3 = 10;
  goto switch_merge_2973;
  goto switch_merge_2973;
...
struct IR操作数 生成函数调用IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_2983; else goto logic_rhs_2982;
  ...
  r20 = cn_var_表达式;
  r21 = r20->参数列表;
  if (r21) goto if_then_2984; else goto if_merge_2985;

  logic_rhs_2982:
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_2983;

  logic_merge_2983:
  if (r4) goto if_then_2980; else goto if_merge_2981;
  ...
  while_cond_2986:
  r24 = cn_var_参数_5;
  if (r24) goto while_body_2987; else goto while_exit_2988;
  ...
  r29 = cn_var_数量_4;
  r30 = r29 > 0;
  if (r30) goto if_then_2989; else goto if_merge_2990;
  ...
  while_cond_2991:
  r38 = cn_var_参数_5;
  if (r38) goto while_body_2992; else goto while_exit_2993;
...
struct IR操作数 生成成员访问IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_2997; else goto logic_rhs_2996;
  ...
  logic_merge_2997:
  if (r4) goto if_then_2994; else goto if_merge_2995;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
struct IR操作数 生成数组访问IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3001; else goto logic_rhs_3000;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3001;

  logic_merge_3001:
  if (r4) goto if_then_2998; else goto if_merge_2999;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
struct IR操作数 生成赋值IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r13 = cn_var_标识符表达式;
  r14 = r12 == r13;
  if (r14) goto if_then_3006; else goto if_else_3007;
  ...
  cn_var_唯一名_1 = r19;
  r20 = cn_var_唯一名_1;
  if (r20) goto if_then_3009; else goto if_merge_3010;
...
struct IR操作数 生成取地址IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3014; else goto logic_rhs_3013;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3014;

  logic_merge_3014:
  if (r4) goto if_then_3011; else goto if_merge_3012;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
struct IR操作数 生成解引用IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3018; else goto logic_rhs_3017;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3018;

  logic_merge_3018:
  if (r4) goto if_then_3015; else goto if_merge_3016;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
void 生成语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  long long r0, r2, r4, r6, r9, r13, r27;
  struct IR生成上下文* r1;
  struct 语句节点* r3;
  struct 语句节点* r5;
  struct IR生成上下文* r25;
  ...
  r7 = cn_var_表达式语句;
  r8 = r6 == r7;
  if (r8) goto case_body_3024; else goto switch_check_3034;
  ...
  r9 = cn_var_变量声明语句;
  r10 = r6 == r9;
  if (r10) goto case_body_3025; else goto switch_check_3035;

  switch_check_3035:
  r11 = cn_var_如果语句;
  r12 = r6 == r11;
  if (r12) goto case_body_3026; else goto switch_check_3036;

  switch_check_3036:
  r13 = cn_var_当循环语句;
  r14 = r6 == r13;
  if (r14) goto case_body_3027; else goto switch_check_3037;

  switch_check_3037:
  r15 = cn_var_循环语句;
  r16 = r6 == r15;
  if (r16) goto case_body_3028; else goto switch_check_3038;

  switch_check_3038:
  r17 = cn_var_返回语句;
  r18 = r6 == r17;
  if (r18) goto case_body_3029; else goto switch_check_3039;

  switch_check_3039:
  r19 = cn_var_中断语句;
  r20 = r6 == r19;
  if (r20) goto case_body_3030; else goto switch_check_3040;

  switch_check_3040:
  r21 = cn_var_继续语句;
  r22 = r6 == r21;
  if (r22) goto case_body_3031; else goto switch_check_3041;

  switch_check_3041:
  r23 = cn_var_块语句;
  r24 = r6 == r23;
  if (r24) goto case_body_3032; else goto case_default_3033;
...
void 生成变量声明IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3045; else goto logic_rhs_3044;
  ...
  r27 = cn_var_语句;
  r28 = r27->初始值表达式;
  if (r28) goto if_then_3046; else goto if_merge_3047;

  logic_rhs_3044:
  r3 = cn_var_语句;
  r4 = !r3;
  goto logic_merge_3045;

  logic_merge_3045:
  if (r4) goto if_then_3042; else goto if_merge_3043;
...
void 生成如果语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r49 = cn_var_语句;
  r50 = r49->假分支语句;
  if (r50) goto if_then_3052; else goto if_merge_3053;
...
void 生成当循环IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3057; else goto logic_rhs_3056;
  ...
  r3 = cn_var_语句;
  r4 = !r3;
  goto logic_merge_3057;

  logic_merge_3057:
  if (r4) goto if_then_3054; else goto if_merge_3055;
  return;
}
...
void 生成循环IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3061; else goto logic_rhs_3060;
  ...
  r31 = cn_var_语句;
  r32 = r31->初始化语句;
  if (r32) goto if_then_3062; else goto if_merge_3063;

  logic_rhs_3060:
  r3 = cn_var_语句;
  r4 = !r3;
  goto logic_merge_3061;

  logic_merge_3061:
  if (r4) goto if_then_3058; else goto if_merge_3059;
  ...
  r48 = cn_var_语句;
  r49 = r48->条件表达式;
  if (r49) goto if_then_3064; else goto if_else_3065;
  ...
  r89 = cn_var_语句;
  r90 = r89->迭代表达式;
  if (r90) goto if_then_3067; else goto if_merge_3068;
...
void 生成返回语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r0 = cn_var_上下文;
  r1 = !r0;
  if (r1) goto if_then_3069; else goto if_merge_3070;
...
void 生成中断语句IR(struct IR生成上下文* cn_var_上下文) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3076; else goto logic_rhs_3075;
  ...
  r4 = r3->循环退出块;
  r5 = !r4;
  goto logic_merge_3076;

  logic_merge_3076:
  if (r5) goto if_then_3073; else goto if_merge_3074;
  return;
}
...
void 生成继续语句IR(struct IR生成上下文* cn_var_上下文) {
  ...
  logic_merge_3080:
  if (r5) goto if_then_3077; else goto if_merge_3078;
  return;
}
...
void 生成块语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  logic_merge_3084:
  if (r4) goto if_then_3081; else goto if_merge_3082;

  while_cond_3085:
  r7 = cn_var_子语句_0;
  if (r7) goto while_body_3086; else goto while_exit_3087;
...
void 生成函数IR(struct IR生成上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3091; else goto logic_rhs_3090;
  ...
  r3 = cn_var_声明;
  r4 = !r3;
  goto logic_merge_3091;

  logic_merge_3091:
  if (r4) goto if_then_3088; else goto if_merge_3089;

  while_cond_3092:
  r13 = cn_var_参数_1;
  if (r13) goto while_body_3093; else goto while_exit_3094;
...
void 生成程序IR(struct IR生成上下文* cn_var_上下文, struct 程序节点* cn_var_程序) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3098; else goto logic_rhs_3097;
  ...
  r6 = r5->声明列表;
  cn_var_声明_0 = r6;
  goto while_cond_3099;

  logic_rhs_3097:
  r3 = cn_var_程序;
  r4 = !r3;
  goto logic_merge_3098;

  logic_merge_3098:
  if (r4) goto if_then_3095; else goto if_merge_3096;

  while_cond_3099:
  r7 = cn_var_声明_0;
  if (r7) goto while_body_3100; else goto while_exit_3101;
  ...
  r10 = cn_var_函数声明;
  r11 = r9 == r10;
  if (r11) goto case_body_3103; else goto switch_check_3106;
  ...
  r12 = cn_var_变量声明;
  r13 = r9 == r12;
  if (r13) goto case_body_3104; else goto case_default_3105;

  case_body_3103:
  r14 = cn_var_上下文;
  r15 = cn_var_声明_0;
  生成函数IR(r14, r15);
  goto switch_merge_3102;
  goto switch_merge_3102;
...
void 生成全局变量IR(struct IR生成上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3110; else goto logic_rhs_3109;
  ...
  r6 = cn_var_声明;
  r7 = r6->初始值表达式;
  if (r7) goto if_then_3111; else goto if_merge_3112;

  logic_rhs_3109:
  r3 = cn_var_声明;
  r4 = !r3;
  goto logic_merge_3110;

  logic_merge_3110:
  if (r4) goto if_then_3107; else goto if_merge_3108;
