...
long long 分配虚拟寄存器(struct IR生成上下文* cn_var_上下文) {
  ...
  logic_merge_2976:
  if (r5) goto if_then_2973; else goto if_merge_2974;
  return 0;
}
...
void 发射指令(struct IR生成上下文* cn_var_上下文, struct IR指令* cn_var_指令) {
  ...
  logic_merge_2980:
  if (r8) goto if_then_2977; else goto if_merge_2978;
  ...
  logic_merge_2982:
  if (r6) goto logic_merge_2980; else goto logic_rhs_2979;
  return;
}
...
char* 查找局部变量唯一名(struct IR生成上下文* cn_var_上下文, const char* cn_var_原始名称) {
  ...
  while_cond_2989:
  r7 = cn_var_映射_0;
  if (r7) goto while_body_2990; else goto while_exit_2991;
  ...
  r11 = 比较字符串(r9, r10);
  r12 = r11 == 0;
  if (r12) goto if_then_2992; else goto if_merge_2993;
...
void 释放局部变量映射表(struct IR生成上下文* cn_var_上下文) {
  ...
  while_cond_3004:
  r4 = cn_var_映射_0;
  if (r4) goto while_body_3005; else goto while_exit_3006;
...
struct IR操作数 生成表达式IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r4 = r3->类型;
  r5 = r4 == 节点类型_字面量表达式;
  if (r5) goto case_body_3049; else goto switch_check_3058;

  switch_check_3058:
  r6 = r4 == 节点类型_标识符表达式;
  if (r6) goto case_body_3050; else goto switch_check_3059;

  switch_check_3059:
  r7 = r4 == 节点类型_二元表达式;
  if (r7) goto case_body_3051; else goto switch_check_3060;

  switch_check_3060:
  r8 = r4 == 节点类型_一元表达式;
  if (r8) goto case_body_3052; else goto switch_check_3061;

  switch_check_3061:
  r9 = r4 == 节点类型_函数调用表达式;
  if (r9) goto case_body_3053; else goto switch_check_3062;

  switch_check_3062:
  r10 = r4 == 节点类型_成员访问表达式;
  if (r10) goto case_body_3054; else goto switch_check_3063;

  switch_check_3063:
  r11 = r4 == 节点类型_数组访问表达式;
  if (r11) goto case_body_3055; else goto switch_check_3064;

  switch_check_3064:
  r12 = r4 == 节点类型_赋值表达式;
  if (r12) goto case_body_3056; else goto case_default_3057;
...
struct IR操作数 生成标识符IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  cn_var_唯一名_0 = r9;
  r10 = cn_var_唯一名_0;
  if (r10) goto if_then_3069; else goto if_merge_3070;
  ...
  r22 = cn_var_源_3;
  r23 = 空操作数();
  r24 = 创建IR指令(IR指令种类_加载指令, r21, r22, r23);
  cn_var_指令_4 = r24;
  r25 = cn_var_上下文;
  r26 = cn_var_指令_4;
  发射指令(r25, r26);
...
struct IR操作数 生成一元运算IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  long long r0, r2, r4, r11, r12, r17;
  struct IR生成上下文* r1;
  struct 表达式节点* r3;
  struct IR生成上下文* r6;
  struct 表达式节点* r7;
  ...
  r17 = r16->运算符;
  r18 = r17 == 一元运算符_一元_取负;
  if (r18) goto case_body_3080; else goto switch_check_3084;
  ...
  switch_check_3084:
  r19 = r17 == 一元运算符_一元_位取反;
  if (r19) goto case_body_3081; else goto switch_check_3085;

  switch_check_3085:
  r20 = r17 == 一元运算符_一元_逻辑非;
  if (r20) goto case_body_3082; else goto case_default_3083;
...
struct IR操作数 生成函数调用IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  long long r0, r2, r4, r11, r12, r25, r26, r28, r29, r30, r31, r32, r33, r35, r44, r45, r46, r48;
  struct IR生成上下文* r1;
  struct 表达式节点* r3;
  struct IR生成上下文* r6;
  struct 表达式节点* r7;
  ...
  r17 = cn_var_被调函数_0;
  r18 = 空操作数();
  r19 = 创建IR指令(IR指令种类_调用指令, r16, r17, r18);
  cn_var_指令_3 = r19;
  r20 = cn_var_表达式;
  r21 = r20->参数列表;
  if (r21) goto if_then_3090; else goto if_merge_3091;
  ...
  while_cond_3092:
  r24 = cn_var_参数_5;
  if (r24) goto while_body_3093; else goto while_exit_3094;
  ...
  r29 = cn_var_数量_4;
  r30 = r29 > 0;
  if (r30) goto if_then_3095; else goto if_merge_3096;
  ...
  while_cond_3097:
  r38 = cn_var_参数_5;
  if (r38) goto while_body_3098; else goto while_exit_3099;
...
struct IR操作数 生成成员访问IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r20 = cn_var_对象_0;
  r21 = cn_var_成员索引_3;
  r22 = 创建IR指令(IR指令种类_成员访问指令, r19, r20, r21);
  cn_var_指令_4 = r22;
  r23 = cn_var_上下文;
  r24 = cn_var_指令_4;
  发射指令(r23, r24);
...
struct IR操作数 生成数组访问IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r21 = cn_var_数组_0;
  r22 = cn_var_索引_1;
  r23 = 创建IR指令(IR指令种类_加载指令, r20, r21, r22);
  cn_var_指令_4 = r23;
  r24 = cn_var_上下文;
  r25 = cn_var_指令_4;
  发射指令(r24, r25);
...
struct IR操作数 生成赋值IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r13 = cn_var_标识符表达式;
  r14 = r12 == r13;
  if (r14) goto if_then_3112; else goto if_else_3113;
  ...
  cn_var_唯一名_1 = r19;
  r20 = cn_var_唯一名_1;
  if (r20) goto if_then_3115; else goto if_merge_3116;
  ...
  r38 = cn_var_值_0;
  r39 = 空操作数();
  r40 = 创建IR指令(IR指令种类_存储指令, r37, r38, r39);
  cn_var_指令_5 = r40;
  r41 = cn_var_上下文;
  r42 = cn_var_指令_5;
  发射指令(r41, r42);
  ...
  r27 = cn_var_值_0;
  r28 = 空操作数();
  r29 = 创建IR指令(IR指令种类_存储指令, r26, r27, r28);
  cn_var_指令_3 = r29;
  r30 = cn_var_上下文;
  r31 = cn_var_指令_3;
  发射指令(r30, r31);
...
struct IR操作数 生成取地址IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r17 = cn_var_操作数_0;
  r18 = 空操作数();
  r19 = 创建IR指令(IR指令种类_取地址指令, r16, r17, r18);
  cn_var_指令_3 = r19;
  r20 = cn_var_上下文;
  r21 = cn_var_指令_3;
  发射指令(r20, r21);
...
struct IR操作数 生成解引用IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r17 = cn_var_指针_0;
  r18 = 空操作数();
  r19 = 创建IR指令(IR指令种类_解引用指令, r16, r17, r18);
  cn_var_指令_3 = r19;
  r20 = cn_var_上下文;
  r21 = cn_var_指令_3;
  发射指令(r20, r21);
...
void 生成语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r6 = r5->类型;
  r7 = r6 == 节点类型_表达式语句;
  if (r7) goto case_body_3130; else goto switch_check_3140;
  ...
  switch_check_3140:
  r8 = r6 == 节点类型_变量声明;
  if (r8) goto case_body_3131; else goto switch_check_3141;

  switch_check_3141:
  r9 = r6 == 节点类型_如果语句;
  if (r9) goto case_body_3132; else goto switch_check_3142;

  switch_check_3142:
  r10 = r6 == 节点类型_当语句;
  if (r10) goto case_body_3133; else goto switch_check_3143;

  switch_check_3143:
  r11 = r6 == 节点类型_循环语句;
  if (r11) goto case_body_3134; else goto switch_check_3144;

  switch_check_3144:
  r12 = r6 == 节点类型_返回语句;
  if (r12) goto case_body_3135; else goto switch_check_3145;

  switch_check_3145:
  r13 = r6 == 节点类型_中断语句;
  if (r13) goto case_body_3136; else goto switch_check_3146;

  switch_check_3146:
  r14 = r6 == 节点类型_继续语句;
  if (r14) goto case_body_3137; else goto switch_check_3147;

  switch_check_3147:
  r15 = r6 == 节点类型_块语句;
  if (r15) goto case_body_3138; else goto case_default_3139;
...
void 生成变量声明IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  long long r0, r2, r4, r6, r10, r13, r14, r16, r19, r28, r31, r35;
  char* r7;
  char* r11;
  char* r33;
  char* r44;
  ...
  r22 = cn_var_大小_3;
  r23 = 空操作数();
  r24 = 创建IR指令(IR指令种类_分配指令, r21, r22, r23);
  cn_var_指令_4 = r24;
  r25 = cn_var_上下文;
  r26 = cn_var_指令_4;
  发射指令(r25, r26);
  r27 = cn_var_语句;
  r28 = r27->初始值表达式;
  if (r28) goto if_then_3152; else goto if_merge_3153;
...
void 生成如果语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r24 = cn_var_假块_5;
  r25 = 标签操作数(r24);
  r26 = 创建IR指令(IR指令种类_条件跳转指令, r21, r23, r25);
  cn_var_跳转_7 = r26;
  r27 = cn_var_上下文;
  r28 = cn_var_跳转_7;
  发射指令(r27, r28);
  ...
  r39 = 空操作数();
  r40 = 空操作数();
  r41 = 创建IR指令(IR指令种类_跳转指令, r38, r39, r40);
  cn_var_跳转到结束_8 = r41;
  r42 = cn_var_上下文;
  r43 = cn_var_跳转到结束_8;
  发射指令(r42, r43);
  ...
  r49 = cn_var_语句;
  r50 = r49->假分支语句;
  if (r50) goto if_then_3158; else goto if_merge_3159;
  ...
  r56 = 空操作数();
  r57 = 空操作数();
  r58 = 创建IR指令(IR指令种类_跳转指令, r55, r56, r57);
  cn_var_跳转到结束2_9 = r58;
  r59 = cn_var_上下文;
  r60 = cn_var_跳转到结束2_9;
  发射指令(r59, r60);
...
void 生成当循环IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r25 = 空操作数();
  r26 = 空操作数();
  r27 = 创建IR指令(IR指令种类_跳转指令, r24, r25, r26);
  cn_var_跳转到条件_8 = r27;
  r28 = cn_var_上下文;
  r29 = cn_var_跳转到条件_8;
  发射指令(r28, r29);
  ...
  r42 = cn_var_退出块_5;
  r43 = 标签操作数(r42);
  r44 = 创建IR指令(IR指令种类_条件跳转指令, r39, r41, r43);
  cn_var_条件跳转_10 = r44;
  r45 = cn_var_上下文;
  r46 = cn_var_条件跳转_10;
  发射指令(r45, r46);
...
void 生成循环IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r31 = cn_var_语句;
  r32 = r31->初始化语句;
  if (r32) goto if_then_3168; else goto if_merge_3169;
  ...
  r38 = 空操作数();
  r39 = 空操作数();
  r40 = 创建IR指令(IR指令种类_跳转指令, r37, r38, r39);
  cn_var_跳转到条件_12 = r40;
  r41 = cn_var_上下文;
  r42 = cn_var_跳转到条件_12;
  发射指令(r41, r42);
  ...
  r48 = cn_var_语句;
  r49 = r48->条件表达式;
  if (r49) goto if_then_3170; else goto if_else_3171;
  ...
  r57 = cn_var_退出块_9;
  r58 = 标签操作数(r57);
  r59 = 创建IR指令(IR指令种类_条件跳转指令, r54, r56, r58);
  cn_var_条件跳转_14 = r59;
  r60 = cn_var_上下文;
  r61 = cn_var_条件跳转_14;
  发射指令(r60, r61);
  ...
  r64 = 空操作数();
  r65 = 空操作数();
  r66 = 创建IR指令(IR指令种类_跳转指令, r63, r64, r65);
  cn_var_无条件跳转_15 = r66;
  r67 = cn_var_上下文;
  r68 = cn_var_无条件跳转_15;
  发射指令(r67, r68);
  ...
  r79 = 空操作数();
  r80 = 空操作数();
  r81 = 创建IR指令(IR指令种类_跳转指令, r78, r79, r80);
  cn_var_跳转到迭代_16 = r81;
  r82 = cn_var_上下文;
  r83 = cn_var_跳转到迭代_16;
  发射指令(r82, r83);
  ...
  r89 = cn_var_语句;
  r90 = r89->迭代表达式;
  if (r90) goto if_then_3173; else goto if_merge_3174;
  ...
  r97 = 空操作数();
  r98 = 空操作数();
  r99 = 创建IR指令(IR指令种类_跳转指令, r96, r97, r98);
  cn_var_跳回条件_17 = r99;
  r100 = cn_var_上下文;
  r101 = cn_var_跳回条件_17;
  发射指令(r100, r101);
...
void 生成返回语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r3 = cn_var_语句;
  r4 = r3->返回表达式;
  if (r4) goto if_then_3177; else goto if_merge_3178;
  ...
  r10 = 空操作数();
  r11 = 空操作数();
  r12 = 创建IR指令(IR指令种类_返回指令, r9, r10, r11);
  cn_var_指令_1 = r12;
  r13 = cn_var_上下文;
  r14 = cn_var_指令_1;
  发射指令(r13, r14);
...
void 生成中断语句IR(struct IR生成上下文* cn_var_上下文) {
  ...
  r9 = 空操作数();
  r10 = 空操作数();
  r11 = 创建IR指令(IR指令种类_跳转指令, r8, r9, r10);
  cn_var_指令_0 = r11;
  r12 = cn_var_上下文;
  r13 = cn_var_指令_0;
  发射指令(r12, r13);
  ...
  logic_merge_3182:
  if (r5) goto if_then_3179; else goto if_merge_3180;
  return;
}
...
void 生成继续语句IR(struct IR生成上下文* cn_var_上下文) {
  ...
  logic_merge_3186:
  if (r5) goto if_then_3183; else goto if_merge_3184;
  return;
}
...
void 生成块语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  while_cond_3191:
  r7 = cn_var_子语句_0;
  if (r7) goto while_body_3192; else goto while_exit_3193;
...
void 生成函数IR(struct IR生成上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  while_cond_3198:
  r13 = cn_var_参数_1;
  if (r13) goto while_body_3199; else goto while_exit_3200;
...
void 生成程序IR(struct IR生成上下文* cn_var_上下文, struct 程序节点* cn_var_程序) {
  ...
  while_cond_3205:
  r7 = cn_var_声明_0;
  if (r7) goto while_body_3206; else goto while_exit_3207;

  while_body_3206:
  r8 = cn_var_声明_0;
  r9 = r8->类型;
  r10 = r9 == 节点类型_函数声明;
  if (r10) goto case_body_3209; else goto switch_check_3212;

  while_exit_3207:

  switch_check_3212:
  r11 = r9 == 节点类型_变量声明;
  if (r11) goto case_body_3210; else goto case_default_3211;
...
void 生成全局变量IR(struct IR生成上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  r6 = cn_var_声明;
  r7 = r6->初始值表达式;
  if (r7) goto if_then_3217; else goto if_merge_3218;
