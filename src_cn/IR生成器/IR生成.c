...
long long 分配虚拟寄存器(struct IR生成上下文* cn_var_上下文) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_2908; else goto logic_rhs_2907;
  ...
  r4 = r3->当前函数;
  r5 = !r4;
  goto logic_merge_2908;

  logic_merge_2908:
  if (r5) goto if_then_2905; else goto if_merge_2906;
  return 0;
}
...
void 发射指令(struct IR生成上下文* cn_var_上下文, struct IR指令* cn_var_指令) {
  ...
  r2 = cn_var_上下文;
  r3 = !r2;
  if (r3) goto logic_merge_2914; else goto logic_rhs_2913;
  ...
  r7 = cn_var_指令;
  r8 = !r7;
  goto logic_merge_2912;

  logic_merge_2912:
  if (r8) goto if_then_2909; else goto if_merge_2910;

  logic_rhs_2913:
  r4 = cn_var_上下文;
  r5 = r4->当前块;
  r6 = !r5;
  goto logic_merge_2914;

  logic_merge_2914:
  if (r6) goto logic_merge_2912; else goto logic_rhs_2911;
  return;
}
...
void 切换基本块(struct IR生成上下文* cn_var_上下文, struct 基本块* cn_var_块) {
  ...
  entry:
  r0 = cn_var_上下文;
  if (r0) goto if_then_2915; else goto if_merge_2916;
...
char* 查找局部变量唯一名(struct IR生成上下文* cn_var_上下文, char* cn_var_原始名称) {
  ...
  while_cond_2921:
  r7 = cn_var_映射_0;
  if (r7) goto while_body_2922; else goto while_exit_2923;
  ...
  r11 = 比较字符串(r9, r10);
  r12 = r11 == 0;
  if (r12) goto if_then_2924; else goto if_merge_2925;
...
void 添加局部变量映射(struct IR生成上下文* cn_var_上下文, char* cn_var_原始名称, char* cn_var_唯一名称) {
  ...
  r2 = cn_var_上下文;
  r3 = !r2;
  if (r3) goto logic_merge_2931; else goto logic_rhs_2930;
  ...
  cn_var_映射_0 = r9;
  r10 = cn_var_映射_0;
  if (r10) goto if_then_2932; else goto if_merge_2933;

  logic_rhs_2928:
  r6 = cn_var_唯一名称;
  r7 = !r6;
  goto logic_merge_2929;

  logic_merge_2929:
  if (r7) goto if_then_2926; else goto if_merge_2927;

  logic_rhs_2930:
  r4 = cn_var_原始名称;
  r5 = !r4;
  goto logic_merge_2931;

  logic_merge_2931:
  if (r5) goto logic_merge_2929; else goto logic_rhs_2928;
...
void 释放局部变量映射表(struct IR生成上下文* cn_var_上下文) {
  ...
  r0 = cn_var_上下文;
  r1 = !r0;
  if (r1) goto if_then_2934; else goto if_merge_2935;
  ...
  r3 = r2->局部变量映射表;
  cn_var_映射_0 = r3;
  goto while_cond_2936;

  while_cond_2936:
  r4 = cn_var_映射_0;
  if (r4) goto while_body_2937; else goto while_exit_2938;
...
struct IR生成上下文* 创建IR生成上下文() {
  ...
  cn_var_上下文_0 = r1;
  r2 = cn_var_上下文_0;
  if (r2) goto if_then_2939; else goto if_merge_2940;
...
void 释放IR生成上下文(struct IR生成上下文* cn_var_上下文) {
  ...
  r0 = cn_var_上下文;
  r1 = !r0;
  if (r1) goto if_then_2941; else goto if_merge_2942;
  ...
  r3 = cn_var_上下文;
  r4 = r3->模块;
  if (r4) goto if_then_2943; else goto if_merge_2944;
...
enum IR操作码 二元运算符转IR(enum 二元运算符 cn_var_运算符) {
  ...
  r0 = cn_var_运算符;
  r1 = r0 == 0;
  if (r1) goto case_body_2946; else goto switch_check_2963;

  switch_check_2963:
  r2 = r0 == 1;
  if (r2) goto case_body_2947; else goto switch_check_2964;

  switch_check_2964:
  r3 = r0 == 2;
  if (r3) goto case_body_2948; else goto switch_check_2965;

  switch_check_2965:
  r4 = r0 == 3;
  if (r4) goto case_body_2949; else goto switch_check_2966;

  switch_check_2966:
  r5 = r0 == 4;
  if (r5) goto case_body_2950; else goto switch_check_2967;

  switch_check_2967:
  r6 = r0 == 5;
  if (r6) goto case_body_2951; else goto switch_check_2968;

  switch_check_2968:
  r7 = r0 == 6;
  if (r7) goto case_body_2952; else goto switch_check_2969;

  switch_check_2969:
  r8 = r0 == 7;
  if (r8) goto case_body_2953; else goto switch_check_2970;

  switch_check_2970:
  r9 = r0 == 8;
  if (r9) goto case_body_2954; else goto switch_check_2971;

  switch_check_2971:
  r10 = r0 == 9;
  if (r10) goto case_body_2955; else goto switch_check_2972;

  switch_check_2972:
  r11 = r0 == 10;
  if (r11) goto case_body_2956; else goto switch_check_2973;

  switch_check_2973:
  r12 = r0 == 11;
  if (r12) goto case_body_2957; else goto switch_check_2974;

  switch_check_2974:
  r13 = r0 == 12;
  if (r13) goto case_body_2958; else goto switch_check_2975;

  switch_check_2975:
  r14 = r0 == 13;
  if (r14) goto case_body_2959; else goto switch_check_2976;

  switch_check_2976:
  r15 = r0 == 14;
  if (r15) goto case_body_2960; else goto switch_check_2977;

  switch_check_2977:
  r16 = r0 == 15;
  if (r16) goto case_body_2961; else goto case_default_2962;

  case_body_2946:
  return 0;
  goto switch_merge_2945;
...
struct IR操作数 生成表达式IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r0 = cn_var_表达式;
  r1 = !r0;
  if (r1) goto if_then_2978; else goto if_merge_2979;
  ...
  r4 = r3->类型;
  r5 = r4 == 25;
  if (r5) goto case_body_2981; else goto switch_check_2990;

  switch_check_2990:
  r6 = r4 == 26;
  if (r6) goto case_body_2982; else goto switch_check_2991;

  switch_check_2991:
  r7 = r4 == 23;
  if (r7) goto case_body_2983; else goto switch_check_2992;

  switch_check_2992:
  r8 = r4 == 24;
  if (r8) goto case_body_2984; else goto switch_check_2993;

  switch_check_2993:
  r9 = r4 == 27;
  if (r9) goto case_body_2985; else goto switch_check_2994;

  switch_check_2994:
  r10 = r4 == 28;
  if (r10) goto case_body_2986; else goto switch_check_2995;

  switch_check_2995:
  r11 = r4 == 29;
  if (r11) goto case_body_2987; else goto switch_check_2996;

  switch_check_2996:
  r12 = r4 == 30;
  if (r12) goto case_body_2988; else goto case_default_2989;
...
struct IR操作数 生成标识符IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3000; else goto logic_rhs_2999;
  ...
  cn_var_唯一名_0 = r9;
  r10 = cn_var_唯一名_0;
  if (r10) goto if_then_3001; else goto if_merge_3002;

  logic_rhs_2999:
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3000;

  logic_merge_3000:
  if (r4) goto if_then_2997; else goto if_merge_2998;
...
struct IR操作数 生成二元运算IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3006; else goto logic_rhs_3005;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3006;

  logic_merge_3006:
  if (r4) goto if_then_3003; else goto if_merge_3004;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
struct IR操作数 生成一元运算IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3010; else goto logic_rhs_3009;
  ...
  r17 = r16->运算符;
  r18 = r17 == 1;
  if (r18) goto case_body_3012; else goto switch_check_3016;

  logic_rhs_3009:
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3010;

  logic_merge_3010:
  if (r4) goto if_then_3007; else goto if_merge_3008;

  switch_check_3016:
  r19 = r17 == 4;
  if (r19) goto case_body_3013; else goto switch_check_3017;

  switch_check_3017:
  r20 = r17 == 0;
  if (r20) goto case_body_3014; else goto case_default_3015;

  case_body_3012:
  cn_var_操作码_3 = 10;
  goto switch_merge_3011;
  goto switch_merge_3011;
...
struct IR操作数 生成函数调用IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3021; else goto logic_rhs_3020;
  ...
  r20 = cn_var_表达式;
  r21 = r20->参数列表;
  if (r21) goto if_then_3022; else goto if_merge_3023;

  logic_rhs_3020:
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3021;

  logic_merge_3021:
  if (r4) goto if_then_3018; else goto if_merge_3019;
  ...
  while_cond_3024:
  r24 = cn_var_参数_5;
  if (r24) goto while_body_3025; else goto while_exit_3026;
  ...
  r29 = cn_var_数量_4;
  r30 = r29 > 0;
  if (r30) goto if_then_3027; else goto if_merge_3028;
  ...
  while_cond_3029:
  r38 = cn_var_参数_5;
  if (r38) goto while_body_3030; else goto while_exit_3031;
...
struct IR操作数 生成数组访问IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3039; else goto logic_rhs_3038;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3039;

  logic_merge_3039:
  if (r4) goto if_then_3036; else goto if_merge_3037;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
struct IR操作数 生成赋值IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3043; else goto logic_rhs_3042;
  ...
  r13 = cn_var_标识符表达式;
  r14 = r12 == r13;
  if (r14) goto if_then_3044; else goto if_else_3045;

  logic_rhs_3042:
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3043;

  logic_merge_3043:
  if (r4) goto if_then_3040; else goto if_merge_3041;
  ...
  cn_var_唯一名_1 = r19;
  r20 = cn_var_唯一名_1;
  if (r20) goto if_then_3047; else goto if_merge_3048;
...
struct IR操作数 生成取地址IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3052; else goto logic_rhs_3051;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3052;

  logic_merge_3052:
  if (r4) goto if_then_3049; else goto if_merge_3050;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
struct IR操作数 生成解引用IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3056; else goto logic_rhs_3055;
  ...
  r3 = cn_var_表达式;
  r4 = !r3;
  goto logic_merge_3056;

  logic_merge_3056:
  if (r4) goto if_then_3053; else goto if_merge_3054;
  {
    static struct IR操作数 _zero = {0};
    return _zero;
  }
...
void 生成语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3060; else goto logic_rhs_3059;
  ...
  r3 = cn_var_语句;
  r4 = !r3;
  goto logic_merge_3060;

  logic_merge_3060:
  if (r4) goto if_then_3057; else goto if_merge_3058;
  ...
  switch_check_3076:
  r12 = r6 == 16;
  if (r12) goto case_body_3067; else goto switch_check_3077;

  switch_check_3077:
  r13 = r6 == 17;
  if (r13) goto case_body_3068; else goto switch_check_3078;

  switch_check_3078:
  r14 = r6 == 18;
  if (r14) goto case_body_3069; else goto switch_check_3079;

  switch_check_3079:
  r15 = r6 == 12;
  if (r15) goto case_body_3070; else goto case_default_3071;
...
void 生成变量声明IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3083; else goto logic_rhs_3082;
  ...
  r27 = cn_var_语句;
  r28 = r27->初始值表达式;
  if (r28) goto if_then_3084; else goto if_merge_3085;

  logic_rhs_3082:
  r3 = cn_var_语句;
  r4 = !r3;
  goto logic_merge_3083;

  logic_merge_3083:
  if (r4) goto if_then_3080; else goto if_merge_3081;
...
void 生成如果语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r49 = cn_var_语句;
  r50 = r49->假分支语句;
  if (r50) goto if_then_3090; else goto if_merge_3091;
...
void 生成当循环IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3095; else goto logic_rhs_3094;
  ...
  r3 = cn_var_语句;
  r4 = !r3;
  goto logic_merge_3095;

  logic_merge_3095:
  if (r4) goto if_then_3092; else goto if_merge_3093;
  return;
}
...
void 生成循环IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r31 = cn_var_语句;
  r32 = r31->初始化语句;
  if (r32) goto if_then_3100; else goto if_merge_3101;
  ...
  r48 = cn_var_语句;
  r49 = r48->条件表达式;
  if (r49) goto if_then_3102; else goto if_else_3103;
  ...
  r89 = cn_var_语句;
  r90 = r89->迭代表达式;
  if (r90) goto if_then_3105; else goto if_merge_3106;
...
void 生成返回语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r0 = cn_var_上下文;
  r1 = !r0;
  if (r1) goto if_then_3107; else goto if_merge_3108;
  ...
  r3 = cn_var_语句;
  r4 = r3->返回表达式;
  if (r4) goto if_then_3109; else goto if_merge_3110;
...
void 生成中断语句IR(struct IR生成上下文* cn_var_上下文) {
  ...
  logic_merge_3114:
  if (r5) goto if_then_3111; else goto if_merge_3112;
  return;
}
...
void 生成继续语句IR(struct IR生成上下文* cn_var_上下文) {
  ...
  logic_merge_3118:
  if (r5) goto if_then_3115; else goto if_merge_3116;
  return;
}
...
void 生成块语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3122; else goto logic_rhs_3121;
  ...
  r3 = cn_var_语句;
  r4 = !r3;
  goto logic_merge_3122;

  logic_merge_3122:
  if (r4) goto if_then_3119; else goto if_merge_3120;

  while_cond_3123:
  r7 = cn_var_子语句_0;
  if (r7) goto while_body_3124; else goto while_exit_3125;
...
void 生成函数IR(struct IR生成上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3129; else goto logic_rhs_3128;
  ...
  r12 = r11->参数列表;
  cn_var_参数_1 = r12;
  goto while_cond_3130;

  logic_rhs_3128:
  r3 = cn_var_声明;
  r4 = !r3;
  goto logic_merge_3129;

  logic_merge_3129:
  if (r4) goto if_then_3126; else goto if_merge_3127;

  while_cond_3130:
  r13 = cn_var_参数_1;
  if (r13) goto while_body_3131; else goto while_exit_3132;
...
void 生成程序IR(struct IR生成上下文* cn_var_上下文, struct 程序节点* cn_var_程序) {
  ...
  while_cond_3137:
  r7 = cn_var_声明_0;
  if (r7) goto while_body_3138; else goto while_exit_3139;
  ...
  r10 = cn_var_函数声明;
  r11 = r9 == r10;
  if (r11) goto case_body_3141; else goto switch_check_3144;
  ...
  r12 = cn_var_变量声明;
  r13 = r9 == r12;
  if (r13) goto case_body_3142; else goto case_default_3143;

  case_body_3141:
  r14 = cn_var_上下文;
  r15 = cn_var_声明_0;
  生成函数IR(r14, r15);
  goto switch_merge_3140;
  goto switch_merge_3140;
...
void 生成全局变量IR(struct IR生成上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  r1 = cn_var_上下文;
  r2 = !r1;
  if (r2) goto logic_merge_3148; else goto logic_rhs_3147;
  ...
  r6 = cn_var_声明;
  r7 = r6->初始值表达式;
  if (r7) goto if_then_3149; else goto if_merge_3150;

  logic_rhs_3147:
  r3 = cn_var_声明;
  r4 = !r3;
  goto logic_merge_3148;

  logic_merge_3148:
  if (r4) goto if_then_3145; else goto if_merge_3146;
