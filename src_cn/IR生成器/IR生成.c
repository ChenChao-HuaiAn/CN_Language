...
struct IR操作数 生成表达式IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  long long r1, r4, r5, r7, r9, r11, r14, r16, r22, r24, r27, r29, r32, r34, r37, r39, r42, r43, r45;
  struct 表达式节点* r0;
  struct 表达式节点* r3;
  struct 表达式节点* r26;
  struct 表达式节点* r28;
...
struct IR操作数 生成赋值IR(struct IR生成上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  long long r0, r2, r4, r8, r11, r12, r13, r16, r17, r22, r23, r34;
  char* r18;
  char* r19;
  char* r20;
  char* r31;
...
void 生成语句IR(struct IR生成上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  long long r0, r2, r4, r6, r8, r11, r20;
  struct IR生成上下文* r1;
  struct 语句节点* r3;
  struct 语句节点* r5;
  struct IR生成上下文* r18;
