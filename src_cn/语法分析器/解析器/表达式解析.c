...
struct 表达式节点* 解析后缀表达式(struct 解析器* cn_var_实例) {
  ...
  r29 = cn_var_成员节点_4;
  r30 = r29 == 0;
  if (r30) goto if_then_1264; else goto if_merge_1265;

  if_else_1262:
  r35 = cn_var_实例;
  r36 = 检查(r35, 词元类型枚举_箭头);
  if (r36) goto if_then_1266; else goto if_else_1267;
  ...
  r44 = cn_var_成员节点_6;
  r45 = r44 == 0;
  if (r45) goto if_then_1269; else goto if_merge_1270;

  if_else_1267:
  r50 = cn_var_实例;
  r51 = 检查(r50, 词元类型枚举_左方括号);
  if (r51) goto if_then_1271; else goto if_else_1272;
  ...
  r58 = cn_var_数组节点_8;
  r59 = r58 == 0;
  if (r59) goto if_then_1274; else goto if_merge_1275;

  if_else_1272:
  r64 = cn_var_实例;
  r65 = 检查(r64, 词元类型枚举_自增);
  if (r65) goto if_then_1276; else goto if_else_1277;
  ...
  r68 = cn_var_一元节点_9;
  r69 = r68 == 0;
  if (r69) goto if_then_1279; else goto if_merge_1280;

  if_else_1277:
  r73 = cn_var_实例;
  r74 = 检查(r73, 词元类型枚举_自减);
  if (r74) goto if_then_1281; else goto if_else_1282;
  ...
  r77 = cn_var_一元节点_10;
  r78 = r77 == 0;
  if (r78) goto if_then_1284; else goto if_merge_1285;
...
struct 表达式节点* 解析字面量(struct 解析器* cn_var_实例) {
  ...
  r7 = r6.类型;
  r8 = r7 == 词元类型枚举_整数字面量;
  if (r8) goto case_body_1315; else goto switch_check_1322;

  switch_check_1322:
  r9 = r7 == 词元类型枚举_浮点字面量;
  if (r9) goto case_body_1316; else goto switch_check_1323;

  switch_check_1323:
  r10 = r7 == 词元类型枚举_字符串字面量;
  if (r10) goto case_body_1317; else goto switch_check_1324;

  switch_check_1324:
  r11 = r7 == 词元类型枚举_字符字面量;
  if (r11) goto case_body_1318; else goto switch_check_1325;

  switch_check_1325:
  r12 = r7 == 词元类型枚举_关键字_真;
  if (r12) goto case_body_1319; else goto switch_check_1326;

  switch_check_1326:
  r13 = r7 == 词元类型枚举_关键字_假;
  if (r13) goto case_body_1320; else goto case_default_1321;
