...
struct 声明节点* 解析顶层声明(struct 解析器* cn_var_实例) {
  ...
  r2 = cn_var_实例;
  r3 = 解析可见性修饰符(r2);
/* P7DBG_STORE src1.kind=1 */  cn_var_当前可见性_0 = r3;
  r4 = cn_var_实例->当前词元;
  r5 = r4.类型;
  r6 = r5 == 词元类型枚举_关键字_函数;
...
struct 参数列表* 解析参数列表(struct 解析器* cn_var_实例) {
  ...
  r7 = cn_var_实例;
  r8 = 解析参数(r7);
/* P7DBG_STORE src1.kind=1 */  cn_var_参数_1 = r8;
  r9 = cn_var_参数_1;
  r10 = r9 != 0;
...
struct 声明节点* 解析结构体声明(struct 解析器* cn_var_实例) {
  ...
  r14 = cn_var_实例;
  r15 = 解析变量声明(r14);
/* P7DBG_STORE src1.kind=1 */  cn_var_成员_1 = r15;
  r16 = cn_var_成员_1;
  r17 = r16 != 0;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_当前值_1 = 0;
  ...
  字符串转整数(r23);
  r24 = cn_var_成员_2->值;
/* P7DBG_STORE src1.kind=1 */  cn_var_当前值_1 = r24;
  r25 = cn_var_实例;
  ...
  r28 = cn_var_当前值_1;
  r29 = r28 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_当前值_1 = r29;
  r30 = cn_var_节点_0;
  r31 = cn_var_成员_2;
  枚举添加成员(r30, r31);
  r32 = cn_var_实例;
...
struct 声明节点* 解析类声明(struct 解析器* cn_var_实例) {
  ...
  r22 = cn_var_实例->当前词元;
  r23 = r22.值;
/* P7DBG_STORE src1.kind=1 */  cn_var_接口名_1 = r23;
  r24 = cn_var_实例;
  ...
  r36 = cn_var_实例;
  r37 = 解析可见性修饰符(r36);
/* P7DBG_STORE src1.kind=1 */  cn_var_成员可见性_2 = r37;
  r38 = cn_var_实例;
  ...
  r40 = cn_var_实例;
  r41 = 解析函数声明(r40);
/* P7DBG_STORE src1.kind=1 */  cn_var_方法_3 = r41;
  r42 = cn_var_方法_3;
  r43 = r42 != 0;
  ...
  r47 = cn_var_实例;
  r48 = 解析变量声明(r47);
/* P7DBG_STORE src1.kind=1 */  cn_var_字段_4 = r48;
  r49 = cn_var_字段_4;
  r50 = r49 != 0;
...
struct 声明节点* 解析接口声明(struct 解析器* cn_var_实例) {
  ...
  r16 = cn_var_实例;
  r17 = 解析函数声明(r16);
/* P7DBG_STORE src1.kind=1 */  cn_var_方法_1 = r17;
  r18 = cn_var_方法_1;
  r19 = r18 != 0;
...
struct 声明节点* 解析导入声明(struct 解析器* cn_var_实例) {
  ...
  r15 = cn_var_实例->当前词元;
  r16 = r15.值;
/* P7DBG_STORE src1.kind=1 */  cn_var_成员名_1 = r16;
  r17 = cn_var_实例;
  r18 = 期望(r17, 词元类型枚举_标识符);
  r19 = cn_var_节点_0;
  r20 = cn_var_成员名_1;
