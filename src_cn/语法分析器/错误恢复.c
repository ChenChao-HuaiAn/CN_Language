...
long long 跳转到同步点(struct 语法错误恢复上下文* cn_var_上下文, enum 词元类型枚举 cn_var_当前词元类型, enum 同步点类型 cn_var_目标同步类型) {
  ...
  r8 = r7->最大恢复次数;
  r9 = r6 > r8;
  if (r9) goto if_then_923; else goto if_merge_924;
  ...
  r11 = cn_var_目标同步类型;
  r12 = 是同步点(r10, r11);
  if (r12) goto if_then_925; else goto if_merge_926;
  ...
  if (r14) goto if_then_927; else goto if_merge_928;

  if_then_927:
  r15 = cn_var_当前词元类型;
  r16 = 是任意同步点(r15);
  if (r16) goto if_then_929; else goto if_merge_930;
...
_Bool 应该抑制错误(struct 语法错误恢复上下文* cn_var_上下文) {
  ...
  r2 = cn_var_上下文;
  r3 = r2->抑制级联错误;
  if (r3) goto if_then_933; else goto if_merge_934;
  ...
  r7 = r6->最大连续错误;
  r8 = r5 >= r7;
  if (r8) goto if_then_935; else goto if_merge_936;
...
void 记录错误(struct 语法错误恢复上下文* cn_var_上下文, long long cn_var_行号) {
  ...
  r4 = cn_var_行号;
  r5 = r3 == r4;
  if (r5) goto if_then_939; else goto if_else_940;
  ...
  r12 = r11->最大连续错误;
  r13 = r10 >= r12;
  if (r13) goto if_then_942; else goto if_merge_943;
