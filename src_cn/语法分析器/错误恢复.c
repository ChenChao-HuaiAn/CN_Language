...
long long 是任意同步点(enum 词元类型枚举 cn_var_词元类型) {
  long long r2, r3, r6, r7, r10, r11, r14, r15, r18, r19, r22, r23, r26, r27, r30, r31;
  enum 词元类型枚举 r0;
  enum 同步点类型 r1;
  enum 词元类型枚举 r4;
  enum 同步点类型 r5;
  ...
  r2 = r1.同步点_分号;
  r3 = 是同步点(r0, r2);
  if (r3) goto if_then_854; else goto if_merge_855;
  ...
  r6 = r5.同步点_右大括号;
  r7 = 是同步点(r4, r6);
  if (r7) goto if_then_856; else goto if_merge_857;
  ...
  r10 = r9.同步点_右小括号;
  r11 = 是同步点(r8, r10);
  if (r11) goto if_then_858; else goto if_merge_859;
  ...
  r14 = r13.同步点_右中括号;
  r15 = 是同步点(r12, r14);
  if (r15) goto if_then_860; else goto if_merge_861;
  ...
  r18 = r17.同步点_逗号;
  r19 = 是同步点(r16, r18);
  if (r19) goto if_then_862; else goto if_merge_863;
  ...
  r22 = r21.同步点_关键字;
  r23 = 是同步点(r20, r22);
  if (r23) goto if_then_864; else goto if_merge_865;
  ...
  r26 = r25.同步点_类型关键字;
  r27 = 是同步点(r24, r26);
  if (r27) goto if_then_866; else goto if_merge_867;
  ...
  r30 = r29.同步点_声明关键字;
  r31 = 是同步点(r28, r30);
  if (r31) goto if_then_868; else goto if_merge_869;
...
long long 跳转到同步点(struct 语法错误恢复上下文* cn_var_上下文, enum 词元类型枚举 cn_var_当前词元类型, enum 同步点类型 cn_var_目标同步类型) {
  long long r1, r3, r4, r6, r8, r9, r12, r15, r16, r18;
  struct 语法错误恢复上下文* r0;
  struct 语法错误恢复上下文* r2;
  struct 语法错误恢复上下文* r5;
  struct 语法错误恢复上下文* r7;
  ...
  r15 = r14.同步点_分号;
  r16 = r13 == r15;
  if (r16) goto if_then_876; else goto if_merge_877;

  if_then_876:
  r17 = cn_var_当前词元类型;
  r18 = 是任意同步点(r17);
  if (r18) goto if_then_878; else goto if_merge_879;
