...
long long 是同步点(enum 词元类型枚举 cn_var_词元类型, enum 同步点类型 cn_var_同步类型) {
  ...
  r20 = cn_var_词元类型;
  r21 = r20 >= 100;
  if (r21) goto logic_rhs_848; else goto logic_merge_849;
  ...
  r25 = cn_var_词元类型;
  r26 = r25 >= 160;
  if (r26) goto logic_rhs_850; else goto logic_merge_851;
  ...
  r30 = cn_var_词元类型;
  r31 = r30 >= 180;
  if (r31) goto logic_rhs_852; else goto logic_merge_853;
...
long long 是任意同步点(enum 词元类型枚举 cn_var_词元类型) {
  ...
  r2 = cn_var_词元类型;
  r3 = 是同步点(r2, 1);
  if (r3) goto if_then_856; else goto if_merge_857;
  ...
  r4 = cn_var_词元类型;
  r5 = 是同步点(r4, 2);
  if (r5) goto if_then_858; else goto if_merge_859;
  ...
  r6 = cn_var_词元类型;
  r7 = 是同步点(r6, 3);
  if (r7) goto if_then_860; else goto if_merge_861;
  ...
  r8 = cn_var_词元类型;
  r9 = 是同步点(r8, 4);
  if (r9) goto if_then_862; else goto if_merge_863;
  ...
  r10 = cn_var_词元类型;
  r11 = 是同步点(r10, 5);
  if (r11) goto if_then_864; else goto if_merge_865;
  ...
  r12 = cn_var_词元类型;
  r13 = 是同步点(r12, 6);
  if (r13) goto if_then_866; else goto if_merge_867;
  ...
  r14 = cn_var_词元类型;
  r15 = 是同步点(r14, 7);
  if (r15) goto if_then_868; else goto if_merge_869;
...
long long 跳转到同步点(struct 语法错误恢复上下文* cn_var_上下文, enum 词元类型枚举 cn_var_当前词元类型, enum 同步点类型 cn_var_目标同步类型) {
  ...
  r11 = cn_var_目标同步类型;
  r12 = 是同步点(r10, r11);
  if (r12) goto if_then_874; else goto if_merge_875;
  ...
  r13 = cn_var_目标同步类型;
  r14 = r13 == 0;
  if (r14) goto if_then_876; else goto if_merge_877;

  if_then_876:
  r15 = cn_var_当前词元类型;
  r16 = 是任意同步点(r15);
  if (r16) goto if_then_878; else goto if_merge_879;
...
char* 同步点类型名称(enum 同步点类型 cn_var_同步类型) {
  ...
  r0 = cn_var_同步类型;
  r1 = r0 == 0;
  if (r1) goto case_body_921; else goto switch_check_930;

  switch_check_930:
  r2 = r0 == 1;
  if (r2) goto case_body_922; else goto switch_check_931;

  switch_check_931:
  r3 = r0 == 2;
  if (r3) goto case_body_923; else goto switch_check_932;

  switch_check_932:
  r4 = r0 == 3;
  if (r4) goto case_body_924; else goto switch_check_933;

  switch_check_933:
  r5 = r0 == 4;
  if (r5) goto case_body_925; else goto switch_check_934;

  switch_check_934:
  r6 = r0 == 5;
  if (r6) goto case_body_926; else goto switch_check_935;

  switch_check_935:
  r7 = r0 == 6;
  if (r7) goto case_body_927; else goto switch_check_936;

  switch_check_936:
  r8 = r0 == 7;
  if (r8) goto case_body_928; else goto case_default_929;
...
char* 恢复策略名称(enum 语法恢复策略 cn_var_策略) {
  ...
  r0 = cn_var_策略;
  r1 = r0 == 0;
  if (r1) goto case_body_938; else goto switch_check_944;

  switch_check_944:
  r2 = r0 == 1;
  if (r2) goto case_body_939; else goto switch_check_945;

  switch_check_945:
  r3 = r0 == 2;
  if (r3) goto case_body_940; else goto switch_check_946;

  switch_check_946:
  r4 = r0 == 3;
  if (r4) goto case_body_941; else goto switch_check_947;

  switch_check_947:
  r5 = r0 == 4;
  if (r5) goto case_body_942; else goto case_default_943;
