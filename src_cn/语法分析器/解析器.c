...
struct 解析器* 创建解析器(struct 扫描器* cn_var_扫描器实例, struct 诊断集合* cn_var_诊断集合指针) {
  ...
  r0 = cn_var_扫描器实例;
  r1 = r0 == 0;
  if (r1) goto if_then_1680; else goto if_merge_1681;
  ...
  r4 = cn_var_实例_0;
  r5 = r4 == 0;
  if (r5) goto if_then_1682; else goto if_merge_1683;
  ...
  r14 = cn_var_初始化结果_1;
  r15 = r14 == 0;
  if (r15) goto if_then_1684; else goto if_merge_1685;
...
void 销毁解析器(struct 解析器* cn_var_实例) {
  ...
  r0 = cn_var_实例;
  r1 = r0 != 0;
  if (r1) goto if_then_1686; else goto if_merge_1687;
...
struct 程序节点* 解析程序(struct 解析器* cn_var_实例) {
  ...
  r0 = cn_var_实例;
  r1 = r0 == 0;
  if (r1) goto if_then_1688; else goto if_merge_1689;
  ...
  r3 = cn_var_程序_0;
  r4 = r3 == 0;
  if (r4) goto if_then_1690; else goto if_merge_1691;
  ...
  r7 = r6.类型;
  r8 = r7 != 80;
  if (r8) goto while_body_1693; else goto while_exit_1694;
  ...
  r11 = cn_var_声明_1;
  r12 = r11 != 0;
  if (r12) goto if_then_1695; else goto if_merge_1696;
...
void 前进词元(struct 解析器* cn_var_实例) {
  ...
  r0 = cn_var_实例;
  r1 = r0 == 0;
  if (r1) goto if_then_1697; else goto if_merge_1698;
...
_Bool 期望(struct 解析器* cn_var_实例, enum 词元类型枚举 cn_var_类型) {
  ...
  r0 = cn_var_实例;
  r1 = r0 == 0;
  if (r1) goto if_then_1699; else goto if_merge_1700;
  ...
  r3 = cn_var_类型;
  r4 = 检查(r2, r3);
  if (r4) goto if_then_1701; else goto if_merge_1702;
...
_Bool 检查(struct 解析器* cn_var_实例, enum 词元类型枚举 cn_var_类型) {
  ...
  r0 = cn_var_实例;
  r1 = r0 == 0;
  if (r1) goto if_then_1703; else goto if_merge_1704;
...
_Bool 匹配(struct 解析器* cn_var_实例, enum 词元类型枚举 cn_var_类型) {
  ...
  r1 = cn_var_类型;
  r2 = 检查(r0, r1);
  if (r2) goto if_then_1705; else goto if_merge_1706;
...
_Bool 匹配多种(struct 解析器* cn_var_实例, enum 词元类型枚举* cn_var_类型数组, long long cn_var_数量) {
  ...
  r2 = cn_var_实例;
  r3 = r2 == 0;
  if (r3) goto logic_merge_1712; else goto logic_rhs_1711;
  ...
  r4 = cn_var_类型数组;
  r5 = r4 == 0;
  goto logic_merge_1712;

  logic_merge_1712:
  if (r5) goto logic_merge_1710; else goto logic_rhs_1709;

  for_cond_1713:
  r8 = cn_var_i_0;
  r9 = cn_var_数量;
  r10 = r8 < r9;
  if (r10) goto for_body_1714; else goto for_exit_1716;
  ...
  r15 = 检查(r11, r14);
  if (r15) goto if_then_1717; else goto if_merge_1718;
...
void 报告错误(struct 解析器* cn_var_实例, enum 诊断错误码 cn_var_错误码, char* cn_var_消息) {
  ...
  r0 = cn_var_实例;
  r1 = r0 == 0;
  if (r1) goto if_then_1719; else goto if_merge_1720;
  ...
  r6 = r5->诊断集合指针;
  r7 = r6 != 0;
  if (r7) goto if_then_1721; else goto if_merge_1722;
...
_Bool 同步恢复(struct 解析器* cn_var_实例) {
  ...
  r0 = cn_var_实例;
  r1 = r0 == 0;
  if (r1) goto if_then_1725; else goto if_merge_1726;
  ...
  r4 = &r6;
  r7 = 应该抑制错误(r4);
  if (r7) goto if_then_1727; else goto if_merge_1728;
  ...
  r13 = cn_var_最大错误恢复次数;
  r14 = r12 > r13;
  if (r14) goto if_then_1729; else goto if_merge_1730;
  ...
  r25 = r24.类型;
  r26 = r25 != 80;
  if (r26) goto while_body_1732; else goto while_exit_1733;
  ...
  r29 = r28.类型;
  r30 = 是任意同步点(r29);
  if (r30) goto if_then_1734; else goto if_merge_1735;
  ...
  r36 = cn_var_实例;
  r37 = 匹配(r36, 75);
  if (r37) goto if_then_1736; else goto if_merge_1737;
  ...
  r43 = cn_var_实例;
  r44 = 检查(r43, 72);
  if (r44) goto if_then_1738; else goto if_merge_1739;
  ...
  r60 = cn_var_类型_0;
  r61 = r60 == 17;
  if (r61) goto logic_merge_1755; else goto logic_rhs_1754;
  ...
  logic_merge_1743:
  if (r75) goto if_then_1740; else goto if_merge_1741;
  ...
  logic_merge_1745:
  if (r73) goto logic_merge_1743; else goto logic_rhs_1742;
  ...
  logic_merge_1747:
  if (r71) goto logic_merge_1745; else goto logic_rhs_1744;
  ...
  logic_merge_1749:
  if (r69) goto logic_merge_1747; else goto logic_rhs_1746;
  ...
  logic_merge_1751:
  if (r67) goto logic_merge_1749; else goto logic_rhs_1748;
  ...
  logic_merge_1753:
  if (r65) goto logic_merge_1751; else goto logic_rhs_1750;
  ...
  logic_merge_1755:
  if (r63) goto logic_merge_1753; else goto logic_rhs_1752;
  return 0;
}
...
_Bool 是否类型关键字(enum 词元类型枚举 cn_var_类型) {
  ...
  r7 = cn_var_类型;
  r8 = r7 == 10;
  if (r8) goto logic_merge_1769; else goto logic_rhs_1768;

  logic_rhs_1756:
  r21 = cn_var_类型;
  r22 = r21 == 40;
  goto logic_merge_1757;
  ...
  r19 = cn_var_类型;
  r20 = r19 == 16;
  goto logic_merge_1759;

  logic_merge_1759:
  if (r20) goto logic_merge_1757; else goto logic_rhs_1756;
  ...
  logic_merge_1761:
  if (r18) goto logic_merge_1759; else goto logic_rhs_1758;
  ...
  logic_merge_1763:
  if (r16) goto logic_merge_1761; else goto logic_rhs_1760;

  logic_rhs_1764:
  r13 = cn_var_类型;
  r14 = r13 == 13;
  goto logic_merge_1765;

  logic_merge_1765:
  if (r14) goto logic_merge_1763; else goto logic_rhs_1762;

  logic_rhs_1766:
  r11 = cn_var_类型;
  r12 = r11 == 12;
  goto logic_merge_1767;

  logic_merge_1767:
  if (r12) goto logic_merge_1765; else goto logic_rhs_1764;

  logic_rhs_1768:
  r9 = cn_var_类型;
  r10 = r9 == 11;
  goto logic_merge_1769;

  logic_merge_1769:
  if (r10) goto logic_merge_1767; else goto logic_rhs_1766;
  return 0;
}
