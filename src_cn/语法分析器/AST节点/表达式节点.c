...
struct 表达式列表* 创建表达式列表() {
  ...
  r2 = cn_var_列表_0;
  r3 = r2 == 0;
  if (r3) goto if_then_299; else goto if_merge_300;
...
void 表达式列表添加(struct 表达式列表* cn_var_列表, struct 表达式节点* cn_var_节点) {
  ...
  r1 = cn_var_列表;
  r2 = r1 == 0;
  if (r2) goto logic_merge_304; else goto logic_rhs_303;
  ...
  r6 = r5->节点;
  r7 = r6 == 0;
  if (r7) goto if_then_305; else goto if_merge_306;
  ...
  logic_merge_304:
  if (r4) goto if_then_301; else goto if_merge_302;
  ...
  r11 = r10->下一个;
  r12 = r11 != 0;
  if (r12) goto while_body_308; else goto while_exit_309;
...
void 释放表达式节点(struct 表达式节点* cn_var_节点) {
  ...
  r0 = cn_var_节点;
  r1 = r0 == 0;
  if (r1) goto if_then_312; else goto if_merge_313;
  ...
  r3 = r2->左操作数;
  r4 = r3 != 0;
  if (r4) goto if_then_314; else goto if_merge_315;
  ...
  r8 = r7->右操作数;
  r9 = r8 != 0;
  if (r9) goto if_then_316; else goto if_merge_317;
  ...
  r18 = r17->被调函数;
  r19 = r18 != 0;
  if (r19) goto if_then_320; else goto if_merge_321;
  ...
  r23 = r22->参数列表;
  r24 = r23 != 0;
  if (r24) goto if_then_322; else goto if_merge_323;
  ...
  r28 = r27->对象;
  r29 = r28 != 0;
  if (r29) goto if_then_324; else goto if_merge_325;
  ...
  r33 = r32->数组;
  r34 = r33 != 0;
  if (r34) goto if_then_326; else goto if_merge_327;
  ...
  r38 = r37->索引;
  r39 = r38 != 0;
  if (r39) goto if_then_328; else goto if_merge_329;
  ...
  r43 = r42->左侧表达式;
  r44 = r43 != 0;
  if (r44) goto if_then_330; else goto if_merge_331;
  ...
  r48 = r47->值;
  r49 = r48 != 0;
  if (r49) goto if_then_332; else goto if_merge_333;
  ...
  r53 = r52->指针;
  r54 = r53 != 0;
  if (r54) goto if_then_334; else goto if_merge_335;
...
void 释放表达式列表(struct 表达式列表* cn_var_列表) {
  ...
  r0 = cn_var_列表;
  r1 = r0 == 0;
  if (r1) goto if_then_336; else goto if_merge_337;
  ...
  r3 = r2->节点;
  r4 = r3 != 0;
  if (r4) goto if_then_338; else goto if_merge_339;
  ...
  r8 = r7->下一个;
  r9 = r8 != 0;
  if (r9) goto if_then_340; else goto if_merge_341;
