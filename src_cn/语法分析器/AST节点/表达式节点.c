...
struct 表达式节点* 创建表达式节点(enum 节点类型 cn_var_类型) {
  ...
  r2 = cn_var_节点_0;
  r3 = r2 == 0;
  if (r3) goto if_then_858; else goto if_merge_859;
...
struct 表达式节点* 创建空值表达式() {
  ...
  r1 = cn_var_节点_0;
  r2 = r1 != 0;
  if (r2) goto if_then_860; else goto if_merge_861;
...
struct 表达式节点* 创建自身表达式() {
  ...
  r1 = cn_var_节点_0;
  r2 = r1 != 0;
  if (r2) goto if_then_862; else goto if_merge_863;
...
struct 表达式节点* 创建基类访问表达式(const char* cn_var_成员名) {
  ...
  r1 = cn_var_节点_0;
  r2 = r1 != 0;
  if (r2) goto if_then_864; else goto if_merge_865;
...
struct 表达式节点* 创建类型转换表达式(struct 类型节点* cn_var_目标类型, struct 表达式节点* cn_var_操作数) {
  ...
  r1 = cn_var_节点_0;
  r2 = r1 != 0;
  if (r2) goto if_then_866; else goto if_merge_867;
...
struct 表达式列表* 创建表达式列表() {
  ...
  r2 = cn_var_列表_0;
  r3 = r2 == 0;
  if (r3) goto if_then_868; else goto if_merge_869;
...
void 表达式列表添加(struct 表达式列表* cn_var_列表, struct 表达式节点* cn_var_节点) {
  ...
  r1 = cn_var_列表;
  r2 = r1 == 0;
  if (r2) goto logic_merge_873; else goto logic_rhs_872;
  ...
  r9 = cn_var_当前_0->下一个;
  r10 = r9 != 0;
  if (r10) goto while_body_877; else goto while_exit_878;
  ...
  r13 = cn_var_新节点_1;
  r14 = r13 != 0;
  if (r14) goto if_then_879; else goto if_merge_880;
...
void 释放表达式节点(struct 表达式节点* cn_var_节点) {
  ...
  r2 = cn_var_节点->左操作数;
  r3 = r2 != 0;
  if (r3) goto if_then_883; else goto if_merge_884;
  ...
  r11 = cn_var_节点->被调函数;
  r12 = r11 != 0;
  if (r12) goto if_then_889; else goto if_merge_890;
  ...
  r14 = cn_var_节点->参数列表;
  r15 = r14 != 0;
  if (r15) goto if_then_891; else goto if_merge_892;
  ...
  r17 = cn_var_节点->对象;
  r18 = r17 != 0;
  if (r18) goto if_then_893; else goto if_merge_894;
  ...
  r20 = cn_var_节点->数组;
  r21 = r20 != 0;
  if (r21) goto if_then_895; else goto if_merge_896;
  ...
  r23 = cn_var_节点->索引;
  r24 = r23 != 0;
  if (r24) goto if_then_897; else goto if_merge_898;
  ...
  r26 = cn_var_节点->左侧表达式;
  r27 = r26 != 0;
  if (r27) goto if_then_899; else goto if_merge_900;
  ...
  r29 = cn_var_节点->值;
  r30 = r29 != 0;
  if (r30) goto if_then_901; else goto if_merge_902;
  ...
  r32 = cn_var_节点->指针;
  r33 = r32 != 0;
  if (r33) goto if_then_903; else goto if_merge_904;
...
void 释放表达式列表(struct 表达式列表* cn_var_列表) {
  ...
  r5 = cn_var_列表->下一个;
  r6 = r5 != 0;
  if (r6) goto if_then_909; else goto if_merge_910;
