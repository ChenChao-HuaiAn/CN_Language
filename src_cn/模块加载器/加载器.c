...
void 销毁模块加载器(struct 模块加载器* cn_var_加载器) {
  long long r2, r4, r8, r13, r15, r16, r17, r18, r22, r32, r33;
  char* r29;
  void* r7;
  void* r12;
  void* r21;
  ...
  r7 = r6->搜索路径列表;
  r8 = cn_var_i_0;
  r9 = *(char***)cn_rt_array_get_element(r7, r8, 8);
  r10 = r9 != 0;
  ...
  r12 = r11->搜索路径列表;
  r13 = cn_var_i_0;
  r14 = *(char***)cn_rt_array_get_element(r12, r13, 8);
  释放内存(r14);
  goto if_merge_9;
  ...
  r18 = cn_var_最大模块缓存数量;
  r19 = r17 < r18;
  if (r19) goto for_body_11; else goto for_exit_13;
  ...
  r21 = r20->缓存列表;
  r22 = cn_var_i_1;
  r23 = *(struct 模块缓存条目**)cn_rt_array_get_element(r21, r22, 8);
  cn_var_条目_2 = r23;
  goto while_cond_14;
  ...
  r24 = cn_var_条目_2;
  r25 = r24 != 0;
  if (r25) goto while_body_15; else goto while_exit_16;
...
_Bool 添加搜索路径(struct 模块加载器* cn_var_加载器, char* cn_var_路径) {
  long long r0, r6, r7, r10, r11, r12, r23, r25, r26;
  char* r3;
  char* r9;
  char* r14;
  char* r16;
  ...
  r22 = cn_var_加载器;
  r23 = r22->搜索路径数量;
    { char* _tmp_r0 = r19; cn_rt_array_set_element(r21, r23, &_tmp_r0, 8); }
  r24 = cn_var_加载器;
  r25 = r24->搜索路径数量;
  r26 = r25 + 1;
  return 1;
...
struct 模块标识符* 解析模块标识符(char* cn_var_模块名) {
  long long r3, r4, r5, r7, r8, r10, r14, r15, r25, r26, r27, r30, r33, r34, r35, r36, r37, r38, r46, r47, r48, r50, r52, r56, r60, r62, r63, r64, r68, r69, r73, r75, r76, r88, r89, r90, r92, r95, r96, r97, r98, r99;
  char* r0;
  char* r2;
  char* r18;
  char* r22;
  ...
  r29 = cn_var_模块名;
  r30 = cn_var_i_3;
  r31 = *(char**)cn_rt_array_get_element(r29, r30, 8);
  r32 = r31 == 46;
  ...
  r51 = cn_var_模块名;
  r52 = cn_var_i_6;
  r53 = *(char**)cn_rt_array_get_element(r51, r52, 8);
  r54 = r53 == 46;
  ...
  r59 = cn_var_缓冲区;
  r60 = cn_var_缓冲区位置_4;
    { long long _tmp_i0 = 0; cn_rt_array_set_element(r59, r60, &_tmp_i0, 8); }
  ...
  r91 = cn_var_模块名;
  r92 = cn_var_i_6;
  r93 = *(char**)cn_rt_array_get_element(r91, r92, 8);
  r94 = cn_var_缓冲区;
  r95 = cn_var_缓冲区位置_4;
    { long long _tmp_r1 = r93; cn_rt_array_set_element(r94, r95, &_tmp_r1, 8); }
  r96 = cn_var_缓冲区位置_4;
  r97 = r96 + 1;
  cn_var_缓冲区位置_4 = r97;
  goto if_merge_51;
  ...
  r55 = cn_var_模块名;
  r56 = cn_var_i_6;
  r57 = *(char**)cn_rt_array_get_element(r55, r56, 8);
  r58 = r57 == 0;
  goto logic_merge_53;
  ...
  r87 = r86->路径段列表;
  r88 = cn_var_当前段索引_5;
    { char* _tmp_r2 = r85; cn_rt_array_set_element(r87, r88, &_tmp_r2, 8); }
  r89 = cn_var_当前段索引_5;
  r90 = r89 + 1;
  cn_var_当前段索引_5 = r90;
  cn_var_缓冲区位置_4 = 0;
  ...
  r72 = r71->路径段列表;
  r73 = cn_var_j_9;
  r74 = *(char***)cn_rt_array_get_element(r72, r73, 8);
  释放内存(r74);
  goto for_update_58;
...
void 销毁模块标识符(struct 模块标识符* cn_var_标识符) {
  ...
  r20 = r19->路径段列表;
  r21 = cn_var_i_0;
  r22 = *(char***)cn_rt_array_get_element(r20, r21, 8);
  释放内存(r22);
  goto if_merge_71;
...
_Bool 解析模块文件路径(struct 模块加载器* cn_var_加载器, struct 模块标识符* cn_var_标识符, char* cn_var_输出路径, long long cn_var_输出路径大小) {
  long long r0, r1, r8, r10, r14, r17, r20, r22, r23, r25, r28, r29, r30, r33, r36, r38, r39, r41, r43, r44, r45, r46, r47, r49, r50, r52, r53, r55, r61, r62, r67, r68;
  char* r6;
  char* r16;
  char* r19;
  char* r35;
  ...
  r13 = r12->搜索路径列表;
  r14 = cn_var_i_0;
  r15 = *(char***)cn_rt_array_get_element(r13, r14, 8);
  cn_var_搜索路径_1 = r15;
  char* cn_var_路径缓冲区;
  ...
  r25 = r24->路径段数量;
  r26 = r23 < r25;
  if (r26) goto for_body_83; else goto for_exit_85;

  for_body_83:
  r27 = cn_var_路径缓冲区;
  r28 = cn_var_路径位置_2;
    { long long _tmp_i1 = 47; cn_rt_array_set_element(r27, r28, &_tmp_i1, 8); }
  r29 = cn_var_路径位置_2;
  r30 = r29 + 1;
  cn_var_路径位置_2 = r30;
  char* cn_var_段_5;
  ...
  r32 = r31->路径段列表;
  r33 = cn_var_j_4;
  r34 = *(char***)cn_rt_array_get_element(r32, r33, 8);
  cn_var_段_5 = r34;
  ...
  r54 = cn_var_路径缓冲区;
  r55 = cn_var_路径位置_2;
    { long long _tmp_i2 = 0; cn_rt_array_set_element(r54, r55, &_tmp_i2, 8); }
  void* cn_var_文件_7;
  r56 = cn_var_路径缓冲区;
  r57 = 打开文件(r56, "r");
  cn_var_文件_7 = r57;
  r58 = cn_var_文件_7;
  r59 = r58 != 0;
  if (r59) goto if_then_86; else goto if_merge_87;
  ...
  r62 = cn_var_输出路径大小;
  r63 = r61 < r62;
  if (r63) goto if_then_88; else goto if_merge_89;
...
struct 模块元数据* 从缓存获取模块(struct 模块加载器* cn_var_加载器, char* cn_var_模块名) {
  ...
  r11 = r10->缓存列表;
  r12 = cn_var_索引_1;
  r13 = *(struct 模块缓存条目**)cn_rt_array_get_element(r11, r12, 8);
  cn_var_条目_2 = r13;
  goto while_cond_102;
...
_Bool 添加模块到缓存(struct 模块加载器* cn_var_加载器, char* cn_var_模块名, struct 模块元数据* cn_var_元数据) {
  long long r0, r1, r9, r10, r11, r12, r13, r18, r19, r20, r33, r38, r40, r41;
  char* r4;
  char* r8;
  char* r17;
  char* r23;
  ...
  r32 = r31->缓存列表;
  r33 = cn_var_索引_1;
  r34 = *(struct 模块缓存条目**)cn_rt_array_get_element(r32, r33, 8);
  r35 = cn_var_新条目_2;
  r36 = cn_var_加载器;
  r37 = r36->缓存列表;
  r38 = cn_var_索引_1;
    { long long _tmp_r3 = r35; cn_rt_array_set_element(r37, r38, &_tmp_r3, 8); }
  r39 = cn_var_加载器;
  r40 = r39->缓存数量;
  r41 = r40 + 1;
  return 1;
...
_Bool 读取文件内容(char* cn_var_文件路径, char** cn_var_输出缓冲区, long long* cn_var_输出大小) {
  ...
  r32 = cn_var_缓冲区_2;
  r33 = cn_var_文件大小_1;
    { long long _tmp_i3 = 0; cn_rt_array_set_element(r32, r33, &_tmp_i3, 8); }
  r34 = cn_var_缓冲区_2;
  r35 = cn_var_文件大小_1;
  return 1;
}
...
_Bool 处理导入语句(struct 模块加载器* cn_var_加载器, struct 导入声明* cn_var_导入节点, struct 模块元数据* cn_var_当前模块) {
  ...
  r39 = cn_var_当前模块;
  r40 = r39->依赖数量;
  r41 = *(struct 模块依赖**)cn_rt_array_get_element(r38, r40, 8);
  cn_var_依赖_4 = r42;
  r43 = cn_var_依赖模块_1;
  r44 = r43->标识符;
  r45 = cn_var_当前模块;
...
_Bool 收集导出符号(struct 模块元数据* cn_var_元数据) {
  long long r0, r14, r18, r19, r20, r23, r25, r26, r31, r38, r42, r45, r49, r52, r56, r58, r59, r61, r64, r68, r70, r71, r73, r75, r78, r85, r86, r87, r88;
  char* r82;
  char* r84;
  struct 模块元数据* r1;
  struct 模块元数据* r3;
  ...
  r44 = r43->导出符号表;
  r45 = cn_var_当前索引_4;
  r46 = *(struct 导出符号**)cn_rt_array_get_element(r44, r45, 8);
  cn_var_符号_6 = r47;
  r48 = cn_var_声明_5;
  r49 = r48->类型;
  r50 = r49 == 1;
