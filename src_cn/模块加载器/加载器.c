...
struct 模块加载器* 创建模块加载器(struct 诊断集合* cn_var_诊断集合指针) {
  ...
  r0 = 模块加载器大小();
  r1 = 分配清零内存(1, r0);
/* P7DBG_STORE src1.kind=7 */  cn_var_加载器_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 模块加载器*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配清零内存(1, /* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */模块加载器大小());
  r2 = cn_var_加载器_0;
  r3 = r2 == 0;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r14 = cn_var_i_0;
  r15 = r14 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r15;
  goto for_cond_4;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_1 = 0;
  ...
  r20 = cn_var_i_1;
  r21 = &r19[r20];
/* P7DBG_STORE src1.kind=1 */  cn_var_条目_2 = r21;
  goto while_cond_14;

  for_update_12:
  r28 = cn_var_i_1;
  r29 = r28 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_1 = r29;
  goto for_cond_10;
  ...
  r24 = cn_var_条目_2->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_下一个_3 = r24;
  r25 = cn_var_条目_2->模块名;
  释放内存(r25);
  r26 = cn_var_条目_2;
  释放内存(r26);
  r27 = cn_var_下一个_3;
/* P7DBG_STORE src1.kind=1 */  cn_var_条目_2 = r27;
  goto while_cond_14;
...
_Bool 添加搜索路径(struct 模块加载器* cn_var_加载器, const char* cn_var_路径) {
  ...
  r8 = cn_var_路径;
  r9 = 获取字符串长度(r8);
/* P7DBG_STORE src1.kind=1 */  cn_var_路径长度_0 = r9;
  char* cn_var_路径副本_1;
  r10 = cn_var_路径长度_0;
  r11 = r10 + 1;
  r12 = 分配内存(r11);
/* P7DBG_STORE src1.kind=7 */  cn_var_路径副本_1 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(char*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(/* P7DBG_expr kind=0 */(/* P7DBG_expr kind=2 */cn_var_路径长度 + 1));
  r13 = cn_var_路径副本_1;
  r14 = r13 == 0;
  ...
  r21 = &r19[r20];
/* P7DBG_STORE src1.kind=1 */  *r21 = r18;
...
struct 模块标识符* 解析模块标识符(const char* cn_var_模块名) {
  ...
  r2 = cn_var_模块名;
  r3 = 获取字符串长度(r2);
/* P7DBG_STORE src1.kind=1 */  cn_var_名称长度_0 = r3;
  r5 = cn_var_名称长度_0;
  r6 = r5 == 0;
  ...
  r10 = 模块标识符大小();
  r11 = 分配清零内存(1, r10);
/* P7DBG_STORE src1.kind=7 */  cn_var_标识符_1 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 模块标识符*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配清零内存(1, /* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */模块标识符大小());
  r12 = cn_var_标识符_1;
  r13 = r12 == 0;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_段数量_2 = 1;
  long long cn_var_i_3;
/* P7DBG_STORE src1.kind=2 */  cn_var_i_3 = 0;
  goto for_cond_37;
  ...
  r34 = cn_var_i_3;
  r35 = r34 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_3 = r35;
  goto for_cond_37;
  ...
  r32 = cn_var_段数量_2;
  r33 = r32 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_段数量_2 = r33;
  goto if_merge_42;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_缓冲区位置_4 = 0;
  long long cn_var_当前段索引_5;
/* P7DBG_STORE src1.kind=2 */  cn_var_当前段索引_5 = 0;
  long long cn_var_i_6;
/* P7DBG_STORE src1.kind=2 */  cn_var_i_6 = 0;
  goto for_cond_45;
  ...
  r97 = cn_var_i_6;
  r98 = r97 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_6 = r98;
  goto for_cond_45;
  ...
  r59 = cn_var_缓冲区位置_4;
  r60 = &r58[r59];
/* P7DBG_STORE src1.kind=2 */  *r60 = 0;
  long long cn_var_段长度_7;
  r61 = cn_var_缓冲区;
  r62 = 获取字符串长度(r61);
/* P7DBG_STORE src1.kind=1 */  cn_var_段长度_7 = r62;
  char* cn_var_段副本_8;
  r63 = cn_var_段长度_7;
  r64 = r63 + 1;
  r65 = 分配内存(r64);
/* P7DBG_STORE src1.kind=7 */  cn_var_段副本_8 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(char*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(/* P7DBG_expr kind=0 */(/* P7DBG_expr kind=2 */cn_var_段长度 + 1));
  r66 = cn_var_段副本_8;
  r67 = r66 == 0;
  ...
  r93 = cn_var_缓冲区位置_4;
  r94 = &r92[r93];
/* P7DBG_STORE src1.kind=1 */  *r94 = r91;
  r95 = cn_var_缓冲区位置_4;
  r96 = r95 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_缓冲区位置_4 = r96;
  goto if_merge_51;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_j_9 = 0;
  goto for_cond_56;
  ...
  r84 = cn_var_当前段索引_5;
  r85 = &r83[r84];
/* P7DBG_STORE src1.kind=1 */  *r85 = r82;
  r86 = cn_var_当前段索引_5;
  r87 = r86 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_当前段索引_5 = r87;
/* P7DBG_STORE src1.kind=2 */  cn_var_缓冲区位置_4 = 0;
  goto if_merge_51;
  ...
  r74 = cn_var_j_9;
  r75 = r74 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_j_9 = r75;
  goto for_cond_56;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r13 = &r11[r12];
  r14 = r13;
/* P7DBG_STORE src1.kind=1 */  cn_var_搜索路径_1 = r14;
  char* cn_var_路径缓冲区;
  cn_var_路径缓冲区 = cn_rt_array_alloc(8, 1024);
  long long cn_var_路径位置_2;
/* P7DBG_STORE src1.kind=2 */  cn_var_路径位置_2 = 0;
  long long cn_var_搜索路径长度_3;
  r15 = cn_var_搜索路径_1;
  r16 = 获取字符串长度(r15);
/* P7DBG_STORE src1.kind=1 */  cn_var_搜索路径长度_3 = r16;
  r17 = cn_var_路径缓冲区;
  r18 = cn_var_搜索路径_1;
  r19 = cn_var_搜索路径长度_3;
  r20 = 复制内存(r17, r18, r19);
  r21 = cn_var_搜索路径长度_3;
/* P7DBG_STORE src1.kind=1 */  cn_var_路径位置_2 = r21;
  long long cn_var_j_4;
/* P7DBG_STORE src1.kind=2 */  cn_var_j_4 = 0;
  goto for_cond_82;

  for_update_80:
  r66 = cn_var_i_0;
  r67 = r66 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r67;
  goto for_cond_78;
  ...
  r26 = cn_var_路径位置_2;
  r27 = &r25[r26];
/* P7DBG_STORE src1.kind=2 */  *r27 = 47;
  r28 = cn_var_路径位置_2;
  r29 = r28 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_路径位置_2 = r29;
  char* cn_var_段_5;
  r30 = cn_var_标识符->路径段列表;
  r31 = cn_var_j_4;
  r32 = *(char*)cn_rt_array_get_element(r30, r31, 8);
/* P7DBG_STORE src1.kind=1 */  cn_var_段_5 = r32;
  long long cn_var_段长度_6;
  r33 = cn_var_段_5;
  r34 = 获取字符串长度(r33);
/* P7DBG_STORE src1.kind=1 */  cn_var_段长度_6 = r34;
  r35 = cn_var_路径缓冲区;
  r36 = cn_var_路径位置_2;
  r37 = r35 + r36;
  r38 = cn_var_段_5;
  ...
  r42 = cn_var_段长度_6;
  r43 = r41 + r42;
/* P7DBG_STORE src1.kind=1 */  cn_var_路径位置_2 = r43;
  goto for_update_84;

  for_update_84:
  r44 = cn_var_j_4;
  r45 = r44 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_j_4 = r45;
  goto for_cond_82;
  ...
  r50 = cn_var_路径位置_2;
  r51 = r50 + 3;
/* P7DBG_STORE src1.kind=1 */  cn_var_路径位置_2 = r51;
  r52 = cn_var_路径缓冲区;
  r53 = cn_var_路径位置_2;
  r54 = &r52[r53];
/* P7DBG_STORE src1.kind=2 */  *r54 = 0;
  void* cn_var_文件_7;
  r55 = cn_var_路径缓冲区;
  r56 = 打开文件(r55, "r");
/* P7DBG_STORE src1.kind=1 */  cn_var_文件_7 = r56;
  r57 = cn_var_文件_7;
  r58 = r57 != 0;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_哈希_0 = 0;
  r0 = cn_var_字符串指针;
  r1 = r0 == 0;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_1 = 0;
  ...
  r13 = *r12;
  r14 = r9 + r13;
/* P7DBG_STORE src1.kind=1 */  cn_var_哈希_0 = r14;
  goto for_update_94;

  for_update_94:
  r15 = cn_var_i_1;
  r16 = r15 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_1 = r16;
  goto for_cond_92;
  ...
  r19 = cn_var_哈希_0;
  r20 = -r19;
/* P7DBG_STORE src1.kind=1 */  cn_var_哈希_0 = r20;
  goto if_merge_97;
...
struct 模块元数据* 从缓存获取模块(struct 模块加载器* cn_var_加载器, const char* cn_var_模块名) {
  ...
  r5 = cn_var_模块名;
  r6 = 计算哈希值(r5);
/* P7DBG_STORE src1.kind=1 */  cn_var_哈希_0 = r6;
  long long cn_var_索引_1;
  r7 = cn_var_哈希_0;
  r8 = cn_var_最大模块缓存数量;
  r9 = r7 % r8;
/* P7DBG_STORE src1.kind=1 */  cn_var_索引_1 = r9;
  struct 模块缓存条目* cn_var_条目_2;
  r10 = cn_var_加载器->缓存列表;
  r11 = cn_var_索引_1;
  r12 = &r10[r11];
/* P7DBG_STORE src1.kind=1 */  cn_var_条目_2 = r12;
  goto while_cond_102;
  ...
  if_merge_106:
  r20 = cn_var_条目_2->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_条目_2 = r20;
  goto while_cond_102;
  return NULL;
}
...
_Bool 添加模块到缓存(struct 模块加载器* cn_var_加载器, const char* cn_var_模块名, struct 模块元数据* cn_var_元数据) {
  ...
  r8 = cn_var_模块名;
  r9 = 计算哈希值(r8);
/* P7DBG_STORE src1.kind=1 */  cn_var_哈希_0 = r9;
  long long cn_var_索引_1;
  r10 = cn_var_哈希_0;
  r11 = cn_var_最大模块缓存数量;
  r12 = r10 % r11;
/* P7DBG_STORE src1.kind=1 */  cn_var_索引_1 = r12;
  struct 模块缓存条目* cn_var_新条目_2;
  r13 = 模块缓存条目大小();
  r14 = 分配清零内存(1, r13);
/* P7DBG_STORE src1.kind=7 */  cn_var_新条目_2 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 模块缓存条目*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配清零内存(1, /* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */模块缓存条目大小());
  r15 = cn_var_新条目_2;
  r16 = r15 == 0;
  ...
  r17 = cn_var_模块名;
  r18 = 获取字符串长度(r17);
/* P7DBG_STORE src1.kind=1 */  cn_var_名称长度_3 = r18;
  r19 = cn_var_名称长度_3;
  r20 = r19 + 1;
  r21 = 分配内存(r20);
  ...
  r34 = cn_var_索引_1;
  r35 = &r33[r34];
/* P7DBG_STORE src1.kind=1 */  *r35 = r32;
  r36 = cn_var_加载器->缓存数量;
  r37 = r36 + 1;
  return 1;
}
...
_Bool 读取文件内容(const char* cn_var_文件路径, char** cn_var_输出缓冲区, long long* cn_var_输出大小) {
  ...
  r8 = cn_var_文件路径;
  r9 = 打开文件(r8, "rb");
/* P7DBG_STORE src1.kind=1 */  cn_var_文件_0 = r9;
  r10 = cn_var_文件_0;
  r11 = r10 == 0;
  ...
  r12 = cn_var_文件_0;
  r13 = 获取文件大小(r12);
/* P7DBG_STORE src1.kind=1 */  cn_var_文件大小_1 = r13;
  r14 = cn_var_文件大小_1;
  r15 = r14 <= 0;
  ...
  r18 = r17 + 1;
  r19 = 分配内存(r18);
/* P7DBG_STORE src1.kind=7 */  cn_var_缓冲区_2 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(char*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(/* P7DBG_expr kind=0 */(/* P7DBG_expr kind=2 */cn_var_文件大小 + 1));
  r20 = cn_var_缓冲区_2;
  r21 = r20 == 0;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_读取字节数_3 = r26;
  r27 = cn_var_文件_0;
  关闭文件(r27);
  r28 = cn_var_读取字节数_3;
  r29 = cn_var_文件大小_1;
...
struct 模块元数据* 创建模块元数据(struct 模块标识符* cn_var_标识符) {
  ...
  r2 = 模块元数据大小();
  r3 = 分配清零内存(1, r2);
/* P7DBG_STORE src1.kind=7 */  cn_var_元数据_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 模块元数据*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配清零内存(1, /* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */模块元数据大小());
  r4 = cn_var_元数据_0;
  r5 = r4 == 0;
...
struct 模块元数据* 加载模块核心(struct 模块加载器* cn_var_加载器, const char* cn_var_模块名) {
  ...
  r6 = cn_var_模块名;
  r7 = 从缓存获取模块(r5, r6);
/* P7DBG_STORE src1.kind=1 */  cn_var_缓存模块_0 = r7;
  r8 = cn_var_缓存模块_0;
  r9 = r8 != 0;
  ...
  r16 = cn_var_模块名;
  r17 = 解析模块标识符(r16);
/* P7DBG_STORE src1.kind=1 */  cn_var_标识符_1 = r17;
  r18 = cn_var_标识符_1;
  r19 = r18 == 0;
  ...
  r22 = cn_var_标识符_1;
  r23 = 创建模块元数据(r22);
/* P7DBG_STORE src1.kind=1 */  cn_var_元数据_2 = r23;
  r24 = cn_var_元数据_2;
  r25 = r24 == 0;
  ...
  r37 = cn_var_文件路径缓冲区;
  r38 = 获取字符串长度(r37);
/* P7DBG_STORE src1.kind=1 */  cn_var_路径长度_3 = r38;
  r39 = cn_var_路径长度_3;
  r40 = r39 + 1;
  r41 = 分配内存(r40);
  ...
  r50 = cn_var_路径长度_3;
  char* cn_var_源码内容_4;
/* P7DBG_STORE src1.kind=2 */  cn_var_源码内容_4 = 0;
  long long cn_var_源码大小_5;
/* P7DBG_STORE src1.kind=2 */  cn_var_源码大小_5 = 0;
  r51 = cn_var_文件路径缓冲区;
  r52 = cn_var_源码内容_4;
  r53 = &cn_var_源码内容_4;
  r54 = cn_var_源码大小_5;
  ...
  r64 = cn_var_源码大小_5;
  r65 = 创建扫描器(r63, r64);
/* P7DBG_STORE src1.kind=1 */  cn_var_扫描器实例_6 = r65;
  r66 = cn_var_扫描器实例_6;
  r67 = r66 == 0;
  ...
  r73 = cn_var_加载器->诊断集合;
  r74 = 创建解析器(r72, r73);
/* P7DBG_STORE src1.kind=1 */  cn_var_解析器实例_7 = r74;
  r75 = cn_var_解析器实例_7;
  r76 = r75 == 0;
  ...
  r82 = cn_var_解析器实例_7;
  r83 = 解析程序(r82);
/* P7DBG_STORE src1.kind=1 */  cn_var_程序_8 = r83;
  r84 = cn_var_程序_8;
  r85 = r84 == 0;
...
struct 模块元数据* 加载模块(struct 模块加载器* cn_var_加载器, const char* cn_var_模块名) {
  ...
  r5 = cn_var_加载器->当前模块;
/* P7DBG_STORE src1.kind=1 */  cn_var_保存当前模块_0 = r5;
  long long cn_var_保存依赖深度_1;
  r6 = cn_var_加载器->当前依赖深度;
/* P7DBG_STORE src1.kind=1 */  cn_var_保存依赖深度_1 = r6;
  ...
  r10 = cn_var_模块名;
  r11 = 加载模块核心(r9, r10);
/* P7DBG_STORE src1.kind=1 */  cn_var_结果_2 = r11;
  r12 = cn_var_保存当前模块_0;
  r13 = cn_var_保存依赖深度_1;
  r14 = cn_var_结果_2;
  return r14;
...
_Bool 处理导入语句(struct 模块加载器* cn_var_加载器, struct 导入声明* cn_var_导入节点, struct 模块元数据* cn_var_当前模块) {
  ...
  char* cn_var_模块名_0;
  r8 = cn_var_导入节点->模块名;
/* P7DBG_STORE src1.kind=1 */  cn_var_模块名_0 = r8;
  r9 = cn_var_模块名_0;
  r10 = r9 == 0;
  ...
  r12 = cn_var_模块名_0;
  r13 = 加载模块(r11, r12);
/* P7DBG_STORE src1.kind=1 */  cn_var_依赖模块_1 = r13;
  r14 = cn_var_依赖模块_1;
  r15 = r14 == 0;
  ...
  r20 = r19 << 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_新容量_2 = r20;
  r21 = cn_var_新容量_2;
  r22 = r21 == 0;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_依赖_4 = r35;
  ...
  if_then_185:
/* P7DBG_STORE src1.kind=2 */  cn_var_新容量_2 = 4;
  goto if_merge_186;
  ...
  r26 = r24 * r25;
  r27 = 重新分配内存(r23, r26);
/* P7DBG_STORE src1.kind=7 */  cn_var_新数组_3 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 模块依赖*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */重新分配内存(/* P7DBG_expr kind=14 *//* P7DBG_expr kind=2 */cn_var_当前模块->依赖列表, /* P7DBG_expr kind=0 */(/* P7DBG_expr kind=2 */cn_var_新容量 * /* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */模块依赖大小()));
  r28 = cn_var_新数组_3;
  r29 = r28 == 0;
...
_Bool 处理所有导入语句(struct 模块加载器* cn_var_加载器, struct 模块元数据* cn_var_当前模块) {
  ...
  r8 = cn_var_当前模块->程序节点;
/* P7DBG_STORE src1.kind=1 */  cn_var_程序_0 = r8;
  struct 声明节点列表* cn_var_声明列表_1;
  r9 = cn_var_程序_0->声明列表;
/* P7DBG_STORE src1.kind=1 */  cn_var_声明列表_1 = r9;
  goto while_cond_195;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_声明_2 = r12;
  r14 = cn_var_声明_2;
  r15 = r14 != 0;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_导入节点_3 = r18;
  r19 = cn_var_加载器;
  r20 = cn_var_导入节点_3;
  r21 = cn_var_当前模块;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_声明列表_1 = r24;
  goto while_cond_195;
...
_Bool 收集导出符号(struct 模块元数据* cn_var_元数据) {
  ...
  struct 程序节点* cn_var_程序_0;
  r5 = cn_var_元数据->程序节点;
/* P7DBG_STORE src1.kind=1 */  cn_var_程序_0 = r5;
  long long cn_var_符号数量_1;
/* P7DBG_STORE src1.kind=2 */  cn_var_符号数量_1 = 0;
  struct 声明节点列表* cn_var_声明列表_2;
  r6 = cn_var_程序_0->声明列表;
/* P7DBG_STORE src1.kind=1 */  cn_var_声明列表_2 = r6;
  goto while_cond_208;
  ...
  r9 = cn_var_声明列表_2->节点;
/* P7DBG_STORE src1.kind=1 */  cn_var_声明_3 = r9;
  r11 = cn_var_声明_3;
  r12 = r11 != 0;
  ...
  r14 = cn_var_符号数量_1;
  r15 = r14 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_符号数量_1 = r15;
  goto if_merge_212;

  if_merge_212:
  r16 = cn_var_声明列表_2->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_声明列表_2 = r16;
  goto while_cond_208;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_声明列表_2 = r25;
  long long cn_var_当前索引_4;
/* P7DBG_STORE src1.kind=2 */  cn_var_当前索引_4 = 0;
  goto while_cond_219;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_声明_5 = r28;
  r30 = cn_var_声明_5;
  r31 = r30 != 0;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_符号_6 = r36;
  r37 = cn_var_声明_5->类型;
  r38 = r37 == 节点类型_函数声明;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_声明列表_2 = r65;
  goto while_cond_219;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_函数声明_7 = r39;
  r40 = cn_var_函数声明_7;
  r41 = r40 != 0;
  ...
  r62 = cn_var_当前索引_4;
  r63 = r62 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_当前索引_4 = r63;
  r64 = cn_var_当前索引_4;
  goto if_merge_223;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_变量声明_8 = r47;
  r48 = cn_var_变量声明_8;
  r49 = r48 != 0;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_常量声明_9 = r56;
  r57 = cn_var_常量声明_9;
  r58 = r57 != 0;
...
long long 获取文件大小(void* cn_var_文件) {
  ...
  r4 = cn_var_文件;
  r5 = 获取文件位置(r4);
/* P7DBG_STORE src1.kind=1 */  cn_var_大小_0 = r5;
  r6 = cn_var_文件;
  r7 = 文件定位(r6, 0, 0);
  r8 = cn_var_大小_0;
  return r8;
