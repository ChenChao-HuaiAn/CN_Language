...
struct 模块标识符* 解析模块标识符(const char* cn_var_模块名) {
  long long r3, r4, r5, r7, r8, r10, r14, r15, r25, r26, r27, r30, r34, r35, r36, r37, r38, r39, r47, r48, r49, r51, r53, r58, r63, r66, r67, r68, r72, r73, r77, r79, r80, r92, r93, r94, r96, r100, r102, r103, r104, r105;
  char* r0;
  char* r2;
  char* r18;
  char* r22;
  ...
  r32 = *r31;
  r33 = r32 == 46;
  if (r33) goto if_then_41; else goto if_merge_42;
  ...
  r42 = r41->路径段列表;
  r43 = r42 == 0;
  if (r43) goto if_then_43; else goto if_merge_44;
  ...
  r49 = cn_var_名称长度_0;
  r50 = r48 <= r49;
  if (r50) goto for_body_46; else goto for_exit_48;
  ...
  r55 = *r54;
  r56 = r55 == 46;
  if (r56) goto logic_merge_53; else goto logic_rhs_52;
  ...
  r70 = cn_var_段副本_8;
  r71 = r70 == 0;
  if (r71) goto if_then_54; else goto if_merge_55;
  ...
  logic_merge_53:
  if (r61) goto if_then_49; else goto if_else_50;
  ...
  r91 = r90->路径段列表;
  r92 = cn_var_当前段索引_5;
    { char* _tmp_r0 = r89; cn_rt_array_set_element(r91, r92, &_tmp_r0, 8); }
  r93 = cn_var_当前段索引_5;
  r94 = r93 + 1;
  cn_var_当前段索引_5 = r94;
  cn_var_缓冲区位置_4 = 0;
  ...
  r73 = cn_var_当前段索引_5;
  r74 = r72 < r73;
  if (r74) goto for_body_57; else goto for_exit_59;

  for_body_57:
  r75 = cn_var_标识符_1;
  r76 = r75->路径段列表;
  r77 = cn_var_j_9;
  r78 = (char**)cn_rt_array_get_element(r76, r77, 8);
  释放内存(r78);
  goto for_update_58;
