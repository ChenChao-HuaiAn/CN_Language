...
struct 模块标识符* 解析模块标识符(const char* cn_var_模块名) {
  long long r3, r4, r5, r7, r8, r10, r14, r15, r23, r24, r25, r28, r32, r33, r34, r35, r36, r37, r43, r44, r45, r47, r49, r54, r59, r62, r63, r64, r68, r69, r72, r74, r75, r84, r86, r87, r89, r93, r95, r96, r97, r98;
  char* r0;
  char* r2;
  char* r17;
  char* r20;
  ...
  *r85 = r82;
  ...
  r72 = cn_var_j_9;
  r73 = *(char*)cn_rt_array_get_element(r71, r72, 8);
  释放内存(r73);
  goto for_update_58;
...
void 销毁模块标识符(struct 模块标识符* cn_var_标识符) {
  ...
  r15 = cn_var_i_0;
  r16 = *(char*)cn_rt_array_get_element(r14, r15, 8);
  释放内存(r16);
  goto if_merge_71;
...
struct 模块元数据* 加载模块核心(struct 模块加载器* cn_var_加载器, const char* cn_var_模块名) {
  long long r0, r11, r12, r35, r36, r38, r39, r40, r45, r46, r50, r54, r61, r62, r64, r70, r71, r80, r81, r90, r91, r100, r101;
  char* r3;
  char* r6;
  char* r16;
  char* r42;
...
函数 加载模块核心(模块加载器* 加载器, 字符串 模块名) -> 模块元数据* {
    ...
    如果 (加载器.当前依赖深度 >= 最大依赖深度) {
        报告错误(加载器.诊断集合, 未知错误, 空源位置, "模块依赖深度超过限制");
        返回 无;
    }
    ...
    如果 (标识符 == 无) {
        报告错误(加载器.诊断集合, 未知错误, 空源位置, "无法解析模块标识符");
        返回 无;
    }
    ...
    如果 (!解析模块文件路径(加载器, 标识符, 文件路径缓冲区, 1024)) {
        报告错误(加载器.诊断集合, 未知错误, 空源位置, "无法找到模块文件");
        元数据.状态 = 加载失败;
        销毁模块元数据(元数据);
    ...
    如果 (!读取文件内容(文件路径缓冲区, &源码内容, &源码大小)) {
        报告错误(加载器.诊断集合, 未知错误, 空源位置, "无法读取模块文件");
        元数据.状态 = 加载失败;
        销毁模块元数据(元数据);
        加载器.加载失败数 = 加载器.加载失败数 + 1;
        返回 无;
...
*)cn_rt_array_get_element(r32, r33, 8);
  cn_var_依赖_4 = r35;
...
_Bool 收集导出符号(struct 模块元数据* cn_var_元数据) {
  long long r0, r10, r14, r15, r17, r19, r20, r24, r29, r34, r42, r43, r44, r50, r51, r52, r53, r61, r62, r63, r64;
  char* r59;
  char* r60;
  struct 模块元数据* r1;
  struct 程序节点* r3;
...
*)cn_rt_array_get_element(r33, r34, 8);
  cn_var_符号_6 = r36;
  r37 = cn_var_声明_5->类型;
  r38 = r37 == 节点类型_函数声明;
