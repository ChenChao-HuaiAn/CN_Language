...
struct 模块加载器* 创建模块加载器(struct 诊断集合* cn_var_诊断集合指针) {
  ...
  r2 = cn_var_加载器_0;
  r3 = r2 == 0;
  if (r3) goto if_then_3518; else goto if_merge_3519;
...
_Bool 添加搜索路径(struct 模块加载器* cn_var_加载器, char* cn_var_路径) {
  long long r0, r2, r4, r6, r7, r8, r10, r11, r12, r15, r21, r23, r25, r26;
  char* r3;
  char* r9;
  char* r14;
  char* r16;
  ...
  r14 = cn_var_路径副本_1;
  r15 = r14 == 0;
  if (r15) goto if_then_3541; else goto if_merge_3542;
...
struct 模块标识符* 解析模块标识符(char* cn_var_模块名) {
  ...
  r5 = cn_var_名称长度_0;
  r6 = r5 == 0;
  if (r6) goto logic_merge_3550; else goto logic_rhs_3549;
  ...
  r12 = cn_var_标识符_1;
  r13 = r12 == 0;
  if (r13) goto if_then_3551; else goto if_merge_3552;
  ...
  logic_merge_3550:
  if (r9) goto if_then_3547; else goto if_merge_3548;
  ...
  r18 = r17.完全限定名;
  r19 = r18 == 0;
  if (r19) goto if_then_3553; else goto if_merge_3554;
  ...
  r27 = cn_var_名称长度_0;
  r28 = r26 < r27;
  if (r28) goto for_body_3556; else goto for_exit_3558;
  ...
  r32 = r31 == 46;
  if (r32) goto if_then_3559; else goto if_merge_3560;
  ...
  r41 = r40.路径段列表;
  r42 = r41 == 0;
  if (r42) goto if_then_3561; else goto if_merge_3562;
  ...
  r48 = cn_var_名称长度_0;
  r49 = r47 <= r48;
  if (r49) goto for_body_3564; else goto for_exit_3566;
  ...
  r54 = r53 == 46;
  if (r54) goto logic_merge_3571; else goto logic_rhs_3570;
  ...
  r66 = cn_var_段副本_8;
  r67 = r66 == 0;
  if (r67) goto if_then_3572; else goto if_merge_3573;
  ...
  logic_merge_3571:
  if (r58) goto if_then_3567; else goto if_else_3568;
  ...
  r69 = cn_var_当前段索引_5;
  r70 = r68 < r69;
  if (r70) goto for_body_3575; else goto for_exit_3577;
...
void 销毁模块标识符(struct 模块标识符* cn_var_标识符) {
  ...
  r0 = cn_var_标识符;
  r1 = r0 == 0;
  if (r1) goto if_then_3578; else goto if_merge_3579;
  ...
  r3 = r2.完全限定名;
  r4 = r3 != 0;
  if (r4) goto if_then_3580; else goto if_merge_3581;
  ...
  r8 = r7.路径段列表;
  r9 = r8 != 0;
  if (r9) goto if_then_3582; else goto if_merge_3583;
  ...
  r12 = r11.路径段数量;
  r13 = r10 < r12;
  if (r13) goto for_body_3585; else goto for_exit_3587;
  ...
  r18 = r17 != 0;
  if (r18) goto if_then_3588; else goto if_merge_3589;
...
_Bool 解析模块文件路径(struct 模块加载器* cn_var_加载器, struct 模块标识符* cn_var_标识符, char* cn_var_输出路径, long long cn_var_输出路径大小) {
  long long r0, r1, r3, r4, r5, r7, r8, r10, r11, r13, r14, r15, r17, r20, r22, r23, r24, r25, r26, r28, r29, r30, r31, r32, r33, r34, r36, r38, r39, r41, r43, r44, r45, r46, r47, r49, r50, r52, r53, r55, r59, r61, r62, r63, r67, r68;
  char* r6;
  char* r16;
  char* r19;
  char* r35;
  ...
  logic_merge_3593:
  if (r7) goto if_then_3590; else goto if_merge_3591;
  ...
  logic_merge_3595:
  if (r5) goto logic_merge_3593; else goto logic_rhs_3592;
  ...
  r10 = r9.搜索路径数量;
  r11 = r8 < r10;
  if (r11) goto for_body_3597; else goto for_exit_3599;
  ...
  r25 = r24.路径段数量;
  r26 = r23 < r25;
  if (r26) goto for_body_3601; else goto for_exit_3603;
  ...
  r58 = cn_var_文件_7;
  r59 = r58 != 0;
  if (r59) goto if_then_3604; else goto if_merge_3605;
  ...
  r62 = cn_var_输出路径大小;
  r63 = r61 < r62;
  if (r63) goto if_then_3606; else goto if_merge_3607;
...
struct 模块元数据* 从缓存获取模块(struct 模块加载器* cn_var_加载器, char* cn_var_模块名) {
  long long r0, r2, r4, r6, r7, r8, r9, r11, r12, r13, r15, r19, r20;
  char* r3;
  char* r5;
  char* r17;
  char* r18;
  ...
  r14 = cn_var_条目_2;
  r15 = r14 != 0;
  if (r15) goto while_body_3621; else goto while_exit_3622;
  ...
  r19 = 比较字符串(r17, r18);
  r20 = r19 == 0;
  if (r20) goto if_then_3623; else goto if_merge_3624;
...
_Bool 添加模块到缓存(struct 模块加载器* cn_var_加载器, char* cn_var_模块名, struct 模块元数据* cn_var_元数据) {
  long long r0, r1, r3, r5, r7, r9, r10, r11, r12, r13, r16, r18, r19, r20, r24, r32, r33, r34, r37, r38, r40, r41;
  char* r4;
  char* r8;
  char* r17;
  char* r23;
  ...
  r15 = cn_var_新条目_2;
  r16 = r15 == 0;
  if (r16) goto if_then_3631; else goto if_merge_3632;
  ...
  r23 = r22->模块名;
  r24 = r23 == 0;
  if (r24) goto if_then_3633; else goto if_merge_3634;
...
_Bool 读取文件内容(char* cn_var_文件路径, char** cn_var_输出缓冲区, long long* cn_var_输出大小) {
  ...
  r10 = cn_var_文件_0;
  r11 = r10 == 0;
  if (r11) goto if_then_3641; else goto if_merge_3642;
  ...
  r14 = cn_var_文件大小_1;
  r15 = r14 <= 0;
  if (r15) goto if_then_3643; else goto if_merge_3644;
  ...
  r20 = cn_var_缓冲区_2;
  r21 = r20 == 0;
  if (r21) goto if_then_3645; else goto if_merge_3646;
  ...
  r29 = cn_var_文件大小_1;
  r30 = r28 != r29;
  if (r30) goto if_then_3647; else goto if_merge_3648;
...
struct 模块元数据* 创建模块元数据(struct 模块标识符* cn_var_标识符) {
  ...
  r0 = cn_var_标识符;
  r1 = r0 == 0;
  if (r1) goto if_then_3649; else goto if_merge_3650;
  ...
  r4 = cn_var_元数据_0;
  r5 = r4 == 0;
  if (r5) goto if_then_3651; else goto if_merge_3652;
...
struct 模块元数据* 加载模块核心(struct 模块加载器* cn_var_加载器, char* cn_var_模块名) {
  long long r0, r2, r4, r9, r12, r13, r14, r16, r19, r20, r22, r23, r26, r27, r29, r32, r34, r37, r38, r40, r41, r42, r46, r49, r50, r55, r58, r59, r60, r62, r64, r67, r68, r70, r73, r77, r78, r81, r84, r89, r90, r94, r100, r101, r111, r112;
  char* r3;
  char* r6;
  char* r17;
  char* r45;
  ...
  r8 = cn_var_缓存模块_0;
  r9 = r8 != 0;
  if (r9) goto if_then_3667; else goto if_merge_3668;
  ...
  r13 = cn_var_最大依赖深度;
  r14 = r12 >= r13;
  if (r14) goto if_then_3669; else goto if_merge_3670;

  if_then_3669:
  r15 = cn_var_加载器;
  r16 = r15.诊断集合;
  报告错误(r16, -842150451, 0, "模块依赖深度超过限制");
  return 0;
  goto if_merge_3670;
  ...
  r19 = cn_var_标识符_1;
  r20 = r19 == 0;
  if (r20) goto if_then_3671; else goto if_merge_3672;

  if_then_3671:
  r21 = cn_var_加载器;
  r22 = r21.诊断集合;
  报告错误(r22, -842150451, 0, "无法解析模块标识符");
  return 0;
  goto if_merge_3672;
  ...
  r25 = cn_var_元数据_2;
  r26 = r25 == 0;
  if (r26) goto if_then_3673; else goto if_merge_3674;
  ...
  r32 = !r31;
  if (r32) goto if_then_3675; else goto if_merge_3676;

  if_then_3675:
  r33 = cn_var_加载器;
  r34 = r33.诊断集合;
  报告错误(r34, -842150451, 0, "无法找到模块文件");
  r35 = cn_var_元数据_2;
  销毁模块元数据(r35);
  r36 = cn_var_加载器;
  r37 = r36.加载失败数;
  ...
  r45 = r44->文件路径;
  r46 = r45 == 0;
  if (r46) goto if_then_3677; else goto if_merge_3678;
  ...
  r62 = !r61;
  if (r62) goto if_then_3679; else goto if_merge_3680;

  if_then_3679:
  r63 = cn_var_加载器;
  r64 = r63.诊断集合;
  报告错误(r64, -842150451, 0, "无法读取模块文件");
  r65 = cn_var_元数据_2;
  销毁模块元数据(r65);
  r66 = cn_var_加载器;
  r67 = r66.加载失败数;
  ...
  r72 = cn_var_扫描器实例_6;
  r73 = r72 == 0;
  if (r73) goto if_then_3681; else goto if_merge_3682;
  ...
  r83 = cn_var_解析器实例_7;
  r84 = r83 == 0;
  if (r84) goto if_then_3683; else goto if_merge_3684;
  ...
  r93 = cn_var_程序_8;
  r94 = r93 == 0;
  if (r94) goto if_then_3685; else goto if_merge_3686;
...
struct 模块元数据* 加载模块(struct 模块加载器* cn_var_加载器, char* cn_var_模块名) {
  long long r0, r2, r4, r6, r8, r10, r11, r16;
  char* r3;
  char* r13;
  struct 模块元数据* r14;
  struct 模块元数据* r15;
...
_Bool 处理导入语句(struct 模块加载器* cn_var_加载器, struct 导入语句节点* cn_var_导入节点, struct 模块元数据* cn_var_当前模块) {
  long long r0, r1, r3, r5, r7, r9, r11, r16, r18, r20, r21, r23, r24, r25, r26, r29, r30, r31, r34, r36, r40, r41, r42, r46, r47;
  char* r10;
  char* r13;
  struct 导入语句节点* r4;
  struct 模块元数据* r6;
  ...
  r15 = cn_var_依赖模块_1;
  r16 = r15 == 0;
  if (r16) goto if_then_3699; else goto if_merge_3700;
  ...
  r20 = r19->依赖容量;
  r21 = r18 >= r20;
  if (r21) goto if_then_3701; else goto if_merge_3702;
  ...
  r33 = cn_var_新数组_3;
  r34 = r33 == 0;
  if (r34) goto if_then_3705; else goto if_merge_3706;
...
_Bool 处理所有导入语句(struct 模块加载器* cn_var_加载器, struct 模块元数据* cn_var_当前模块) {
  long long r0, r1, r3, r5, r8, r12, r14, r16, r17, r19, r23, r24, r26, r31, r33;
  struct 模块元数据* r4;
  struct 模块元数据* r6;
  long long* r7;
  struct 模块元数据* r9;
  ...
  r28 = cn_var_导入节点_3;
  r29 = cn_var_当前模块;
  r30 = 处理导入语句(r27, r28, r29);
  r31 = !r30;
  if (r31) goto if_then_3720; else goto if_merge_3721;
...
_Bool 收集导出符号(struct 模块元数据* cn_var_元数据) {
  long long r0, r2, r5, r9, r11, r13, r14, r16, r18, r19, r20, r22, r23, r24, r25, r26, r30, r31, r33, r35, r37, r38, r40, r42, r45, r46, r47, r51, r52, r54, r55, r56, r57, r58, r59, r60, r61, r65, r66, r68, r69, r70, r71, r72, r73, r74, r75, r76, r77, r81, r82, r84, r86, r88, r90, r91, r92, r93, r94, r96;
  struct 模块元数据* r1;
  struct 模块元数据* r3;
  long long* r4;
  struct 模块元数据* r6;
  ...
  r29 = r28->导出符号表;
  r30 = r29 == 0;
  if (r30) goto if_then_3735; else goto if_merge_3736;
  ...
  r34 = cn_var_声明列表_2;
  r35 = r34 != 0;
  if (r35) goto while_body_3738; else goto while_exit_3739;
  ...
  r39 = cn_var_声明_5;
  r40 = r39 != 0;
  if (r40) goto logic_rhs_3742; else goto logic_merge_3743;
  ...
  r51 = r50.函数声明;
  r52 = r49 == r51;
  if (r52) goto if_then_3744; else goto if_else_3745;
  ...
  logic_merge_3743:
  if (r42) goto if_then_3740; else goto if_merge_3741;
  ...
  r55 = cn_var_函数声明_7;
  r56 = r55 != 0;
  if (r56) goto if_then_3747; else goto if_merge_3748;
  ...
  r65 = r64.变量声明;
  r66 = r63 == r65;
  if (r66) goto if_then_3749; else goto if_else_3750;
  ...
  r69 = cn_var_变量声明_8;
  r70 = r69 != 0;
  if (r70) goto if_then_3752; else goto if_merge_3753;
  ...
  r81 = r80.变量声明;
  r82 = r79 == r81;
  if (r82) goto if_then_3754; else goto if_merge_3755;
  ...
  r85 = cn_var_常量声明_9;
  r86 = r85 != 0;
  if (r86) goto if_then_3756; else goto if_merge_3757;
