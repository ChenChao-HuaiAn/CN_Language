...
_Bool 处理所有导入语句(struct 模块加载器* cn_var_加载器, struct 模块元数据* cn_var_当前模块) {
  long long r0, r1, r2, r3, r5, r8, r12, r14, r17, r19, r22, r25, r29;
  struct 模块元数据* r4;
  struct 模块元数据* r6;
  long long* r7;
  struct 模块元数据* r9;
  ...
  r29 = !r28;
  if (r29) goto if_then_3720; else goto if_merge_3721;
  ...
  logic_merge_3719:
  if (r22) goto if_then_3716; else goto if_merge_3717;
...
_Bool 收集导出符号(struct 模块元数据* cn_var_元数据) {
  long long r0, r2, r5, r9, r11, r14, r16, r19, r20, r23, r24, r25, r26, r30, r31, r33, r35, r38, r40, r45, r46, r47, r50, r53, r54, r55, r56, r57, r58, r59, r62, r65, r66, r67, r68, r69, r70, r71, r72, r73, r76, r80, r82, r84, r85, r86, r87, r88;
  struct 模块元数据* r1;
  struct 模块元数据* r3;
  long long* r4;
  struct 模块元数据* r6;
  ...
  r53 = cn_var_函数声明_7;
  r54 = r53 != 0;
  if (r54) goto if_then_3747; else goto if_merge_3748;

  if_else_3745:
  r60 = cn_var_声明_5;
  r61 = r60->类型;
  r62 = r61 == 2;
  if (r62) goto if_then_3749; else goto if_else_3750;
  ...
  r65 = cn_var_变量声明_8;
  r66 = r65 != 0;
  if (r66) goto if_then_3752; else goto if_merge_3753;

  if_else_3750:
  r74 = cn_var_声明_5;
  r75 = r74->类型;
  r76 = r75 == 2;
  if (r76) goto if_then_3754; else goto if_merge_3755;
  ...
  r79 = cn_var_常量声明_9;
  r80 = r79 != 0;
  if (r80) goto if_then_3756; else goto if_merge_3757;
