...
struct 诊断集合* 创建诊断集合(long long cn_var_初始容量) {
  ...
  r6 = r5->诊断数组;
  r7 = r6 == 0;
  if (r7) goto if_then_768; else goto if_merge_769;
...
_Bool 扩展诊断数组(struct 诊断集合* cn_var_集合) {
  long long r1, r3, r4, r5, r6, r9, r10, r12, r14;
  struct 诊断集合* r0;
  struct 诊断集合* r2;
  struct 诊断集合* r7;
  struct 诊断信息* r8;
  ...
  r11 = cn_var_新数组_1;
  r12 = r11 == 0;
  if (r12) goto if_then_778; else goto if_merge_779;
...
void 报告诊断(struct 诊断集合* cn_var_集合, enum 诊断严重级别 cn_var_级别, enum 诊断错误码 cn_var_代码, struct 源位置 cn_var_位置, char* cn_var_消息) {
  long long r1, r3, r5, r6, r8, r12, r13, r19, r20, r22, r24, r25, r27, r28;
  char* r17;
  struct 诊断集合* r0;
  struct 诊断集合* r2;
  struct 诊断集合* r4;
  ...
  扩展诊断数组(r7);
  r8 = /* NONE */ == 0;
  if (r8) goto if_then_784; else goto if_merge_785;
  ...
  r21 = cn_var_级别;
  r22 = r21 == -842150451;
  if (r22) goto if_then_786; else goto if_else_787;
...
void 打印诊断信息(struct 诊断信息* cn_var_信息) {
  ...
  r6 = r5.文件名;
  r7 = r6 != 0;
  if (r7) goto if_then_807; else goto if_else_808;
...
void 诊断集合添加(struct 诊断集合* cn_var_集合, struct 诊断信息 cn_var_信息) {
  long long r1, r3, r5, r6, r8, r13, r15, r16, r19, r21, r22, r24, r25;
  struct 诊断集合* r0;
  struct 诊断集合* r2;
  struct 诊断集合* r4;
  struct 诊断集合* r7;
  ...
  扩展诊断数组(r7);
  r8 = /* NONE */ == 0;
  if (r8) goto if_then_822; else goto if_merge_823;
  ...
  r12 = cn_var_集合;
  r13 = r12->长度;
    { long long _tmp_r1 = r9; cn_rt_array_set_element(r11, r13, &_tmp_r1, 8); }
  r14 = cn_var_集合;
  r15 = r14->长度;
  r16 = r15 + 1;
  r17 = cn_var_信息;
  r18 = r17.严重级别;
  r19 = r18 == -842150451;
  if (r19) goto if_then_824; else goto if_else_825;
