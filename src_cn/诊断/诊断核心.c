...
struct 诊断集合* 创建诊断集合(long long cn_var_初始容量) {
  ...
  r8 = r7->诊断数组;
  r9 = r8 == 0;
  if (r9) goto if_then_819; else goto if_merge_820;
...
void 释放诊断集合(struct 诊断集合* cn_var_集合) {
  ...
  r3 = r2->诊断数组;
  r4 = r3 != 0;
  if (r4) goto if_then_823; else goto if_merge_824;
...
_Bool 扩展诊断数组(struct 诊断集合* cn_var_集合) {
  ...
  r5 = cn_var_新容量_0;
  r6 = r5 <= 0;
  if (r6) goto if_then_827; else goto if_merge_828;
  ...
  r12 = cn_var_新数组_1;
  r13 = r12 == 0;
  if (r13) goto if_then_829; else goto if_merge_830;
...
void 报告诊断(struct 诊断集合* cn_var_集合, enum 诊断严重级别 cn_var_级别, enum 诊断错误码 cn_var_代码, struct 源位置 cn_var_位置, char* cn_var_消息) {
  ...
  r5 = r4->容量;
  r6 = r3 >= r5;
  if (r6) goto if_then_833; else goto if_merge_834;

  if_then_833:
  r7 = cn_var_集合;
  r8 = 扩展诊断数组(r7);
  r9 = r8 == 0;
  if (r9) goto if_then_835; else goto if_merge_836;
  ...
  if (r23) goto if_then_837; else goto if_else_838;
...
_Bool 应该继续(struct 诊断集合* cn_var_集合) {
  ...
  r3 = r2->最大错误数;
  r4 = r3 > 0;
  if (r4) goto if_then_848; else goto if_merge_849;
...
void 打印诊断信息(struct 诊断信息* cn_var_信息) {
  ...
  r7 = r6.文件名;
  r8 = r7 != 0;
  if (r8) goto if_then_858; else goto if_else_859;
...
void 打印所有诊断(struct 诊断集合* cn_var_集合) {
  ...
  r4 = r3->长度;
  r5 = r2 < r4;
  if (r5) goto for_body_864; else goto for_exit_866;
...
void 诊断集合添加(struct 诊断集合* cn_var_集合, struct 诊断信息 cn_var_信息) {
  ...
  r5 = r4->容量;
  r6 = r3 >= r5;
  if (r6) goto if_then_871; else goto if_merge_872;

  if_then_871:
  r7 = cn_var_集合;
  r8 = 扩展诊断数组(r7);
  r9 = r8 == 0;
  if (r9) goto if_then_873; else goto if_merge_874;
  ...
  if (r20) goto if_then_875; else goto if_else_876;
