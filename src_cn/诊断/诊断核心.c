...
void 释放诊断集合(struct 诊断集合* cn_var_集合) {
  ...
  r3 = r2->诊断数组;
  r4 = r3 != 0;
  if (r4) goto if_then_8; else goto if_merge_9;
...
_Bool 扩展诊断数组(struct 诊断集合* cn_var_集合) {
  ...
  r12 = cn_var_新数组_1;
  r13 = r12 == 0;
  if (r13) goto if_then_14; else goto if_merge_15;
...
void 报告诊断(struct 诊断集合* cn_var_集合, enum 诊断严重级别 cn_var_级别, enum 诊断错误码 cn_var_代码, struct 源位置 cn_var_位置, char* cn_var_消息) {
  long long r3, r5, r13, r20, r21, r25, r26, r28, r29;
  char* r18;
  struct 诊断集合* r0;
  struct 诊断集合* r2;
  struct 诊断集合* r4;
  ...
  r5 = r4->容量;
  r6 = r3 >= r5;
  if (r6) goto if_then_18; else goto if_merge_19;
  ...
  r22 = cn_var_级别;
  r23 = r22 == 0;
  if (r23) goto if_then_22; else goto if_else_23;
...
long long 获取警告计数(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_29; else goto if_merge_30;
...
_Bool 应该继续(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_31; else goto if_merge_32;
  ...
  r3 = r2->最大错误数;
  r4 = r3 > 0;
  if (r4) goto if_then_33; else goto if_merge_34;
...
char* 获取严重级别字符串(enum 诊断严重级别 cn_var_级别) {
  ...
  r0 = cn_var_级别;
  r1 = r0 == 0;
  if (r1) goto if_then_35; else goto if_else_36;
  ...
  r2 = cn_var_级别;
  r3 = r2 == 1;
  if (r3) goto if_then_38; else goto if_else_39;
...
void 打印诊断信息(struct 诊断信息* cn_var_信息) {
  ...
  r0 = cn_var_信息;
  r1 = r0 == 0;
  if (r1) goto if_then_41; else goto if_merge_42;
  ...
  r7 = r6.文件名;
  r8 = r7 != 0;
  if (r8) goto if_then_43; else goto if_else_44;
...
void 打印所有诊断(struct 诊断集合* cn_var_集合) {
  long long r2, r4, r8, r10, r11, r13, r15, r16;
  struct 诊断集合* r0;
  struct 诊断集合* r3;
  struct 诊断集合* r6;
  struct 诊断信息* r7;
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_46; else goto if_merge_47;
  ...
  r4 = r3->长度;
  r5 = r2 < r4;
  if (r5) goto for_body_49; else goto for_exit_51;
...
void 诊断集合添加(struct 诊断集合* cn_var_集合, struct 诊断信息 cn_var_信息) {
  long long r3, r5, r14, r16, r17, r22, r23, r25, r26;
  struct 诊断集合* r0;
  struct 诊断集合* r2;
  struct 诊断集合* r4;
  struct 诊断集合* r7;
  ...
  r19 = r18.严重级别;
  r20 = r19 == 0;
  if (r20) goto if_then_60; else goto if_else_61;
