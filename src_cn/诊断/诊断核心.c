...
struct 诊断集合* 创建诊断集合(long long cn_var_初始容量) {
  ...
  r0 = cn_var_初始容量;
  r1 = r0 <= 0;
  if (r1) goto if_then_350; else goto if_merge_351;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_集合_0 = r2;
  r3 = cn_var_集合_0;
  r4 = r3 == 0;
  if (r4) goto if_then_352; else goto if_merge_353;
  ...
  r7 = cn_var_集合_0->诊断数组;
  r8 = r7 == 0;
  if (r8) goto if_then_354; else goto if_merge_355;
...
void 释放诊断集合(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_356; else goto if_merge_357;
  ...
  r2 = cn_var_集合->诊断数组;
  r3 = r2 != 0;
  if (r3) goto if_then_358; else goto if_merge_359;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_新数组_1 = r9;
  r10 = cn_var_新数组_1;
  r11 = r10 == 0;
  if (r11) goto if_then_364; else goto if_merge_365;
...
void 报告诊断(struct 诊断集合* cn_var_集合, enum 诊断严重级别 cn_var_级别, enum 诊断错误码 cn_var_代码, struct 源位置 cn_var_位置, const char* cn_var_消息) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_366; else goto if_merge_367;
  ...
  r3 = cn_var_集合->容量;
  r4 = r2 >= r3;
  if (r4) goto if_then_368; else goto if_merge_369;

  if_then_368:
  r5 = cn_var_集合;
  r6 = 扩展诊断数组(r5);
  r7 = r6 == 0;
  if (r7) goto if_then_370; else goto if_merge_371;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_信息_0 = r10;
  ...
  if (r18) goto if_then_372; else goto if_else_373;
...
_Bool 应该继续(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_381; else goto if_merge_382;
  ...
  r2 = cn_var_集合->最大错误数;
  r3 = r2 > 0;
  if (r3) goto if_then_383; else goto if_merge_384;
...
char* 获取严重级别字符串(enum 诊断严重级别 cn_var_级别) {
  ...
  r0 = cn_var_级别;
  r1 = r0 == 诊断严重级别_诊断_错误;
  if (r1) goto if_then_385; else goto if_else_386;
  ...
  r2 = cn_var_级别;
  r3 = r2 == 诊断严重级别_诊断_警告;
  if (r3) goto if_then_388; else goto if_else_389;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_级别字符串_0 = r3;
  ...
  r5 = r4.文件名;
  r6 = r5 != 0;
  if (r6) goto if_then_393; else goto if_else_394;
...
void 打印所有诊断(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_396; else goto if_merge_397;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r3 = cn_var_集合->长度;
  r4 = r2 < r3;
  if (r4) goto for_body_399; else goto for_exit_401;
...
void 诊断集合添加(struct 诊断集合* cn_var_集合, struct 诊断信息 cn_var_信息) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_404; else goto if_merge_405;
  ...
  r6 = 扩展诊断数组(r5);
  r7 = r6 == 0;
  if (r7) goto if_then_408; else goto if_merge_409;
...
/* P7DBG_STORE src1.kind=1 */  *r11 = r8;
  ...
  if (r15) goto if_then_410; else goto if_else_411;
