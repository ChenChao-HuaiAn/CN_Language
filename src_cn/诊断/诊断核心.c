...
struct 诊断集合* 创建诊断集合(long long cn_var_初始容量) {
  ...
  r0 = cn_var_初始容量;
  r1 = r0 <= 0;
  if (r1) goto if_then_585; else goto if_merge_586;
  ...
  r3 = cn_var_集合_0;
  r4 = r3 == 0;
  if (r4) goto if_then_587; else goto if_merge_588;
  ...
  r8 = r7->诊断数组;
  r9 = r8 == 0;
  if (r9) goto if_then_589; else goto if_merge_590;
...
void 释放诊断集合(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_591; else goto if_merge_592;
...
_Bool 扩展诊断数组(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_595; else goto if_merge_596;
  ...
  r5 = cn_var_新容量_0;
  r6 = r5 <= 0;
  if (r6) goto if_then_597; else goto if_merge_598;
  ...
  r12 = cn_var_新数组_1;
  r13 = r12 == 0;
  if (r13) goto if_then_599; else goto if_merge_600;
...
void 报告诊断(struct 诊断集合* cn_var_集合, enum 诊断严重级别 cn_var_级别, enum 诊断错误码 cn_var_代码, struct 源位置 cn_var_位置, char* cn_var_消息) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_601; else goto if_merge_602;
  ...
  r5 = r4->容量;
  r6 = r3 >= r5;
  if (r6) goto if_then_603; else goto if_merge_604;

  if_then_603:
  r7 = cn_var_集合;
  r8 = 扩展诊断数组(r7);
  r9 = r8 == 0;
  if (r9) goto if_then_605; else goto if_merge_606;
  ...
  r22 = cn_var_级别;
  r23 = r22 == 0;
  if (r23) goto if_then_607; else goto if_else_608;
...
_Bool 有错误(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_610; else goto if_merge_611;
...
long long 获取错误计数(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_612; else goto if_merge_613;
...
long long 获取警告计数(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_614; else goto if_merge_615;
...
_Bool 应该继续(struct 诊断集合* cn_var_集合) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_616; else goto if_merge_617;
...
char* 获取严重级别字符串(enum 诊断严重级别 cn_var_级别) {
  ...
  r0 = cn_var_级别;
  r1 = r0 == 0;
  if (r1) goto if_then_620; else goto if_else_621;
  ...
  r2 = cn_var_级别;
  r3 = r2 == 1;
  if (r3) goto if_then_623; else goto if_else_624;
...
void 打印诊断信息(struct 诊断信息* cn_var_信息) {
  ...
  r0 = cn_var_信息;
  r1 = r0 == 0;
  if (r1) goto if_then_626; else goto if_merge_627;
  ...
  r7 = r6.文件名;
  r8 = r7 != 0;
  if (r8) goto if_then_628; else goto if_else_629;
...
void 打印所有诊断(struct 诊断集合* cn_var_集合) {
  ...
  r4 = r3->长度;
  r5 = r2 < r4;
  if (r5) goto for_body_634; else goto for_exit_636;
...
void 诊断集合添加(struct 诊断集合* cn_var_集合, struct 诊断信息 cn_var_信息) {
  ...
  r0 = cn_var_集合;
  r1 = r0 == 0;
  if (r1) goto if_then_639; else goto if_merge_640;
  ...
  r5 = r4->容量;
  r6 = r3 >= r5;
  if (r6) goto if_then_641; else goto if_merge_642;

  if_then_641:
  r7 = cn_var_集合;
  r8 = 扩展诊断数组(r7);
  r9 = r8 == 0;
  if (r9) goto if_then_643; else goto if_merge_644;
  ...
  r19 = r18.严重级别;
  r20 = r19 == 0;
  if (r20) goto if_then_645; else goto if_else_646;
