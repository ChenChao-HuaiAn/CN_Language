...
_Bool 执行词法分析(struct 编译上下文*, const char*, long long);
...
_Bool 读取文件内容到缓冲区(const char*, char**, long long*);
long long 编译上下文大小();
long long 编译选项大小();
...
_Bool 解析命令行参数(long long cn_var_参数数量, char** cn_var_参数数组, struct 编译选项* cn_var_选项) {
  long long r0, r6, r7, r10, r14, r16, r19, r21, r23, r26, r29, r31, r32, r33, r36, r37, r39, r40, r42, r44, r45, r46, r47, r49, r52, r53, r56, r57, r58, r59, r60, r62, r65, r68, r71, r80, r81;
  char* r12;
  char* r15;
  char* r18;
  char* r22;
  ...
  if_merge_25:
  r61 = cn_var_参数_1;
  r62 = 比较字符串(r61, "--verbose");
  r63 = r62 == 0;
  if (r63) goto if_then_30; else goto if_merge_31;

  if_then_26:
  r51 = cn_var_参数数组;
  r52 = cn_var_i_0;
  r53 = r52 + 1;
  r54 = (char**)cn_rt_array_get_element(r51, r53, 8);
  r55 = cn_var_选项->搜索路径列表;
  r56 = cn_var_选项->搜索路径数量;
    { long long _tmp_r0 = r54; cn_rt_array_set_element(r55, r56, &_tmp_r0, 8); }
  r57 = cn_var_选项->搜索路径数量;
  r58 = r57 + 1;
  r59 = cn_var_i_0;
  r60 = r59 + 1;
  cn_var_i_0 = r60;
  ...
  logic_rhs_28:
  r49 = cn_var_选项->搜索路径数量;
  r50 = r49 < 64;
  goto logic_merge_29;

  logic_merge_29:
  if (r50) goto if_then_26; else goto if_merge_27;
  ...
  if_merge_31:
  r64 = cn_var_参数_1;
  r65 = 比较字符串(r64, "--syntax-only");
  r66 = r65 == 0;
  if (r66) goto if_then_32; else goto if_merge_33;
  ...
  r68 = 比较字符串(r67, "-O0");
  r69 = r68 == 0;
  if (r69) goto if_then_34; else goto if_merge_35;
  ...
  r71 = 比较字符串(r70, "-O2");
  r72 = r71 == 0;
  if (r72) goto if_then_36; else goto if_merge_37;
  ...
  r75 = *r74;
  r76 = r75 != 45;
  if (r76) goto if_then_38; else goto if_merge_39;

  if_then_38:
  r77 = cn_var_选项->输入文件路径;
  r78 = r77 == 0;
  if (r78) goto if_then_40; else goto if_merge_41;
...
struct 编译上下文* 创建编译上下文(struct 编译选项* cn_var_选项) {
  long long r2, r10, r22, r23, r27, r30, r31;
  char** r26;
  struct 编译选项* r0;
  void* r3;
  struct 编译上下文* r4;
  ...
  r11 = 复制内存(r7, r9, r10);
  r12 = 创建诊断集合(16);
  r13 = cn_var_上下文_0->诊断集合;
  r14 = r13 == 0;
  if (r14) goto if_then_46; else goto if_merge_47;
  ...
  if_merge_47:
  r16 = cn_var_上下文_0->诊断集合;
  r17 = 创建模块加载器(r16);
  r18 = cn_var_上下文_0->模块加载器;
  r19 = r18 == 0;
  if (r19) goto if_then_48; else goto if_merge_49;

  if_then_48:
  r20 = cn_var_上下文_0->诊断集合;
  释放诊断集合(r20);
  r21 = cn_var_上下文_0;
  释放内存(r21);
  return 0;
  ...
  for_cond_50:
  r22 = cn_var_i_1;
  r23 = cn_var_选项->搜索路径数量;
  r24 = r22 < r23;
  if (r24) goto for_body_51; else goto for_exit_53;

  for_body_51:
  r25 = cn_var_上下文_0->模块加载器;
  r26 = cn_var_选项->搜索路径列表;
  r27 = cn_var_i_1;
  r28 = (char**)cn_rt_array_get_element(r26, r27, 8);
  r29 = 添加搜索路径(r25, r28);
  goto for_update_52;
...
void 销毁编译上下文(struct 编译上下文* cn_var_上下文) {
  ...
  r2 = cn_var_上下文->解析器实例;
  r3 = r2 != 0;
  if (r3) goto if_then_56; else goto if_merge_57;
  ...
  r5 = cn_var_上下文->扫描器实例;
  r6 = r5 != 0;
  if (r6) goto if_then_58; else goto if_merge_59;
  ...
  r8 = cn_var_上下文->模块加载器;
  r9 = r8 != 0;
  if (r9) goto if_then_60; else goto if_merge_61;

  if_then_60:
  r10 = cn_var_上下文->模块加载器;
  销毁模块加载器(r10);
  goto if_merge_61;
  ...
  r11 = cn_var_上下文->诊断集合;
  r12 = r11 != 0;
  if (r12) goto if_then_62; else goto if_merge_63;
...
_Bool 执行词法分析(struct 编译上下文* cn_var_上下文, const char* cn_var_源码, long long cn_var_源码长度) {
  long long r0, r7, r9, r13;
  char* r3;
  char* r8;
  struct 编译上下文* r1;
  struct 扫描器* r10;
  ...
  r5 = cn_var_上下文->选项;
  r6 = r5.详细输出;
  if (r6) goto if_then_68; else goto if_merge_69;
...
_Bool 执行语法分析(struct 编译上下文* cn_var_上下文) {
  ...
  r5 = cn_var_上下文->选项;
  r6 = r5.详细输出;
  if (r6) goto if_then_76; else goto if_merge_77;
  ...
  r9 = cn_var_上下文->诊断集合;
  r10 = 创建解析器(r8, r9);
  r11 = cn_var_上下文->解析器实例;
  r12 = r11 == 0;
  if (r12) goto if_then_78; else goto if_merge_79;

  if_then_78:
  r13 = 打印格式("错误: 无法创建语法分析器\n");
  return 0;
  goto if_merge_79;

  if_merge_79:
  r14 = cn_var_上下文->解析器实例;
  r15 = 解析程序(r14);
  r16 = cn_var_上下文->程序节点;
  r17 = r16 == 0;
...
_Bool 执行语义分析(struct 编译上下文* cn_var_上下文) {
  ...
  r5 = cn_var_上下文->选项;
  r6 = r5.详细输出;
  if (r6) goto if_then_86; else goto if_merge_87;
  ...
  logic_merge_85:
  if (r4) goto if_then_82; else goto if_merge_83;
  ...
  r8 = cn_var_上下文->诊断集合;
  r9 = 创建语义检查上下文(r8);
  r10 = cn_var_上下文->语义上下文;
  r11 = r10 == 0;
  if (r11) goto if_then_88; else goto if_merge_89;

  if_then_88:
  r12 = 打印格式("错误: 无法创建语义分析器\n");
  return 0;
  goto if_merge_89;

  if_merge_89:
  _Bool cn_var_检查结果_0;
  r13 = cn_var_上下文->语义上下文;
  r14 = cn_var_上下文->程序节点;
  r15 = 执行语义检查(r13, r14);
  cn_var_检查结果_0 = r15;
  r16 = cn_var_检查结果_0;
  r17 = !r16;
  if (r17) goto if_then_90; else goto if_merge_91;
...
_Bool 执行IR生成(struct 编译上下文* cn_var_上下文) {
  ...
  r5 = cn_var_上下文->选项;
  r6 = r5.详细输出;
  if (r6) goto if_then_96; else goto if_merge_97;
  ...
  logic_merge_95:
  if (r4) goto if_then_92; else goto if_merge_93;
  ...
  r9 = cn_var_上下文->IR模块;
  r10 = r9 == 0;
  if (r10) goto if_then_98; else goto if_merge_99;

  if_then_98:
  r11 = 打印格式("错误: 无法创建IR模块\n");
  return 0;
  goto if_merge_99;
  ...
  r12 = cn_var_IR上下文_0;
  r13 = &cn_var_IR上下文_0;
  r14 = sizeof(struct IR生成上下文);
  r15 = 设置内存(r13, 0, r14);
  r16 = cn_var_上下文->IR模块;
  r17 = cn_var_上下文->语义上下文;
  r18 = r17->符号表;
  r19 = r18->全局作用域;
  r20 = cn_var_IR上下文_0;
  r21 = &cn_var_IR上下文_0;
  ...
  r24 = r23->首个函数;
  r25 = r24 == 0;
  if (r25) goto if_then_100; else goto if_merge_101;

  if_then_100:
  r26 = 打印格式("警告: IR模块没有生成任何函数\n");
  goto if_merge_101;
...
_Bool 执行代码生成(struct 编译上下文* cn_var_上下文) {
  long long r0, r7, r23, r24, r25, r26, r29, r34, r36, r37, r44, r54, r59;
  char* r14;
  char* r21;
  char* r39;
  char* r41;
  ...
  void* r45;
  struct IR模块* r48;
  struct 模块代码生成上下文* r51;
  struct 模块代码生成上下文* r52;
  struct 模块代码生成上下文* r55;
  _Bool r2;
  _Bool r4;
  _Bool r6;
  _Bool r10;
  ...
  r5 = cn_var_上下文->选项;
  r6 = r5.详细输出;
  if (r6) goto if_then_106; else goto if_merge_107;
  ...
  logic_merge_105:
  if (r4) goto if_then_102; else goto if_merge_103;
  ...
  r9 = r8.输出文件路径;
  r10 = r9 != 0;
  if (r10) goto if_then_108; else goto if_else_109;
  ...
  r16 = r15.输入文件路径;
  r17 = r16 != 0;
  if (r17) goto if_then_111; else goto if_else_112;

  if_merge_110:
  struct 代码生成选项 cn_var_生成选项_2;
  r42 = cn_var_生成选项_2;
  r43 = &cn_var_生成选项_2;
  r44 = sizeof(struct 代码生成选项);
  r45 = 设置内存(r43, 0, r44);
  r46 = cn_var_上下文->选项;
  r47 = r46.详细输出;
  r48 = cn_var_上下文->IR模块;
  r49 = cn_var_输出路径;
  r50 = cn_var_生成选项_2;
  r51 = 创建模块代码生成上下文(r48, r49, r50);
  r52 = cn_var_上下文->代码生成上下文;
  r53 = r52 == 0;
  if (r53) goto if_then_120; else goto if_merge_121;
  ...
  r26 = cn_var_i_1;
  r27 = r26 >= 0;
  if (r27) goto for_body_115; else goto for_exit_117;
  ...
  r31 = r30;
  r32 = r31 == 46;
  if (r32) goto if_then_118; else goto if_merge_119;
  ...
  if_then_120:
  r54 = 打印格式("错误: 无法创建代码生成上下文\n");
  return 0;
  goto if_merge_121;

  if_merge_121:
  r55 = cn_var_上下文->代码生成上下文;
  生成模块代码(r55);
  r56 = cn_var_上下文->选项;
  r57 = r56.详细输出;
  if (r57) goto if_then_122; else goto if_merge_123;
...
_Bool 编译文件(struct 编译上下文* cn_var_上下文) {
  long long r0, r8, r9, r10, r15, r19, r20, r21, r24;
  char* r13;
  char* r23;
  char* r27;
  char* r31;
  ...
  r6 = cn_var_上下文->选项;
  r7 = r6.详细输出;
  if (r7) goto if_then_128; else goto if_merge_129;
  ...
  logic_merge_127:
  if (r5) goto if_then_124; else goto if_merge_125;
  ...
  r15 = cn_var_源码长度_1;
  r16 = &cn_var_源码长度_1;
  r17 = 读取文件内容到缓冲区(r12, r14, r16);
  r18 = !r17;
  if (r18) goto if_then_130; else goto if_merge_131;

  if_then_130:
  r19 = cn_var_上下文.选项;
  r20 = r19.输入文件路径;
  r21 = 打印格式("错误: 无法读取文件: %s\n", r20);
  return 0;
  goto if_merge_131;
  ...
  r23 = cn_var_源码_0;
  r24 = cn_var_源码长度_1;
  r25 = 执行词法分析(r22, r23, r24);
  r26 = !r25;
  if (r26) goto if_then_132; else goto if_merge_133;
  ...
  r28 = cn_var_上下文->选项;
  r29 = r28.停止阶段;
  r30 = r29 == 编译阶段_阶段_词法分析;
  if (r30) goto if_then_134; else goto if_merge_135;
  ...
  r33 = 执行语法分析(r32);
  r34 = !r33;
  if (r34) goto if_then_136; else goto if_merge_137;
  ...
  r36 = cn_var_上下文->选项;
  r37 = r36.停止阶段;
  r38 = r37 == 编译阶段_阶段_语法分析;
  if (r38) goto if_then_138; else goto if_merge_139;
  ...
  r41 = 执行语义分析(r40);
  r42 = !r41;
  if (r42) goto if_then_140; else goto if_merge_141;
  ...
  r44 = cn_var_上下文->选项;
  r45 = r44.停止阶段;
  r46 = r45 == 编译阶段_阶段_语义分析;
  if (r46) goto if_then_142; else goto if_merge_143;
  ...
  r49 = 执行IR生成(r48);
  r50 = !r49;
  if (r50) goto if_then_144; else goto if_merge_145;
  ...
  r52 = cn_var_上下文->选项;
  r53 = r52.停止阶段;
  r54 = r53 == 编译阶段_阶段_IR生成;
  if (r54) goto if_then_146; else goto if_merge_147;
  ...
  r57 = 执行代码生成(r56);
  r58 = !r57;
  if (r58) goto if_then_148; else goto if_merge_149;
...
_Bool 读取文件内容到缓冲区(const char* cn_var_文件路径, char** cn_var_缓冲区, long long* cn_var_大小) {
  ...
  r36 = cn_var_内容_2;
  r37 = cn_var_文件大小_1;
    { long long _tmp_i0 = 0; cn_rt_array_set_element(r36, r37, &_tmp_i0, 8); }
  r38 = cn_var_内容_2;
  r39 = cn_var_文件大小_1;
  return 1;
}
...
long long main(long long cn_var_参数数量, char** cn_var_参数数组) {
  cn_rt_init();
  long long r0, r6, r11, r17, r21, r22, r23, r24, r25;
  char** r1;
  struct 编译选项* r3;
  char* r9;
  struct 编译选项* r13;
  ...
  if_merge_165:
  r7 = cn_var_选项_0.显示版本;
  if (r7) goto if_then_166; else goto if_merge_167;
  ...
  if_merge_167:
  r8 = cn_var_选项_0.显示帮助;
  if (r8) goto if_then_168; else goto if_merge_169;
  ...
  if_merge_169:
  r9 = cn_var_选项_0.输入文件路径;
  r10 = r9 == 0;
  if (r10) goto if_then_170; else goto if_merge_171;
  ...
  r15 = cn_var_上下文_1;
  r16 = r15 == 0;
  if (r16) goto if_then_172; else goto if_merge_173;

  if_then_172:
  r17 = 打印格式("错误: 无法创建编译上下文\n");
  return 1;
  goto if_merge_173;
  ...
  r19 = 编译文件(r18);
  cn_var_编译结果_2 = r19;
  r20 = cn_var_选项_0.详细输出;
  if (r20) goto if_then_174; else goto if_merge_175;

  if_then_174:
  r21 = 打印格式("\n编译统计:\n");
  r22 = cn_var_上下文_1->总错误数;
  r23 = 打印格式("  总错误数: %d\n", r22);
  r24 = cn_var_上下文_1->总警告数;
  r25 = 打印格式("  总警告数: %d\n", r24);
  goto if_merge_175;
  ...
  销毁编译上下文(r26);
  r27 = cn_var_编译结果_2;
  if (r27) goto if_then_176; else goto if_else_177;
