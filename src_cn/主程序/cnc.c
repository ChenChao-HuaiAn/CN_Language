...
_Bool 解析命令行参数(long long cn_var_参数数量, char** cn_var_参数数组, struct 编译选项* cn_var_选项) {
  long long r0, r6, r7, r10, r14, r16, r19, r21, r23, r26, r29, r31, r32, r33, r36, r37, r39, r40, r42, r44, r45, r46, r47, r50, r53, r54, r59, r61, r62, r63, r64, r66, r69, r72, r75, r85, r86;
  char* r12;
  char* r15;
  char* r18;
  char* r22;
  ...
  r58 = cn_var_选项;
  r59 = r58->搜索路径数量;
    { long long _tmp_r0 = r55; cn_rt_array_set_element(r57, r59, &_tmp_r0, 8); }
  r60 = cn_var_选项;
  r61 = r60->搜索路径数量;
  r62 = r61 + 1;
  r63 = cn_var_i_0;
  ...
  r79 = *r78;
  r80 = r79 != 45;
  if (r80) goto if_then_38; else goto if_merge_39;

  if_then_38:
  r81 = cn_var_选项;
  r82 = r81->输入文件路径;
  r83 = r82 == 0;
  if (r83) goto if_then_40; else goto if_merge_41;
...
_Bool 执行代码生成(struct 编译上下文* cn_var_上下文) {
  long long r0, r9, r29, r30, r31, r32, r35, r40, r42, r43, r50, r63, r70;
  char* r18;
  char* r27;
  char* r45;
  char* r47;
  ...
  struct 编译上下文* r60;
  struct 模块代码生成上下文* r61;
  struct 编译上下文* r64;
  struct 模块代码生成上下文* r65;
  struct 编译上下文* r66;
  _Bool r2;
  _Bool r5;
  _Bool r8;
  ...
  r57 = cn_var_输出路径;
  r58 = cn_var_生成选项_2;
  r59 = 创建模块代码生成上下文(r56, r57, r58);
  r60 = cn_var_上下文;
  r61 = r60->代码生成上下文;
  r62 = r61 == 0;
  if (r62) goto if_then_120; else goto if_merge_121;
  ...
  r37 = r36;
  r38 = r37 == 46;
  if (r38) goto if_then_118; else goto if_merge_119;
  ...
  r67 = r66->选项;
  r68 = r67.详细输出;
  if (r68) goto if_then_122; else goto if_merge_123;
