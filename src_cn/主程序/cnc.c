...
_Bool 执行IR生成(struct 编译上下文* cn_var_上下文) {
  ...
  r32 = r31->首个函数;
  r33 = r32 == 0;
  if (r33) goto if_then_100; else goto if_merge_101;

  if_then_100:
  r34 = 打印格式("警告: IR模块没有生成任何函数\n");
  goto if_merge_101;
...
_Bool 执行代码生成(struct 编译上下文* cn_var_上下文) {
  long long r0, r9, r29, r30, r31, r32, r35, r39, r40, r41, r49, r62, r68, r69;
  char* r18;
  char* r27;
  char* r43;
  char* r45;
  ...
  struct 编译上下文* r54;
  struct IR模块* r55;
  struct 模块代码生成上下文* r58;
  struct 编译上下文* r59;
  struct 模块代码生成上下文* r60;
  struct 编译上下文* r63;
  struct 模块代码生成上下文* r64;
  struct 编译上下文* r65;
  _Bool r2;
  _Bool r5;
  _Bool r8;
  ...
  r56 = cn_var_输出路径;
  r57 = cn_var_生成选项_2;
  r58 = 创建模块代码生成上下文(r55, r56, r57);
  r59 = cn_var_上下文;
  r60 = r59->代码生成上下文;
  r61 = r60 == 0;
  if (r61) goto if_then_120; else goto if_merge_121;
  ...
  r66 = r65->选项;
  r67 = r66.详细输出;
  if (r67) goto if_then_122; else goto if_merge_123;
...
_Bool 编译文件(struct 编译上下文* cn_var_上下文) {
  long long r0, r10, r11, r12, r13, r19, r23, r24, r25, r26, r29;
  char* r17;
  char* r28;
  char* r32;
  char* r37;
...
long long main(long long cn_var_参数数量, char** cn_var_参数数组) {
  cn_rt_init();
  long long r0, r6, r14, r17, r20, r25, r26, r27, r28, r29, r30, r31;
  char** r1;
  struct 编译选项* r3;
  char* r12;
  struct 编译选项* r16;
