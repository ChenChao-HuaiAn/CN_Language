...
struct 词元 报告词法错误(struct 扫描器* cn_var_实例, enum 词法错误类型 cn_var_错误类型, const char* cn_var_详情) {
  long long r2, r6, r8, r13, r15, r17, r18, r19;
  char* r0;
  char* r1;
  char* r10;
  char* r11;
...
void 执行恢复(struct 扫描器* cn_var_实例, enum 恢复策略 cn_var_策略) {
  long long r10, r12, r13, r14, r16, r19, r23, r25, r27, r33, r34, r35, r37, r38, r39, r41, r46;
  struct 扫描器* r0;
  struct 扫描器* r9;
  struct 扫描器* r11;
  struct 扫描器* r18;
  ...
  r31 = r30.类型;
  r32 = 是否同步点(r31);
  if (r32) goto if_then_65; else goto if_merge_66;
  ...
  r39 = cn_var_c_5;
  r40 = 是空白字符(r39);
  if (r40) goto logic_merge_73; else goto logic_rhs_72;
  ...
  r43 = cn_var_实例;
  r44 = 是否结束(r43);
  if (r44) goto if_then_74; else goto if_merge_75;
  ...
  logic_merge_73:
  if (r42) goto if_then_70; else goto if_merge_71;
...
_Bool 应该抑制错误(struct 错误恢复上下文* cn_var_上下文) {
  ...
  r4 = cn_var_级联错误阈值;
  r5 = r3 >= r4;
  if (r5) goto if_then_89; else goto if_merge_90;
  ...
  r9 = r8->最大连续错误;
  r10 = r7 >= r9;
  if (r10) goto if_then_91; else goto if_merge_92;
...
void 更新错误上下文(struct 错误恢复上下文* cn_var_上下文, long long cn_var_当前行号) {
  long long r3, r4, r5, r7, r10, r11, r13, r14, r16;
  struct 错误恢复上下文* r0;
  struct 错误恢复上下文* r2;
  struct 错误恢复上下文* r6;
  struct 错误恢复上下文* r9;
  ...
  r7 = r6->最后错误行号;
  r8 = r5 == r7;
  if (r8) goto if_then_163; else goto if_else_164;
  ...
  r14 = cn_var_级联错误阈值;
  r15 = r13 >= r14;
  if (r15) goto if_then_166; else goto if_merge_167;
