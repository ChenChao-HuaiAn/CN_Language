...
struct 词元 报告词法错误(struct 扫描器* cn_var_实例, enum 词法错误类型 cn_var_错误类型, const char* cn_var_详情) {
  ...
  r7 = cn_var_错误类型;
  r8 = 词法错误名称(r7);
/* P7DBG_STORE src1.kind=1 */  cn_var_错误名称_1 = r8;
  char* cn_var_完整消息_2;
  r9 = cn_var_错误名称_1;
  r10 = cn_var_详情;
  r11 = 字符串格式("词法错误: %s - %s", r9, r10);
/* P7DBG_STORE src1.kind=1 */  cn_var_完整消息_2 = r11;
...
void 执行恢复(struct 扫描器* cn_var_实例, enum 恢复策略 cn_var_策略) {
  ...
  r11 = cn_var_实例;
  r12 = 当前字符(r11);
/* P7DBG_STORE src1.kind=1 */  cn_var_c_0 = r12;
  r14 = cn_var_c_0;
  r15 = r14 == 0;
  ...
  r22 = cn_var_实例->位置;
/* P7DBG_STORE src1.kind=1 */  cn_var_保存位置_1 = r22;
  long long cn_var_保存行号_2;
  r23 = cn_var_实例->行号;
/* P7DBG_STORE src1.kind=1 */  cn_var_保存行号_2 = r23;
  long long cn_var_保存列号_3;
  r24 = cn_var_实例->列号;
/* P7DBG_STORE src1.kind=1 */  cn_var_保存列号_3 = r24;
  struct 词元 cn_var_当前词元_4;
  r25 = cn_var_实例;
  r26 = 下一个词元(r25);
/* P7DBG_STORE src1.kind=1 */  cn_var_当前词元_4 = r26;
  ...
  r32 = cn_var_实例;
  r33 = 当前字符(r32);
/* P7DBG_STORE src1.kind=1 */  cn_var_c_5 = r33;
  r35 = cn_var_c_5;
  r36 = 是空白字符(r35);
