...
void 构建声明作用域(struct 作用域构建器* cn_var_构建器, struct 声明节点* cn_var_声明) {
  long long r1, r3, r4, r5, r6, r8, r9, r11, r12, r14, r15, r17, r18, r20, r21, r23, r24;
  struct 声明节点* r0;
  struct 声明节点* r2;
  struct 作用域构建器* r26;
  struct 声明节点* r27;
...
void 构建函数声明作用域(struct 作用域构建器* cn_var_构建器, struct 函数声明* cn_var_函数节点) {
  long long r1, r9, r14, r15, r19, r21, r27, r31, r34, r38, r40, r41, r45, r46, r47, r48, r51;
  char* r5;
  char* r24;
  char* r33;
  void* r7;
...
void 构建变量声明作用域(struct 作用域构建器* cn_var_构建器, struct 变量声明* cn_var_变量节点) {
  long long r1, r8, r15, r16, r20, r22, r28, r31;
  char* r10;
  char* r25;
  struct 变量声明* r0;
  struct 变量声明* r2;
...
void 构建结构体声明作用域(struct 作用域构建器* cn_var_构建器, struct 结构体声明* cn_var_结构体节点) {
  long long r1, r6, r10, r12, r18, r22, r25, r30, r32, r33, r35, r37, r38, r41, r42, r43, r44, r45, r46, r49, r50, r53, r54, r55, r56, r59, r61, r62;
  char* r3;
  char* r15;
  char* r24;
  void* r40;
...
void 构建枚举声明作用域(struct 作用域构建器* cn_var_构建器, struct 枚举声明* cn_var_枚举节点) {
  long long r1, r6, r10, r12, r18, r22, r25, r30, r32, r33, r35, r37, r38, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50, r51, r54, r56, r57, r58, r59, r62, r64, r65, r66, r67;
  char* r3;
  char* r15;
  char* r24;
  void* r40;
...
void 构建类声明作用域(struct 作用域构建器* cn_var_构建器, struct 类声明* cn_var_类节点) {
  long long r1, r6, r12, r14, r20, r21, r24, r27, r28, r34, r35, r36, r37, r38, r40, r41, r42, r44, r45, r47, r49, r50, r52, r54, r55, r60, r61, r63, r64, r65, r66, r67, r69, r70, r71, r72, r73, r74, r75, r76, r80, r83, r88, r90, r91, r93, r95, r96, r100, r101, r102, r103, r104, r105;
  char* r3;
  char* r17;
  char* r23;
  char* r26;
...
void 构建类成员作用域(struct 作用域构建器* cn_var_构建器, struct 类成员* cn_var_成员节点, struct 符号* cn_var_类符号, long long cn_var_索引) {
  long long r1, r4, r5, r6, r12, r13, r17, r18, r22, r23, r32, r33, r36, r39, r40, r41, r53, r54, r58, r59, r63, r64, r72, r79, r80, r83, r84, r85, r86, r87, r88, r89, r92;
  char* r25;
  char* r66;
  void* r69;
  struct 类成员* r0;
...
void 构建接口声明作用域(struct 作用域构建器* cn_var_构建器, struct 接口声明* cn_var_接口节点) {
  long long r1, r6, r10, r12, r18, r22, r25, r30, r32, r33, r35, r37, r38, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50, r53, r54, r57, r58, r59, r60, r61, r64, r66, r67;
  char* r3;
  char* r15;
  char* r24;
  struct 接口声明* r0;
...
void 构建语句作用域(struct 作用域构建器* cn_var_构建器, struct 语句节点* cn_var_语句) {
  long long r1, r3, r4, r5, r6, r8, r9, r11, r12, r14, r15, r17, r18, r20, r21, r23, r24, r26, r27;
  struct 语句节点* r0;
  struct 语句节点* r2;
  struct 作用域构建器* r29;
  struct 语句节点* r30;
...
void 构建循环语句作用域(struct 作用域构建器* cn_var_构建器, struct 循环语句* cn_var_循环节点) {
  long long r1, r5, r10, r16, r22, r28;
  struct 循环语句* r0;
  struct 作用域构建器* r2;
  struct 符号表管理器* r3;
  struct 作用域构建器* r6;
...
void 构建选择语句作用域(struct 作用域构建器* cn_var_构建器, struct 选择语句* cn_var_选择节点) {
  long long r1, r5, r7, r8, r11, r12, r13, r14, r15, r18;
  struct 选择语句* r0;
  struct 作用域构建器* r2;
  struct 选择语句* r3;
  struct 表达式节点* r4;
