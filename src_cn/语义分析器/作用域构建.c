...
void 构建声明作用域(struct 作用域构建器* cn_var_构建器, struct 声明节点* cn_var_声明) {
  ...
  r4 = r3.类型;
  r5 = r4 == 1;
  if (r5) goto case_body_2079; else goto switch_check_2087;

  switch_check_2087:
  r6 = r4 == 2;
  if (r6) goto case_body_2080; else goto switch_check_2088;

  switch_check_2088:
  r7 = r4 == 3;
  if (r7) goto case_body_2081; else goto switch_check_2089;

  switch_check_2089:
  r8 = r4 == 4;
  if (r8) goto case_body_2082; else goto switch_check_2090;

  switch_check_2090:
  r9 = r4 == 7;
  if (r9) goto case_body_2083; else goto switch_check_2091;

  switch_check_2091:
  r10 = r4 == 8;
  if (r10) goto case_body_2084; else goto switch_check_2092;

  switch_check_2092:
  r11 = r4 == 6;
  if (r11) goto case_body_2085; else goto case_default_2086;
...
void 构建函数声明作用域(struct 作用域构建器* cn_var_构建器, struct 函数声明* cn_var_函数节点) {
  long long r1, r9, r15, r19, r21, r32, r36, r38, r39, r43, r44, r45, r46, r49;
  char* r5;
  char* r24;
  char* r31;
  void* r7;
  ...
  r38 = r37->参数个数;
  r39 = r36 < r38;
  if (r39) goto for_body_2098; else goto for_exit_2100;
  ...
  r48 = r47->函数体;
  r49 = r48 != 0;
  if (r49) goto if_then_2101; else goto if_merge_2102;
...
void 构建结构体声明作用域(struct 作用域构建器* cn_var_构建器, struct 结构体声明* cn_var_结构体节点) {
  long long r1, r10, r12, r23, r28, r30, r31, r33, r35, r36, r39, r40, r41, r42, r43, r44, r48, r51, r52, r53, r54, r57, r59, r60;
  char* r3;
  char* r15;
  char* r22;
  void* r38;
  ...
  r35 = r34->成员个数;
  r36 = r33 < r35;
  if (r36) goto for_body_2118; else goto for_exit_2120;
...
void 构建枚举声明作用域(struct 作用域构建器* cn_var_构建器, struct 枚举声明* cn_var_枚举节点) {
  long long r1, r10, r12, r23, r28, r30, r31, r33, r35, r36, r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r54, r55, r56, r57, r60, r62, r63, r64, r65;
  char* r3;
  char* r15;
  char* r22;
  void* r38;
  ...
  r35 = r34->成员个数;
  r36 = r33 < r35;
  if (r36) goto for_body_2126; else goto for_exit_2128;
  ...
  r41 = cn_var_成员_3;
  r42 = r41.有显式值;
  if (r42) goto if_then_2129; else goto if_merge_2130;
...
void 构建类声明作用域(struct 作用域构建器* cn_var_构建器, struct 类声明* cn_var_类节点) {
  long long r1, r12, r14, r21, r24, r27, r28, r34, r35, r36, r37, r38, r39, r40, r42, r43, r45, r47, r48, r50, r52, r53, r58, r59, r61, r62, r63, r64, r65, r66, r67, r68, r69, r70, r71, r72, r77, r82, r84, r85, r87, r89, r90, r94, r95, r96, r97, r98, r99;
  char* r3;
  char* r17;
  char* r23;
  char* r26;
  ...
  r42 = r41->接口个数;
  r43 = r42 > 0;
  if (r43) goto if_then_2143; else goto if_merge_2144;
  ...
  logic_merge_2142:
  if (r39) goto if_then_2139; else goto if_merge_2140;
  ...
  r52 = r51->接口个数;
  r53 = r50 < r52;
  if (r53) goto for_body_2146; else goto for_exit_2148;
  ...
  r62 = cn_var_接口符号_3;
  r63 = r62 != 0;
  if (r63) goto logic_rhs_2151; else goto logic_merge_2152;
  ...
  logic_merge_2152:
  if (r66) goto if_then_2149; else goto if_merge_2150;
  ...
  r89 = r88->成员个数;
  r90 = r87 < r89;
  if (r90) goto for_body_2154; else goto for_exit_2156;
...
void 构建类成员作用域(struct 作用域构建器* cn_var_构建器, struct 类成员* cn_var_成员节点, struct 符号* cn_var_类符号, long long cn_var_索引) {
  ...
  r3 = r2->类型;
  r4 = r3 == 2;
  if (r4) goto if_then_2159; else goto if_else_2160;
  ...
  r28 = r27->类型;
  r29 = r28 == 1;
  if (r29) goto if_then_2162; else goto if_merge_2163;

  if_merge_2161:
  r64 = cn_var_成员符号_0;
  r65 = r64 != 0;
  if (r65) goto if_then_2164; else goto if_merge_2165;
...
void 构建接口声明作用域(struct 作用域构建器* cn_var_构建器, struct 接口声明* cn_var_接口节点) {
  long long r1, r10, r12, r23, r28, r30, r31, r33, r35, r36, r38, r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r52, r54, r55, r56, r57, r60, r62, r63;
  char* r3;
  char* r15;
  char* r22;
  struct 接口声明* r0;
  ...
  r35 = r34->方法个数;
  r36 = r33 < r35;
  if (r36) goto for_body_2171; else goto for_exit_2173;
...
void 构建语句作用域(struct 作用域构建器* cn_var_构建器, struct 语句节点* cn_var_语句) {
  ...
  r4 = r3.类型;
  r5 = r4 == 12;
  if (r5) goto case_body_2179; else goto switch_check_2188;

  switch_check_2188:
  r6 = r4 == 13;
  if (r6) goto case_body_2180; else goto switch_check_2189;

  switch_check_2189:
  r7 = r4 == 14;
  if (r7) goto case_body_2181; else goto switch_check_2190;

  switch_check_2190:
  r8 = r4 == 15;
  if (r8) goto case_body_2182; else goto switch_check_2191;

  switch_check_2191:
  r9 = r4 == 19;
  if (r9) goto case_body_2183; else goto switch_check_2192;

  switch_check_2192:
  r10 = r4 == 11;
  if (r10) goto case_body_2184; else goto switch_check_2193;

  switch_check_2193:
  r11 = r4 == 16;
  if (r11) goto case_body_2185; else goto switch_check_2194;

  switch_check_2194:
  r12 = r4 == 20;
  if (r12) goto case_body_2186; else goto case_default_2187;
...
void 构建块语句作用域(struct 作用域构建器* cn_var_构建器, struct 块语句* cn_var_块节点) {
  long long r1, r4, r6, r7, r10, r11, r12, r13, r14;
  struct 块语句* r0;
  struct 作用域构建器* r2;
  struct 符号表管理器* r3;
  struct 块语句* r5;
  ...
  r6 = r5->语句个数;
  r7 = r4 < r6;
  if (r7) goto for_body_2198; else goto for_exit_2200;
...
void 构建当语句作用域(struct 作用域构建器* cn_var_构建器, struct 当语句* cn_var_当节点) {
  ...
  r10 = r9->循环体;
  r11 = r10 != 0;
  if (r11) goto if_then_2209; else goto if_merge_2210;
...
void 构建循环语句作用域(struct 作用域构建器* cn_var_构建器, struct 循环语句* cn_var_循环节点) {
  ...
  r7 = r6->初始化;
  r8 = r7 != 0;
  if (r8) goto if_then_2213; else goto if_merge_2214;
  ...
  r13 = r12->条件;
  r14 = r13 != 0;
  if (r14) goto if_then_2215; else goto if_merge_2216;
  ...
  r19 = r18->更新;
  r20 = r19 != 0;
  if (r20) goto if_then_2217; else goto if_merge_2218;
  ...
  r25 = r24->循环体;
  r26 = r25 != 0;
  if (r26) goto if_then_2219; else goto if_merge_2220;
...
void 构建选择语句作用域(struct 作用域构建器* cn_var_构建器, struct 选择语句* cn_var_选择节点) {
  long long r1, r5, r7, r8, r12, r13, r14, r15, r18;
  void* r11;
  struct 选择语句* r0;
  struct 作用域构建器* r2;
  struct 选择语句* r3;
...
void 构建情况分支作用域(struct 作用域构建器* cn_var_构建器, struct 情况分支* cn_var_情况节点) {
  ...
  r6 = r5->语句体;
  r7 = r6 != 0;
  if (r7) goto if_then_2231; else goto if_merge_2232;
...
void 构建返回语句作用域(struct 作用域构建器* cn_var_构建器, struct 返回语句* cn_var_返回节点) {
  ...
  r0 = cn_var_返回节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2233; else goto if_merge_2234;
  ...
  r3 = r2->返回值;
  r4 = r3 != 0;
  if (r4) goto if_then_2235; else goto if_merge_2236;
...
void 构建尝试语句作用域(struct 作用域构建器* cn_var_构建器, struct 尝试语句* cn_var_尝试节点) {
  ...
  r0 = cn_var_尝试节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2237; else goto if_merge_2238;
  ...
  r3 = r2->尝试块;
  r4 = r3 != 0;
  if (r4) goto if_then_2239; else goto if_merge_2240;
  ...
  r10 = r9->捕获个数;
  r11 = r8 < r10;
  if (r11) goto for_body_2242; else goto for_exit_2244;
  ...
  r20 = r19->最终块;
  r21 = r20 != 0;
  if (r21) goto if_then_2245; else goto if_merge_2246;
...
void 构建捕获子句作用域(struct 作用域构建器* cn_var_构建器, struct 捕获子句* cn_var_捕获节点) {
  ...
  r0 = cn_var_捕获节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2247; else goto if_merge_2248;
  ...
  r5 = r4->语句体;
  r6 = r5 != 0;
  if (r6) goto if_then_2249; else goto if_merge_2250;
...
void 构建表达式作用域(struct 作用域构建器* cn_var_构建器, struct 表达式节点* cn_var_表达式) {
  ...
  r4 = r3.类型;
  r5 = r4 == 23;
  if (r5) goto case_body_2254; else goto switch_check_2263;

  switch_check_2263:
  r6 = r4 == 24;
  if (r6) goto case_body_2255; else goto switch_check_2264;

  switch_check_2264:
  r7 = r4 == 27;
  if (r7) goto case_body_2256; else goto switch_check_2265;

  switch_check_2265:
  r8 = r4 == 28;
  if (r8) goto case_body_2257; else goto switch_check_2266;

  switch_check_2266:
  r9 = r4 == 29;
  if (r9) goto case_body_2258; else goto switch_check_2267;
  ...
  switch_check_2268:
  r11 = r4 == 31;
  if (r11) goto case_body_2260; else goto switch_check_2269;

  switch_check_2269:
  r12 = r4 == 26;
  if (r12) goto case_body_2261; else goto case_default_2262;

  case_body_2254:
  r13 = cn_var_构建器;
  r14 = cn_var_表达式;
  构建二元表达式作用域(r13, (struct 二元表达式*)cn_var_表达式);
  goto switch_merge_2253;
  goto switch_merge_2253;
...
void 构建函数调用表达式作用域(struct 作用域构建器* cn_var_构建器, struct 函数调用表达式* cn_var_调用节点) {
  long long r1, r5, r7, r8, r12, r13, r14, r15;
  void* r11;
  struct 函数调用表达式* r0;
  struct 作用域构建器* r2;
  struct 函数调用表达式* r3;
  ...
  r7 = r6->参数个数;
  r8 = r5 < r7;
  if (r8) goto for_body_2277; else goto for_exit_2279;
...
void 构建数组访问表达式作用域(struct 作用域构建器* cn_var_构建器, struct 数组访问表达式* cn_var_数组节点) {
  ...
  r0 = cn_var_数组节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2282; else goto if_merge_2283;
...
void 构建标识符表达式作用域(struct 作用域构建器* cn_var_构建器, struct 标识符表达式* cn_var_标识符节点) {
  ...
  r7 = cn_var_符号指针_0;
  r8 = r7 == 0;
  if (r8) goto if_then_2290; else goto if_else_2291;
