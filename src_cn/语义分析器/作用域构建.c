...
void 销毁作用域构建器(struct 作用域构建器* cn_var_构建器) {
  ...
  r0 = cn_var_构建器;
  r1 = r0 == 0;
  if (r1) goto if_then_2111; else goto if_merge_2112;
...
void 构建程序作用域(struct 作用域构建器* cn_var_构建器, struct 程序节点* cn_var_程序) {
  ...
  r4 = r3->声明个数;
  r5 = r2 < r4;
  if (r5) goto for_body_2116; else goto for_exit_2118;
...
void 构建声明作用域(struct 作用域构建器* cn_var_构建器, struct 声明节点* cn_var_声明) {
  ...
  r0 = cn_var_声明;
  r1 = r0 == 0;
  if (r1) goto if_then_2119; else goto if_merge_2120;
  ...
  r4 = r3.类型;
  r5 = r4 == 1;
  if (r5) goto case_body_2122; else goto switch_check_2130;

  switch_check_2130:
  r6 = r4 == 2;
  if (r6) goto case_body_2123; else goto switch_check_2131;

  switch_check_2131:
  r7 = r4 == 3;
  if (r7) goto case_body_2124; else goto switch_check_2132;

  switch_check_2132:
  r8 = r4 == 4;
  if (r8) goto case_body_2125; else goto switch_check_2133;

  switch_check_2133:
  r9 = r4 == 7;
  if (r9) goto case_body_2126; else goto switch_check_2134;

  switch_check_2134:
  r10 = r4 == 8;
  if (r10) goto case_body_2127; else goto switch_check_2135;

  switch_check_2135:
  r11 = r4 == 6;
  if (r11) goto case_body_2128; else goto case_default_2129;

  case_body_2122:
  r12 = cn_var_构建器;
  r13 = cn_var_声明;
  构建函数声明作用域(r12, (struct 函数声明*)cn_var_声明);
  goto switch_merge_2121;
  goto switch_merge_2121;
...
void 构建函数声明作用域(struct 作用域构建器* cn_var_构建器, struct 函数声明* cn_var_函数节点) {
  long long r1, r9, r15, r19, r21, r32, r36, r38, r39, r43, r45, r46, r49;
  char* r5;
  char* r24;
  char* r31;
  void* r7;
  ...
  r0 = cn_var_函数节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2136; else goto if_merge_2137;
  ...
  r20 = 插入符号(r18, r19);
  r21 = r20 == 0;
  if (r21) goto if_then_2138; else goto if_merge_2139;
  ...
  r38 = r37->参数个数;
  r39 = r36 < r38;
  if (r39) goto for_body_2141; else goto for_exit_2143;
  ...
  r48 = r47->函数体;
  r49 = r48 != 0;
  if (r49) goto if_then_2144; else goto if_merge_2145;
...
void 构建参数作用域(struct 作用域构建器* cn_var_构建器, struct 参数* cn_var_参数节点) {
  ...
  r0 = cn_var_参数节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2146; else goto if_merge_2147;
  ...
  r12 = 插入符号(r10, r11);
  r13 = r12 == 0;
  if (r13) goto if_then_2148; else goto if_merge_2149;
...
void 构建变量声明作用域(struct 作用域构建器* cn_var_构建器, struct 变量声明* cn_var_变量节点) {
  long long r1, r8, r16, r20, r22, r31;
  char* r10;
  char* r25;
  struct 变量声明* r0;
  struct 变量声明* r2;
  ...
  r0 = cn_var_变量节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2150; else goto if_merge_2151;
  ...
  r21 = 插入符号(r19, r20);
  r22 = r21 == 0;
  if (r22) goto if_then_2152; else goto if_merge_2153;
  ...
  r30 = r29->初始值;
  r31 = r30 != 0;
  if (r31) goto if_then_2154; else goto if_merge_2155;
...
void 构建结构体声明作用域(struct 作用域构建器* cn_var_构建器, struct 结构体声明* cn_var_结构体节点) {
  long long r1, r10, r12, r23, r28, r30, r31, r33, r35, r36, r39, r41, r42, r43, r44, r48, r51, r52, r53, r54, r57, r59, r60;
  char* r3;
  char* r15;
  char* r22;
  void* r38;
  ...
  r0 = cn_var_结构体节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2156; else goto if_merge_2157;
  ...
  r11 = 插入符号(r9, r10);
  r12 = r11 == 0;
  if (r12) goto if_then_2158; else goto if_merge_2159;
  ...
  r35 = r34->成员个数;
  r36 = r33 < r35;
  if (r36) goto for_body_2161; else goto for_exit_2163;
...
void 构建枚举声明作用域(struct 作用域构建器* cn_var_构建器, struct 枚举声明* cn_var_枚举节点) {
  long long r1, r10, r12, r23, r28, r30, r31, r33, r35, r36, r39, r41, r42, r43, r44, r45, r46, r47, r48, r49, r54, r55, r56, r57, r60, r62, r63, r64, r65;
  char* r3;
  char* r15;
  char* r22;
  void* r38;
  ...
  r11 = 插入符号(r9, r10);
  r12 = r11 == 0;
  if (r12) goto if_then_2166; else goto if_merge_2167;
  ...
  r35 = r34->成员个数;
  r36 = r33 < r35;
  if (r36) goto for_body_2169; else goto for_exit_2171;
  ...
  r41 = cn_var_成员_3;
  r42 = r41.有显式值;
  if (r42) goto if_then_2172; else goto if_merge_2173;
  ...
  r63 = r62 + 1;
  cn_var_当前值_1 = r63;
  goto for_update_2170;
  return;
}

void 构建类声明作用域(struct 作用域构建器* cn_var_构建器, struct 类声明* cn_var_类节点) {
  long long r1, r12, r14, r21, r24, r27, r28, r34, r35, r36, r37, r38, r39, r40, r42, r43, r45, r47, r48, r50, r52, r53, r58, r61, r62, r63, r64, r65, r66, r67, r68, r69, r70, r71, r72, r77, r82, r84, r85, r87, r89, r90, r94, r96, r97, r98, r99;
  char* r3;
  char* r17;
  char* r23;
  char* r26;
  ...
  r13 = 插入符号(r11, r12);
  r14 = r13 == 0;
  if (r14) goto if_then_2176; else goto if_merge_2177;
  ...
  r23 = r22->基类名称;
  r24 = r23 != 0;
  if (r24) goto logic_rhs_2180; else goto logic_merge_2181;
  ...
  r35 = cn_var_父类符号_1;
  r36 = r35 != 0;
  if (r36) goto logic_rhs_2184; else goto logic_merge_2185;

  if_merge_2179:
  r41 = cn_var_类节点;
  r42 = r41->接口个数;
  r43 = r42 > 0;
  if (r43) goto if_then_2186; else goto if_merge_2187;
  ...
  r27 = 获取字符串长度(r26);
  r28 = r27 > 0;
  goto logic_merge_2181;

  logic_merge_2181:
  if (r28) goto if_then_2178; else goto if_merge_2179;
  ...
  r38 = r37.种类;
  r39 = r38 == 6;
  goto logic_merge_2185;

  logic_merge_2185:
  if (r39) goto if_then_2182; else goto if_merge_2183;
  ...
  r52 = r51->接口个数;
  r53 = r50 < r52;
  if (r53) goto for_body_2189; else goto for_exit_2191;

  for_body_2189:
  long long cn_var_接口符号_3;
  r54 = cn_var_构建器;
  r55 = r54->符号表;
  r56 = cn_var_类节点;
  r57 = r56->实现接口;
  ...
  r62 = cn_var_接口符号_3;
  r63 = r62 != 0;
  if (r63) goto logic_rhs_2194; else goto logic_merge_2195;
  ...
  if_merge_2193:
  goto for_update_2190;

  logic_rhs_2194:
  r64 = cn_var_接口符号_3;
  r65 = r64.种类;
  r66 = r65 == 7;
  goto logic_merge_2195;

  logic_merge_2195:
  if (r66) goto if_then_2192; else goto if_merge_2193;
  ...
  r89 = r88->成员个数;
  r90 = r87 < r89;
  if (r90) goto for_body_2197; else goto for_exit_2199;
...
void 构建类成员作用域(struct 作用域构建器* cn_var_构建器, struct 类成员* cn_var_成员节点, struct 符号* cn_var_类符号, long long cn_var_索引) {
  long long r1, r4, r9, r12, r15, r25, r29, r40, r43, r46, r54, r62, r64, r65, r66, r67, r68, r69, r72;
  char* r17;
  char* r48;
  void* r51;
  struct 类成员* r0;
  ...
  r0 = cn_var_成员节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2200; else goto if_merge_2201;
  ...
  r3 = r2->类型;
  r4 = r3 == 2;
  if (r4) goto if_then_2202; else goto if_else_2203;
  ...
  r28 = r27->类型;
  r29 = r28 == 1;
  if (r29) goto if_then_2205; else goto if_merge_2206;

  if_merge_2204:
  r64 = cn_var_成员符号_0;
  r65 = r64 != 0;
  if (r65) goto if_then_2207; else goto if_merge_2208;
...
void 构建接口声明作用域(struct 作用域构建器* cn_var_构建器, struct 接口声明* cn_var_接口节点) {
  long long r1, r10, r12, r23, r28, r30, r31, r33, r35, r36, r38, r39, r41, r42, r43, r44, r45, r46, r47, r48, r52, r54, r55, r56, r57, r60, r62, r63;
  char* r3;
  char* r15;
  char* r22;
  struct 接口声明* r0;
  ...
  r0 = cn_var_接口节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2209; else goto if_merge_2210;
  ...
  r11 = 插入符号(r9, r10);
  r12 = r11 == 0;
  if (r12) goto if_then_2211; else goto if_merge_2212;
  ...
  r35 = r34->方法个数;
  r36 = r33 < r35;
  if (r36) goto for_body_2214; else goto for_exit_2216;
...
void 构建导入声明作用域(struct 作用域构建器* cn_var_构建器, struct 导入声明* cn_var_导入节点) {
  ...
  r0 = cn_var_导入节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2217; else goto if_merge_2218;
...
void 构建语句作用域(struct 作用域构建器* cn_var_构建器, struct 语句节点* cn_var_语句) {
  ...
  r0 = cn_var_语句;
  r1 = r0 == 0;
  if (r1) goto if_then_2219; else goto if_merge_2220;
  ...
  r4 = r3.类型;
  r5 = r4 == 12;
  if (r5) goto case_body_2222; else goto switch_check_2231;

  switch_check_2231:
  r6 = r4 == 13;
  if (r6) goto case_body_2223; else goto switch_check_2232;

  switch_check_2232:
  r7 = r4 == 14;
  if (r7) goto case_body_2224; else goto switch_check_2233;

  switch_check_2233:
  r8 = r4 == 15;
  if (r8) goto case_body_2225; else goto switch_check_2234;

  switch_check_2234:
  r9 = r4 == 19;
  if (r9) goto case_body_2226; else goto switch_check_2235;

  switch_check_2235:
  r10 = r4 == 11;
  if (r10) goto case_body_2227; else goto switch_check_2236;

  switch_check_2236:
  r11 = r4 == 16;
  if (r11) goto case_body_2228; else goto switch_check_2237;

  switch_check_2237:
  r12 = r4 == 20;
  if (r12) goto case_body_2229; else goto case_default_2230;

  case_body_2222:
  r13 = cn_var_构建器;
  r14 = cn_var_语句;
  构建块语句作用域(r13, (struct 块语句*)cn_var_语句);
  goto switch_merge_2221;
  goto switch_merge_2221;
...
void 构建块语句作用域(struct 作用域构建器* cn_var_构建器, struct 块语句* cn_var_块节点) {
  ...
  r0 = cn_var_块节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2238; else goto if_merge_2239;
  ...
  r6 = r5->语句个数;
  r7 = r4 < r6;
  if (r7) goto for_body_2241; else goto for_exit_2243;
...
void 构建如果语句作用域(struct 作用域构建器* cn_var_构建器, struct 如果语句* cn_var_如果节点) {
  ...
  r0 = cn_var_如果节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2244; else goto if_merge_2245;
  ...
  r6 = r5->真分支;
  r7 = r6 != 0;
  if (r7) goto if_then_2246; else goto if_merge_2247;
  ...
  r12 = r11->假分支;
  r13 = r12 != 0;
  if (r13) goto if_then_2248; else goto if_merge_2249;
...
void 构建当语句作用域(struct 作用域构建器* cn_var_构建器, struct 当语句* cn_var_当节点) {
  ...
  r0 = cn_var_当节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2250; else goto if_merge_2251;
  ...
  r10 = r9->循环体;
  r11 = r10 != 0;
  if (r11) goto if_then_2252; else goto if_merge_2253;
...
void 构建循环语句作用域(struct 作用域构建器* cn_var_构建器, struct 循环语句* cn_var_循环节点) {
  ...
  r0 = cn_var_循环节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2254; else goto if_merge_2255;
  ...
  r7 = r6->初始化;
  r8 = r7 != 0;
  if (r8) goto if_then_2256; else goto if_merge_2257;
  ...
  r13 = r12->条件;
  r14 = r13 != 0;
  if (r14) goto if_then_2258; else goto if_merge_2259;
  ...
  r19 = r18->更新;
  r20 = r19 != 0;
  if (r20) goto if_then_2260; else goto if_merge_2261;
  ...
  r25 = r24->循环体;
  r26 = r25 != 0;
  if (r26) goto if_then_2262; else goto if_merge_2263;
...
void 构建选择语句作用域(struct 作用域构建器* cn_var_构建器, struct 选择语句* cn_var_选择节点) {
  ...
  r0 = cn_var_选择节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2264; else goto if_merge_2265;
  ...
  r7 = r6->情况个数;
  r8 = r5 < r7;
  if (r8) goto for_body_2267; else goto for_exit_2269;
  ...
  r17 = r16->默认分支;
  r18 = r17 != 0;
  if (r18) goto if_then_2270; else goto if_merge_2271;
...
void 构建情况分支作用域(struct 作用域构建器* cn_var_构建器, struct 情况分支* cn_var_情况节点) {
  ...
  r0 = cn_var_情况节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2272; else goto if_merge_2273;
  ...
  r6 = r5->语句体;
  r7 = r6 != 0;
  if (r7) goto if_then_2274; else goto if_merge_2275;
...
void 构建返回语句作用域(struct 作用域构建器* cn_var_构建器, struct 返回语句* cn_var_返回节点) {
  ...
  r3 = r2->返回值;
  r4 = r3 != 0;
  if (r4) goto if_then_2278; else goto if_merge_2279;
...
void 构建尝试语句作用域(struct 作用域构建器* cn_var_构建器, struct 尝试语句* cn_var_尝试节点) {
  ...
  r0 = cn_var_尝试节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2280; else goto if_merge_2281;
  ...
  r3 = r2->尝试块;
  r4 = r3 != 0;
  if (r4) goto if_then_2282; else goto if_merge_2283;
  ...
  r10 = r9->捕获个数;
  r11 = r8 < r10;
  if (r11) goto for_body_2285; else goto for_exit_2287;
  ...
  r20 = r19->最终块;
  r21 = r20 != 0;
  if (r21) goto if_then_2288; else goto if_merge_2289;
...
void 构建捕获子句作用域(struct 作用域构建器* cn_var_构建器, struct 捕获子句* cn_var_捕获节点) {
  ...
  r5 = r4->语句体;
  r6 = r5 != 0;
  if (r6) goto if_then_2292; else goto if_merge_2293;
...
void 构建表达式作用域(struct 作用域构建器* cn_var_构建器, struct 表达式节点* cn_var_表达式) {
  ...
  r0 = cn_var_表达式;
  r1 = r0 == 0;
  if (r1) goto if_then_2294; else goto if_merge_2295;
  ...
  r4 = r3.类型;
  r5 = r4 == 23;
  if (r5) goto case_body_2297; else goto switch_check_2306;

  switch_check_2306:
  r6 = r4 == 24;
  if (r6) goto case_body_2298; else goto switch_check_2307;

  switch_check_2307:
  r7 = r4 == 27;
  if (r7) goto case_body_2299; else goto switch_check_2308;

  switch_check_2308:
  r8 = r4 == 28;
  if (r8) goto case_body_2300; else goto switch_check_2309;

  switch_check_2309:
  r9 = r4 == 29;
  if (r9) goto case_body_2301; else goto switch_check_2310;

  switch_check_2310:
  r10 = r4 == 30;
  if (r10) goto case_body_2302; else goto switch_check_2311;

  switch_check_2311:
  r11 = r4 == 31;
  if (r11) goto case_body_2303; else goto switch_check_2312;

  switch_check_2312:
  r12 = r4 == 26;
  if (r12) goto case_body_2304; else goto case_default_2305;

  case_body_2297:
  r13 = cn_var_构建器;
  r14 = cn_var_表达式;
  构建二元表达式作用域(r13, (struct 二元表达式*)cn_var_表达式);
  goto switch_merge_2296;
  goto switch_merge_2296;
...
void 构建二元表达式作用域(struct 作用域构建器* cn_var_构建器, struct 二元表达式* cn_var_二元节点) {
  ...
  r0 = cn_var_二元节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2313; else goto if_merge_2314;
...
void 构建函数调用表达式作用域(struct 作用域构建器* cn_var_构建器, struct 函数调用表达式* cn_var_调用节点) {
  ...
  r0 = cn_var_调用节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2317; else goto if_merge_2318;
  ...
  r7 = r6->参数个数;
  r8 = r5 < r7;
  if (r8) goto for_body_2320; else goto for_exit_2322;
...
void 构建数组访问表达式作用域(struct 作用域构建器* cn_var_构建器, struct 数组访问表达式* cn_var_数组节点) {
  ...
  r0 = cn_var_数组节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2325; else goto if_merge_2326;
...
void 构建三元表达式作用域(struct 作用域构建器* cn_var_构建器, struct 三元表达式* cn_var_三元节点) {
  ...
  r0 = cn_var_三元节点;
  r1 = r0 == 0;
  if (r1) goto if_then_2329; else goto if_merge_2330;
...
void 构建标识符表达式作用域(struct 作用域构建器* cn_var_构建器, struct 标识符表达式* cn_var_标识符节点) {
  ...
  r7 = cn_var_符号指针_0;
  r8 = r7 == 0;
  if (r8) goto if_then_2333; else goto if_else_2334;
