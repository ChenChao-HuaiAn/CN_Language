...
void 构建函数声明作用域(struct 作用域构建器* cn_var_构建器, struct 函数声明* cn_var_函数节点) {
  long long r1, r4, r5, r6, r7, r8, r9, r10, r12, r15, r17, r18, r19, r20, r21, r23, r24, r25, r26, r27, r29, r30, r32, r33, r34, r35, r37, r38;
  struct 函数声明* r0;
  struct 函数声明* r2;
  struct 符号* r11;
  struct 作用域构建器* r16;
...
void 构建参数作用域(struct 作用域构建器* cn_var_构建器, struct 参数* cn_var_参数节点) {
  long long r1, r2, r3, r4, r6, r9, r11, r12;
  struct 参数* r0;
  struct 符号* r5;
  struct 作用域构建器* r10;
  _Bool r8;
...
void 构建变量声明作用域(struct 作用域构建器* cn_var_构建器, struct 变量声明* cn_var_变量节点) {
  long long r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r12, r15, r17, r18, r19, r20, r21, r23;
  struct 变量声明* r0;
  struct 符号* r11;
  struct 作用域构建器* r16;
  struct 作用域构建器* r22;
...
void 构建结构体声明作用域(struct 作用域构建器* cn_var_构建器, struct 结构体声明* cn_var_结构体节点) {
  long long r1, r2, r3, r4, r6, r9, r11, r12, r13, r14, r15, r17, r18, r19, r20, r21, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r36, r37, r38, r39, r40, r42, r43, r44;
  struct 结构体声明* r0;
  struct 符号* r5;
  struct 作用域构建器* r10;
  void* r22;
...
void 构建枚举声明作用域(struct 作用域构建器* cn_var_构建器, struct 枚举声明* cn_var_枚举节点) {
  long long r1, r2, r3, r4, r6, r9, r11, r12, r13, r14, r15, r17, r18, r19, r20, r21, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r37, r38, r39, r40, r41, r43, r44, r45, r46, r47;
  struct 枚举声明* r0;
  struct 符号* r5;
  struct 作用域构建器* r10;
  void* r22;
...
void 构建类声明作用域(struct 作用域构建器* cn_var_构建器, struct 类声明* cn_var_类节点) {
  long long r1, r2, r3, r4, r5, r7, r10, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r36, r37, r38, r39, r40, r41, r44, r46, r47, r48, r50, r51, r52, r53, r54, r55, r57, r58, r59, r60, r61, r63, r64, r65, r67, r68, r71, r72, r73, r74;
  struct 类声明* r0;
  struct 符号* r6;
  struct 作用域构建器* r11;
  struct 符号* r23;
...
void 构建类成员作用域(struct 作用域构建器* cn_var_构建器, struct 类成员* cn_var_成员节点, struct 符号* cn_var_类符号, long long cn_var_索引) {
  long long r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r43, r44, r45, r46, r47, r48, r49;
  struct 类成员* r0;
  struct 符号* r18;
  struct 符号* r42;
  _Bool r50;
...
void 构建接口声明作用域(struct 作用域构建器* cn_var_构建器, struct 接口声明* cn_var_接口节点) {
  long long r1, r2, r3, r4, r6, r9, r11, r12, r13, r14, r15, r17, r18, r19, r20, r21, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r37, r38, r39, r40, r41, r43, r44, r45;
  struct 接口声明* r0;
  struct 符号* r5;
  struct 作用域构建器* r10;
  void* r22;
...
void 构建块语句作用域(struct 作用域构建器* cn_var_构建器, struct 块语句* cn_var_块节点) {
  long long r1, r2, r3, r4, r5, r7, r8, r10, r11, r12;
  struct 块语句* r0;
  struct 作用域构建器* r6;
  void* r9;
...
void 构建如果语句作用域(struct 作用域构建器* cn_var_构建器, struct 如果语句* cn_var_如果节点) {
  long long r1, r3, r4, r5, r7, r8, r9, r11;
  struct 如果语句* r0;
  struct 作用域构建器* r2;
  struct 作用域构建器* r6;
  struct 作用域构建器* r10;
...
void 构建当语句作用域(struct 作用域构建器* cn_var_构建器, struct 当语句* cn_var_当节点) {
  long long r1, r3, r4, r5, r6, r7, r9, r10;
  struct 当语句* r0;
  struct 作用域构建器* r2;
  struct 作用域构建器* r8;
...
void 构建循环语句作用域(struct 作用域构建器* cn_var_构建器, struct 循环语句* cn_var_循环节点) {
  long long r1, r2, r3, r4, r5, r7, r8, r9, r11, r12, r13, r15, r16, r17, r19, r20;
  struct 循环语句* r0;
  struct 作用域构建器* r6;
  struct 作用域构建器* r10;
  struct 作用域构建器* r14;
...
void 构建选择语句作用域(struct 作用域构建器* cn_var_构建器, struct 选择语句* cn_var_选择节点) {
  long long r1, r3, r4, r5, r6, r8, r9, r11, r12, r13, r14, r16;
  struct 选择语句* r0;
  struct 作用域构建器* r2;
  struct 作用域构建器* r7;
  void* r10;
...
void 构建函数调用表达式作用域(struct 作用域构建器* cn_var_构建器, struct 函数调用表达式* cn_var_调用节点) {
  long long r1, r3, r4, r5, r6, r8, r9, r11, r12;
  struct 函数调用表达式* r0;
  struct 作用域构建器* r2;
  struct 作用域构建器* r7;
  void* r10;
...
void 构建标识符表达式作用域(struct 作用域构建器* cn_var_构建器, struct 标识符表达式* cn_var_标识符节点) {
  long long r1, r2, r3, r5, r6, r8, r9, r10;
  struct 标识符表达式* r0;
  struct 符号* r4;
  struct 作用域构建器* r7;
