...
void 销毁作用域(struct 作用域* cn_var_作用域指针) {
  long long r1, r2, r4, r5, r8, r10, r11, r12, r14, r15, r18, r20, r21;
  void* r7;
  void* r17;
  void* r23;
  void* r25;
  ...
  r0 = cn_var_作用域指针;
  r1 = r0 == 0;
  if (r1) goto if_then_1770; else goto if_merge_1771;
  ...
  r4 = r3->子作用域数量;
  r5 = r2 < r4;
  if (r5) goto for_body_1773; else goto for_exit_1775;
  ...
  r14 = r13->符号数量;
  r15 = r12 < r14;
  if (r15) goto for_body_1777; else goto for_exit_1779;
...
void 进入作用域(struct 符号表管理器* cn_var_管理器, enum 作用域类型 cn_var_类型, char* cn_var_名称, struct 符号* cn_var_关联符号) {
  long long r8, r11, r12, r15, r16, r22, r23, r24, r26, r32, r35, r36, r37, r39, r40;
  char* r1;
  void* r19;
  void* r29;
  struct 符号表管理器* r2;
  ...
  r11 = r10->子作用域容量;
  r12 = r8 >= r11;
  if (r12) goto if_then_1782; else goto if_merge_1783;
  ...
  r31 = r30->当前作用域;
  r32 = r31->子作用域数量;
    { long long _tmp_r5 = r26; cn_rt_array_set_element(r29, r32, &_tmp_r5, 8); }
  r33 = cn_var_管理器;
  r34 = r33->当前作用域;
  r35 = r34->子作用域数量;
  r36 = r35 + 1;
...
void 离开作用域(struct 符号表管理器* cn_var_管理器) {
  ...
  r2 = r1->父作用域;
  r3 = r2 != 0;
  if (r3) goto if_then_1784; else goto if_merge_1785;
...
_Bool 在循环体内(struct 符号表管理器* cn_var_管理器) {
  ...
  r1 = r0->当前作用域;
  cn_var_作用域指针_0 = r1;
  goto while_cond_1786;

  while_cond_1786:
  r2 = cn_var_作用域指针_0;
  r3 = r2 != 0;
  if (r3) goto while_body_1787; else goto while_exit_1788;

  while_body_1787:
  r4 = cn_var_作用域指针_0;
  r5 = r4.是循环体;
  if (r5) goto if_then_1789; else goto if_merge_1790;
...
_Bool 插入符号(struct 符号表管理器* cn_var_管理器, struct 符号* cn_var_符号指针) {
  long long r4, r5, r7, r8, r11, r14, r15, r18, r19, r25, r26, r27, r35, r38, r39;
  char* r2;
  void* r22;
  void* r32;
  struct 符号表管理器* r0;
  ...
  r4 = cn_var_已存在_0;
  r5 = r4 != 0;
  if (r5) goto if_then_1791; else goto if_merge_1792;
  ...
  r14 = r13->符号容量;
  r15 = r11 >= r14;
  if (r15) goto if_then_1793; else goto if_merge_1794;
  ...
  r34 = r33->当前作用域;
  r35 = r34->符号数量;
    { long long _tmp_r6 = r29; cn_rt_array_set_element(r32, r35, &_tmp_r6, 8); }
  r36 = cn_var_管理器;
  r37 = r36->当前作用域;
  r38 = r37->符号数量;
  r39 = r38 + 1;
...
_Bool 在作用域插入符号(struct 作用域* cn_var_目标作用域, struct 符号* cn_var_符号指针) {
  long long r0, r2, r3, r6, r8, r11, r12, r13, r14, r16, r18, r19, r21, r22, r26, r27, r28, r34, r36, r37;
  char* r10;
  void* r5;
  void* r24;
  void* r32;
  ...
  r2 = r1->符号数量;
  r3 = r0 < r2;
  if (r3) goto for_body_1796; else goto for_exit_1798;
  ...
  r11 = 比较字符串(r8, r10);
  r12 = r11 == 0;
  if (r12) goto if_then_1799; else goto if_merge_1800;
  ...
  r18 = r17->符号容量;
  r19 = r16 >= r18;
  if (r19) goto if_then_1801; else goto if_merge_1802;
  ...
  r33 = cn_var_目标作用域;
  r34 = r33->符号数量;
    { long long _tmp_r7 = r30; cn_rt_array_set_element(r32, r34, &_tmp_r7, 8); }
  r35 = cn_var_目标作用域;
  r36 = r35->符号数量;
  r37 = r36 + 1;
  r38 = cn_var_目标作用域;
...
struct 符号* 查找当前作用域符号(struct 符号表管理器* cn_var_管理器, char* cn_var_名称) {
  long long r0, r3, r4, r8, r10, r12, r13, r17, r19, r20;
  char* r11;
  void* r7;
  void* r16;
  struct 符号表管理器* r1;
  ...
  r3 = r2->符号数量;
  r4 = r0 < r3;
  if (r4) goto for_body_1804; else goto for_exit_1806;
  ...
  r12 = 比较字符串(r10, r11);
  r13 = r12 == 0;
  if (r13) goto if_then_1807; else goto if_merge_1808;
  ...
  if_merge_1808:
  goto for_update_1805;
  return NULL;
}

struct 符号* 查找符号(struct 符号表管理器* cn_var_管理器, char* cn_var_名称) {
  long long r2, r3, r4, r5, r6, r7, r8, r9, r10, r12, r14, r15, r16, r17, r18, r20, r21, r22, r23;
  char* r13;
  struct 符号表管理器* r0;
  struct 作用域* r1;
  void* r11;
  ...
  r1 = r0->当前作用域;
  cn_var_作用域指针_0 = r1;
  goto while_cond_1809;

  while_cond_1809:
  r2 = cn_var_作用域指针_0;
  r3 = r2 != 0;
  if (r3) goto while_body_1810; else goto while_exit_1811;
  ...
  r6 = r5.符号数量;
  r7 = r4 < r6;
  if (r7) goto for_body_1813; else goto for_exit_1815;
  ...
  r14 = 比较字符串(r12, r13);
  r15 = r14 == 0;
  if (r15) goto if_then_1816; else goto if_merge_1817;
...
struct 符号* 查找全局符号(struct 符号表管理器* cn_var_管理器, char* cn_var_名称) {
  ...
  r3 = r2->符号数量;
  r4 = r0 < r3;
  if (r4) goto for_body_1819; else goto for_exit_1821;
  ...
  r12 = 比较字符串(r10, r11);
  r13 = r12 == 0;
  if (r13) goto if_then_1822; else goto if_merge_1823;
...
struct 符号* 在作用域查找符号(struct 作用域* cn_var_目标作用域, char* cn_var_名称) {
  ...
  r2 = r1->符号数量;
  r3 = r0 < r2;
  if (r3) goto for_body_1825; else goto for_exit_1827;
  ...
  r10 = 比较字符串(r8, r9);
  r11 = r10 == 0;
  if (r11) goto if_then_1828; else goto if_merge_1829;
  ...
  if_merge_1829:
  goto for_update_1826;
  return NULL;
}

struct 符号* 查找类成员(struct 符号* cn_var_类符号, char* cn_var_成员名) {
  long long r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32;
...
char* 获取符号类型名称(enum 符号类型 cn_var_类型) {
  ...
  r0 = cn_var_类型;
  r1 = r0 == 0;
  if (r1) goto case_body_1843; else goto switch_check_1856;

  switch_check_1856:
  r2 = r0 == 1;
  if (r2) goto case_body_1844; else goto switch_check_1857;

  switch_check_1857:
  r3 = r0 == 2;
  if (r3) goto case_body_1845; else goto switch_check_1858;

  switch_check_1858:
  r4 = r0 == 3;
  if (r4) goto case_body_1846; else goto switch_check_1859;

  switch_check_1859:
  r5 = r0 == 4;
  if (r5) goto case_body_1847; else goto switch_check_1860;

  switch_check_1860:
  r6 = r0 == 5;
  if (r6) goto case_body_1848; else goto switch_check_1861;

  switch_check_1861:
  r7 = r0 == 6;
  if (r7) goto case_body_1849; else goto switch_check_1862;

  switch_check_1862:
  r8 = r0 == 7;
  if (r8) goto case_body_1850; else goto switch_check_1863;

  switch_check_1863:
  r9 = r0 == 8;
  if (r9) goto case_body_1851; else goto switch_check_1864;

  switch_check_1864:
  r10 = r0 == 9;
  if (r10) goto case_body_1852; else goto switch_check_1865;

  switch_check_1865:
  r11 = r0 == 10;
  if (r11) goto case_body_1853; else goto switch_check_1866;

  switch_check_1866:
  r12 = r0 == 11;
  if (r12) goto case_body_1854; else goto case_default_1855;

  case_body_1843:
  return "变量";
  goto switch_merge_1842;
...
char* 获取作用域类型名称(enum 作用域类型 cn_var_类型) {
  ...
  r0 = cn_var_类型;
  r1 = r0 == 0;
  if (r1) goto case_body_1868; else goto switch_check_1877;

  switch_check_1877:
  r2 = r0 == 1;
  if (r2) goto case_body_1869; else goto switch_check_1878;

  switch_check_1878:
  r3 = r0 == 2;
  if (r3) goto case_body_1870; else goto switch_check_1879;

  switch_check_1879:
  r4 = r0 == 3;
  if (r4) goto case_body_1871; else goto switch_check_1880;

  switch_check_1880:
  r5 = r0 == 4;
  if (r5) goto case_body_1872; else goto switch_check_1881;

  switch_check_1881:
  r6 = r0 == 5;
  if (r6) goto case_body_1873; else goto switch_check_1882;

  switch_check_1882:
  r7 = r0 == 6;
  if (r7) goto case_body_1874; else goto switch_check_1883;

  switch_check_1883:
  r8 = r0 == 7;
  if (r8) goto case_body_1875; else goto case_default_1876;

  case_body_1868:
  return "全局";
  goto switch_merge_1867;
...
_Bool 检查符号可访问性(struct 符号* cn_var_符号指针, struct 作用域* cn_var_访问者作用域) {
  ...
  r1 = r0->标志;
  r2 = r1.是公开;
  if (r2) goto if_then_1884; else goto if_merge_1885;
  ...
  r4 = r3->标志;
  r5 = r4.是私有;
  if (r5) goto if_then_1886; else goto if_merge_1887;
  ...
  r11 = r10->标志;
  r12 = r11.是保护;
  if (r12) goto if_then_1888; else goto if_merge_1889;

  if_then_1888:
  long long cn_var_当前_0;
  r13 = cn_var_访问者作用域;
  cn_var_当前_0 = r13;
  goto while_cond_1890;
  ...
  r14 = cn_var_当前_0;
  r15 = r14 != 0;
  if (r15) goto while_body_1891; else goto while_exit_1892;
  ...
  r18 = r17->所属作用域;
  r19 = r16 == r18;
  if (r19) goto if_then_1893; else goto if_merge_1894;
