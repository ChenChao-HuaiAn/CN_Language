...
struct 符号* 创建变量符号(const char* cn_var_名称, struct 类型节点* cn_var_类型, struct 源位置 cn_var_位置, struct 符号标志 cn_var_标志) {
  ...
  r0 = cn_var_符号大小;
  r1 = 分配内存(r0);
/* P7DBG_STORE src1.kind=7 */  cn_var_符号指针_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 符号*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(/* P7DBG_expr kind=2 */cn_var_符号大小);
  r2 = cn_var_名称;
  r3 = cn_var_类型;
  r4 = cn_var_位置;
  r5 = cn_var_标志;
...
struct 作用域* 创建作用域(enum 作用域类型 cn_var_类型, const char* cn_var_名称, struct 作用域* cn_var_父作用域) {
  ...
  r0 = cn_var_作用域大小;
  r1 = 分配清零内存(1, r0);
/* P7DBG_STORE src1.kind=7 */  cn_var_作用域指针_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 作用域*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配清零内存(1, /* P7DBG_expr kind=2 */cn_var_作用域大小);
  r2 = cn_var_类型;
  r3 = cn_var_名称;
  r4 = cn_var_父作用域;
  r5 = cn_var_初始符号容量;
...
struct 符号表管理器* 创建符号表管理器() {
  ...
  r0 = cn_var_符号表管理器大小;
  r1 = 分配清零内存(1, r0);
/* P7DBG_STORE src1.kind=7 */  cn_var_管理器_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 符号表管理器*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配清零内存(1, /* P7DBG_expr kind=2 */cn_var_符号表管理器大小);
...
void 进入作用域(struct 符号表管理器* cn_var_管理器, enum 作用域类型 cn_var_类型, const char* cn_var_名称, struct 符号* cn_var_关联符号) {
  ...
  r2 = cn_var_管理器->当前作用域;
  r3 = 创建作用域(r0, r1, r2);
/* P7DBG_STORE src1.kind=1 */  cn_var_新作用域_0 = r3;
  r4 = cn_var_关联符号;
  r5 = cn_var_管理器->当前作用域;
  r6 = r5->子作用域数量;
  r7 = cn_var_管理器->当前作用域;
