...
void 检查程序(struct 语义检查上下文* cn_var_上下文, struct 程序节点* cn_var_程序) {
  ...
  r4 = r3->声明个数;
  r5 = r2 < r4;
  if (r5) goto for_body_2394; else goto for_exit_2396;
...
void 检查声明(struct 语义检查上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  r5 = cn_var_节点类型值_0;
  r6 = r5 == 节点类型_函数声明;
  if (r6) goto case_body_2400; else goto switch_check_2407;

  switch_check_2407:
  r7 = r5 == 节点类型_变量声明;
  if (r7) goto case_body_2401; else goto switch_check_2408;

  switch_check_2408:
  r8 = r5 == 节点类型_结构体声明;
  if (r8) goto case_body_2402; else goto switch_check_2409;

  switch_check_2409:
  r9 = r5 == 节点类型_枚举声明;
  if (r9) goto case_body_2403; else goto switch_check_2410;

  switch_check_2410:
  r10 = r5 == 节点类型_类声明;
  if (r10) goto case_body_2404; else goto switch_check_2411;

  switch_check_2411:
  r11 = r5 == 节点类型_接口声明;
  if (r11) goto case_body_2405; else goto case_default_2406;
...
void 检查函数声明(struct 语义检查上下文* cn_var_上下文, struct 函数声明* cn_var_函数节点) {
  ...
  r20 = r19->参数个数;
  r21 = r18 < r20;
  if (r21) goto for_body_2415; else goto for_exit_2417;
  ...
  r30 = r29->函数体;
  r31 = r30 != 0;
  if (r31) goto if_then_2418; else goto if_merge_2419;
  ...
  r37 = r36->期望返回类型;
  r38 = r37 != 0;
  if (r38) goto logic_rhs_2422; else goto logic_merge_2423;

  if_then_2420:
  r44 = cn_var_上下文;
  r45 = r44->有返回语句;
  r46 = r45 == 0;
  if (r46) goto logic_rhs_2426; else goto logic_merge_2427;
  ...
  logic_merge_2423:
  if (r42) goto if_then_2420; else goto if_merge_2421;
  ...
  logic_merge_2427:
  if (r49) goto if_then_2424; else goto if_merge_2425;
  return;
}
...
void 检查参数(struct 语义检查上下文* cn_var_上下文, struct 参数* cn_var_参数节点) {
  ...
  r11 = cn_var_类型_0;
  r12 = r11 == 0;
  if (r12) goto if_then_2432; else goto if_merge_2433;
  ...
  logic_merge_2431:
  if (r5) goto if_then_2428; else goto if_merge_2429;

  if_then_2432:
  r13 = cn_var_上下文;
  r14 = cn_var_参数节点;
  r15 = r14->定义位置;
  报告错误(r13, r15, 诊断错误码_语义_未定义标识符);
  goto if_merge_2433;
...
void 检查变量声明(struct 语义检查上下文* cn_var_上下文, struct 变量声明* cn_var_变量节点) {
  ...
  r2 = cn_var_变量节点;
  r3 = r2->是常量;
  if (r3) goto if_then_2436; else goto if_merge_2437;

  if_then_2436:
  r4 = cn_var_变量节点;
  r5 = r4->初始值;
  r6 = r5 == 0;
  if (r6) goto if_then_2438; else goto if_else_2439;

  if_merge_2437:
  r19 = cn_var_变量节点;
  r20 = r19->是静态;
  if (r20) goto if_then_2443; else goto if_merge_2444;
  ...
  r13 = 是常量表达式(r12);
  r14 = r13 == 0;
  if (r14) goto if_then_2441; else goto if_merge_2442;
  ...
  r17 = r16->节点基类;
  r18 = r17.位置;
  报告错误(r15, r18, 诊断错误码_语义_常量非常量初始化);
  goto if_merge_2442;
  ...
  r22 = r21->初始值;
  r23 = r22 != 0;
  if (r23) goto if_then_2445; else goto if_merge_2446;
  ...
  r50 = r49->初始值;
  r51 = r50 != 0;
  if (r51) goto if_then_2455; else goto if_merge_2456;
  ...
  r26 = 是常量表达式(r25);
  r27 = r26 == 0;
  if (r27) goto if_then_2447; else goto if_merge_2448;

  if_merge_2446:
  r33 = cn_var_变量节点;
  r34 = r33->类型;
  r35 = r34 != 0;
  if (r35) goto logic_rhs_2451; else goto logic_merge_2452;
  ...
  r30 = r29->节点基类;
  r31 = r30.位置;
  报告错误(r28, r31, 诊断错误码_语义_静态非常量初始化);
  goto if_merge_2448;
  ...
  r43 = 比较字符串(r42, "空类型");
  r44 = r43 == 0;
  if (r44) goto if_then_2453; else goto if_merge_2454;
  ...
  logic_merge_2452:
  if (r39) goto if_then_2449; else goto if_merge_2450;
  ...
  r57 = r56->类型;
  r58 = r57 != 0;
  if (r58) goto if_then_2457; else goto if_else_2458;
  ...
  r64 = cn_var_类型_1;
  r65 = r64 == 0;
  if (r65) goto if_then_2460; else goto if_merge_2461;

  if_else_2458:
  r88 = cn_var_推断类型_0;
  r89 = r88 != 0;
  if (r89) goto if_then_2468; else goto if_merge_2469;
  ...
  r68 = r67->节点基类;
  r69 = r68.位置;
  报告错误(r66, r69, 诊断错误码_语义_未定义标识符);
  goto if_merge_2461;

  if_merge_2461:
  r70 = cn_var_推断类型_0;
  r71 = r70 != 0;
  if (r71) goto if_then_2462; else goto if_merge_2463;
  ...
  r77 = cn_var_变量类型_2;
  r78 = r77 != 0;
  if (r78) goto if_then_2464; else goto if_merge_2465;
  ...
  r82 = cn_var_兼容性_3;
  r83 = r82 == 类型兼容性_不兼容;
  if (r83) goto if_then_2466; else goto if_merge_2467;
  ...
  r97 = cn_var_符号指针_4;
  r98 = r97 != 0;
  if (r98) goto if_then_2470; else goto if_merge_2471;
...
void 检查结构体声明(struct 语义检查上下文* cn_var_上下文, struct 结构体声明* cn_var_结构体节点) {
  ...
  r11 = r10.类型;
  r12 = r11 != 0;
  if (r12) goto if_then_2478; else goto if_merge_2479;
  ...
  r18 = cn_var_类型_2;
  r19 = r18 == 0;
  if (r19) goto if_then_2480; else goto if_merge_2481;
...
void 检查枚举声明(struct 语义检查上下文* cn_var_上下文, struct 枚举声明* cn_var_枚举节点) {
  ...
  r4 = r3->成员个数;
  r5 = r2 < r4;
  if (r5) goto for_body_2485; else goto for_exit_2487;
  ...
  r10 = r9->成员个数;
  r11 = r8 < r10;
  if (r11) goto for_body_2489; else goto for_exit_2491;
  ...
  r22 = 比较字符串(r16, r21);
  r23 = r22 == 0;
  if (r23) goto if_then_2492; else goto if_merge_2493;
...
void 检查类声明(struct 语义检查上下文* cn_var_上下文, struct 类声明* cn_var_类节点) {
  long long r1, r2, r5, r8, r9, r15, r16, r17, r18, r19, r20, r25, r27, r28, r33, r36, r38, r40, r41, r46, r47, r48, r50, r51, r55, r57, r58;
  char* r4;
  char* r7;
  char* r13;
  void* r32;
  ...
  r4 = r3->基类名称;
  r5 = r4 != 0;
  if (r5) goto logic_rhs_2498; else goto logic_merge_2499;
  ...
  r16 = cn_var_父类符号_0;
  r17 = r16 == 0;
  if (r17) goto logic_merge_2503; else goto logic_rhs_2502;
  ...
  logic_merge_2499:
  if (r9) goto if_then_2496; else goto if_merge_2497;
  ...
  logic_merge_2503:
  if (r20) goto if_then_2500; else goto if_merge_2501;
  ...
  r27 = r26->接口个数;
  r28 = r25 < r27;
  if (r28) goto for_body_2505; else goto for_exit_2507;
  ...
  r37 = cn_var_接口符号_2;
  r38 = r37 == 0;
  if (r38) goto logic_merge_2511; else goto logic_rhs_2510;
  ...
  logic_merge_2511:
  if (r41) goto if_then_2508; else goto if_merge_2509;
  ...
  r50 = r49->成员个数;
  r51 = r48 < r50;
  if (r51) goto for_body_2513; else goto for_exit_2515;
...
void 检查类成员(struct 语义检查上下文* cn_var_上下文, struct 类成员* cn_var_成员节点) {
  ...
  r3 = r2->类型;
  r4 = r3 == 节点类型_变量声明;
  if (r4) goto if_then_2518; else goto if_else_2519;
  ...
  r9 = r8->类型;
  r10 = r9 == 节点类型_函数声明;
  if (r10) goto if_then_2521; else goto if_merge_2522;
...
void 检查接口声明(struct 语义检查上下文* cn_var_上下文, struct 接口声明* cn_var_接口节点) {
  ...
  r4 = r3->方法个数;
  r5 = r2 < r4;
  if (r5) goto for_body_2526; else goto for_exit_2528;
  ...
  r12 = r11.参数个数;
  r13 = r10 < r12;
  if (r13) goto for_body_2530; else goto for_exit_2532;
  ...
  r18 = r17->类型;
  r19 = r18 != 0;
  if (r19) goto if_then_2533; else goto if_merge_2534;
  ...
  r37 = r36.返回类型;
  r38 = r37 != 0;
  if (r38) goto if_then_2537; else goto if_merge_2538;
  ...
  r28 = cn_var_类型_3;
  r29 = r28 == 0;
  if (r29) goto if_then_2535; else goto if_merge_2536;
  ...
  r44 = cn_var_类型_4;
  r45 = r44 == 0;
  if (r45) goto if_then_2539; else goto if_merge_2540;
...
void 检查语句(struct 语义检查上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r4 = r3.类型;
  r5 = r4 == 节点类型_块语句;
  if (r5) goto case_body_2544; else goto switch_check_2556;

  switch_check_2556:
  r6 = r4 == 节点类型_如果语句;
  if (r6) goto case_body_2545; else goto switch_check_2557;

  switch_check_2557:
  r7 = r4 == 节点类型_当语句;
  if (r7) goto case_body_2546; else goto switch_check_2558;

  switch_check_2558:
  r8 = r4 == 节点类型_循环语句;
  if (r8) goto case_body_2547; else goto switch_check_2559;

  switch_check_2559:
  r9 = r4 == 节点类型_返回语句;
  if (r9) goto case_body_2548; else goto switch_check_2560;

  switch_check_2560:
  r10 = r4 == 节点类型_中断语句;
  if (r10) goto case_body_2549; else goto switch_check_2561;

  switch_check_2561:
  r11 = r4 == 节点类型_继续语句;
  if (r11) goto case_body_2550; else goto switch_check_2562;

  switch_check_2562:
  r12 = r4 == 节点类型_选择语句;
  if (r12) goto case_body_2551; else goto switch_check_2563;

  switch_check_2563:
  r13 = r4 == 节点类型_表达式语句;
  if (r13) goto case_body_2552; else goto switch_check_2564;

  switch_check_2564:
  r14 = r4 == 节点类型_尝试语句;
  if (r14) goto case_body_2553; else goto switch_check_2565;

  switch_check_2565:
  r15 = r4 == 节点类型_抛出语句;
  if (r15) goto case_body_2554; else goto case_default_2555;
...
void 检查块语句(struct 语义检查上下文* cn_var_上下文, struct 块语句* cn_var_块节点) {
  ...
  r4 = r3->语句个数;
  r5 = r2 < r4;
  if (r5) goto for_body_2569; else goto for_exit_2571;
...
void 检查如果语句(struct 语义检查上下文* cn_var_上下文, struct 如果语句* cn_var_如果节点) {
  ...
  r7 = cn_var_条件类型_0;
  r8 = r7 != 0;
  if (r8) goto logic_rhs_2576; else goto logic_merge_2577;
  ...
  r18 = r17->真分支;
  r19 = r18 != 0;
  if (r19) goto if_then_2578; else goto if_merge_2579;
  ...
  logic_merge_2577:
  if (r11) goto if_then_2574; else goto if_merge_2575;
  ...
  r24 = r23->假分支;
  r25 = r24 != 0;
  if (r25) goto if_then_2580; else goto if_merge_2581;
...
void 检查当语句(struct 语义检查上下文* cn_var_上下文, struct 当语句* cn_var_当节点) {
  ...
  r7 = cn_var_条件类型_0;
  r8 = r7 != 0;
  if (r8) goto logic_rhs_2586; else goto logic_merge_2587;
  ...
  r21 = r20->循环体;
  r22 = r21 != 0;
  if (r22) goto if_then_2588; else goto if_merge_2589;
  ...
  logic_merge_2587:
  if (r11) goto if_then_2584; else goto if_merge_2585;
...
void 检查循环语句(struct 语义检查上下文* cn_var_上下文, struct 循环语句* cn_var_循环节点) {
  ...
  r9 = r8->条件;
  r10 = r9 != 0;
  if (r10) goto if_then_2594; else goto if_merge_2595;
  ...
  r16 = cn_var_条件类型_0;
  r17 = r16 != 0;
  if (r17) goto logic_rhs_2598; else goto logic_merge_2599;

  if_merge_2595:
  r26 = cn_var_循环节点;
  r27 = r26->更新;
  r28 = r27 != 0;
  if (r28) goto if_then_2600; else goto if_merge_2601;
  ...
  logic_merge_2599:
  if (r20) goto if_then_2596; else goto if_merge_2597;
  ...
  r37 = r36->循环体;
  r38 = r37 != 0;
  if (r38) goto if_then_2602; else goto if_merge_2603;
...
void 检查返回语句(struct 语义检查上下文* cn_var_上下文, struct 返回语句* cn_var_返回节点) {
  ...
  r3 = r2->当前函数;
  r4 = r3 == 0;
  if (r4) goto if_then_2606; else goto if_merge_2607;
  ...
  r10 = r9->返回值;
  r11 = r10 != 0;
  if (r11) goto if_then_2608; else goto if_else_2609;
  ...
  r18 = r17->期望返回类型;
  r19 = r18 != 0;
  if (r19) goto logic_rhs_2613; else goto logic_merge_2614;

  if_else_2609:
  r33 = cn_var_上下文;
  r34 = r33->期望返回类型;
  r35 = r34 != 0;
  if (r35) goto logic_rhs_2619; else goto logic_merge_2620;
  ...
  r26 = cn_var_兼容性_1;
  r27 = r26 == 类型兼容性_不兼容;
  if (r27) goto if_then_2615; else goto if_merge_2616;
  ...
  logic_merge_2614:
  if (r21) goto if_then_2611; else goto if_merge_2612;
  ...
  logic_merge_2620:
  if (r39) goto if_then_2617; else goto if_merge_2618;
  return;
}
...
void 检查中断语句(struct 语义检查上下文* cn_var_上下文, struct 中断语句* cn_var_中断节点) {
  ...
  r3 = r2->循环深度;
  r4 = r3 == 0;
  if (r4) goto if_then_2623; else goto if_merge_2624;
...
void 检查继续语句(struct 语义检查上下文* cn_var_上下文, struct 继续语句* cn_var_继续节点) {
  ...
  r3 = r2->循环深度;
  r4 = r3 == 0;
  if (r4) goto if_then_2627; else goto if_merge_2628;
...
void 检查选择语句(struct 语义检查上下文* cn_var_上下文, struct 选择语句* cn_var_选择节点) {
  long long r1, r6, r7, r8, r9, r10, r12, r13, r14, r15, r19, r20, r21, r23, r24, r28, r30, r31, r34;
  void* r27;
  struct 选择语句* r0;
  struct 语义检查上下文* r2;
  struct 选择语句* r3;
  ...
  r8 = cn_var_选择类型_0;
  r9 = r8 != 0;
  if (r9) goto logic_rhs_2635; else goto logic_merge_2636;
  ...
  logic_merge_2634:
  if (r15) goto if_then_2631; else goto if_merge_2632;
  ...
  logic_merge_2636:
  if (r12) goto logic_rhs_2633; else goto logic_merge_2634;
  ...
  r23 = r22->情况个数;
  r24 = r21 < r23;
  if (r24) goto for_body_2638; else goto for_exit_2640;
  ...
  r33 = r32->默认分支;
  r34 = r33 != 0;
  if (r34) goto if_then_2641; else goto if_merge_2642;
...
void 检查情况分支(struct 语义检查上下文* cn_var_上下文, struct 情况分支* cn_var_情况节点) {
  ...
  r3 = r2->匹配值;
  r4 = r3 != 0;
  if (r4) goto if_then_2645; else goto if_merge_2646;
  ...
  r7 = 是常量表达式(r6);
  r8 = r7 == 0;
  if (r8) goto if_then_2647; else goto if_merge_2648;

  if_merge_2646:
  r14 = cn_var_情况节点;
  r15 = r14->语句体;
  r16 = r15 != 0;
  if (r16) goto if_then_2649; else goto if_merge_2650;
...
void 检查尝试语句(struct 语义检查上下文* cn_var_上下文, struct 尝试语句* cn_var_尝试节点) {
  ...
  r3 = r2->尝试块;
  r4 = r3 != 0;
  if (r4) goto if_then_2653; else goto if_merge_2654;
  ...
  r10 = r9->捕获个数;
  r11 = r8 < r10;
  if (r11) goto for_body_2656; else goto for_exit_2658;
  ...
  r20 = r19->最终块;
  r21 = r20 != 0;
  if (r21) goto if_then_2659; else goto if_merge_2660;
...
void 检查捕获子句(struct 语义检查上下文* cn_var_上下文, struct 捕获子句* cn_var_捕获节点) {
  ...
  r3 = r2->语句体;
  r4 = r3 != 0;
  if (r4) goto if_then_2663; else goto if_merge_2664;
...
void 检查抛出语句(struct 语义检查上下文* cn_var_上下文, struct 抛出语句* cn_var_抛出节点) {
  ...
  r3 = r2->抛出值;
  r4 = r3 != 0;
  if (r4) goto if_then_2667; else goto if_merge_2668;
...
struct 类型信息* 检查表达式(struct 语义检查上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r4 = r3.类型;
  r5 = r4 == 节点类型_二元表达式;
  if (r5) goto case_body_2672; else goto switch_check_2682;

  switch_check_2682:
  r6 = r4 == 节点类型_一元表达式;
  if (r6) goto case_body_2673; else goto switch_check_2683;

  switch_check_2683:
  r7 = r4 == 节点类型_字面量表达式;
  if (r7) goto case_body_2674; else goto switch_check_2684;

  switch_check_2684:
  r8 = r4 == 节点类型_标识符表达式;
  if (r8) goto case_body_2675; else goto switch_check_2685;

  switch_check_2685:
  r9 = r4 == 节点类型_函数调用表达式;
  if (r9) goto case_body_2676; else goto switch_check_2686;

  switch_check_2686:
  r10 = r4 == 节点类型_成员访问表达式;
  if (r10) goto case_body_2677; else goto switch_check_2687;

  switch_check_2687:
  r11 = r4 == 节点类型_数组访问表达式;
  if (r11) goto case_body_2678; else goto switch_check_2688;

  switch_check_2688:
  r12 = r4 == 节点类型_赋值表达式;
  if (r12) goto case_body_2679; else goto switch_check_2689;

  switch_check_2689:
  r13 = r4 == 节点类型_三元表达式;
  if (r13) goto case_body_2680; else goto case_default_2681;
  ...
  r41 = cn_var_结果类型_0;
  r42 = r41 != 0;
  if (r42) goto if_then_2690; else goto if_merge_2691;
...
struct 类型信息* 检查二元表达式(struct 语义检查上下文* cn_var_上下文, struct 二元表达式* cn_var_二元节点) {
  ...
  r11 = r10->运算符;
  r12 = r11 == 二元运算符_二元_加;
  if (r12) goto case_body_2695; else goto switch_check_2712;

  switch_check_2712:
  r13 = r11 == 二元运算符_二元_减;
  if (r13) goto case_body_2696; else goto switch_check_2713;

  switch_check_2713:
  r14 = r11 == 二元运算符_二元_乘;
  if (r14) goto case_body_2697; else goto switch_check_2714;

  switch_check_2714:
  r15 = r11 == 二元运算符_二元_除;
  if (r15) goto case_body_2698; else goto switch_check_2715;

  switch_check_2715:
  r16 = r11 == 二元运算符_二元_取模;
  if (r16) goto case_body_2699; else goto switch_check_2716;

  switch_check_2716:
  r17 = r11 == 二元运算符_二元_等于;
  if (r17) goto case_body_2700; else goto switch_check_2717;

  switch_check_2717:
  r18 = r11 == 二元运算符_二元_不等于;
  if (r18) goto case_body_2701; else goto switch_check_2718;

  switch_check_2718:
  r19 = r11 == 二元运算符_二元_小于;
  if (r19) goto case_body_2702; else goto switch_check_2719;

  switch_check_2719:
  r20 = r11 == 二元运算符_二元_小于等于;
  if (r20) goto case_body_2703; else goto switch_check_2720;

  switch_check_2720:
  r21 = r11 == 二元运算符_二元_大于;
  if (r21) goto case_body_2704; else goto switch_check_2721;

  switch_check_2721:
  r22 = r11 == 二元运算符_二元_大于等于;
  if (r22) goto case_body_2705; else goto switch_check_2722;

  switch_check_2722:
  r23 = r11 == 二元运算符_二元_位与;
  if (r23) goto case_body_2706; else goto switch_check_2723;

  switch_check_2723:
  r24 = r11 == 二元运算符_二元_位或;
  if (r24) goto case_body_2707; else goto switch_check_2724;

  switch_check_2724:
  r25 = r11 == 二元运算符_二元_位异或;
  if (r25) goto case_body_2708; else goto switch_check_2725;

  switch_check_2725:
  r26 = r11 == 二元运算符_二元_左移;
  if (r26) goto case_body_2709; else goto switch_check_2726;

  switch_check_2726:
  r27 = r11 == 二元运算符_二元_右移;
  if (r27) goto case_body_2710; else goto case_default_2711;
  ...
  r29 = cn_var_左类型_0;
  r30 = 是数值类型(r29);
  if (r30) goto logic_rhs_2729; else goto logic_merge_2730;
  ...
  logic_merge_2730:
  if (r32) goto if_then_2727; else goto if_merge_2728;
  ...
  r40 = cn_var_左类型_0;
  r41 = 是整数类型(r40);
  if (r41) goto logic_rhs_2733; else goto logic_merge_2734;
  ...
  logic_merge_2734:
  if (r43) goto if_then_2731; else goto if_merge_2732;
...
struct 类型信息* 检查一元表达式(struct 语义检查上下文* cn_var_上下文, struct 一元表达式* cn_var_一元节点) {
  ...
  r7 = r6->运算符;
  r8 = r7 == 一元运算符_一元_取负;
  if (r8) goto case_body_2738; else goto switch_check_2748;

  switch_check_2748:
  r9 = r7 == 一元运算符_一元_逻辑非;
  if (r9) goto case_body_2739; else goto switch_check_2749;

  switch_check_2749:
  r10 = r7 == 一元运算符_一元_位取反;
  if (r10) goto case_body_2740; else goto switch_check_2750;

  switch_check_2750:
  r11 = r7 == 一元运算符_一元_取地址;
  if (r11) goto case_body_2741; else goto switch_check_2751;

  switch_check_2751:
  r12 = r7 == 一元运算符_一元_解引用;
  if (r12) goto case_body_2742; else goto switch_check_2752;

  switch_check_2752:
  r13 = r7 == 一元运算符_一元_前置自增;
  if (r13) goto case_body_2743; else goto switch_check_2753;

  switch_check_2753:
  r14 = r7 == 一元运算符_一元_前置自减;
  if (r14) goto case_body_2744; else goto switch_check_2754;

  switch_check_2754:
  r15 = r7 == 一元运算符_一元_后置自增;
  if (r15) goto case_body_2745; else goto switch_check_2755;

  switch_check_2755:
  r16 = r7 == 一元运算符_一元_后置自减;
  if (r16) goto case_body_2746; else goto case_default_2747;

  case_body_2738:
  r17 = cn_var_操作数类型_0;
  r18 = 是数值类型(r17);
  if (r18) goto if_then_2756; else goto if_merge_2757;
  ...
  r25 = cn_var_操作数类型_0;
  r26 = 是整数类型(r25);
  if (r26) goto if_then_2758; else goto if_merge_2759;
  ...
  r34 = cn_var_操作数类型_0;
  r35 = 是指针类型(r34);
  if (r35) goto if_then_2760; else goto if_merge_2761;
  ...
  r42 = cn_var_操作数类型_0;
  r43 = 是数值类型(r42);
  if (r43) goto if_then_2762; else goto if_merge_2763;
...
struct 类型信息* 检查标识符表达式(struct 语义检查上下文* cn_var_上下文, struct 标识符表达式* cn_var_标识符节点) {
  ...
  r7 = cn_var_符号指针_0;
  r8 = r7 == 0;
  if (r8) goto if_then_2779; else goto if_merge_2780;
  ...
  r14 = r13.类型信息;
  r15 = r14 != 0;
  if (r15) goto if_then_2781; else goto if_merge_2782;
...
struct 类型信息* 检查函数调用表达式(struct 语义检查上下文* cn_var_上下文, struct 函数调用表达式* cn_var_调用节点) {
  long long r1, r6, r8, r11, r17, r19, r20, r25, r26, r28, r29, r30, r32, r33, r37, r41, r42, r44, r45, r47, r48, r52, r54, r55, r56, r57, r59;
  void* r36;
  void* r51;
  struct 函数调用表达式* r0;
  struct 语义检查上下文* r2;
  ...
  r7 = cn_var_函数类型_0;
  r8 = r7 == 0;
  if (r8) goto logic_merge_2788; else goto logic_rhs_2787;
  ...
  r19 = r18.参数个数;
  r20 = r17 != r19;
  if (r20) goto if_then_2789; else goto if_merge_2790;
  ...
  logic_merge_2788:
  if (r11) goto if_then_2785; else goto if_merge_2786;
  ...
  r28 = r27->参数个数;
  r29 = r26 < r28;
  if (r29) goto logic_rhs_2795; else goto logic_merge_2796;
  ...
  r47 = cn_var_兼容性_4;
  r48 = r47 == 类型兼容性_不兼容;
  if (r48) goto if_then_2797; else goto if_merge_2798;
  ...
  logic_merge_2796:
  if (r33) goto for_body_2792; else goto for_exit_2794;
...
struct 类型信息* 检查成员访问表达式(struct 语义检查上下文* cn_var_上下文, struct 成员访问表达式* cn_var_成员节点) {
  long long r1, r6, r7, r10, r12, r17, r18, r19, r20, r22, r24, r25, r29, r30, r31, r34, r35, r36, r37, r38, r39, r44, r49, r54, r55, r56, r57, r58;
  char* r27;
  char* r33;
  struct 成员访问表达式* r0;
  struct 语义检查上下文* r2;
  ...
  r6 = cn_var_对象类型_0;
  r7 = r6 == 0;
  if (r7) goto if_then_2801; else goto if_merge_2802;
  ...
  r8 = cn_var_成员节点;
  r9 = r8->是指针访问;
  if (r9) goto if_then_2803; else goto if_merge_2804;

  if_then_2803:
  r10 = cn_var_对象类型_0;
  r11 = 是指针类型(r10);
  r12 = r11 == 0;
  if (r12) goto if_then_2805; else goto if_merge_2806;
  ...
  r20 = cn_var_对象类型_0;
  r21 = 是结构体类型(r20);
  if (r21) goto logic_merge_2811; else goto logic_rhs_2810;
  ...
  r38 = cn_var_成员符号_1;
  r39 = r38 == 0;
  if (r39) goto if_then_2816; else goto if_merge_2817;
  ...
  logic_merge_2811:
  if (r23) goto if_then_2807; else goto if_else_2808;
  ...
  r34 = cn_var_成员符号_1;
  r35 = r34 != 0;
  if (r35) goto if_then_2814; else goto if_merge_2815;
  ...
  r46 = r45->符号表;
  r47 = r46->当前作用域;
  r48 = 检查符号可访问性(r44, r47);
  r49 = r48 == 0;
  if (r49) goto if_then_2818; else goto if_merge_2819;
  ...
  r55 = r54.类型信息;
  r56 = r55 != 0;
  if (r56) goto if_then_2820; else goto if_merge_2821;
...
struct 类型信息* 检查数组访问表达式(struct 语义检查上下文* cn_var_上下文, struct 数组访问表达式* cn_var_数组节点) {
  long long r1, r10, r13, r16, r21, r23, r27, r28, r32, r34;
  struct 数组访问表达式* r0;
  struct 语义检查上下文* r2;
  struct 数组访问表达式* r3;
  struct 表达式节点* r4;
  ...
  r12 = 是数组类型(r11);
  r13 = r12 == 0;
  if (r13) goto logic_rhs_2826; else goto logic_merge_2827;
  ...
  r22 = 是整数类型(r21);
  r23 = r22 == 0;
  if (r23) goto if_then_2828; else goto if_merge_2829;
  ...
  logic_merge_2827:
  if (r16) goto if_then_2824; else goto if_merge_2825;
  ...
  r27 = r26->节点基类;
  r28 = r27.位置;
  报告错误(r24, r28, 诊断错误码_语义_类型不匹配);
  goto if_merge_2829;

  if_merge_2829:
  r29 = cn_var_数组类型_0;
  r30 = 是数组类型(r29);
  if (r30) goto if_then_2830; else goto if_else_2831;
...
struct 类型信息* 检查赋值表达式(struct 语义检查上下文* cn_var_上下文, struct 赋值表达式* cn_var_赋值节点) {
  ...
  r11 = cn_var_目标类型_0;
  r12 = r11 != 0;
  if (r12) goto logic_rhs_2837; else goto logic_merge_2838;
  ...
  r18 = cn_var_兼容性_2;
  r19 = r18 == 类型兼容性_不兼容;
  if (r19) goto if_then_2839; else goto if_merge_2840;
  ...
  logic_merge_2838:
  if (r14) goto if_then_2835; else goto if_merge_2836;
...
struct 类型信息* 检查三元表达式(struct 语义检查上下文* cn_var_上下文, struct 三元表达式* cn_var_三元节点) {
  ...
  r15 = cn_var_条件类型_0;
  r16 = r15 != 0;
  if (r16) goto logic_rhs_2845; else goto logic_merge_2846;
  ...
  r23 = r22->节点基类;
  r24 = r23.位置;
  报告错误(r20, r24, 诊断错误码_语义_类型不匹配);
  goto if_merge_2844;

  if_merge_2844:
  r26 = cn_var_真值类型_1;
  r27 = r26 != 0;
  if (r27) goto logic_rhs_2849; else goto logic_merge_2850;
  ...
  logic_merge_2846:
  if (r19) goto if_then_2843; else goto if_merge_2844;
  ...
  r33 = cn_var_兼容性_3;
  r34 = r33 == 类型兼容性_不兼容;
  if (r34) goto if_then_2851; else goto if_merge_2852;
  ...
  logic_merge_2850:
  if (r29) goto if_then_2847; else goto if_merge_2848;
...
_Bool 是常量表达式(struct 表达式节点* cn_var_表达式) {
  long long r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41;
