...
void 检查函数声明(struct 语义检查上下文* cn_var_上下文, struct 函数声明* cn_var_函数节点) {
  long long r1, r11, r14, r18, r20, r21, r24, r25, r26, r27, r28, r30, r31, r34, r35, r38, r43, r44, r45, r48, r50, r51, r54, r55, r57, r58, r59, r60;
  struct 函数声明* r0;
  struct 语义检查上下文* r2;
  struct 符号* r3;
  struct 语义检查上下文* r4;
...
void 检查变量声明(struct 语义检查上下文* cn_var_上下文, struct 变量声明* cn_var_变量节点) {
  long long r1, r3, r5, r6, r9, r10, r12, r14, r16, r19, r20, r22, r24, r26, r27, r29, r31, r34, r35, r37, r38, r40, r41, r43, r44, r46, r47, r49, r50, r51, r52, r55, r56, r58, r60, r61, r63, r67, r68, r71, r72, r74, r76, r77, r80, r82, r84, r85, r86, r87, r89, r93, r94, r95, r96, r98, r100, r101, r104, r105, r107;
  struct 变量声明* r0;
  struct 变量声明* r2;
  struct 变量声明* r4;
  struct 语义检查上下文* r7;
...
void 检查结构体声明(struct 语义检查上下文* cn_var_上下文, struct 结构体声明* cn_var_结构体节点) {
  long long r1, r2, r4, r5, r7, r8, r9, r10, r11, r12, r13, r14, r18, r19, r22, r23, r25, r26, r27;
  struct 结构体声明* r0;
  struct 结构体声明* r3;
  struct 结构体声明* r6;
  struct 语义检查上下文* r15;
...
void 检查枚举声明(struct 语义检查上下文* cn_var_上下文, struct 枚举声明* cn_var_枚举节点) {
  long long r1, r2, r4, r5, r6, r7, r8, r10, r11, r13, r14, r15, r16, r18, r19, r20, r21, r22, r23, r26, r27, r29, r30, r31, r32, r33;
  struct 枚举声明* r0;
  struct 枚举声明* r3;
  struct 枚举声明* r9;
  struct 枚举声明* r12;
...
void 检查类声明(struct 语义检查上下文* cn_var_上下文, struct 类声明* cn_var_类节点) {
  long long r1, r2, r4, r5, r7, r8, r9, r13, r15, r16, r17, r18, r19, r21, r22, r25, r26, r28, r29, r31, r32, r36, r37, r38, r40, r41, r42, r43, r44, r46, r47, r50, r51, r53, r54, r55, r56, r58, r59, r62, r63, r64, r65, r66;
  struct 类声明* r0;
  struct 类声明* r3;
  struct 类声明* r6;
  struct 语义检查上下文* r10;
...
void 检查接口声明(struct 语义检查上下文* cn_var_上下文, struct 接口声明* cn_var_接口节点) {
  long long r1, r2, r4, r5, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r28, r29, r32, r33, r35, r36, r37, r38, r39, r40, r41, r42, r46, r47, r50, r51, r53, r54, r55;
  struct 接口声明* r0;
  struct 接口声明* r3;
  struct 接口声明* r6;
  struct 语义检查上下文* r25;
...
void 检查如果语句(struct 语义检查上下文* cn_var_上下文, struct 如果语句* cn_var_如果节点) {
  long long r1, r4, r6, r7, r8, r9, r10, r12, r13, r16, r17, r18, r20, r22, r23, r26, r28, r29, r32;
  struct 如果语句* r0;
  struct 语义检查上下文* r2;
  struct 如果语句* r3;
  struct 类型信息* r5;
...
void 检查当语句(struct 语义检查上下文* cn_var_上下文, struct 当语句* cn_var_当节点) {
  long long r1, r4, r6, r7, r8, r9, r10, r12, r13, r16, r17, r18, r20, r22, r23, r25, r26, r29, r31, r32;
  struct 当语句* r0;
  struct 语义检查上下文* r2;
  struct 当语句* r3;
  struct 类型信息* r5;
...
void 检查循环语句(struct 语义检查上下文* cn_var_上下文, struct 循环语句* cn_var_循环节点) {
  long long r1, r3, r4, r7, r9, r10, r13, r15, r16, r17, r18, r19, r21, r22, r25, r26, r27, r29, r31, r32, r35, r38, r39, r41, r42, r45, r47, r48;
  struct 循环语句* r0;
  struct 循环语句* r2;
  struct 语义检查上下文* r5;
  struct 循环语句* r6;
...
void 检查返回语句(struct 语义检查上下文* cn_var_上下文, struct 返回语句* cn_var_返回节点) {
  long long r1, r4, r7, r8, r10, r12, r13, r16, r18, r21, r22, r23, r24, r28, r30, r31, r34, r35, r37, r38, r41, r46, r47, r50, r51, r53;
  struct 返回语句* r0;
  struct 语义检查上下文* r2;
  struct 符号* r3;
  struct 语义检查上下文* r5;
...
void 检查选择语句(struct 语义检查上下文* cn_var_上下文, struct 选择语句* cn_var_选择节点) {
  long long r1, r4, r6, r7, r8, r9, r11, r14, r15, r16, r18, r19, r21, r22, r25, r26, r27, r28, r29, r31, r32, r35;
  struct 选择语句* r0;
  struct 语义检查上下文* r2;
  struct 选择语句* r3;
  struct 类型信息* r5;
...
struct 类型信息* 检查二元表达式(struct 语义检查上下文* cn_var_上下文, struct 二元表达式* cn_var_二元节点) {
  long long r1, r4, r8, r11, r13, r16, r19, r22, r25, r28, r31, r34, r37, r40, r43, r46, r49, r52, r55, r58, r60, r61, r63, r65, r68, r69, r71, r73, r74, r76, r78, r81, r82, r84;
  struct 二元表达式* r0;
  struct 语义检查上下文* r2;
  struct 二元表达式* r3;
  struct 类型信息* r5;
...
struct 类型信息* 检查一元表达式(struct 语义检查上下文* cn_var_上下文, struct 一元表达式* cn_var_一元节点) {
  long long r1, r4, r7, r9, r12, r15, r18, r21, r24, r27, r30, r33, r35, r37, r40, r41, r43, r45, r47, r50, r51, r53, r54, r56, r58, r59, r62, r63, r65, r66, r68, r71, r72, r74;
  struct 一元表达式* r0;
  struct 语义检查上下文* r2;
  struct 一元表达式* r3;
  struct 类型信息* r5;
...
struct 类型信息* 检查字面量表达式(struct 语义检查上下文* cn_var_上下文, struct 字面量表达式* cn_var_字面量节点) {
  long long r1, r3, r5, r8, r11, r14, r17, r19, r21;
  struct 字面量表达式* r0;
  struct 字面量表达式* r2;
  struct 类型信息* r20;
  struct 类型信息* r22;
...
struct 类型信息* 检查标识符表达式(struct 语义检查上下文* cn_var_上下文, struct 标识符表达式* cn_var_标识符节点) {
  long long r1, r5, r7, r8, r11, r12, r14, r15, r16, r17, r18, r19;
  struct 标识符表达式* r0;
  struct 语义检查上下文* r2;
  struct 符号表管理器* r3;
  struct 标识符表达式* r4;
...
struct 类型信息* 检查函数调用表达式(struct 语义检查上下文* cn_var_上下文, struct 函数调用表达式* cn_var_调用节点) {
  long long r1, r4, r6, r7, r8, r9, r11, r14, r15, r17, r19, r20, r21, r22, r25, r26, r28, r29, r30, r32, r33, r34, r35, r36, r37, r40, r41, r42, r44, r45, r46, r47, r48, r49, r51, r53, r54, r57, r58, r59, r60, r61, r63, r64, r65, r66, r67;
  struct 函数调用表达式* r0;
  struct 语义检查上下文* r2;
  struct 函数调用表达式* r3;
  struct 类型信息* r5;
...
struct 类型信息* 检查成员访问表达式(struct 语义检查上下文* cn_var_上下文, struct 成员访问表达式* cn_var_成员节点) {
  long long r1, r4, r6, r7, r9, r10, r12, r15, r16, r18, r19, r20, r21, r22, r24, r26, r27, r29, r31, r32, r35, r36, r38, r39, r44, r47, r48, r50, r51, r52, r53, r54, r55;
  struct 成员访问表达式* r0;
  struct 语义检查上下文* r2;
  struct 成员访问表达式* r3;
  struct 类型信息* r5;
...
struct 类型信息* 检查数组访问表达式(struct 语义检查上下文* cn_var_上下文, struct 数组访问表达式* cn_var_数组节点) {
  long long r1, r4, r8, r10, r11, r13, r14, r16, r19, r20, r22, r23, r25, r28, r29, r30, r32, r33, r35, r36, r37, r38;
  struct 数组访问表达式* r0;
  struct 语义检查上下文* r2;
  struct 数组访问表达式* r3;
  struct 类型信息* r5;
...
struct 类型信息* 检查赋值表达式(struct 语义检查上下文* cn_var_上下文, struct 赋值表达式* cn_var_赋值节点) {
  long long r1, r4, r8, r10, r11, r12, r13, r14, r15, r16, r18, r20, r21, r24, r25, r27, r28;
  struct 赋值表达式* r0;
  struct 语义检查上下文* r2;
  struct 赋值表达式* r3;
  struct 类型信息* r5;
...
struct 类型信息* 检查三元表达式(struct 语义检查上下文* cn_var_上下文, struct 三元表达式* cn_var_三元节点) {
  long long r1, r4, r8, r12, r14, r15, r16, r17, r18, r20, r21, r24, r25, r26, r28, r29, r30, r31, r32, r33, r34, r35, r37, r39, r40, r43, r44, r46, r47;
  struct 三元表达式* r0;
  struct 语义检查上下文* r2;
  struct 三元表达式* r3;
  struct 类型信息* r5;
