...
void 检查声明(struct 语义检查上下文* cn_var_上下文, struct 声明节点* cn_var_声明) {
  ...
  r5 = cn_var_节点类型值_0;
  r6 = r5 == 1;
  if (r6) goto case_body_2310; else goto switch_check_2317;

  switch_check_2317:
  r7 = r5 == 2;
  if (r7) goto case_body_2311; else goto switch_check_2318;

  switch_check_2318:
  r8 = r5 == 3;
  if (r8) goto case_body_2312; else goto switch_check_2319;

  switch_check_2319:
  r9 = r5 == 4;
  if (r9) goto case_body_2313; else goto switch_check_2320;

  switch_check_2320:
  r10 = r5 == 7;
  if (r10) goto case_body_2314; else goto switch_check_2321;

  switch_check_2321:
  r11 = r5 == 8;
  if (r11) goto case_body_2315; else goto case_default_2316;
...
void 检查函数声明(struct 语义检查上下文* cn_var_上下文, struct 函数声明* cn_var_函数节点) {
  long long r1, r11, r14, r18, r20, r21, r24, r25, r26, r27, r28, r30, r31, r34, r35, r38, r42, r43, r46, r48, r49, r52, r53, r54, r55, r56;
  struct 函数声明* r0;
  struct 语义检查上下文* r2;
  struct 符号* r3;
  struct 语义检查上下文* r4;
  ...
  r45 = r44->有返回语句;
  r46 = r45 == 0;
  if (r46) goto logic_rhs_2336; else goto logic_merge_2337;
  ...
  logic_merge_2333:
  if (r42) goto if_then_2330; else goto if_merge_2331;
  ...
  logic_merge_2337:
  if (r49) goto if_then_2334; else goto if_merge_2335;
  return;
}
...
void 检查变量声明(struct 语义检查上下文* cn_var_上下文, struct 变量声明* cn_var_变量节点) {
  long long r1, r3, r5, r6, r9, r10, r12, r14, r17, r18, r20, r22, r23, r25, r27, r30, r31, r32, r34, r35, r37, r38, r39, r41, r42, r43, r44, r47, r48, r50, r51, r53, r57, r58, r61, r62, r64, r65, r68, r70, r72, r73, r74, r75, r77, r81, r82, r83, r84, r86, r87, r90, r91;
  struct 变量声明* r0;
  struct 变量声明* r2;
  struct 变量声明* r4;
  struct 语义检查上下文* r7;
  ...
  r19 = cn_var_变量节点;
  r20 = r19->是静态;
  if (r20) goto if_then_2353; else goto if_merge_2354;
  ...
  r13 = 是常量表达式(r12);
  r14 = r13 == 0;
  if (r14) goto if_then_2351; else goto if_merge_2352;
  ...
  r22 = r21->初始值;
  r23 = r22 != 0;
  if (r23) goto if_then_2355; else goto if_merge_2356;

  if_merge_2354:
  r49 = cn_var_变量节点;
  r50 = r49->类型;
  r51 = r50 != 0;
  if (r51) goto if_then_2365; else goto if_merge_2366;
  ...
  r26 = 是常量表达式(r25);
  r27 = r26 == 0;
  if (r27) goto if_then_2357; else goto if_merge_2358;

  if_merge_2356:
  r33 = cn_var_变量节点;
  r34 = r33->类型;
  r35 = r34 != 0;
  if (r35) goto logic_rhs_2361; else goto logic_merge_2362;
  ...
  r43 = 比较字符串(r42, "空类型");
  r44 = r43 == 0;
  if (r44) goto if_then_2363; else goto if_merge_2364;
  ...
  logic_merge_2362:
  if (r39) goto if_then_2359; else goto if_merge_2360;
  ...
  r57 = cn_var_类型_0;
  r58 = r57 == 0;
  if (r58) goto if_then_2367; else goto if_merge_2368;

  if_merge_2366:
  r63 = cn_var_变量节点;
  r64 = r63->初始值;
  r65 = r64 != 0;
  if (r65) goto if_then_2369; else goto if_merge_2370;
  ...
  r72 = r71->类型;
  r73 = r72 != 0;
  if (r73) goto logic_rhs_2373; else goto logic_merge_2374;
  ...
  r81 = cn_var_变量类型_2;
  r82 = r81 != 0;
  if (r82) goto if_then_2375; else goto if_merge_2376;
  ...
  logic_merge_2374:
  if (r75) goto if_then_2371; else goto if_merge_2372;
  ...
  r86 = cn_var_兼容性_3;
  r87 = r86 == 3;
  if (r87) goto if_then_2377; else goto if_merge_2378;
...
void 检查结构体声明(struct 语义检查上下文* cn_var_上下文, struct 结构体声明* cn_var_结构体节点) {
  long long r1, r2, r4, r5, r7, r8, r9, r10, r11, r12, r13, r14, r18, r19, r22, r23, r24, r25;
  struct 结构体声明* r0;
  struct 结构体声明* r3;
  struct 结构体声明* r6;
  struct 语义检查上下文* r15;
...
void 检查枚举声明(struct 语义检查上下文* cn_var_上下文, struct 枚举声明* cn_var_枚举节点) {
  long long r1, r2, r4, r5, r6, r7, r8, r10, r11, r13, r14, r15, r16, r18, r19, r20, r21, r22, r23, r26, r27, r28, r29, r30, r31;
  struct 枚举声明* r0;
  struct 枚举声明* r3;
  struct 枚举声明* r9;
  struct 枚举声明* r12;
...
void 检查类声明(struct 语义检查上下文* cn_var_上下文, struct 类声明* cn_var_类节点) {
  long long r1, r2, r4, r5, r7, r8, r9, r13, r15, r16, r17, r18, r19, r20, r23, r24, r25, r27, r28, r32, r33, r34, r36, r37, r38, r39, r40, r41, r44, r45, r46, r47, r48, r50, r51, r54, r55, r56, r57, r58;
  struct 类声明* r0;
  struct 类声明* r3;
  struct 类声明* r6;
  struct 语义检查上下文* r10;
  ...
  logic_merge_2410:
  if (r20) goto if_then_2407; else goto if_merge_2408;
  ...
  r27 = r26->接口个数;
  r28 = r25 < r27;
  if (r28) goto for_body_2412; else goto for_exit_2414;
  ...
  r37 = cn_var_接口符号_2;
  r38 = r37 == 0;
  if (r38) goto logic_merge_2418; else goto logic_rhs_2417;
  ...
  logic_merge_2418:
  if (r41) goto if_then_2415; else goto if_merge_2416;
  ...
  r50 = r49->成员个数;
  r51 = r48 < r50;
  if (r51) goto for_body_2420; else goto for_exit_2422;
...
void 检查类成员(struct 语义检查上下文* cn_var_上下文, struct 类成员* cn_var_成员节点) {
  ...
  r3 = r2->类型;
  r4 = r3 == 2;
  if (r4) goto if_then_2425; else goto if_else_2426;
  ...
  r9 = r8->类型;
  r10 = r9 == 1;
  if (r10) goto if_then_2428; else goto if_merge_2429;
...
void 检查接口声明(struct 语义检查上下文* cn_var_上下文, struct 接口声明* cn_var_接口节点) {
  long long r1, r2, r4, r5, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r28, r29, r32, r33, r34, r35, r36, r37, r38, r39, r40, r44, r45, r48, r49, r50, r51;
  struct 接口声明* r0;
  struct 接口声明* r3;
  struct 接口声明* r6;
  struct 语义检查上下文* r25;
  ...
  r37 = r36.返回类型;
  r38 = r37 != 0;
  if (r38) goto if_then_2444; else goto if_merge_2445;
  ...
  r44 = cn_var_类型_4;
  r45 = r44 == 0;
  if (r45) goto if_then_2446; else goto if_merge_2447;
...
void 检查语句(struct 语义检查上下文* cn_var_上下文, struct 语句节点* cn_var_语句) {
  ...
  r4 = r3.类型;
  r5 = r4 == 12;
  if (r5) goto case_body_2451; else goto switch_check_2463;

  switch_check_2463:
  r6 = r4 == 13;
  if (r6) goto case_body_2452; else goto switch_check_2464;

  switch_check_2464:
  r7 = r4 == 14;
  if (r7) goto case_body_2453; else goto switch_check_2465;

  switch_check_2465:
  r8 = r4 == 15;
  if (r8) goto case_body_2454; else goto switch_check_2466;

  switch_check_2466:
  r9 = r4 == 16;
  if (r9) goto case_body_2455; else goto switch_check_2467;

  switch_check_2467:
  r10 = r4 == 17;
  if (r10) goto case_body_2456; else goto switch_check_2468;

  switch_check_2468:
  r11 = r4 == 18;
  if (r11) goto case_body_2457; else goto switch_check_2469;

  switch_check_2469:
  r12 = r4 == 19;
  if (r12) goto case_body_2458; else goto switch_check_2470;

  switch_check_2470:
  r13 = r4 == 11;
  if (r13) goto case_body_2459; else goto switch_check_2471;

  switch_check_2471:
  r14 = r4 == 20;
  if (r14) goto case_body_2460; else goto switch_check_2472;

  switch_check_2472:
  r15 = r4 == 21;
  if (r15) goto case_body_2461; else goto case_default_2462;
...
void 检查如果语句(struct 语义检查上下文* cn_var_上下文, struct 如果语句* cn_var_如果节点) {
  long long r1, r4, r6, r7, r8, r9, r10, r11, r14, r15, r16, r18, r19, r22, r24, r25, r28;
  struct 如果语句* r0;
  struct 语义检查上下文* r2;
  struct 如果语句* r3;
  struct 类型信息* r5;
  ...
  r18 = r17->真分支;
  r19 = r18 != 0;
  if (r19) goto if_then_2485; else goto if_merge_2486;
  ...
  logic_merge_2484:
  if (r11) goto if_then_2481; else goto if_merge_2482;
  ...
  r24 = r23->假分支;
  r25 = r24 != 0;
  if (r25) goto if_then_2487; else goto if_merge_2488;
...
void 检查当语句(struct 语义检查上下文* cn_var_上下文, struct 当语句* cn_var_当节点) {
  long long r1, r4, r6, r7, r8, r9, r10, r11, r14, r15, r16, r18, r19, r21, r22, r25, r27, r28;
  struct 当语句* r0;
  struct 语义检查上下文* r2;
  struct 当语句* r3;
  struct 类型信息* r5;
  ...
  r21 = r20->循环体;
  r22 = r21 != 0;
  if (r22) goto if_then_2495; else goto if_merge_2496;
  ...
  logic_merge_2494:
  if (r11) goto if_then_2491; else goto if_merge_2492;
...
void 检查循环语句(struct 语义检查上下文* cn_var_上下文, struct 循环语句* cn_var_循环节点) {
  long long r1, r3, r4, r7, r9, r10, r13, r15, r16, r17, r18, r19, r20, r23, r24, r25, r27, r28, r31, r34, r35, r37, r38, r41, r43, r44;
  struct 循环语句* r0;
  struct 循环语句* r2;
  struct 语义检查上下文* r5;
  struct 循环语句* r6;
  ...
  r27 = r26->更新;
  r28 = r27 != 0;
  if (r28) goto if_then_2507; else goto if_merge_2508;
  ...
  logic_merge_2506:
  if (r20) goto if_then_2503; else goto if_merge_2504;
  ...
  r37 = r36->循环体;
  r38 = r37 != 0;
  if (r38) goto if_then_2509; else goto if_merge_2510;
...
void 检查返回语句(struct 语义检查上下文* cn_var_上下文, struct 返回语句* cn_var_返回节点) {
  long long r1, r4, r7, r8, r10, r11, r14, r16, r19, r20, r21, r22, r26, r27, r30, r31, r32, r35, r39, r42, r43;
  struct 返回语句* r0;
  struct 语义检查上下文* r2;
  struct 符号* r3;
  struct 语义检查上下文* r5;
  ...
  r10 = r9->返回值;
  r11 = r10 != 0;
  if (r11) goto if_then_2515; else goto if_else_2516;
  ...
  r18 = r17->期望返回类型;
  r19 = r18 != 0;
  if (r19) goto logic_rhs_2520; else goto logic_merge_2521;

  if_else_2516:
  r33 = cn_var_上下文;
  r34 = r33->期望返回类型;
  r35 = r34 != 0;
  if (r35) goto logic_rhs_2526; else goto logic_merge_2527;
  ...
  r26 = cn_var_兼容性_1;
  r27 = r26 == 3;
  if (r27) goto if_then_2522; else goto if_merge_2523;
  ...
  logic_merge_2521:
  if (r21) goto if_then_2518; else goto if_merge_2519;
  ...
  logic_merge_2527:
  if (r39) goto if_then_2524; else goto if_merge_2525;
  return;
}

void 检查中断语句(struct 语义检查上下文* cn_var_上下文, struct 中断语句* cn_var_中断节点) {
  long long r1, r3, r4, r7, r8;
  struct 中断语句* r0;
  struct 语义检查上下文* r2;
  struct 语义检查上下文* r5;
  struct 中断语句* r6;
...
void 检查选择语句(struct 语义检查上下文* cn_var_上下文, struct 选择语句* cn_var_选择节点) {
  long long r1, r4, r6, r7, r8, r9, r11, r14, r15, r16, r17, r19, r20, r23, r24, r25, r26, r27, r29, r30, r33;
  struct 选择语句* r0;
  struct 语义检查上下文* r2;
  struct 选择语句* r3;
  struct 类型信息* r5;
  ...
  r19 = r18->情况个数;
  r20 = r17 < r19;
  if (r20) goto for_body_2543; else goto for_exit_2545;
  ...
  r29 = r28->默认分支;
  r30 = r29 != 0;
  if (r30) goto if_then_2546; else goto if_merge_2547;
...
void 检查情况语句(struct 语义检查上下文* cn_var_上下文, struct 情况语句* cn_var_情况节点) {
  long long r1, r3, r4, r6, r8, r11, r12, r13, r14, r16, r17, r20, r21, r22, r23, r24;
  struct 情况语句* r0;
  struct 情况语句* r2;
  struct 情况语句* r5;
  struct 语义检查上下文* r9;
  ...
  r16 = r15->语句个数;
  r17 = r14 < r16;
  if (r17) goto for_body_2555; else goto for_exit_2557;
...
struct 类型信息* 检查表达式(struct 语义检查上下文* cn_var_上下文, struct 表达式节点* cn_var_表达式) {
  ...
  r4 = r3.类型;
  r5 = r4 == 23;
  if (r5) goto case_body_2581; else goto switch_check_2591;

  switch_check_2591:
  r6 = r4 == 24;
  if (r6) goto case_body_2582; else goto switch_check_2592;

  switch_check_2592:
  r7 = r4 == 25;
  if (r7) goto case_body_2583; else goto switch_check_2593;

  switch_check_2593:
  r8 = r4 == 26;
  if (r8) goto case_body_2584; else goto switch_check_2594;

  switch_check_2594:
  r9 = r4 == 27;
  if (r9) goto case_body_2585; else goto switch_check_2595;

  switch_check_2595:
  r10 = r4 == 28;
  if (r10) goto case_body_2586; else goto switch_check_2596;

  switch_check_2596:
  r11 = r4 == 29;
  if (r11) goto case_body_2587; else goto switch_check_2597;

  switch_check_2597:
  r12 = r4 == 30;
  if (r12) goto case_body_2588; else goto switch_check_2598;

  switch_check_2598:
  r13 = r4 == 31;
  if (r13) goto case_body_2589; else goto case_default_2590;
...
struct 类型信息* 检查二元表达式(struct 语义检查上下文* cn_var_上下文, struct 二元表达式* cn_var_二元节点) {
  long long r1, r4, r8, r11, r28, r29, r31, r33, r36, r37, r39, r40, r42, r44, r47, r48;
  struct 二元表达式* r0;
  struct 语义检查上下文* r2;
  struct 二元表达式* r3;
  struct 类型信息* r5;
  ...
  r11 = r10->运算符;
  r12 = r11 == 0;
  if (r12) goto case_body_2602; else goto switch_check_2619;

  switch_check_2619:
  r13 = r11 == 1;
  if (r13) goto case_body_2603; else goto switch_check_2620;

  switch_check_2620:
  r14 = r11 == 2;
  if (r14) goto case_body_2604; else goto switch_check_2621;

  switch_check_2621:
  r15 = r11 == 3;
  if (r15) goto case_body_2605; else goto switch_check_2622;

  switch_check_2622:
  r16 = r11 == 4;
  if (r16) goto case_body_2606; else goto switch_check_2623;

  switch_check_2623:
  r17 = r11 == 5;
  if (r17) goto case_body_2607; else goto switch_check_2624;

  switch_check_2624:
  r18 = r11 == 6;
  if (r18) goto case_body_2608; else goto switch_check_2625;

  switch_check_2625:
  r19 = r11 == 7;
  if (r19) goto case_body_2609; else goto switch_check_2626;

  switch_check_2626:
  r20 = r11 == 9;
  if (r20) goto case_body_2610; else goto switch_check_2627;

  switch_check_2627:
  r21 = r11 == 8;
  if (r21) goto case_body_2611; else goto switch_check_2628;

  switch_check_2628:
  r22 = r11 == 10;
  if (r22) goto case_body_2612; else goto switch_check_2629;

  switch_check_2629:
  r23 = r11 == 11;
  if (r23) goto case_body_2613; else goto switch_check_2630;

  switch_check_2630:
  r24 = r11 == 12;
  if (r24) goto case_body_2614; else goto switch_check_2631;

  switch_check_2631:
  r25 = r11 == 13;
  if (r25) goto case_body_2615; else goto switch_check_2632;

  switch_check_2632:
  r26 = r11 == 14;
  if (r26) goto case_body_2616; else goto switch_check_2633;

  switch_check_2633:
  r27 = r11 == 15;
  if (r27) goto case_body_2617; else goto case_default_2618;
  ...
  r29 = cn_var_左类型_0;
  r30 = 是数值类型(r29);
  if (r30) goto logic_rhs_2636; else goto logic_merge_2637;
  ...
  logic_merge_2637:
  if (r32) goto if_then_2634; else goto if_merge_2635;
  ...
  r40 = cn_var_左类型_0;
  r41 = 是整数类型(r40);
  if (r41) goto logic_rhs_2640; else goto logic_merge_2641;
  ...
  logic_merge_2641:
  if (r43) goto if_then_2638; else goto if_merge_2639;
...
struct 类型信息* 检查一元表达式(struct 语义检查上下文* cn_var_上下文, struct 一元表达式* cn_var_一元节点) {
  long long r1, r4, r7, r17, r19, r22, r23, r25, r27, r30, r31, r32, r34, r36, r37, r40, r41, r42, r44, r47, r48;
  struct 一元表达式* r0;
  struct 语义检查上下文* r2;
  struct 一元表达式* r3;
  struct 类型信息* r5;
  ...
  r7 = r6->运算符;
  r8 = r7 == /* NONE */;
  if (r8) goto case_body_2645; else goto switch_check_2655;

  switch_check_2655:
  r9 = r7 == 0;
  if (r9) goto case_body_2646; else goto switch_check_2656;

  switch_check_2656:
  r10 = r7 == 4;
  if (r10) goto case_body_2647; else goto switch_check_2657;

  switch_check_2657:
  r11 = r7 == 2;
  if (r11) goto case_body_2648; else goto switch_check_2658;

  switch_check_2658:
  r12 = r7 == 3;
  if (r12) goto case_body_2649; else goto switch_check_2659;

  switch_check_2659:
  r13 = r7 == 5;
  if (r13) goto case_body_2650; else goto switch_check_2660;

  switch_check_2660:
  r14 = r7 == 6;
  if (r14) goto case_body_2651; else goto switch_check_2661;

  switch_check_2661:
  r15 = r7 == 7;
  if (r15) goto case_body_2652; else goto switch_check_2662;

  switch_check_2662:
  r16 = r7 == 8;
  if (r16) goto case_body_2653; else goto case_default_2654;

  case_body_2645:
  r17 = cn_var_操作数类型_0;
  r18 = 是数值类型(r17);
  if (r18) goto if_then_2663; else goto if_merge_2664;
  ...
  r25 = cn_var_操作数类型_0;
  r26 = 是整数类型(r25);
  if (r26) goto if_then_2665; else goto if_merge_2666;
  ...
  r34 = cn_var_操作数类型_0;
  r35 = 是指针类型(r34);
  if (r35) goto if_then_2667; else goto if_merge_2668;
  ...
  r42 = cn_var_操作数类型_0;
  r43 = 是数值类型(r42);
  if (r43) goto if_then_2669; else goto if_merge_2670;
...
struct 类型信息* 检查字面量表达式(struct 语义检查上下文* cn_var_上下文, struct 字面量表达式* cn_var_字面量节点) {
  ...
  r3 = r2->类型;
  r4 = r3 == /* NONE */;
  if (r4) goto case_body_2674; else goto switch_check_2680;

  switch_check_2680:
  r5 = r3 == /* NONE */;
  if (r5) goto case_body_2675; else goto switch_check_2681;

  switch_check_2681:
  r6 = r3 == /* NONE */;
  if (r6) goto case_body_2676; else goto switch_check_2682;

  switch_check_2682:
  r7 = r3 == /* NONE */;
  if (r7) goto case_body_2677; else goto switch_check_2683;

  switch_check_2683:
  r8 = r3 == /* NONE */;
  if (r8) goto case_body_2678; else goto case_default_2679;
...
struct 类型信息* 检查标识符表达式(struct 语义检查上下文* cn_var_上下文, struct 标识符表达式* cn_var_标识符节点) {
  long long r1, r5, r7, r8, r11, r12, r13, r14, r15, r16, r17;
  struct 标识符表达式* r0;
  struct 语义检查上下文* r2;
  struct 符号表管理器* r3;
  struct 标识符表达式* r4;
  ...
  r14 = r13.类型信息;
  r15 = r14 != 0;
  if (r15) goto if_then_2688; else goto if_merge_2689;
...
struct 类型信息* 检查函数调用表达式(struct 语义检查上下文* cn_var_上下文, struct 函数调用表达式* cn_var_调用节点) {
  long long r1, r4, r6, r7, r8, r9, r11, r14, r15, r17, r18, r19, r20, r23, r24, r25, r26, r28, r29, r30, r31, r32, r33, r36, r37, r38, r40, r41, r42, r43, r44, r45, r47, r48, r51, r52, r53, r54, r55, r56, r57, r58, r59;
  struct 函数调用表达式* r0;
  struct 语义检查上下文* r2;
  struct 函数调用表达式* r3;
  struct 类型信息* r5;
  ...
  r19 = r18.参数个数;
  r20 = r17 != r19;
  if (r20) goto if_then_2696; else goto if_merge_2697;
  ...
  r28 = r27->参数个数;
  r29 = r26 < r28;
  if (r29) goto logic_rhs_2702; else goto logic_merge_2703;
  ...
  r47 = cn_var_兼容性_4;
  r48 = r47 == 3;
  if (r48) goto if_then_2704; else goto if_merge_2705;
  ...
  logic_merge_2703:
  if (r33) goto for_body_2699; else goto for_exit_2701;
...
struct 类型信息* 检查成员访问表达式(struct 语义检查上下文* cn_var_上下文, struct 成员访问表达式* cn_var_成员节点) {
  long long r1, r4, r6, r7, r9, r10, r12, r15, r16, r17, r18, r19, r20, r22, r24, r25, r27, r29, r30, r33, r34, r35, r40, r43, r44, r45, r46, r47, r48, r49;
  struct 成员访问表达式* r0;
  struct 语义检查上下文* r2;
  struct 成员访问表达式* r3;
  struct 类型信息* r5;
  ...
  r20 = cn_var_对象类型_0;
  r21 = 是结构体类型(r20);
  if (r21) goto logic_merge_2717; else goto logic_rhs_2716;
  ...
  r29 = cn_var_成员符号_1;
  r30 = r29 == 0;
  if (r30) goto if_then_2718; else goto if_merge_2719;
  ...
  logic_merge_2717:
  if (r23) goto if_then_2714; else goto if_merge_2715;
  ...
  r40 = r39 == 0;
  if (r40) goto if_then_2720; else goto if_merge_2721;
  ...
  r46 = r45.类型信息;
  r47 = r46 != 0;
  if (r47) goto if_then_2722; else goto if_merge_2723;
...
struct 类型信息* 检查数组访问表达式(struct 语义检查上下文* cn_var_上下文, struct 数组访问表达式* cn_var_数组节点) {
  long long r1, r4, r8, r10, r11, r13, r14, r16, r19, r20, r21, r23, r26, r27, r28, r29, r31, r32, r33, r34;
  struct 数组访问表达式* r0;
  struct 语义检查上下文* r2;
  struct 数组访问表达式* r3;
  struct 类型信息* r5;
  ...
  r22 = 是整数类型(r21);
  r23 = r22 == 0;
  if (r23) goto if_then_2730; else goto if_merge_2731;
  ...
  r29 = cn_var_数组类型_0;
  r30 = 是数组类型(r29);
  if (r30) goto if_then_2732; else goto if_else_2733;
...
struct 类型信息* 检查赋值表达式(struct 语义检查上下文* cn_var_上下文, struct 赋值表达式* cn_var_赋值节点) {
  long long r1, r4, r8, r10, r11, r12, r13, r14, r15, r16, r18, r19, r22, r23, r24;
  struct 赋值表达式* r0;
  struct 语义检查上下文* r2;
  struct 赋值表达式* r3;
  struct 类型信息* r5;
  ...
  r18 = cn_var_兼容性_2;
  r19 = r18 == 3;
  if (r19) goto if_then_2741; else goto if_merge_2742;
...
struct 类型信息* 检查三元表达式(struct 语义检查上下文* cn_var_上下文, struct 三元表达式* cn_var_三元节点) {
  long long r1, r4, r8, r12, r14, r15, r16, r17, r18, r19, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r33, r34, r37, r38, r39;
  struct 三元表达式* r0;
  struct 语义检查上下文* r2;
  struct 三元表达式* r3;
  struct 类型信息* r5;
  ...
  r26 = cn_var_真值类型_1;
  r27 = r26 != 0;
  if (r27) goto logic_rhs_2751; else goto logic_merge_2752;
  ...
  logic_merge_2748:
  if (r19) goto if_then_2745; else goto if_merge_2746;
  ...
  r33 = cn_var_兼容性_3;
  r34 = r33 == 3;
  if (r34) goto if_then_2753; else goto if_merge_2754;
  ...
  logic_merge_2752:
  if (r29) goto if_then_2749; else goto if_merge_2750;
