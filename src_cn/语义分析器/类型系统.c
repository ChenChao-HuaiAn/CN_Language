...
_Bool 类型相同(struct 类型信息* cn_var_类型1, struct 类型信息* cn_var_类型2) {
  ...
  r9 = cn_var_类型2->种类;
  r10 = r8 != r9;
  if (r10) goto if_then_8; else goto if_merge_9;
  ...
  r11 = cn_var_类型1->种类;
  r12 = r11 == 类型种类_类型_空;
  if (r12) goto case_body_11; else goto switch_check_24;

  switch_check_24:
  r13 = r11 == 类型种类_类型_整数;
  if (r13) goto case_body_12; else goto switch_check_25;

  switch_check_25:
  r14 = r11 == 类型种类_类型_小数;
  if (r14) goto case_body_13; else goto switch_check_26;

  switch_check_26:
  r15 = r11 == 类型种类_类型_布尔;
  if (r15) goto case_body_14; else goto switch_check_27;

  switch_check_27:
  r16 = r11 == 类型种类_类型_字符串;
  if (r16) goto case_body_15; else goto switch_check_28;

  switch_check_28:
  r17 = r11 == 类型种类_类型_指针;
  if (r17) goto case_body_16; else goto switch_check_29;

  switch_check_29:
  r18 = r11 == 类型种类_类型_数组;
  if (r18) goto case_body_17; else goto switch_check_30;

  switch_check_30:
  r19 = r11 == 类型种类_类型_结构体;
  if (r19) goto case_body_18; else goto switch_check_31;

  switch_check_31:
  r20 = r11 == 类型种类_类型_枚举;
  if (r20) goto case_body_19; else goto switch_check_32;

  switch_check_32:
  r21 = r11 == 类型种类_类型_类;
  if (r21) goto case_body_20; else goto switch_check_33;

  switch_check_33:
  r22 = r11 == 类型种类_类型_接口;
  if (r22) goto case_body_21; else goto switch_check_34;

  switch_check_34:
  r23 = r11 == 类型种类_类型_函数;
  if (r23) goto case_body_22; else goto case_default_23;

  case_body_11:
  return 1;
  goto switch_merge_10;
  ...
  r32 = cn_var_类型2->数组维度;
  r33 = r31 != r32;
  if (r33) goto if_then_35; else goto if_merge_36;
  ...
  r35 = cn_var_类型2->总元素数;
  r36 = r34 != r35;
  if (r36) goto if_then_37; else goto if_merge_38;
  ...
  r44 = cn_var_类型2->参数个数;
  r45 = r43 != r44;
  if (r45) goto if_then_39; else goto if_merge_40;
  ...
  r48 = 类型相同(r46, r47);
  r49 = r48 == 0;
  if (r49) goto if_then_41; else goto if_merge_42;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r51 = cn_var_类型1->参数个数;
  r52 = r50 < r51;
  if (r52) goto for_body_44; else goto for_exit_46;

  for_body_44:
  r53 = cn_var_类型1->参数类型列表;
  r54 = cn_var_i_0;
  r55 = (struct 类型信息*)cn_rt_array_get_element(r53, r54, 8);
  r56 = cn_var_类型2->参数类型列表;
  r57 = cn_var_i_0;
  r58 = (struct 类型信息*)cn_rt_array_get_element(r56, r57, 8);
  r59 = 类型相同(r55, r58);
  r60 = r59 == 0;
  if (r60) goto if_then_47; else goto if_merge_48;

  for_update_45:
  r61 = cn_var_i_0;
  r62 = r61 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r62;
  goto for_cond_43;
...
_Bool 实现接口(struct 类型信息* cn_var_类类型, struct 类型信息* cn_var_接口类型) {
  ...
  r6 = cn_var_类类型->种类;
  r7 = r6 != 类型种类_类型_类;
  if (r7) goto logic_merge_109; else goto logic_rhs_108;
  ...
  if_merge_107:
  struct 符号* cn_var_类符号_0;
  r10 = cn_var_类类型->类型符号;
/* P7DBG_STORE src1.kind=1 */  cn_var_类符号_0 = r10;
  r11 = cn_var_类符号_0;
  r12 = r11 == 0;
  if (r12) goto if_then_110; else goto if_merge_111;
  ...
  logic_merge_109:
  if (r9) goto if_then_106; else goto if_merge_107;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_1 = 0;
  ...
  for_cond_112:
  r13 = cn_var_i_1;
  r14 = cn_var_类符号_0->接口个数;
  r15 = r13 < r14;
  if (r15) goto for_body_113; else goto for_exit_115;

  for_body_113:
  r16 = cn_var_类符号_0->实现接口;
  r17 = cn_var_i_1;
  r18 = (struct 符号*)cn_rt_array_get_element(r16, r17, 8);
  r19 = cn_var_接口类型->类型符号;
  r20 = r18 == r19;
  if (r20) goto if_then_116; else goto if_merge_117;

  for_update_114:
  r21 = cn_var_i_1;
  r22 = r21 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_1 = r22;
  goto for_cond_112;

  for_exit_115:
  r23 = cn_var_类符号_0->父类符号;
  r24 = r23 != 0;
  if (r24) goto if_then_118; else goto if_merge_119;
  ...
  if_then_118:
  struct 类型信息* cn_var_父类类型_2;
  r25 = cn_var_类符号_0->父类符号;
  r26 = r25.名称;
  r27 = cn_var_类符号_0->父类符号;
  r28 = 创建类类型(r26, r27);
/* P7DBG_STORE src1.kind=1 */  cn_var_父类类型_2 = r28;
  r29 = cn_var_父类类型_2;
  r30 = cn_var_接口类型;
  r32 = r29;
  r33 = r30;
...
/* P7DBG_STORE src1.kind=7 */  cn_var_维度大小_1 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(long long*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(/* P7DBG_expr kind=0 */(/* P7DBG_expr kind=14 *//* P7DBG_expr kind=2 */cn_var_类型节点指针->数组维度 * /* P7DBG_expr kind=2 */cn_var_整数大小));
  ...
  r10 = cn_var_维度大小_1;
  r11 = &r10[0];
/* P7DBG_STORE src1.kind=1 */  *r11 = r9;
  r12 = cn_var_元素类型_0;
  r13 = cn_var_维度大小_1;
