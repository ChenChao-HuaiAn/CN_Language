...
struct 类型信息* 创建指针类型(struct 类型信息* cn_var_指向类型) {
  long long r0, r3, r6, r7, r8, r9, r12;
  char* r11;
  void* r1;
  struct 类型信息* r4;
  struct 类型信息* r5;
...
struct 类型信息* 创建数组类型(struct 类型信息* cn_var_元素类型, long long* cn_var_维度大小, long long cn_var_维度) {
  long long r0, r3, r5, r7, r8, r9, r10, r12, r13, r14, r15, r16, r17, r18, r20, r21, r23;
  void* r1;
  struct 类型信息* r4;
  long long* r6;
  long long* r11;
  ...
  r8 = cn_var_维度;
  r9 = r7 < r8;
  if (r9) goto for_body_1831; else goto for_exit_1833;
...
enum 类型兼容性 检查类型兼容性(struct 类型信息* cn_var_源类型, struct 类型信息* cn_var_目标类型) {
  long long r4, r5, r9, r10, r14, r15, r20, r21, r23, r24, r28, r29, r33, r34, r36, r37, r41, r42, r46, r47, r49, r50, r54, r55, r59, r60, r62, r63, r67, r68, r72, r73, r75, r76, r80, r81, r85, r86, r88, r89, r93, r94, r98, r99, r104, r105, r109, r110, r114, r115, r120, r122;
  struct 类型信息* r0;
  struct 类型信息* r1;
  struct 类型信息* r6;
  struct 类型信息* r11;
  ...
  r9 = r8.类型_指针;
  r10 = r7 == r9;
  if (r10) goto logic_rhs_1883; else goto logic_merge_1884;
  ...
  r20 = r19.类型_空;
  r21 = r18 == r20;
  if (r21) goto if_then_1885; else goto if_merge_1886;
  ...
  r28 = r27.类型_整数;
  r29 = r26 == r28;
  if (r29) goto logic_rhs_1889; else goto logic_merge_1890;
  ...
  logic_merge_1884:
  if (r15) goto if_then_1881; else goto if_merge_1882;
  ...
  r41 = r40.类型_整数;
  r42 = r39 == r41;
  if (r42) goto logic_rhs_1893; else goto logic_merge_1894;
  ...
  logic_merge_1890:
  if (r34) goto if_then_1887; else goto if_merge_1888;
  ...
  r54 = r53.类型_枚举;
  r55 = r52 == r54;
  if (r55) goto logic_rhs_1897; else goto logic_merge_1898;
  ...
  logic_merge_1894:
  if (r47) goto if_then_1891; else goto if_merge_1892;
  ...
  r67 = r66.类型_整数;
  r68 = r65 == r67;
  if (r68) goto logic_rhs_1901; else goto logic_merge_1902;
  ...
  logic_merge_1898:
  if (r60) goto if_then_1895; else goto if_merge_1896;
  ...
  r80 = r79.类型_小数;
  r81 = r78 == r80;
  if (r81) goto logic_rhs_1905; else goto logic_merge_1906;
  ...
  logic_merge_1902:
  if (r73) goto if_then_1899; else goto if_merge_1900;
  ...
  r93 = r92.类型_类;
  r94 = r91 == r93;
  if (r94) goto logic_rhs_1909; else goto logic_merge_1910;
  ...
  logic_merge_1906:
  if (r86) goto if_then_1903; else goto if_merge_1904;

  if_then_1907:
  r100 = cn_var_源类型;
  r101 = cn_var_目标类型;
  r102 = 是派生类(r100, r101);
  if (r102) goto if_then_1911; else goto if_merge_1912;
  ...
  r109 = r108.类型_类;
  r110 = r107 == r109;
  if (r110) goto logic_rhs_1915; else goto logic_merge_1916;
  ...
  logic_merge_1910:
  if (r99) goto if_then_1907; else goto if_merge_1908;
  ...
  r117 = cn_var_目标类型;
  r118 = 实现接口(r116, r117);
  if (r118) goto if_then_1917; else goto if_merge_1918;
  ...
  logic_merge_1916:
  if (r115) goto if_then_1913; else goto if_merge_1914;
...
_Bool 实现接口(struct 类型信息* cn_var_类类型, struct 类型信息* cn_var_接口类型) {
  long long r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r42, r43, r44, r45, r46;
...
struct 类型信息* 从类型节点推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r1, r3, r4, r5, r7, r8, r10, r11, r13, r14, r16, r17, r19, r20, r22, r23, r25, r26;
  struct 类型节点* r0;
  struct 类型节点* r2;
  struct 类型节点* r28;
  struct 类型推断上下文* r29;
...
struct 类型信息* 从基础类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r1, r2, r3, r4, r5, r7, r8, r9, r10, r12, r13, r14, r16, r17, r18, r20, r21, r22, r26, r28, r29, r30, r31, r33, r34, r35, r36, r38, r39, r41, r42, r43, r44, r46, r47, r49, r50, r51, r52, r54, r55, r57, r58, r59, r60;
  struct 类型节点* r0;
  struct 类型信息* r6;
  struct 类型信息* r11;
  struct 类型信息* r15;
  ...
  r33 = r32.结构体符号;
  r34 = r31 == r33;
  if (r34) goto if_then_2005; else goto if_merge_2006;
  ...
  r41 = r40.枚举符号;
  r42 = r39 == r41;
  if (r42) goto if_then_2007; else goto if_merge_2008;
  ...
  r49 = r48.类符号;
  r50 = r47 == r49;
  if (r50) goto if_then_2009; else goto if_merge_2010;
  ...
  r57 = r56.接口符号;
  r58 = r55 == r57;
  if (r58) goto if_then_2011; else goto if_merge_2012;
...
struct 类型信息* 从指针类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r1, r4, r5, r6, r8, r10, r11, r12, r14, r15, r16;
  struct 类型节点* r0;
  struct 类型推断上下文* r2;
  struct 类型信息* r3;
  struct 类型信息* r7;
...
struct 类型信息* 从数组类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r1, r4, r5, r7, r8, r9, r12, r14, r17;
  struct 类型节点* r0;
  struct 类型推断上下文* r2;
  struct 类型信息* r3;
  struct 类型节点* r6;
...
struct 类型信息* 从结构体类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r3, r5, r6, r7, r8, r9, r11, r12, r14, r15;
  struct 类型推断上下文* r0;
  struct 符号表管理器* r1;
  struct 类型节点* r2;
  struct 符号* r4;
  ...
  logic_merge_2024:
  if (r12) goto if_then_2021; else goto if_merge_2022;
  return NULL;
}
...
struct 类型信息* 从枚举类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  logic_merge_2028:
  if (r12) goto if_then_2025; else goto if_merge_2026;
  return NULL;
}
...
struct 类型信息* 从类类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  logic_merge_2032:
  if (r12) goto if_then_2029; else goto if_merge_2030;
  return NULL;
}
...
struct 类型信息* 从接口类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  logic_merge_2036:
  if (r12) goto if_then_2033; else goto if_merge_2034;
  return NULL;
}
