...
struct 类型信息* 创建指针类型(struct 类型信息* cn_var_指向类型) {
  ...
  r8 = cn_var_指向类型;
  r9 = r8->名称;
  r10 = cn_rt_string_concat(r9, "*");
  r11 = cn_var_类型_0;
  return r11;
}

struct 类型信息* 创建数组类型(struct 类型信息* cn_var_元素类型, long long* cn_var_维度大小, long long cn_var_维度) {
  long long r0, r3, r5, r6, r8, r10, r12, r13, r14, r15, r16, r18, r19, r21;
  void* r1;
  struct 类型信息* r2;
  long long* r4;
  long long* r9;
...
enum 类型兼容性 检查类型兼容性(struct 类型信息* cn_var_源类型, struct 类型信息* cn_var_目标类型) {
  long long r3, r14, r21, r28, r35, r42, r49, r59;
  struct 类型信息* r0;
  struct 类型信息* r1;
  struct 类型信息* r4;
  struct 类型信息* r7;
  ...
  r5 = r4->种类;
  r6 = r5 == 6;
  if (r6) goto logic_rhs_53; else goto logic_merge_54;
  ...
  r12 = r11->种类;
  r13 = r12 == 0;
  if (r13) goto if_then_55; else goto if_merge_56;

  if_merge_52:
  r15 = cn_var_源类型;
  r16 = r15->种类;
  r17 = r16 == 1;
  if (r17) goto logic_rhs_59; else goto logic_merge_60;
  ...
  logic_merge_54:
  if (r9) goto if_then_51; else goto if_merge_52;
  ...
  r23 = r22->种类;
  r24 = r23 == 1;
  if (r24) goto logic_rhs_63; else goto logic_merge_64;
  ...
  logic_merge_60:
  if (r20) goto if_then_57; else goto if_merge_58;
  ...
  r30 = r29->种类;
  r31 = r30 == 9;
  if (r31) goto logic_rhs_67; else goto logic_merge_68;
  ...
  logic_merge_64:
  if (r27) goto if_then_61; else goto if_merge_62;
  ...
  r37 = r36->种类;
  r38 = r37 == 1;
  if (r38) goto logic_rhs_71; else goto logic_merge_72;
  ...
  logic_merge_68:
  if (r34) goto if_then_65; else goto if_merge_66;
  ...
  r44 = r43->种类;
  r45 = r44 == 2;
  if (r45) goto logic_rhs_75; else goto logic_merge_76;
  ...
  logic_merge_72:
  if (r41) goto if_then_69; else goto if_merge_70;
  ...
  r51 = r50->种类;
  r52 = r51 == 10;
  if (r52) goto logic_rhs_79; else goto logic_merge_80;
  ...
  logic_merge_76:
  if (r48) goto if_then_73; else goto if_merge_74;

  if_then_77:
  r56 = cn_var_源类型;
  r57 = cn_var_目标类型;
  r58 = 是派生类(r56, r57);
  if (r58) goto if_then_81; else goto if_merge_82;

  if_merge_78:
  r60 = cn_var_源类型;
  r61 = r60->种类;
  r62 = r61 == 10;
  if (r62) goto logic_rhs_85; else goto logic_merge_86;
  ...
  logic_merge_80:
  if (r55) goto if_then_77; else goto if_merge_78;
  ...
  r67 = cn_var_目标类型;
  r68 = 实现接口(r66, r67);
  if (r68) goto if_then_87; else goto if_merge_88;
  ...
  logic_merge_86:
  if (r65) goto if_then_83; else goto if_merge_84;
...
_Bool 是派生类(struct 类型信息* cn_var_子类, struct 类型信息* cn_var_父类) {
  ...
  r7 = r6->种类;
  r8 = r7 != 10;
  if (r8) goto logic_merge_96; else goto logic_rhs_95;
  ...
  logic_merge_96:
  if (r11) goto if_then_93; else goto if_merge_94;

  while_cond_97:
  r14 = cn_var_当前_0;
  r15 = r14 != 0;
  if (r15) goto while_body_98; else goto while_exit_99;
  ...
  r18 = r17->类型符号;
  r19 = r16 == r18;
  if (r19) goto if_then_100; else goto if_merge_101;
...
_Bool 是数值类型(struct 类型信息* cn_var_类型) {
  ...
  r4 = r3->种类;
  r5 = r4 == 1;
  if (r5) goto logic_merge_123; else goto logic_rhs_122;
...
_Bool 是整数类型(struct 类型信息* cn_var_类型) {
  ...
  r4 = r3->种类;
  r5 = r4 == 1;
  if (r5) goto logic_merge_127; else goto logic_rhs_126;
...
_Bool 是可调用类型(struct 类型信息* cn_var_类型) {
  ...
  r8 = r7->种类;
  r9 = r8 == 6;
  if (r9) goto logic_rhs_142; else goto logic_merge_143;
...
struct 类型信息* 从类型节点推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  r3 = r2->类型;
  r4 = r3 == 36;
  if (r4) goto case_body_147; else goto switch_check_156;

  switch_check_156:
  r5 = r3 == 37;
  if (r5) goto case_body_148; else goto switch_check_157;

  switch_check_157:
  r6 = r3 == 38;
  if (r6) goto case_body_149; else goto switch_check_158;

  switch_check_158:
  r7 = r3 == 40;
  if (r7) goto case_body_150; else goto switch_check_159;

  switch_check_159:
  r8 = r3 == 41;
  if (r8) goto case_body_151; else goto switch_check_160;

  switch_check_160:
  r9 = r3 == 42;
  if (r9) goto case_body_152; else goto switch_check_161;

  switch_check_161:
  r10 = r3 == 43;
  if (r10) goto case_body_153; else goto switch_check_162;

  switch_check_162:
  r11 = r3 == 39;
  if (r11) goto case_body_154; else goto case_default_155;
...
struct 类型信息* 从基础类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r3, r5, r8, r10, r13, r17, r21;
  char* r1;
  char* r2;
  char* r7;
  char* r12;
  ...
  r3 = 比较字符串(r2, "整数");
  r4 = r3 == 0;
  if (r4) goto if_then_163; else goto if_merge_164;
  ...
  r8 = 比较字符串(r7, "小数");
  r9 = r8 == 0;
  if (r9) goto if_then_165; else goto if_merge_166;
  ...
  r13 = 比较字符串(r12, "布尔");
  r14 = r13 == 0;
  if (r14) goto if_then_167; else goto if_merge_168;
  ...
  r17 = 比较字符串(r16, "字符串");
  r18 = r17 == 0;
  if (r18) goto if_then_169; else goto if_merge_170;
  ...
  r21 = 比较字符串(r20, "空类型");
  r22 = r21 == 0;
  if (r22) goto if_then_171; else goto if_merge_172;
  ...
  r28 = cn_var_符号指针_1;
  r29 = r28 != 0;
  if (r29) goto if_then_173; else goto if_merge_174;

  if_then_173:
  r30 = cn_var_符号指针_1;
  r31 = r30->种类;
  r32 = r31 == 3;
  if (r32) goto if_then_175; else goto if_merge_176;
  ...
  r37 = r36->种类;
  r38 = r37 == 4;
  if (r38) goto if_then_177; else goto if_merge_178;
  ...
  r43 = r42->种类;
  r44 = r43 == 6;
  if (r44) goto if_then_179; else goto if_merge_180;
  ...
  r49 = r48->种类;
  r50 = r49 == 7;
  if (r50) goto if_then_181; else goto if_merge_182;
...
struct 类型信息* 从指针类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  r10 = r9->指针层级;
  r11 = r8 < r10;
  if (r11) goto for_body_186; else goto for_exit_188;
...
struct 类型信息* 从数组类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  r4 = cn_var_元素类型_0;
  r5 = r4 == 0;
  if (r5) goto if_then_189; else goto if_merge_190;
  ...
  r12 = r11->数组大小;
  r13 = cn_var_维度大小_1;
    { long long _tmp_r0 = r12; cn_rt_array_set_element(r13, 0, &_tmp_r0, 8); }
  r14 = cn_var_元素类型_0;
  r15 = cn_var_维度大小_1;
  r16 = cn_var_类型节点指针;
  r17 = r16->数组维度;
...
struct 类型信息* 从结构体类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  r6 = cn_var_符号指针_0;
  r7 = r6 == 0;
  if (r7) goto logic_merge_194; else goto logic_rhs_193;
  ...
  logic_merge_194:
  if (r10) goto if_then_191; else goto if_merge_192;
  return NULL;
}
...
struct 类型信息* 从枚举类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  r6 = cn_var_符号指针_0;
  r7 = r6 == 0;
  if (r7) goto logic_merge_198; else goto logic_rhs_197;
  ...
  logic_merge_198:
  if (r10) goto if_then_195; else goto if_merge_196;
  return NULL;
}
...
struct 类型信息* 从类类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  r6 = cn_var_符号指针_0;
  r7 = r6 == 0;
  if (r7) goto logic_merge_202; else goto logic_rhs_201;
  ...
  logic_merge_202:
  if (r10) goto if_then_199; else goto if_merge_200;
  return NULL;
}
...
struct 类型信息* 从接口类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  ...
  r6 = cn_var_符号指针_0;
  r7 = r6 == 0;
  if (r7) goto logic_merge_206; else goto logic_rhs_205;
  ...
  logic_merge_206:
  if (r10) goto if_then_203; else goto if_merge_204;
  return NULL;
}
...
char* 获取类型种类名称(enum 类型种类 cn_var_种类) {
  ...
  r0 = cn_var_种类;
  r1 = r0 == 0;
  if (r1) goto case_body_208; else goto switch_check_224;

  switch_check_224:
  r2 = r0 == 1;
  if (r2) goto case_body_209; else goto switch_check_225;

  switch_check_225:
  r3 = r0 == 2;
  if (r3) goto case_body_210; else goto switch_check_226;

  switch_check_226:
  r4 = r0 == 3;
  if (r4) goto case_body_211; else goto switch_check_227;

  switch_check_227:
  r5 = r0 == 4;
  if (r5) goto case_body_212; else goto switch_check_228;

  switch_check_228:
  r6 = r0 == 5;
  if (r6) goto case_body_213; else goto switch_check_229;

  switch_check_229:
  r7 = r0 == 6;
  if (r7) goto case_body_214; else goto switch_check_230;

  switch_check_230:
  r8 = r0 == 7;
  if (r8) goto case_body_215; else goto switch_check_231;

  switch_check_231:
  r9 = r0 == 8;
  if (r9) goto case_body_216; else goto switch_check_232;

  switch_check_232:
  r10 = r0 == 9;
  if (r10) goto case_body_217; else goto switch_check_233;

  switch_check_233:
  r11 = r0 == 10;
  if (r11) goto case_body_218; else goto switch_check_234;

  switch_check_234:
  r12 = r0 == 11;
  if (r12) goto case_body_219; else goto switch_check_235;

  switch_check_235:
  r13 = r0 == 12;
  if (r13) goto case_body_220; else goto switch_check_236;

  switch_check_236:
  r14 = r0 == 13;
  if (r14) goto case_body_221; else goto switch_check_237;

  switch_check_237:
  r15 = r0 == 14;
  if (r15) goto case_body_222; else goto case_default_223;

  case_body_208:
  return "空类型";
  goto switch_merge_207;
