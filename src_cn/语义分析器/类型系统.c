...
struct 类型信息* 从基础类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r2, r3, r4, r5, r7, r8, r9, r10, r12, r13, r14, r16, r17, r18, r20, r21, r22, r26, r28, r29, r30, r31, r33, r34, r35, r36, r38, r39, r41, r42, r43, r44, r46, r47, r49, r50, r51, r52, r54, r55, r57, r58, r59, r60;
  char* r1;
  struct 类型节点* r0;
  struct 类型信息* r6;
  struct 类型信息* r11;
...
struct 类型信息* 从结构体类型推断(struct 类型节点* cn_var_类型节点指针, struct 类型推断上下文* cn_var_上下文) {
  long long r5, r6, r7, r8, r9, r11, r12, r15;
  char* r3;
  char* r14;
  struct 类型推断上下文* r0;
  struct 符号表管理器* r1;
