...
void 生成结构体定义(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r2, r4, r12, r13, r14, r17, r25, r30, r31;
  char* r8;
  char* r20;
  struct 类型信息** r16;
  char** r24;
...
void 生成枚举定义(struct 类型信息* cn_var_类型, struct 符号* cn_var_符号, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r2, r4, r12, r13, r14, r16, r22, r23, r24, r25, r26, r30, r31, r33, r34, r35, r36, r40, r41;
  char* r8;
  char* r20;
  struct 符号** r15;
  struct 类型信息* r1;
...
void 生成函数声明(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r12, r13, r14, r15, r16, r20, r22, r25, r26;
  char* r4;
  char* r8;
  char* r24;
  struct IR函数* r0;
...
void 生成模块代码(struct 模块代码生成上下文* cn_var_上下文) {
  long long r0, r2, r4, r15, r16, r25, r26;
  struct 模块代码生成上下文* r1;
  struct IR模块* r3;
  struct 模块代码生成上下文* r5;
  struct 模块代码生成上下文* r6;
...
_Bool 写入代码文件(struct 模块代码生成上下文* cn_var_上下文, const char* cn_var_输出目录) {
  long long r1, r3, r5, r6, r7, r9, r12, r14, r17, r20, r22, r23, r24, r26, r29, r31, r34, r36, r38, r39, r43, r44, r45, r46, r48, r49, r53, r54, r55, r56, r57;
  char* r2;
  char* r4;
  char* r10;
  char* r11;
