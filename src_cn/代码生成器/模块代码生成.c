...
void 生成结构体定义(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r16 = r15->成员个数;
  r17 = r14 < r16;
  if (r17) goto for_body_3424; else goto for_exit_3426;
...
void 生成结构体前向声明(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3430:
  if (r5) goto if_then_3427; else goto if_merge_3428;
  return;
}
...
void 生成枚举定义(struct 类型信息* cn_var_类型, struct 符号* cn_var_符号, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3434:
  if (r5) goto if_then_3431; else goto if_merge_3432;

  while_cond_3435:
  r16 = cn_var_成员_0;
  if (r16) goto while_body_3436; else goto while_exit_3437;
  ...
  cn_var_成员_0 = r29;
  r30 = cn_var_成员_0;
  if (r30) goto if_then_3440; else goto if_merge_3441;
...
void 生成枚举前向声明(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3445:
  if (r5) goto if_then_3442; else goto if_merge_3443;
  return;
}
...
void 生成类定义(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r16 = r15->成员个数;
  r17 = r14 < r16;
  if (r17) goto for_body_3451; else goto for_exit_3453;
...
void 生成类前向声明(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3457:
  if (r5) goto if_then_3454; else goto if_merge_3455;
  return;
}
...
void 生成全局变量定义(struct 全局变量* cn_var_全局变量信息, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r14 = r13.种类;
  r15 = r14 != 0;
  if (r15) goto if_then_3462; else goto if_merge_3463;
...
void 生成函数声明(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r16 = r15->参数数量;
  r17 = r14 < r16;
  if (r17) goto for_body_3467; else goto for_exit_3469;

  for_body_3467:
  r18 = cn_var_i_0;
  r19 = r18 > 0;
  if (r19) goto if_then_3470; else goto if_merge_3471;
...
struct 模块代码生成上下文* 创建模块代码生成上下文(struct IR模块* cn_var_模块, char* cn_var_模块名, struct 代码生成选项 cn_var_选项) {
  ...
  cn_var_上下文_0 = r1;
  r2 = cn_var_上下文_0;
  if (r2) goto if_then_3474; else goto if_merge_3475;
...
_Bool 写入代码文件(struct 模块代码生成上下文* cn_var_上下文, char* cn_var_输出目录) {
  ...
  cn_var_头文件_2 = r41;
  r42 = cn_var_头文件_2;
  if (r42) goto if_then_3502; else goto if_merge_3503;
  ...
  cn_var_源文件_3 = r53;
  r54 = cn_var_源文件_3;
  if (r54) goto if_then_3504; else goto if_merge_3505;
