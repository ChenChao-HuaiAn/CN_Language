...
void 生成结构体定义(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r2, r6, r7, r16, r18, r19, r23, r24, r32, r33, r37, r38;
  char* r12;
  char* r26;
  void* r22;
  void* r31;
  ...
  r18 = r17->成员个数;
  r19 = r16 < r18;
  if (r19) goto for_body_3424; else goto for_exit_3426;
  ...
  r31 = r30->成员名称列表;
  r32 = cn_var_i_0;
  r33 = *(void*)cn_rt_array_get_element(r31, r32, 8);
  r34 = 追加字符串(r29, r33);
  r35 = cn_var_缓冲区;
  r36 = 追加字符串(r35, ";\n");
...
void 生成枚举定义(struct 类型信息* cn_var_类型, struct 符号* cn_var_符号, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r2, r6, r7, r17, r28, r31, r36, r37;
  char* r12;
  char* r22;
  struct 类型信息* r1;
  struct 类型信息* r3;
  ...
  while_cond_3435:
  r18 = cn_var_成员_0;
  if (r18) goto while_body_3436; else goto while_exit_3437;
  ...
  cn_var_成员_0 = r31;
  r32 = cn_var_成员_0;
  if (r32) goto if_then_3440; else goto if_merge_3441;
...
void 生成类定义(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r18 = r17->成员个数;
  r19 = r16 < r18;
  if (r19) goto for_body_3451; else goto for_exit_3453;
...
void 生成全局变量定义(struct 全局变量* cn_var_全局变量信息, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r16 = r15.无操作数;
  r17 = r14 != r16;
  if (r17) goto if_then_3462; else goto if_merge_3463;
