...
/* P7DBG_STORE src1.kind=1 */  cn_var_缓冲区_0 = r2;
  r3 = cn_var_缓冲区_0;
  r4 = 追加字符串(r3, "// ========================================\n");
  r5 = cn_var_缓冲区_0;
  ...
  r14 = 创建输出缓冲区(256);
/* P7DBG_STORE src1.kind=1 */  cn_var_保护宏_1 = r14;
  r15 = cn_var_上下文->模块名称;
  r16 = cn_var_保护宏_1;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_缓冲区_0 = r2;
  ...
  struct 输出缓冲区* cn_var_保护宏_1;
  r6 = 创建输出缓冲区(256);
/* P7DBG_STORE src1.kind=1 */  cn_var_保护宏_1 = r6;
  r7 = cn_var_上下文->模块名称;
  r8 = cn_var_保护宏_1;
  r9 = 生成头文件保护宏(r7, r8);
  r10 = cn_var_缓冲区_0;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r17 = cn_var_i_0;
  r18 = (struct 类型信息*)cn_rt_array_get_element(r16, r17, 8);
  r19 = cn_var_缓冲区;
  r20 = 类型到C类型(r18, r19);
  r21 = cn_var_缓冲区;
  r22 = 追加字符串(r21, " ");
...
void 生成枚举定义(struct 类型信息* cn_var_类型, struct 符号* cn_var_符号, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r12, r13, r16, r22, r23, r25, r30, r31, r33, r34, r35, r40, r41;
  char* r8;
  char* r20;
  struct 符号** r15;
  struct 类型信息* r1;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_索引_0 = 0;
  goto for_cond_22;
  ...
  r15 = cn_var_符号->成员列表;
  r16 = cn_var_索引_0;
  r17 = (struct 符号*)cn_rt_array_get_element(r15, r16, 8);
/* P7DBG_STORE src1.kind=1 */  cn_var_成员_1 = r17;
  r18 = cn_var_缓冲区;
  追加缩进(r18, 4);
  r19 = cn_var_缓冲区;
  r20 = cn_var_成员_1->名称;
  ...
  r40 = cn_var_索引_0;
  r41 = r40 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_索引_0 = r41;
  goto for_cond_22;
...
void 生成函数声明(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  long long r12, r13, r15, r20, r22, r25, r26;
  char* r4;
  char* r8;
  char* r24;
  struct IR函数* r0;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r25 = cn_var_i_0;
  r26 = r25 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r26;
  goto for_cond_56;
  ...
  r20 = cn_var_i_0;
  r21 = (struct IR操作数*)cn_rt_array_get_element(r19, r20, 8);
...
/* P7DBG_STORE src1.kind=1 */  cn_var_全局_0 = r8;
  ...
  生成全局变量定义(r12, r13);
  r14 = cn_var_全局_0->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_全局_0 = r14;
  ...
  r17 = cn_var_上下文->模块;
  r18 = r17->首个函数;
/* P7DBG_STORE src1.kind=1 */  cn_var_函数指针_1 = r18;
  goto while_cond_79;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_函数指针_1 = r24;
...
_Bool 写入代码文件(struct 模块代码生成上下文* cn_var_上下文, const char* cn_var_输出目录) {
  ...
  r7 = r6 + 4;
  r8 = 分配内存(r7);
/* P7DBG_STORE src1.kind=1 */  cn_var_头文件路径_0 = r8;
  r9 = cn_var_头文件路径_0;
  r10 = cn_var_输出目录;
  r11 = 连接字符串(r9, r10);
  r12 = cn_var_头文件路径_0;
  ...
  r24 = r23 + 4;
  r25 = 分配内存(r24);
/* P7DBG_STORE src1.kind=1 */  cn_var_源文件路径_1 = r25;
  r26 = cn_var_源文件路径_1;
  r27 = cn_var_输出目录;
  r28 = 连接字符串(r26, r27);
  r29 = cn_var_源文件路径_1;
  ...
  r36 = cn_var_头文件路径_0;
  r37 = 打开文件(r36, "w");
/* P7DBG_STORE src1.kind=1 */  cn_var_头文件_2 = r37;
  r38 = cn_var_头文件_2;
  ...
  r46 = cn_var_源文件路径_1;
  r47 = 打开文件(r46, "w");
/* P7DBG_STORE src1.kind=1 */  cn_var_源文件_3 = r47;
  r48 = cn_var_源文件_3;
