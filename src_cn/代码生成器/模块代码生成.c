...
void 生成结构体定义(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3554:
  if (r5) goto if_then_3551; else goto if_merge_3552;
  ...
  r16 = r15->成员个数;
  r17 = r14 < r16;
  if (r17) goto for_body_3556; else goto for_exit_3558;
...
void 生成结构体前向声明(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3562:
  if (r5) goto if_then_3559; else goto if_merge_3560;
  return;
}

void 生成枚举定义(struct 类型信息* cn_var_类型, struct 符号* cn_var_符号, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r2, r5, r14, r16, r17, r20, r27, r29, r30, r31, r32, r37, r38, r40, r42, r43, r44, r48, r49;
  char* r10;
  char* r25;
  struct 符号** r19;
  struct 类型信息* r1;
  ...
  logic_merge_3566:
  if (r5) goto if_then_3563; else goto if_merge_3564;
  ...
  r16 = r15.成员个数;
  r17 = r14 < r16;
  if (r17) goto for_body_3568; else goto for_exit_3570;
  ...
  r29 = r28->枚举值;
  r30 = r29 != 0;
  if (r30) goto logic_merge_3574; else goto logic_rhs_3573;
  ...
  r43 = r42 - 1;
  r44 = r40 < r43;
  if (r44) goto if_then_3575; else goto if_merge_3576;
  ...
  logic_merge_3574:
  if (r32) goto if_then_3571; else goto if_merge_3572;
...
void 生成枚举前向声明(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3580:
  if (r5) goto if_then_3577; else goto if_merge_3578;
  return;
}
...
void 生成类定义(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3584:
  if (r5) goto if_then_3581; else goto if_merge_3582;
  ...
  r16 = r15->成员个数;
  r17 = r14 < r16;
  if (r17) goto for_body_3586; else goto for_exit_3588;
...
void 生成类前向声明(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3592:
  if (r5) goto if_then_3589; else goto if_merge_3590;
  return;
}
...
void 生成全局变量定义(struct 全局变量* cn_var_全局变量信息, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r13 = r12->初始值;
  r14 = r13.种类;
  r15 = r14 != IR操作数种类_无操作数;
  if (r15) goto if_then_3597; else goto if_merge_3598;
...
void 生成函数声明(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r16 = r15->参数数量;
  r17 = r14 < r16;
  if (r17) goto for_body_3602; else goto for_exit_3604;

  for_body_3602:
  r18 = cn_var_i_0;
  r19 = r18 > 0;
  if (r19) goto if_then_3605; else goto if_merge_3606;
...
void 释放模块代码生成上下文(struct 模块代码生成上下文* cn_var_上下文) {
  ...
  r17 = cn_var_上下文;
  r18 = r17->模块名称;
  if (r18) goto if_then_3613; else goto if_merge_3614;
  ...
  r21 = cn_var_上下文;
  r22 = r21->输出文件名;
  if (r22) goto if_then_3615; else goto if_merge_3616;
...
void 生成模块代码(struct 模块代码生成上下文* cn_var_上下文) {
  ...
  logic_merge_3620:
  if (r5) goto if_then_3617; else goto if_merge_3618;

  while_cond_3621:
  r11 = cn_var_全局_0;
  if (r11) goto while_body_3622; else goto while_exit_3623;
  ...
  while_cond_3624:
  r26 = cn_var_函数指针_1;
  if (r26) goto while_body_3625; else goto while_exit_3626;
...
char* 获取头文件内容(struct 模块代码生成上下文* cn_var_上下文) {
  ...
  logic_merge_3630:
  if (r3) goto if_then_3627; else goto if_merge_3628;
  return NULL;
}
...
char* 获取源文件内容(struct 模块代码生成上下文* cn_var_上下文) {
  ...
  logic_merge_3634:
  if (r3) goto if_then_3631; else goto if_merge_3632;
  return NULL;
}
...
_Bool 写入代码文件(struct 模块代码生成上下文* cn_var_上下文, const char* cn_var_输出目录) {
  ...
  cn_var_头文件_2 = r41;
  r42 = cn_var_头文件_2;
  if (r42) goto if_then_3637; else goto if_merge_3638;
  ...
  cn_var_源文件_3 = r53;
  r54 = cn_var_源文件_3;
  if (r54) goto if_then_3639; else goto if_merge_3640;
