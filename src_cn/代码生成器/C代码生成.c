...
struct 输出缓冲区* 创建输出缓冲区(long long cn_var_初始容量) {
  ...
  r1 = 分配内存(r0);
/* P7DBG_STORE src1.kind=1 */  cn_var_缓冲区_0 = r1;
  r2 = cn_var_缓冲区_0;
...
_Bool 扩展缓冲区(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_新容量) {
  ...
  r7 = cn_var_新容量;
  r8 = 重新分配内存(r6, r7);
/* P7DBG_STORE src1.kind=1 */  cn_var_新数据_0 = r8;
  r9 = cn_var_新数据_0;
...
_Bool 追加字符串(struct 输出缓冲区* cn_var_缓冲区, const char* cn_var_字符串值) {
  long long r0, r2, r4, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r22, r24, r26, r29, r31, r32, r33, r35;
  char* r3;
  char* r5;
  char* r25;
  char* r27;
  ...
  r5 = cn_var_字符串值;
  r6 = 获取字符串长度(r5);
/* P7DBG_STORE src1.kind=1 */  cn_var_字符串长度_0 = r6;
  long long cn_var_需要容量_1;
  r7 = cn_var_缓冲区->长度;
  r8 = cn_var_字符串长度_0;
  r9 = r7 + r8;
  r10 = r9 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_需要容量_1 = r10;
  r11 = cn_var_需要容量_1;
  r12 = cn_var_缓冲区->容量;
  r13 = r11 > r12;
  ...
  r14 = cn_var_缓冲区->容量;
  r15 = r14 << 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_新容量_2 = r15;
  goto while_cond_947;
...
_Bool 追加字符(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_字符值) {
  ...
  char* cn_var_字符串缓冲_0;
  r0 = 分配内存(2);
/* P7DBG_STORE src1.kind=7 */  cn_var_字符串缓冲_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(char*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(2);
  r1 = cn_var_字符值;
  r2 = cn_var_字符串缓冲_0;
...
_Bool 追加整数(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_数值) {
  ...
  char* cn_var_字符串缓冲_0;
  r0 = 分配内存(32);
/* P7DBG_STORE src1.kind=7 */  cn_var_字符串缓冲_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(char*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(32);
  r1 = cn_var_字符串缓冲_0;
  r2 = cn_var_数值;
  格式化整数(r1, 32, r2);
  _Bool cn_var_结果_1;
  ...
  r4 = cn_var_字符串缓冲_0;
  r5 = 追加字符串(r3, r4);
/* P7DBG_STORE src1.kind=1 */  cn_var_结果_1 = r5;
  r6 = cn_var_字符串缓冲_0;
  释放内存(r6);
  r7 = cn_var_结果_1;
  return r7;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r9 = cn_var_i_0;
  r10 = r9 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r10;
  goto for_cond_954;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r78 = cn_var_i_0;
  r79 = r78 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r79;
  goto for_cond_995;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r32 = cn_var_i_0;
  r33 = r32 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r33;
  goto for_cond_1007;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r76 = cn_var_i_0;
  r77 = r76 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r77;
  goto for_cond_1128;
...
void 生成结构体指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r30 = 生成操作数代码(r28, r29);
  _Bool cn_var_是指针_0;
/* P7DBG_STORE src1.kind=2 */  cn_var_是指针_0 = 0;
  r31 = cn_var_指令->源操作数1;
  r32 = r31.类型信息;
  r33 = r32 != 0;
  ...
  if_then_1145:
/* P7DBG_STORE src1.kind=2 */  cn_var_是指针_0 = 1;
  goto if_merge_1146;
...
void 生成基本块代码(struct 基本块* cn_var_块, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r10 = cn_var_块->首条指令;
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r10;
  ...
  生成指令代码(r12, r13);
  r14 = cn_var_指令_0->下一条;
/* P7DBG_STORE src1.kind=1 */  cn_var_指令_0 = r14;
  goto while_cond_1232;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_局部变量_1 = r7;
  r8 = cn_var_缓冲区;
  追加缩进(r8, 4);
  ...
  r20 = cn_var_i_0;
  r21 = r20 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r21;
  goto for_cond_1237;
...
/* P7DBG_STORE src1.kind=2 */  cn_var_i_0 = 0;
  ...
  r30 = cn_var_i_0;
  r31 = r30 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_i_0 = r31;
  goto for_cond_1243;
...
/* P7DBG_STORE src1.kind=1 */  cn_var_参数_1 = r21;
  ...
  r40 = cn_var_函数指针->首个块;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_2 = r40;
  ...
  生成基本块代码(r42, r43);
  r44 = cn_var_块_2->下一个;
/* P7DBG_STORE src1.kind=1 */  cn_var_块_2 = r44;
  goto while_cond_1251;
...
struct C代码生成上下文* 创建C代码生成上下文(struct IR模块* cn_var_模块, struct 代码生成选项 cn_var_选项) {
  ...
  r1 = 分配内存(r0);
/* P7DBG_STORE src1.kind=1 */  cn_var_上下文_0 = r1;
  r2 = cn_var_上下文_0;
...
struct 代码生成选项 获取默认生成选项() {
  ...
  r1 = 分配清零内存(1, r0);
/* P7DBG_STORE src1.kind=7 */  cn_var_选项_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(struct 代码生成选项*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配清零内存(1, /* P7DBG_expr kind=1 */sizeof(struct 代码生成选项));
  r2 = cn_var_选项_0;
...
void 格式化整数(const char* cn_var_缓冲区, long long cn_var_缓冲区大小, long long cn_var_数值) {
  ...
  entry:
/* P7DBG_STORE src1.kind=2 */  cn_var_数值 = 0;
  ...
  char* cn_var_临时_0;
  r2 = 分配内存(32);
/* P7DBG_STORE src1.kind=7 */  cn_var_临时_0 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(char*)/* P7DBG_expr kind=1 *//* P7DBG_expr kind=2 */分配内存(32);
  long long cn_var_索引_1;
/* P7DBG_STORE src1.kind=2 */  cn_var_索引_1 = 0;
  long long cn_var_负数_2;
/* P7DBG_STORE src1.kind=2 */  cn_var_负数_2 = 0;
  r3 = cn_var_数值;
  r4 = r3 < 0;
  if (r4) goto if_then_1260; else goto if_merge_1261;

  if_then_1260:
/* P7DBG_STORE src1.kind=2 */  cn_var_负数_2 = 1;
  r5 = cn_var_数值;
  r6 = -r5;
/* P7DBG_STORE src1.kind=1 */  cn_var_数值 = r6;
  goto if_merge_1261;
  ...
  r14 = cn_var_索引_1;
  r15 = r14 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_索引_1 = r15;
  r16 = cn_var_数值;
  r17 = r16 / 10;
/* P7DBG_STORE src1.kind=1 */  cn_var_数值 = r17;
  goto while_cond_1262;

  while_exit_1264:
  long long cn_var_输出索引_3;
/* P7DBG_STORE src1.kind=2 */  cn_var_输出索引_3 = 0;
  r18 = cn_var_负数_2;
  ...
  r21 = cn_var_输出索引_3;
  r22 = r21 + 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_输出索引_3 = r22;
  goto if_merge_1266;
  ...
  r25 = cn_var_索引_1;
  r26 = r25 - 1;
/* P7DBG_STORE src1.kind=1 */  cn_var_索引_1 = r26;
  r27 = cn_var_临时_0;
  r28 = cn_var_索引_1;
...
void 追加小数(struct 输出缓冲区* cn_var_缓冲区, double cn_var_数值) {
  ...
  r0 = cn_var_数值;
/* P7DBG_STORE src1.kind=1 */  cn_var_整数部分_0 = r0;
  double cn_var_小数临时_1;
  r1 = cn_var_数值;
  r2 = cn_var_整数部分_0;
  r3 = r1 - r2;
/* P7DBG_STORE src1.kind=1 */  cn_var_小数临时_1 = r3;
  long long cn_var_小数部分_2;
  r4 = cn_var_小数临时_1;
  r5 = r4 * 1000000;
/* P7DBG_STORE src1.kind=7 */  cn_var_小数部分_2 = /* P7DBG_AST_EXPR kind=24 *//* P7DBG_expr kind=24 */(long long)/* P7DBG_expr kind=0 */(/* P7DBG_expr kind=2 */cn_var_小数临时 * 1000000);
  r6 = cn_var_缓冲区;
  r7 = cn_var_整数部分_0;
  r8 = 追加整数(r6, r7);
  r9 = cn_var_缓冲区;
