...
char* 类型到C类型(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r3 = r2->种类;
  r4 = r3 == 0;
  if (r4) goto case_body_3163; else goto switch_check_3177;

  switch_check_3177:
  r5 = r3 == 1;
  if (r5) goto case_body_3164; else goto switch_check_3178;

  switch_check_3178:
  r6 = r3 == 2;
  if (r6) goto case_body_3165; else goto switch_check_3179;

  switch_check_3179:
  r7 = r3 == 3;
  if (r7) goto case_body_3166; else goto switch_check_3180;

  switch_check_3180:
  r8 = r3 == 4;
  if (r8) goto case_body_3167; else goto switch_check_3181;

  switch_check_3181:
  r9 = r3 == 5;
  if (r9) goto case_body_3168; else goto switch_check_3182;

  switch_check_3182:
  r10 = r3 == 6;
  if (r10) goto case_body_3169; else goto switch_check_3183;

  switch_check_3183:
  r11 = r3 == 7;
  if (r11) goto case_body_3170; else goto switch_check_3184;

  switch_check_3184:
  r12 = r3 == 8;
  if (r12) goto case_body_3171; else goto switch_check_3185;

  switch_check_3185:
  r13 = r3 == 9;
  if (r13) goto case_body_3172; else goto switch_check_3186;

  switch_check_3186:
  r14 = r3 == 10;
  if (r14) goto case_body_3173; else goto switch_check_3187;

  switch_check_3187:
  r15 = r3 == 11;
  if (r15) goto case_body_3174; else goto switch_check_3188;

  switch_check_3188:
  r16 = r3 == 12;
  if (r16) goto case_body_3175; else goto case_default_3176;
  ...
  r82 = r81->参数个数;
  r83 = r80 < r82;
  if (r83) goto for_body_3190; else goto for_exit_3192;

  for_body_3190:
  r84 = cn_var_i_0;
  r85 = r84 > 0;
  if (r85) goto if_then_3193; else goto if_merge_3194;
...
char* 生成类型声明(struct 类型信息* cn_var_类型, char* cn_var_名称, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  if_merge_3196:
  if (6) goto if_then_3197; else goto if_merge_3198;
  ...
  if_merge_3198:
  if (7) goto if_then_3199; else goto if_merge_3200;
  ...
  r24 = r23->数组维度;
  r25 = r22 < r24;
  if (r25) goto for_body_3202; else goto for_exit_3204;
...
char* 生成操作数代码(struct IR操作数 cn_var_操作数, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r1 = r0.种类;
  r2 = r1 == 1;
  if (r2) goto case_body_3206; else goto switch_check_3213;

  switch_check_3213:
  r3 = r1 == 2;
  if (r3) goto case_body_3207; else goto switch_check_3214;

  switch_check_3214:
  r4 = r1 == 3;
  if (r4) goto case_body_3208; else goto switch_check_3215;

  switch_check_3215:
  r5 = r1 == 4;
  if (r5) goto case_body_3209; else goto switch_check_3216;

  switch_check_3216:
  r6 = r1 == 5;
  if (r6) goto case_body_3210; else goto switch_check_3217;

  switch_check_3217:
  r7 = r1 == 6;
  if (r7) goto case_body_3211; else goto case_default_3212;
...
void 生成算术指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r12 = r11->操作码;
  r13 = r12 == 0;
  if (r13) goto case_body_3219; else goto switch_check_3230;

  switch_check_3230:
  r14 = r12 == 1;
  if (r14) goto case_body_3220; else goto switch_check_3231;

  switch_check_3231:
  r15 = r12 == 2;
  if (r15) goto case_body_3221; else goto switch_check_3232;

  switch_check_3232:
  r16 = r12 == 3;
  if (r16) goto case_body_3222; else goto switch_check_3233;

  switch_check_3233:
  r17 = r12 == 4;
  if (r17) goto case_body_3223; else goto switch_check_3234;

  switch_check_3234:
  r18 = r12 == 5;
  if (r18) goto case_body_3224; else goto switch_check_3235;

  switch_check_3235:
  r19 = r12 == 6;
  if (r19) goto case_body_3225; else goto switch_check_3236;

  switch_check_3236:
  r20 = r12 == 7;
  if (r20) goto case_body_3226; else goto switch_check_3237;

  switch_check_3237:
  r21 = r12 == 8;
  if (r21) goto case_body_3227; else goto switch_check_3238;

  switch_check_3238:
  r22 = r12 == 9;
  if (r22) goto case_body_3228; else goto case_default_3229;
...
void 生成一元指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r8 = r7->操作码;
  r9 = r8 == 10;
  if (r9) goto case_body_3240; else goto switch_check_3244;

  switch_check_3244:
  r10 = r8 == 11;
  if (r10) goto case_body_3241; else goto switch_check_3245;

  switch_check_3245:
  r11 = r8 == 12;
  if (r11) goto case_body_3242; else goto case_default_3243;
...
void 生成比较指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r12 = r11->操作码;
  r13 = r12 == 13;
  if (r13) goto case_body_3247; else goto switch_check_3254;

  switch_check_3254:
  r14 = r12 == 14;
  if (r14) goto case_body_3248; else goto switch_check_3255;

  switch_check_3255:
  r15 = r12 == 15;
  if (r15) goto case_body_3249; else goto switch_check_3256;

  switch_check_3256:
  r16 = r12 == 16;
  if (r16) goto case_body_3250; else goto switch_check_3257;

  switch_check_3257:
  r17 = r12 == 17;
  if (r17) goto case_body_3251; else goto switch_check_3258;

  switch_check_3258:
  r18 = r12 == 18;
  if (r18) goto case_body_3252; else goto case_default_3253;
...
void 生成内存指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r1 = r0->操作码;
  r2 = r1 == 19;
  if (r2) goto case_body_3260; else goto switch_check_3267;

  switch_check_3267:
  r3 = r1 == 20;
  if (r3) goto case_body_3261; else goto switch_check_3268;

  switch_check_3268:
  r4 = r1 == 21;
  if (r4) goto case_body_3262; else goto switch_check_3269;

  switch_check_3269:
  r5 = r1 == 22;
  if (r5) goto case_body_3263; else goto switch_check_3270;

  switch_check_3270:
  r6 = r1 == 23;
  if (r6) goto case_body_3264; else goto switch_check_3271;

  switch_check_3271:
  r7 = r1 == 24;
  if (r7) goto case_body_3265; else goto case_default_3266;
...
void 生成控制流指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r1 = r0->操作码;
  r2 = r1 == 25;
  if (r2) goto case_body_3273; else goto switch_check_3279;

  switch_check_3279:
  r3 = r1 == 26;
  if (r3) goto case_body_3274; else goto switch_check_3280;

  switch_check_3280:
  r4 = r1 == 27;
  if (r4) goto case_body_3275; else goto switch_check_3281;

  switch_check_3281:
  r5 = r1 == 28;
  if (r5) goto case_body_3276; else goto switch_check_3282;

  switch_check_3282:
  r6 = r1 == 29;
  if (r6) goto case_body_3277; else goto case_default_3278;
  ...
  r59 = r58.种类;
  r60 = r59 != 0;
  if (r60) goto if_then_3283; else goto if_merge_3284;
  ...
  r75 = r74->额外参数数量;
  r76 = r73 < r75;
  if (r76) goto for_body_3286; else goto for_exit_3288;

  for_body_3286:
  r77 = cn_var_i_0;
  r78 = r77 > 0;
  if (r78) goto if_then_3289; else goto if_merge_3290;
  ...
  r97 = r96.种类;
  r98 = r97 != 0;
  if (r98) goto if_then_3291; else goto if_merge_3292;
...
void 生成结构体指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r1 = r0->操作码;
  r2 = r1 == 30;
  if (r2) goto case_body_3294; else goto switch_check_3298;

  switch_check_3298:
  r3 = r1 == 31;
  if (r3) goto case_body_3295; else goto switch_check_3299;

  switch_check_3299:
  r4 = r1 == 32;
  if (r4) goto case_body_3296; else goto case_default_3297;
...
void 生成指令代码(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r3 = r2->操作码;
  r4 = r3 == 0;
  if (r4) goto case_body_3303; else goto switch_check_3339;

  switch_check_3339:
  r5 = r3 == 1;
  if (r5) goto case_body_3304; else goto switch_check_3340;

  switch_check_3340:
  r6 = r3 == 2;
  if (r6) goto case_body_3305; else goto switch_check_3341;

  switch_check_3341:
  r7 = r3 == 3;
  if (r7) goto case_body_3306; else goto switch_check_3342;

  switch_check_3342:
  r8 = r3 == 4;
  if (r8) goto case_body_3307; else goto switch_check_3343;

  switch_check_3343:
  r9 = r3 == 5;
  if (r9) goto case_body_3308; else goto switch_check_3344;

  switch_check_3344:
  r10 = r3 == 6;
  if (r10) goto case_body_3309; else goto switch_check_3345;

  switch_check_3345:
  r11 = r3 == 7;
  if (r11) goto case_body_3310; else goto switch_check_3346;

  switch_check_3346:
  r12 = r3 == 8;
  if (r12) goto case_body_3311; else goto switch_check_3347;

  switch_check_3347:
  r13 = r3 == 9;
  if (r13) goto case_body_3312; else goto switch_check_3348;

  switch_check_3348:
  r14 = r3 == 10;
  if (r14) goto case_body_3313; else goto switch_check_3349;

  switch_check_3349:
  r15 = r3 == 11;
  if (r15) goto case_body_3314; else goto switch_check_3350;

  switch_check_3350:
  r16 = r3 == 12;
  if (r16) goto case_body_3315; else goto switch_check_3351;

  switch_check_3351:
  r17 = r3 == 13;
  if (r17) goto case_body_3316; else goto switch_check_3352;

  switch_check_3352:
  r18 = r3 == 14;
  if (r18) goto case_body_3317; else goto switch_check_3353;

  switch_check_3353:
  r19 = r3 == 15;
  if (r19) goto case_body_3318; else goto switch_check_3354;

  switch_check_3354:
  r20 = r3 == 16;
  if (r20) goto case_body_3319; else goto switch_check_3355;

  switch_check_3355:
  r21 = r3 == 17;
  if (r21) goto case_body_3320; else goto switch_check_3356;

  switch_check_3356:
  r22 = r3 == 18;
  if (r22) goto case_body_3321; else goto switch_check_3357;

  switch_check_3357:
  r23 = r3 == 19;
  if (r23) goto case_body_3322; else goto switch_check_3358;

  switch_check_3358:
  r24 = r3 == 20;
  if (r24) goto case_body_3323; else goto switch_check_3359;

  switch_check_3359:
  r25 = r3 == 21;
  if (r25) goto case_body_3324; else goto switch_check_3360;

  switch_check_3360:
  r26 = r3 == 22;
  if (r26) goto case_body_3325; else goto switch_check_3361;

  switch_check_3361:
  r27 = r3 == 23;
  if (r27) goto case_body_3326; else goto switch_check_3362;

  switch_check_3362:
  r28 = r3 == 24;
  if (r28) goto case_body_3327; else goto switch_check_3363;

  switch_check_3363:
  r29 = r3 == 25;
  if (r29) goto case_body_3328; else goto switch_check_3364;

  switch_check_3364:
  r30 = r3 == 26;
  if (r30) goto case_body_3329; else goto switch_check_3365;

  switch_check_3365:
  r31 = r3 == 27;
  if (r31) goto case_body_3330; else goto switch_check_3366;

  switch_check_3366:
  r32 = r3 == 28;
  if (r32) goto case_body_3331; else goto switch_check_3367;

  switch_check_3367:
  r33 = r3 == 29;
  if (r33) goto case_body_3332; else goto switch_check_3368;

  switch_check_3368:
  r34 = r3 == 30;
  if (r34) goto case_body_3333; else goto switch_check_3369;

  switch_check_3369:
  r35 = r3 == 31;
  if (r35) goto case_body_3334; else goto switch_check_3370;

  switch_check_3370:
  r36 = r3 == 32;
  if (r36) goto case_body_3335; else goto switch_check_3371;

  switch_check_3371:
  r37 = r3 == 33;
  if (r37) goto case_body_3336; else goto switch_check_3372;

  switch_check_3372:
  r38 = r3 == 34;
  if (r38) goto case_body_3337; else goto case_default_3338;
