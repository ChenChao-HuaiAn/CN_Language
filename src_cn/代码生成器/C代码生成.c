...
struct 输出缓冲区* 创建输出缓冲区(long long cn_var_初始容量) {
  ...
  r5 = cn_var_初始容量;
  r6 = cn_var_缓冲区_0->数据;
  if (r6) goto if_then_3221; else goto if_merge_3222;
  ...
  if_then_3221:
  r7 = cn_var_缓冲区_0->数据;
    { long long _tmp_i2 = 0; cn_rt_array_set_element(r7, 0, &_tmp_i2, 8); }
  goto if_merge_3222;
...
_Bool 扩展缓冲区(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_新容量) {
  long long r0, r2, r3, r4, r5, r6, r7, r11;
  char* r9;
  char* r10;
  struct 输出缓冲区* r1;
  void* r8;
  ...
  cn_var_新数据_0 = r8;
  r9 = cn_var_新数据_0;
  if (r9) goto if_then_3231; else goto if_merge_3232;
  ...
  logic_merge_3230:
  if (r5) goto if_then_3227; else goto if_merge_3228;
...
_Bool 追加字符串(struct 输出缓冲区* cn_var_缓冲区, const char* cn_var_字符串值) {
  long long r0, r2, r4, r6, r7, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r22, r24, r25, r26, r27, r31, r33, r34, r35;
  char* r3;
  char* r5;
  char* r28;
  struct 输出缓冲区* r1;
  ...
  r12 = cn_var_缓冲区->容量;
  r13 = r11 > r12;
  if (r13) goto if_then_3237; else goto if_merge_3238;
  ...
  r34 = cn_var_缓冲区->数据;
  r35 = cn_var_缓冲区->长度;
    { long long _tmp_i3 = 0; cn_rt_array_set_element(r34, r35, &_tmp_i3, 8); }
  return 1;
  ...
  r17 = cn_var_需要容量_1;
  r18 = r16 < r17;
  if (r18) goto while_body_3240; else goto while_exit_3241;
  ...
  r23 = 扩展缓冲区(r21, r22);
  r24 = !r23;
  if (r24) goto if_then_3242; else goto if_merge_3243;
...
void 追加缩进(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_缩进宽度) {
  ...
  r5 = r3 * r4;
  r6 = r2 < r5;
  if (r6) goto for_body_3247; else goto for_exit_3249;
...
void 增加缩进(struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3253:
  if (r4) goto if_then_3250; else goto if_merge_3251;
  return;
}
...
void 减少缩进(struct 输出缓冲区* cn_var_缓冲区) {
  ...
  logic_merge_3257:
  if (r3) goto if_then_3254; else goto if_merge_3255;
  return;
}

char* 类型到C类型(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r2, r16, r21, r22, r28, r30, r34, r38, r40, r44, r46, r50, r52, r56, r60, r61, r66, r67, r68, r69, r70, r73, r74, r78, r79, r82;
  char* r18;
  char* r24;
  char* r63;
  char* r77;
  ...
  r2 = cn_var_类型->种类;
  r3 = r2 == 类型种类_类型_空;
  if (r3) goto case_body_3261; else goto switch_check_3275;

  switch_check_3275:
  r4 = r2 == 类型种类_类型_整数;
  if (r4) goto case_body_3262; else goto switch_check_3276;

  switch_check_3276:
  r5 = r2 == 类型种类_类型_小数;
  if (r5) goto case_body_3263; else goto switch_check_3277;

  switch_check_3277:
  r6 = r2 == 类型种类_类型_布尔;
  if (r6) goto case_body_3264; else goto switch_check_3278;

  switch_check_3278:
  r7 = r2 == 类型种类_类型_字符串;
  if (r7) goto case_body_3265; else goto switch_check_3279;

  switch_check_3279:
  r8 = r2 == 类型种类_类型_字符;
  if (r8) goto case_body_3266; else goto switch_check_3280;

  switch_check_3280:
  r9 = r2 == 类型种类_类型_指针;
  if (r9) goto case_body_3267; else goto switch_check_3281;

  switch_check_3281:
  r10 = r2 == 类型种类_类型_数组;
  if (r10) goto case_body_3268; else goto switch_check_3282;

  switch_check_3282:
  r11 = r2 == 类型种类_类型_结构体;
  if (r11) goto case_body_3269; else goto switch_check_3283;

  switch_check_3283:
  r12 = r2 == 类型种类_类型_枚举;
  if (r12) goto case_body_3270; else goto switch_check_3284;

  switch_check_3284:
  r13 = r2 == 类型种类_类型_类;
  if (r13) goto case_body_3271; else goto switch_check_3285;

  switch_check_3285:
  r14 = r2 == 类型种类_类型_接口;
  if (r14) goto case_body_3272; else goto switch_check_3286;

  switch_check_3286:
  r15 = r2 == 类型种类_类型_函数;
  if (r15) goto case_body_3273; else goto case_default_3274;
  ...
  r27 = cn_var_缓冲区;
  r28 = cn_var_类型->维度大小;
  r29 = (void*)cn_rt_array_get_element(r28, 0, 8);
  r30 = 0 + r29;
  r31 = 追加整数(r27, r30);
  r32 = cn_var_缓冲区;
  r33 = 追加字符串(r32, "]");
  ...
  r67 = cn_var_类型->参数个数;
  r68 = r66 < r67;
  if (r68) goto for_body_3288; else goto for_exit_3290;

  for_body_3288:
  r69 = cn_var_i_0;
  r70 = r69 > 0;
  if (r70) goto if_then_3291; else goto if_merge_3292;
...
char* 生成类型声明(struct 类型信息* cn_var_类型, const char* cn_var_名称, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r2, r10, r11, r19, r20, r21, r25, r26, r28, r32, r33, r34, r43;
  char* r4;
  char* r8;
  char* r13;
  char* r17;
  ...
  r20 = cn_var_类型->数组维度;
  r21 = r19 < r20;
  if (r21) goto for_body_3300; else goto for_exit_3302;
...
char* 类型节点到C类型(struct 类型节点* cn_var_类型节点指针, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r2, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r30, r32, r33, r38, r39, r45, r46, r50, r54, r56, r60, r62, r66, r68, r72, r74, r77, r78, r80, r82;
  char* r35;
  char* r41;
  struct 类型节点* r0;
  struct 输出缓冲区* r29;
  ...
  r2 = cn_var_类型节点指针->类型;
  r3 = r2 == 节点类型_基础类型;
  if (r3) goto case_body_3306; else goto switch_check_3315;

  switch_check_3315:
  r4 = r2 == 节点类型_指针类型;
  if (r4) goto case_body_3307; else goto switch_check_3316;

  switch_check_3316:
  r5 = r2 == 节点类型_数组类型;
  if (r5) goto case_body_3308; else goto switch_check_3317;

  switch_check_3317:
  r6 = r2 == 节点类型_结构体类型;
  if (r6) goto case_body_3309; else goto switch_check_3318;

  switch_check_3318:
  r7 = r2 == 节点类型_枚举类型;
  if (r7) goto case_body_3310; else goto switch_check_3319;

  switch_check_3319:
  r8 = r2 == 节点类型_类类型;
  if (r8) goto case_body_3311; else goto switch_check_3320;

  switch_check_3320:
  r9 = r2 == 节点类型_接口类型;
  if (r9) goto case_body_3312; else goto switch_check_3321;

  switch_check_3321:
  r10 = r2 == 节点类型_函数类型;
  if (r10) goto case_body_3313; else goto case_default_3314;

  case_body_3306:
  r11 = cn_var_类型节点指针->名称;
  r12 = 比较字符串(r11, "整数");
  r13 = r12 == 0;
  if (r13) goto if_then_3322; else goto if_merge_3323;
  ...
  r15 = 比较字符串(r14, "小数");
  r16 = r15 == 0;
  if (r16) goto if_then_3324; else goto if_merge_3325;
  ...
  r18 = 比较字符串(r17, "布尔");
  r19 = r18 == 0;
  if (r19) goto if_then_3326; else goto if_merge_3327;
  ...
  r21 = 比较字符串(r20, "字符串");
  r22 = r21 == 0;
  if (r22) goto if_then_3328; else goto if_merge_3329;
  ...
  r24 = 比较字符串(r23, "字符");
  r25 = r24 == 0;
  if (r25) goto if_then_3330; else goto if_merge_3331;
  ...
  r27 = 比较字符串(r26, "空类型");
  r28 = r27 == 0;
  if (r28) goto if_then_3332; else goto if_merge_3333;
  ...
  if (r78) goto if_then_3334; else goto if_else_3335;
...
char* 生成操作数代码(struct IR操作数 cn_var_操作数, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r10, r12, r14, r16, r18, r19, r23, r25, r27, r29, r33, r34, r36;
  struct 输出缓冲区* r7;
  struct 输出缓冲区* r9;
  struct 输出缓冲区* r13;
  struct 输出缓冲区* r17;
  ...
  r0 = cn_var_操作数.种类;
  r1 = r0 == IR操作数种类_虚拟寄存器;
  if (r1) goto case_body_3338; else goto switch_check_3345;

  switch_check_3345:
  r2 = r0 == IR操作数种类_整数常量;
  if (r2) goto case_body_3339; else goto switch_check_3346;

  switch_check_3346:
  r3 = r0 == IR操作数种类_小数常量;
  if (r3) goto case_body_3340; else goto switch_check_3347;

  switch_check_3347:
  r4 = r0 == IR操作数种类_字符串常量;
  if (r4) goto case_body_3341; else goto switch_check_3348;

  switch_check_3348:
  r5 = r0 == IR操作数种类_全局符号;
  if (r5) goto case_body_3342; else goto switch_check_3349;

  switch_check_3349:
  r6 = r0 == IR操作数种类_基本块标签;
  if (r6) goto case_body_3343; else goto case_default_3344;
...
void 生成算术指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r9 = cn_var_指令->操作码;
  r10 = r9 == IR操作码_加法指令;
  if (r10) goto case_body_3351; else goto switch_check_3362;

  switch_check_3362:
  r11 = r9 == IR操作码_减法指令;
  if (r11) goto case_body_3352; else goto switch_check_3363;

  switch_check_3363:
  r12 = r9 == IR操作码_乘法指令;
  if (r12) goto case_body_3353; else goto switch_check_3364;

  switch_check_3364:
  r13 = r9 == IR操作码_除法指令;
  if (r13) goto case_body_3354; else goto switch_check_3365;

  switch_check_3365:
  r14 = r9 == IR操作码_取模指令;
  if (r14) goto case_body_3355; else goto switch_check_3366;

  switch_check_3366:
  r15 = r9 == IR操作码_与指令;
  if (r15) goto case_body_3356; else goto switch_check_3367;

  switch_check_3367:
  r16 = r9 == IR操作码_或指令;
  if (r16) goto case_body_3357; else goto switch_check_3368;

  switch_check_3368:
  r17 = r9 == IR操作码_异或指令;
  if (r17) goto case_body_3358; else goto switch_check_3369;

  switch_check_3369:
  r18 = r9 == IR操作码_左移指令;
  if (r18) goto case_body_3359; else goto switch_check_3370;

  switch_check_3370:
  r19 = r9 == IR操作码_右移指令;
  if (r19) goto case_body_3360; else goto case_default_3361;
...
void 生成一元指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r6 = cn_var_指令->操作码;
  r7 = r6 == IR操作码_负号指令;
  if (r7) goto case_body_3372; else goto switch_check_3376;

  switch_check_3376:
  r8 = r6 == IR操作码_取反指令;
  if (r8) goto case_body_3373; else goto switch_check_3377;

  switch_check_3377:
  r9 = r6 == IR操作码_逻辑非指令;
  if (r9) goto case_body_3374; else goto case_default_3375;
...
void 生成比较指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r9 = cn_var_指令->操作码;
  r10 = r9 == IR操作码_相等指令;
  if (r10) goto case_body_3379; else goto switch_check_3386;

  switch_check_3386:
  r11 = r9 == IR操作码_不等指令;
  if (r11) goto case_body_3380; else goto switch_check_3387;

  switch_check_3387:
  r12 = r9 == IR操作码_小于指令;
  if (r12) goto case_body_3381; else goto switch_check_3388;

  switch_check_3388:
  r13 = r9 == IR操作码_小于等于指令;
  if (r13) goto case_body_3382; else goto switch_check_3389;

  switch_check_3389:
  r14 = r9 == IR操作码_大于指令;
  if (r14) goto case_body_3383; else goto switch_check_3390;

  switch_check_3390:
  r15 = r9 == IR操作码_大于等于指令;
  if (r15) goto case_body_3384; else goto case_default_3385;
...
void 生成内存指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r8, r14, r15, r16, r17, r23, r28, r37, r42, r49, r54, r61, r66, r73, r78;
  char* r10;
  char* r25;
  char* r30;
  char* r39;
  ...
  r0 = cn_var_指令->操作码;
  r1 = r0 == IR操作码_分配指令;
  if (r1) goto case_body_3392; else goto switch_check_3399;

  switch_check_3399:
  r2 = r0 == IR操作码_加载指令;
  if (r2) goto case_body_3393; else goto switch_check_3400;

  switch_check_3400:
  r3 = r0 == IR操作码_存储指令;
  if (r3) goto case_body_3394; else goto switch_check_3401;

  switch_check_3401:
  r4 = r0 == IR操作码_移动指令;
  if (r4) goto case_body_3395; else goto switch_check_3402;

  switch_check_3402:
  r5 = r0 == IR操作码_取地址指令;
  if (r5) goto case_body_3396; else goto switch_check_3403;

  switch_check_3403:
  r6 = r0 == IR操作码_解引用指令;
  if (r6) goto case_body_3397; else goto case_default_3398;
...
void 生成控制流指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r9, r10, r11, r20, r21, r22, r30, r36, r37, r38, r43, r44, r45, r51, r52, r53, r54, r59, r64, r65, r66, r67, r68, r71, r72, r76, r77, r84, r85, r86, r89;
  char* r32;
  char* r56;
  char* r61;
  char* r75;
  ...
  r0 = cn_var_指令->操作码;
  r1 = r0 == IR操作码_标签指令;
  if (r1) goto case_body_3405; else goto switch_check_3411;

  switch_check_3411:
  r2 = r0 == IR操作码_跳转指令;
  if (r2) goto case_body_3406; else goto switch_check_3412;

  switch_check_3412:
  r3 = r0 == IR操作码_条件跳转指令;
  if (r3) goto case_body_3407; else goto switch_check_3413;

  switch_check_3413:
  r4 = r0 == IR操作码_调用指令;
  if (r4) goto case_body_3408; else goto switch_check_3414;

  switch_check_3414:
  r5 = r0 == IR操作码_返回指令;
  if (r5) goto case_body_3409; else goto case_default_3410;
  ...
  if (r53) goto if_then_3415; else goto if_merge_3416;
  ...
  r66 = r64 < r65;
  if (r66) goto for_body_3418; else goto for_exit_3420;

  for_body_3418:
  r67 = cn_var_i_0;
  r68 = r67 > 0;
  if (r68) goto if_then_3421; else goto if_merge_3422;
  ...
  if (r86) goto if_then_3423; else goto if_merge_3424;
...
void 生成结构体指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r0, r5, r10, r16, r17, r23, r28, r34, r35, r43, r48;
  char* r7;
  char* r12;
  char* r25;
  char* r30;
  ...
  r0 = cn_var_指令->操作码;
  r1 = r0 == IR操作码_成员指针指令;
  if (r1) goto case_body_3426; else goto switch_check_3430;

  switch_check_3430:
  r2 = r0 == IR操作码_成员访问指令;
  if (r2) goto case_body_3427; else goto switch_check_3431;

  switch_check_3431:
  r3 = r0 == IR操作码_结构体初始化指令;
  if (r3) goto case_body_3428; else goto case_default_3429;
...
void 生成指令代码(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r2, r51, r56, r61, r66;
  char* r53;
  char* r58;
  char* r63;
  char* r68;
  ...
  r2 = cn_var_指令->操作码;
  r3 = r2 == IR操作码_加法指令;
  if (r3) goto case_body_3435; else goto switch_check_3471;

  switch_check_3471:
  r4 = r2 == IR操作码_减法指令;
  if (r4) goto case_body_3436; else goto switch_check_3472;

  switch_check_3472:
  r5 = r2 == IR操作码_乘法指令;
  if (r5) goto case_body_3437; else goto switch_check_3473;

  switch_check_3473:
  r6 = r2 == IR操作码_除法指令;
  if (r6) goto case_body_3438; else goto switch_check_3474;

  switch_check_3474:
  r7 = r2 == IR操作码_取模指令;
  if (r7) goto case_body_3439; else goto switch_check_3475;

  switch_check_3475:
  r8 = r2 == IR操作码_与指令;
  if (r8) goto case_body_3440; else goto switch_check_3476;

  switch_check_3476:
  r9 = r2 == IR操作码_或指令;
  if (r9) goto case_body_3441; else goto switch_check_3477;

  switch_check_3477:
  r10 = r2 == IR操作码_异或指令;
  if (r10) goto case_body_3442; else goto switch_check_3478;

  switch_check_3478:
  r11 = r2 == IR操作码_左移指令;
  if (r11) goto case_body_3443; else goto switch_check_3479;

  switch_check_3479:
  r12 = r2 == IR操作码_右移指令;
  if (r12) goto case_body_3444; else goto switch_check_3480;

  switch_check_3480:
  r13 = r2 == IR操作码_负号指令;
  if (r13) goto case_body_3445; else goto switch_check_3481;

  switch_check_3481:
  r14 = r2 == IR操作码_取反指令;
  if (r14) goto case_body_3446; else goto switch_check_3482;

  switch_check_3482:
  r15 = r2 == IR操作码_逻辑非指令;
  if (r15) goto case_body_3447; else goto switch_check_3483;

  switch_check_3483:
  r16 = r2 == IR操作码_相等指令;
  if (r16) goto case_body_3448; else goto switch_check_3484;

  switch_check_3484:
  r17 = r2 == IR操作码_不等指令;
  if (r17) goto case_body_3449; else goto switch_check_3485;

  switch_check_3485:
  r18 = r2 == IR操作码_小于指令;
  if (r18) goto case_body_3450; else goto switch_check_3486;

  switch_check_3486:
  r19 = r2 == IR操作码_小于等于指令;
  if (r19) goto case_body_3451; else goto switch_check_3487;

  switch_check_3487:
  r20 = r2 == IR操作码_大于指令;
  if (r20) goto case_body_3452; else goto switch_check_3488;

  switch_check_3488:
  r21 = r2 == IR操作码_大于等于指令;
  if (r21) goto case_body_3453; else goto switch_check_3489;

  switch_check_3489:
  r22 = r2 == IR操作码_分配指令;
  if (r22) goto case_body_3454; else goto switch_check_3490;

  switch_check_3490:
  r23 = r2 == IR操作码_加载指令;
  if (r23) goto case_body_3455; else goto switch_check_3491;

  switch_check_3491:
  r24 = r2 == IR操作码_存储指令;
  if (r24) goto case_body_3456; else goto switch_check_3492;

  switch_check_3492:
  r25 = r2 == IR操作码_移动指令;
  if (r25) goto case_body_3457; else goto switch_check_3493;

  switch_check_3493:
  r26 = r2 == IR操作码_取地址指令;
  if (r26) goto case_body_3458; else goto switch_check_3494;

  switch_check_3494:
  r27 = r2 == IR操作码_解引用指令;
  if (r27) goto case_body_3459; else goto switch_check_3495;

  switch_check_3495:
  r28 = r2 == IR操作码_标签指令;
  if (r28) goto case_body_3460; else goto switch_check_3496;

  switch_check_3496:
  r29 = r2 == IR操作码_跳转指令;
  if (r29) goto case_body_3461; else goto switch_check_3497;

  switch_check_3497:
  r30 = r2 == IR操作码_条件跳转指令;
  if (r30) goto case_body_3462; else goto switch_check_3498;

  switch_check_3498:
  r31 = r2 == IR操作码_调用指令;
  if (r31) goto case_body_3463; else goto switch_check_3499;

  switch_check_3499:
  r32 = r2 == IR操作码_返回指令;
  if (r32) goto case_body_3464; else goto switch_check_3500;

  switch_check_3500:
  r33 = r2 == IR操作码_成员指针指令;
  if (r33) goto case_body_3465; else goto switch_check_3501;

  switch_check_3501:
  r34 = r2 == IR操作码_成员访问指令;
  if (r34) goto case_body_3466; else goto switch_check_3502;

  switch_check_3502:
  r35 = r2 == IR操作码_结构体初始化指令;
  if (r35) goto case_body_3467; else goto switch_check_3503;

  switch_check_3503:
  r36 = r2 == IR操作码_PHI指令;
  if (r36) goto case_body_3468; else goto switch_check_3504;

  switch_check_3504:
  r37 = r2 == IR操作码_选择指令;
  if (r37) goto case_body_3469; else goto case_default_3470;
...
void 生成基本块代码(struct 基本块* cn_var_块, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  while_cond_3507:
  r11 = cn_var_指令_0;
  if (r11) goto while_body_3508; else goto while_exit_3509;
...
void 生成局部变量声明(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r2, r3, r4, r5, r6, r9, r15, r20, r21;
  char* r11;
  struct IR函数* r0;
  void* r7;
  struct 输出缓冲区* r8;
  ...
  r4 = r2 < r3;
  if (r4) goto for_body_3513; else goto for_exit_3515;
...
void 生成函数代码(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r2, r8, r12, r13, r14, r15, r16, r19, r20, r22, r28, r30, r31, r40, r44;
  char* r4;
  char* r24;
  struct IR函数* r0;
  struct 输出缓冲区* r3;
  ...
  r14 = r12 < r13;
  if (r14) goto for_body_3519; else goto for_exit_3521;

  for_body_3519:
  r15 = cn_var_i_0;
  r16 = r15 > 0;
  if (r16) goto if_then_3522; else goto if_merge_3523;
  ...
  while_cond_3526:
  r41 = cn_var_块_2;
  if (r41) goto while_body_3527; else goto while_exit_3528;
