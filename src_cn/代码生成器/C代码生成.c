...
struct 输出缓冲区* 创建输出缓冲区(long long cn_var_初始容量) {
  ...
  cn_var_缓冲区_0 = /* NONE */;
  r1 = cn_var_缓冲区_0;
  if (r1) goto if_then_3121; else goto if_merge_3122;
  ...
  r4 = cn_var_缓冲区_0;
  r5 = r4->数据;
  if (r5) goto if_then_3123; else goto if_merge_3124;
  ...
  r6 = cn_var_缓冲区_0;
  r7 = r6->数据;
    { long long _tmp_i4 = 0; cn_rt_array_set_element(r7, 0, &_tmp_i4, 8); }
  goto if_merge_3124;
...
_Bool 扩展缓冲区(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_新容量) {
  long long r0, r2, r3, r5, r6, r9, r12;
  char* r8;
  char* r10;
  char* r11;
  struct 输出缓冲区* r1;
  ...
  cn_var_新数据_0 = /* NONE */;
  r10 = cn_var_新数据_0;
  if (r10) goto if_then_3133; else goto if_merge_3134;
...
_Bool 追加字符串(struct 输出缓冲区* cn_var_缓冲区, char* cn_var_字符串值) {
  long long r0, r2, r4, r7, r9, r10, r11, r13, r14, r16, r17, r18, r19, r20, r21, r22, r24, r25, r29, r30, r34, r36, r40;
  char* r3;
  char* r5;
  char* r27;
  char* r31;
  ...
  r13 = r12->容量;
  r14 = r11 > r13;
  if (r14) goto if_then_3139; else goto if_merge_3140;
  ...
  r39 = cn_var_缓冲区;
  r40 = r39->长度;
    { long long _tmp_i5 = 0; cn_rt_array_set_element(r38, r40, &_tmp_i5, 8); }
  return 1;
  ...
  r19 = cn_var_需要容量_1;
  r20 = r18 < r19;
  if (r20) goto while_body_3142; else goto while_exit_3143;
  ...
  扩展缓冲区(r23, r24);
  r25 = !/* NONE */;
  if (r25) goto if_then_3144; else goto if_merge_3145;
...
_Bool 追加字符(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_字符值) {
  ...
  r0 = cn_var_字符值;
  r1 = cn_var_字符串缓冲_0;
    { long long _tmp_r12 = r0; cn_rt_array_set_element(r1, 0, &_tmp_r12, 8); }
  r2 = cn_var_字符串缓冲_0;
    { long long _tmp_i6 = 0; cn_rt_array_set_element(r2, 1, &_tmp_i6, 8); }
  void cn_var_结果_1;
  r3 = cn_var_缓冲区;
  r4 = cn_var_字符串缓冲_0;
  追加字符串(r3, r4);
...
void 追加缩进(struct 输出缓冲区* cn_var_缓冲区, long long cn_var_缩进宽度) {
  long long r1, r2, r4, r5, r6, r7, r9, r10;
  struct 输出缓冲区* r0;
  struct 输出缓冲区* r3;
  struct 输出缓冲区* r8;
...
char* 类型到C类型(struct 类型信息* cn_var_类型, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r5, r8, r11, r14, r17, r20, r23, r26, r29, r32, r35, r38, r41, r56, r89, r91, r92, r93, r94, r98, r99, r101, r102;
  char* r48;
  char* r59;
  char* r63;
  char* r65;
  ...
  r54 = cn_var_类型;
  r55 = r54->维度大小;
  r56 = *(void*)cn_rt_array_get_element(r55, 0, 8);
  追加整数(r53, r56);
  r57 = cn_var_缓冲区;
  追加字符串(r57, "]");
  r58 = cn_var_缓冲区;
  ...
  r91 = r90->参数个数;
  r92 = r89 < r91;
  if (r92) goto for_body_3190; else goto for_exit_3192;

  for_body_3190:
  r93 = cn_var_i_0;
  r94 = r93 > 0;
  if (r94) goto if_then_3193; else goto if_merge_3194;
  ...
  r97 = r96->参数类型列表;
  r98 = cn_var_i_0;
  r99 = *(void*)cn_rt_array_get_element(r97, r98, 8);
  r100 = cn_var_缓冲区;
  类型到C类型(r99, r100);
...
char* 生成类型声明(struct 类型信息* cn_var_类型, char* cn_var_名称, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r3, r13, r20, r22, r23, r28, r29, r31, r32;
  char* r9;
  char* r11;
  char* r19;
  char* r34;
  ...
  r12 = cn_var_类型种类;
  r13 = r12.类型_数组;
  if (r13) goto if_then_3199; else goto if_merge_3200;
  ...
  r22 = r21->数组维度;
  r23 = r20 < r22;
  if (r23) goto for_body_3202; else goto for_exit_3204;
...
char* 生成操作数代码(struct IR操作数 cn_var_操作数, struct 输出缓冲区* cn_var_缓冲区) {
  long long r3, r6, r9, r12, r15, r18, r23, r28, r39, r51;
  char* r25;
  char* r30;
  char* r35;
  char* r41;
...
void 生成算术指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r11, r14, r17, r20, r23, r26, r29, r32, r35, r38;
  struct 输出缓冲区* r0;
  struct IR指令* r1;
  struct 输出缓冲区* r3;
  struct 输出缓冲区* r4;
  ...
  r11 = r10.加法指令;
  r12 = r9 == r11;
  if (r12) goto case_body_3219; else goto switch_check_3230;

  switch_check_3230:
  r13 = cn_var_IR操作码;
  r14 = r13.减法指令;
  r15 = r9 == r14;
  if (r15) goto case_body_3220; else goto switch_check_3231;

  switch_check_3231:
  r16 = cn_var_IR操作码;
  r17 = r16.乘法指令;
  r18 = r9 == r17;
  if (r18) goto case_body_3221; else goto switch_check_3232;

  switch_check_3232:
  r19 = cn_var_IR操作码;
  r20 = r19.除法指令;
  r21 = r9 == r20;
  if (r21) goto case_body_3222; else goto switch_check_3233;

  switch_check_3233:
  r22 = cn_var_IR操作码;
  r23 = r22.取模指令;
  r24 = r9 == r23;
  if (r24) goto case_body_3223; else goto switch_check_3234;

  switch_check_3234:
  r25 = cn_var_IR操作码;
  r26 = r25.与指令;
  r27 = r9 == r26;
  if (r27) goto case_body_3224; else goto switch_check_3235;

  switch_check_3235:
  r28 = cn_var_IR操作码;
  r29 = r28.或指令;
  r30 = r9 == r29;
  if (r30) goto case_body_3225; else goto switch_check_3236;

  switch_check_3236:
  r31 = cn_var_IR操作码;
  r32 = r31.异或指令;
  r33 = r9 == r32;
  if (r33) goto case_body_3226; else goto switch_check_3237;

  switch_check_3237:
  r34 = cn_var_IR操作码;
  r35 = r34.左移指令;
  r36 = r9 == r35;
  if (r36) goto case_body_3227; else goto switch_check_3238;

  switch_check_3238:
  r37 = cn_var_IR操作码;
  r38 = r37.右移指令;
  r39 = r9 == r38;
  if (r39) goto case_body_3228; else goto case_default_3229;
...
void 生成一元指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  r11 = r10.取反指令;
  r12 = r6 == r11;
  if (r12) goto case_body_3241; else goto switch_check_3245;

  switch_check_3245:
  r13 = cn_var_IR操作码;
  r14 = r13.逻辑非指令;
  r15 = r6 == r14;
  if (r15) goto case_body_3242; else goto case_default_3243;
...
void 生成比较指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r11, r14, r17, r20, r23, r26;
  struct 输出缓冲区* r0;
  struct IR指令* r1;
  struct 输出缓冲区* r3;
  struct 输出缓冲区* r4;
  ...
  r11 = r10.相等指令;
  r12 = r9 == r11;
  if (r12) goto case_body_3247; else goto switch_check_3254;

  switch_check_3254:
  r13 = cn_var_IR操作码;
  r14 = r13.不等指令;
  r15 = r9 == r14;
  if (r15) goto case_body_3248; else goto switch_check_3255;

  switch_check_3255:
  r16 = cn_var_IR操作码;
  r17 = r16.小于指令;
  r18 = r9 == r17;
  if (r18) goto case_body_3249; else goto switch_check_3256;

  switch_check_3256:
  r19 = cn_var_IR操作码;
  r20 = r19.小于等于指令;
  r21 = r9 == r20;
  if (r21) goto case_body_3250; else goto switch_check_3257;

  switch_check_3257:
  r22 = cn_var_IR操作码;
  r23 = r22.大于指令;
  r24 = r9 == r23;
  if (r24) goto case_body_3251; else goto switch_check_3258;

  switch_check_3258:
  r25 = cn_var_IR操作码;
  r26 = r25.大于等于指令;
  r27 = r9 == r26;
  if (r27) goto case_body_3252; else goto case_default_3253;
...
void 生成内存指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r3, r6, r9, r12, r15, r18, r29;
  struct IR指令* r0;
  struct 输出缓冲区* r20;
  struct IR指令* r21;
  struct 输出缓冲区* r23;
...
void 生成控制流指令(struct IR指令* cn_var_指令, struct 输出缓冲区* cn_var_缓冲区) {
  long long r3, r6, r9, r12, r15, r22, r31, r44, r50, r58, r59, r68, r70, r71, r72, r73, r77, r78, r80, r81, r90, r91;
  void* r76;
  struct IR指令* r0;
  struct 输出缓冲区* r17;
  struct 输出缓冲区* r18;
  ...
  r58 = r57.无操作数;
  r59 = r56 != r58;
  if (r59) goto if_then_3283; else goto if_merge_3284;
  ...
  r70 = r69->额外参数数量;
  r71 = r68 < r70;
  if (r71) goto for_body_3286; else goto for_exit_3288;

  for_body_3286:
  r72 = cn_var_i_0;
  r73 = r72 > 0;
  if (r73) goto if_then_3289; else goto if_merge_3290;
  ...
  r76 = r75->额外参数;
  r77 = cn_var_i_0;
  r78 = *(void*)cn_rt_array_get_element(r76, r77, 8);
  r79 = cn_var_缓冲区;
  生成操作数代码(r78, r79);
  ...
  r90 = r89.无操作数;
  r91 = r88 != r90;
  if (r91) goto if_then_3291; else goto if_merge_3292;
...
void 生成基本块代码(struct 基本块* cn_var_块, struct 输出缓冲区* cn_var_缓冲区) {
  ...
  while_cond_3375:
  r10 = cn_var_指令_0;
  if (r10) goto while_body_3376; else goto while_exit_3377;
...
void 生成局部变量声明(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r2, r4, r5, r8, r9, r17, r20, r21;
  void* r7;
  struct IR函数* r0;
  struct IR函数* r3;
  struct IR函数* r6;
...
void 生成函数代码(struct IR函数* cn_var_函数指针, struct 输出缓冲区* cn_var_缓冲区) {
  long long r1, r10, r12, r13, r14, r15, r19, r20, r22, r26, r27, r28;
  char* r8;
  void* r18;
  struct IR函数* r0;
  struct IR函数* r2;
  ...
  r12 = r11->参数数量;
  r13 = r10 < r12;
  if (r13) goto for_body_3387; else goto for_exit_3389;

  for_body_3387:
  r14 = cn_var_i_0;
  r15 = r14 > 0;
  if (r15) goto if_then_3390; else goto if_merge_3391;
  ...
  while_cond_3394:
  r37 = cn_var_块_2;
  if (r37) goto while_body_3395; else goto while_exit_3396;
...
struct 代码生成选项 获取默认生成选项() {
  ...
  cn_var_选项_0 = /* NONE */;
  r1 = cn_var_选项_0;
  r2 = *(void*)cn_rt_array_get_element(r1, 0, 8);
  return r2;
}

void 格式化整数(char* cn_var_缓冲区, long long cn_var_缓冲区大小, long long cn_var_数值) {
  long long r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r30, r31, r32, r34, r35;
  char* r0;
  char* r1;
  char* r18;
  char* r29;
  ...
  if_then_3401:
  r0 = cn_var_缓冲区;
    { long long _tmp_i7 = 48; cn_rt_array_set_element(r0, 0, &_tmp_i7, 8); }
  r1 = cn_var_缓冲区;
    { long long _tmp_i8 = 0; cn_rt_array_set_element(r1, 1, &_tmp_i8, 8); }
  return;
  goto if_merge_3402;
  ...
  r2 = cn_var_数值;
  r3 = r2 < 0;
  if (r3) goto if_then_3403; else goto if_merge_3404;
  ...
  r6 = cn_var_数值;
  r7 = r6 > 0;
  if (r7) goto while_body_3406; else goto while_exit_3407;
  ...
  r11 = cn_var_临时_0;
  r12 = cn_var_索引_1;
    { long long _tmp_r13 = r10; cn_rt_array_set_element(r11, r12, &_tmp_r13, 8); }
  r13 = cn_var_索引_1;
  r14 = r13 + 1;
  cn_var_索引_1 = r14;
  r15 = cn_var_数值;
  ...
  cn_var_输出索引_3 = 0;
  r17 = cn_var_负数_2;
  if (r17) goto if_then_3408; else goto if_merge_3409;

  if_then_3408:
  r18 = cn_var_缓冲区;
  r19 = cn_var_输出索引_3;
    { long long _tmp_i9 = 45; cn_rt_array_set_element(r18, r19, &_tmp_i9, 8); }
  r20 = cn_var_输出索引_3;
  r21 = r20 + 1;
  cn_var_输出索引_3 = r21;
  goto if_merge_3409;
  ...
  r22 = cn_var_索引_1;
  r23 = r22 > 0;
  if (r23) goto while_body_3411; else goto while_exit_3412;
  ...
  r29 = cn_var_缓冲区;
  r30 = cn_var_输出索引_3;
    { long long _tmp_r14 = r28; cn_rt_array_set_element(r29, r30, &_tmp_r14, 8); }
  r31 = cn_var_输出索引_3;
  r32 = r31 + 1;
  cn_var_输出索引_3 = r32;
  goto while_cond_3410;
  ...
  r33 = cn_var_缓冲区;
  r34 = cn_var_输出索引_3;
    { long long _tmp_i10 = 0; cn_rt_array_set_element(r33, r34, &_tmp_i10, 8); }
  r35 = cn_var_临时_0;
  释放内存(r35);
  return;
}
