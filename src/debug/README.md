...
int main()
{
    ...
    // 输出不同级别的调试信息
    CN_DEBUG(CN_DEBUG_LEVEL_ERROR, "这是一个错误信息: %d", 42);
    CN_DEBUG(CN_DEBUG_LEVEL_WARN, "这是一个警告信息");
    CN_DEBUG(CN_DEBUG_LEVEL_INFO, "这是一个普通信息");
    CN_DEBUG(CN_DEBUG_LEVEL_DEBUG, "这是一个调试信息");
...
int main()
{
    ...
    CN_DEBUG(CN_DEBUG_LEVEL_INFO, "这条信息将写入debug.log文件");
