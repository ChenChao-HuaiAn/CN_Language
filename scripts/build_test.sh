...
# 编译器设置
CC="gcc"
CFLAGS="-std=c99 -Wall -Wextra -I. -I./src -I./tests"
LDFLAGS=""
...
TEST_FILES=(
    ...
    "tests/infrastructure/containers/array/test_runner.c"
)
...
# 链接可执行文件
echo "链接可执行文件..."
EXECUTABLE="$BIN_DIR/test_dynamic_array"
OBJ_FILES=("$OBJ_DIR"/*.o)
